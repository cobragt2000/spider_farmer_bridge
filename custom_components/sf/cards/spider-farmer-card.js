/*! spider-farmer-card v0.20.3 | MIT */
...
`;function wt(t){const e=new Set;for(const s of Object.keys(t.states)){const t=bt(s).match(vt);t&&e.add(t[1])}return[...e].sort()}function St(t){return wt(t).filter(e=>Object.keys(t.states).some(t=>{const s=bt(t);return s===`sf_${e}_temperature`||s===`sf_${e}_soil_avg_temperature`||s===`sf_${e}_light_1`||s===`sf_${e}_fan`||s===`sf_${e}_blower`}))}function kt(t,e){const s=`sf_${e}_`,i=Object.keys(t.states);return i.find(t=>bt(t)===`sf_${e}_temperature`)??i.find(t=>{const i=bt(t);return i.startsWith(s)&&!i.startsWith(`sf_${e}_env_`)})}function Ot(t,e){const s=kt(t,e);return s?t.entities?.[s]?.device_id:void 0}function Mt(t,e){if(!e)return[];const s=Ot(t,e);return function(t){return wt(t).filter(e=>!!t.states[`switch.sf_${e}_outlet_1`])}(t).filter(i=>{if(i===e)return!0;if(!s)return!1;const o=Ot(t,i),r=o?t.devices?.[o]:void 0;return r?.via_device_id===s})}function Ct(t,e){if(!t||!e)return"";const s=kt(t,e);if(!s)return"";const i=t.entities?.[s]?.device_id,o=i?t.devices?.[i]:void 0;if(o)return o.name_by_user||o.name||"";const r=(t.states[s].attributes.friendly_name||"").match(/^(SF .+? [0-9A-Fa-f]{4})\b/);return r?r[1]:""}const At=[["temperature","Air Temp","mdi:thermometer"],["humidity","Air Humi","mdi:water-percent"],["vpd","Air VPD","mdi:water-opacity"],["leaf_vpd","Leaf VPD","mdi:leaf"],["co2","CO2","mdi:molecule-co2"],["ppfd","PPFD","mdi:white-balance-sunny"],["soil_avg_temperature","Soil Temp","mdi:thermometer"],["soil_avg_moisture","Moisture","mdi:water"],["soil_avg_ec","Soil EC","mdi:flash"]],Dt={temperature:"temp",humidity:"humi",vpd:"vpd",co2:"co2",ppfd:"ppfd",soil_avg_temperature:"tempSoil",soil_avg_moisture:"humiSoil",soil_avg_ec:"ECSoil"},Tt={temperature:"temp",humidity:"humi",co2:"co2"},Rt="#ff6b6b",Et="rgba(255,107,107,0.16)",Nt=(t,e=.16)=>{const s=/^#?([0-9a-fA-F]{6})$/.exec((t||"").trim());if(!s)return`rgba(255,107,107,${e})`;const i=parseInt(s[1],16);return`rgba(${i>>16&255},${i>>8&255},${255&i},${e})`},Pt=t=>"string"==typeof t&&/^#[0-9a-fA-F]{6}$/.test(t),Ft=t=>"alarms"===t||"targets"===t||"both"===t,zt=gt,Bt={"Time Slot":["ts_type","ts_start","ts_stop"],Cycle:["cycle_start","cycle_run","cycle_off","cycle_times"],Temperature:["temp_device"],Humidity:["humidity_device"],CO2:["co2_device"],"Drip Irrigation":["drip_soil","drip_avg"],Manual:[]},Lt=gt,It=t=>!!t&&("unavailable"===t.state||"unknown"===t.state),Ht=t=>{const e=(t||"").match(/^(\d{1,2}):(\d{2})$/);if(!e)return null;const s=+e[1],i=+e[2];return s<=23&&i<=59?60*s+i:null},jt=(t,e,s,i,o="")=>W`<div class="save-bar ${o}">
  ${((t,e,s,i)=>W`
    ...
    @click=${i}>Discard</button>`)(t,e,s,i)}
      ...
      <div class="pg-plot">
        ...
        <svg viewBox="0 0 ${g} ${m}" preserveAspectRatio="none" class="pg-svg">
          ...
          <circle cx=${y(o[M].t).toFixed(1)} cy=${w(a).toFixed(1)} r="2.5" fill=${this.colLo}></circle>
      ...
      ${t.map(t=>{const s=Ct(this.hass,t)||`${t.toUpperCase()} Power Strip`;return W`
      ...
      ${o.length?W`
        ...
        @click=${()=>this.tab=t}>${i}</button>`,o=Ct(this.hass,this.config.panel);return W`
      <ha-card>
        <div class="header">
      ...
      <details class="leaf-cal">
        ...
        <div class="set-note">
          ...
          becomes leaf temp; the implied offset (leaf − air) fills the field
          above — Apply to save it.
        </div>
      ...
      <div class="seg-row">
        ${M("alarms","Alarms","mdi:bell-outline")}
        ${M("targets","Targets","mdi:target")}
        ${M("both","Both","mdi:set-center")}
      </div>
      ...
      <div class="color-row">
        ${C("Above max",o,t=>S({hi:t}))}
        ${C("Below min",r,t=>S({lo:t}))}
        ${C("Near edge",n,t=>S({warn:t}))}
      </div>
      ...
      ${v?W`
            ...
            <div class="color-row">
              ${C("Manual",u,t=>S({ocManual:t}))}
              ${C("Scheduled",f,t=>S({ocSched:t}))}
            </div>
            <div class="color-row">
              ${C("Environment",g,t=>S({ocEnv:t}))}
              ${C("Drip",m,t=>S({ocDrip:t}))}
            </div>`:q}
      ...
      ${y?W`
            ...
            <div class="color-row">
              ${C("Manual",_,t=>S({dcManual:t}))}
              ${C("Scheduled",$,t=>S({dcSched:t}))}
              ${C("Auto",x,t=>S({dcAuto:t}))}
            </div>`:q}
  ...
  `,t([ut({attribute:!1})],Jt.prototype,"hass",void 0),t([ft()],Jt.prototype,"_config",void 0);const Kt=/^sf_(se\d+)_light$/;function Zt(t){const e=new Set;for(const s of Object.keys(t.states)){if(!s.startsWith("light."))continue;const t=bt(s).match(Kt);t&&e.add(t[1])}return[...e].sort((t,e)=>Number(t.replace(/\D/g,""))-Number(e.replace(/\D/g,"")))}class Xt extends dt{constructor(){super(...arguments),this.draft=null,this.ctlDraft={}}setConfig(t){this.config=t}getCardSize(){return 7}static getStubConfig(t){const e=t?Zt(t):[];return{type:"custom:spider-light-card",...e[0]?{light:e[0]}:{}}}accent(){return this.config.accent||gt}seSlot(){return this.config.light||(this.hass?Zt(this.hass)[0]:"")||"se1"}get(t){return this.hass?.states[t]}shouldUpdate(t){return t.has("config")||t.has("hass")||t.has("draft")||t.has("ctlDraft")}cur(t,e){return t in this.ctlDraft?this.ctlDraft[t]:e}stageCtl(t,e){this.ctlDraft={...this.ctlDraft,[t]:e}}isDirty(){return Object.keys(this.ctlDraft).length>0||null!==this.draft}applyAll(t){const e=this.ctlDraft,s=`light.sf_${t}_light`;if("bri"in e){const t=Number(e.bri);t>0?this.hass?.callService("light","turn_on",{entity_id:s,brightness_pct:t}):this.hass?.callService("light","turn_off",{entity_id:s})}"mode"in e&&this.hass?.callService("select","select_option",{entity_id:`select.sf_${t}_mode`,option:e.mode});for(const t of Object.keys(e))t.includes(".")&&(t.startsWith("number.")?this.hass?.callService("number","set_value",{entity_id:t,value:Number(e[t])}):t.startsWith("text.")&&this.hass?.callService("text","set_value",{entity_id:t,value:e[t]}));if("power"in e){const t="on"===e.power;t&&"bri"in e||this.hass?.callService("light",t?"turn_on":"turn_off",{entity_id:s})}this.draft&&this.saveSchedule(t),this.ctlDraft={}}discardAll(){Object.keys(this.ctlDraft).length&&(this.ctlDraft={}),null!==this.draft&&(this.draft=null)}render(){if(!this.hass||!this.config)return q;const t=this.seSlot(),e=this.get(`light.sf_${t}_light`);if(!e)return W`<ha-card>
      ...
      </ha-card>`;const s="on"===e.state,i=s?Math.max(0,Math.min(100,Math.round((e.attributes.brightness??0)/255*100))):0,o=this.get(`select.sf_${t}_mode`),r=this.cur("mode",o?.state??""),a="bri"in this.ctlDraft,n="on"===this.cur("power",s?"on":"off"),l=a?Number(this.ctlDraft.bri):n?i:0,d=a?l>0:n,c=Ct(this.hass,t),h=this.accent(),p=l/100,[u,f]=_t(100,100,78,135+270*p);return W`
      <ha-card>
        <div class="header">
        ...
        <div class="gauge">
          <svg viewBox="0 0 200 190" aria-hidden="true">
            ...
            ${d&&p>0?V`<path d=${$t(100,100,78,0,p)} fill="none"
