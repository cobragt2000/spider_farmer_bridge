/*! spider-farmer-card v0.20.18 | MIT */
...
`;function wt(t){const e=new Set;for(const s of Object.keys(t.states)){const t=bt(s).match(vt);t&&e.add(t[1])}return[...e].sort()}function St(t){return wt(t).filter(e=>e.startsWith("st")&&!!t.states[`switch.sf_${e}_outlet_1`]||Object.keys(t.states).some(t=>{const s=bt(t);return s===`sf_${e}_temperature`||s===`sf_${e}_soil_avg_temperature`||s===`sf_${e}_light_1`||s===`sf_${e}_fan`||s===`sf_${e}_blower`}))}function Ot(t,e){const s=`sf_${e}_`,i=Object.keys(t.states);return i.find(t=>bt(t)===`sf_${e}_temperature`)??i.find(t=>{const i=bt(t);return i.startsWith(s)&&!i.startsWith(`sf_${e}_env_`)})}function kt(t,e){const s=Ot(t,e);return s?t.entities?.[s]?.device_id:void 0}function Ct(t,e){if(!e)return[];const s=kt(t,e);return s?function(t){return wt(t).filter(e=>!!t.states[`switch.sf_${e}_outlet_1`])}(t).filter(i=>{if(i===e)return!1;const o=kt(t,i),a=o?t.devices?.[o]:void 0;return a?.via_device_id===s}):[]}function Dt(t,e){if(!t||!e)return"";const s=Ot(t,e);if(!s)return"";const i=t.entities?.[s]?.device_id,o=i?t.devices?.[i]:void 0;if(o)return o.name_by_user||o.name||"";const a=(t.states[s].attributes.friendly_name||"").match(/^(SF .+? [0-9A-Fa-f]{4})\b/);return a?a[1]:""}const Mt=[["temperature","Air Temp","mdi:thermometer"],["humidity","Air Humi","mdi:water-percent"],["vpd","Air VPD","mdi:water-opacity"],["leaf_vpd","Leaf VPD","mdi:leaf"],["co2","CO2","mdi:molecule-co2"],["ppfd","PPFD","mdi:white-balance-sunny"],["soil_avg_temperature","Soil Temp","mdi:thermometer"],["soil_avg_moisture","Moisture","mdi:water"],["soil_avg_ec","Soil EC","mdi:flash"]],At={temperature:"temp",humidity:"humi",vpd:"vpd",co2:"co2",ppfd:"ppfd",soil_avg_temperature:"tempSoil",soil_avg_moisture:"humiSoil",soil_avg_ec:"ECSoil"},Nt={temperature:"temp",humidity:"humi",co2:"co2"},Tt="#ff6b6b",Rt="rgba(255,107,107,0.16)",Et=(t,e=.16)=>{const s=/^#?([0-9a-fA-F]{6})$/.exec((t||"").trim());if(!s)return`rgba(255,107,107,${e})`;const i=parseInt(s[1],16);return`rgba(${i>>16&255},${i>>8&255},${255&i},${e})`},Pt=t=>"string"==typeof t&&/^#[0-9a-fA-F]{6}$/.test(t),Lt=t=>"alarms"===t||"targets"===t||"both"===t,Ft=gt,zt={"Time Slot":["ts_type","ts_start","ts_stop"],Cycle:["cycle_start","cycle_run","cycle_off","cycle_times"],Temperature:["temp_device"],Humidity:["humidity_device"],CO2:["co2_device"],"Drip Irrigation":["drip_soil","drip_avg"],Manual:[]},Bt=gt,It=t=>!!t&&("unavailable"===t.state||"unknown"===t.state),Ht=t=>{const e=(t||"").match(/^(\d{1,2}):(\d{2})$/);if(!e)return null;const s=+e[1],i=+e[2];return s<=23&&i<=59?60*s+i:null},jt=(t,e,s,i,o="")=>W`<div class="save-bar ${o}">
  ${((t,e,s,i)=>W`
  ...
  <button class="discard-btn" ?disabled=${!e}
    @click=${i}>Discard</button>`)(t,e,s,i)}
      ...
      <div class="pg-plot">
        <div class="pg-yax"><span>${h(_)}</span><span>${h($)}</span></div>
        <svg viewBox="0 0 ${g} ${m}" preserveAspectRatio="none" class="pg-svg">
          ${p?V`
            <rect x="0" y=${w(p.warnHi).toFixed(1)} width=${g} height=${(w(p.bandHi)-w(p.warnHi)).toFixed(1)} fill=${Et(this.colWarn,.16)}></rect>
            <rect x="0" y=${w(p.bandLo).toFixed(1)} width=${g} height=${(w(p.warnLo)-w(p.bandLo)).toFixed(1)} fill=${Et(this.colWarn,.16)}></rect>
            <rect x="0" y=${w(p.bandHi).toFixed(1)} width=${g} height=${(w(p.bandLo)-w(p.bandHi)).toFixed(1)} fill=${Et(this.colIn,.2)}></rect>
          ...
          <circle cx=${y(o[D].t).toFixed(1)} cy=${w(n).toFixed(1)} r="2.5" fill=${this.colHi}></circle>
    ...
    </div>`}soilCellStyle(t,e){const s=this.get(`sensor.sf_${this.config.panel}_${t}_${e}`);if(!s||It(s))return"";const i="temperature"===e?"tempSoil":"moisture"===e?"humiSoil":"ECSoil",o=this.readingColor(i,s.state);return o?`color:${o.color}`:""}getCardSize(){return 8}static getConfigElement(){return document.createElement("spider-farmer-card-editor")}static getStubConfig(t){const e=(t?St(t):[])[0]||"dp1",s=t?Ct(t,e):[];return{type:"custom:spider-farmer-card",panel:e,...s.length?{outlets:s}:{}}}eid(t,e){return`${t}.sf_${this.config.panel}_${e}`}get(t){return this.hass?.states[t]}accent(){return this.config.accent||gt}shouldUpdate(t){return t.has("config")||t.has("hass")||t.has("tab")||t.has("soilOpen")||t.has("soilAllOpen")||t.has("outletDraft")||t.has("outletNameDraft")||t.has("outletCfgDraft")||t.has("alertsDraft")||t.has("deviceOpen")||t.has("outletOpen")||t.has("draft")||t.has("modePick")||t.has("logDate")||t.has("logDev")||t.has("logType")||t.has("colorMode")||t.has("colorModeIn")||t.has("colHi")||t.has("colLo")||t.has("colIn")||t.has("hideLight2")||t.has("colorDraft")||t.has("outletColorMode")||t.has("ocManual")||t.has("ocSched")||t.has("ocEnv")||t.has("ocDrip")||t.has("deviceColorMode")||t.has("dcManual")||t.has("dcSched")||t.has("dcAuto")||t.has("colorSource")||t.has("colWarn")||t.has("showTrend")||t.has("showBand")||t.has("paramOpen")||t.has("_graphVer")||t.has("showTargets")||t.has("leafSpots")||t.has("leafCalTarget")||t.has("customOutletNames")||t.has("outletNames")||t.has("customLayout")||t.has("cardScale")||t.has("tileCols")}willUpdate(t){if(!this._colorSynced){const t=this.serverColors();Object.keys(t).length&&(t.mode&&(this.colorMode=t.mode),t.modeIn&&(this.colorModeIn=t.modeIn),t.source&&(this.colorSource=t.source),t.warn&&(this.colWarn=t.warn),void 0!==t.showTrend&&(this.showTrend=t.showTrend),void 0!==t.showBand&&(this.showBand=t.showBand),void 0!==t.showTargets&&(this.showTargets=t.showTargets),t.hi&&(this.colHi=t.hi),t.lo&&(this.colLo=t.lo),t.in&&(this.colIn=t.in),void 0!==t.hide2&&(this.hideLight2=t.hide2),t.omode&&(this.outletColorMode=t.omode),t.ocManual&&(this.ocManual=t.ocManual),t.ocSched&&(this.ocSched=t.ocSched),t.ocEnv&&(this.ocEnv=t.ocEnv),t.ocDrip&&(this.ocDrip=t.ocDrip),t.dmode&&(this.deviceColorMode=t.dmode),t.dcManual&&(this.dcManual=t.dcManual),t.dcSched&&(this.dcSched=t.dcSched),t.dcAuto&&(this.dcAuto=t.dcAuto),void 0!==t.customNames&&(this.customOutletNames=t.customNames),void 0!==t.customLayout&&(this.customLayout=t.customLayout),t.scale&&(this.cardScale=t.scale),t.cols&&(this.tileCols=t.cols),this._colorSynced=!0,this.cacheColors());const e=this.serverOutletNames();Object.keys(e).length&&(this.outletNames=e)}if(t.has("tab")&&(null!==this.colorDraft&&(this.colorDraft=null),null!==this.alertsDraft&&(this.alertsDraft=null),Object.keys(this.draft).length&&(this.draft={}),Object.keys(this.outletDraft).length&&(this.outletDraft={}),Object.keys(this.outletNameDraft).length&&(this.outletNameDraft={}),Object.keys(this.outletCfgDraft).length&&(this.outletCfgDraft={}),Object.keys(this.modePick).length&&(this.modePick={})),t.has("hass")&&this.recordHistory(),t.has("hass")&&Object.keys(this.modePick).length){let t=null;const e=Date.now();for(const[s,i]of Object.entries(this.modePick)){const o=this.get(s)?.state===i,a=e-(this.modePickAt[s]??e)>6e3;(o||a)&&(t=t??{...this.modePick},delete t[s],delete this.modePickAt[s])}t&&(this.modePick=t)}}renderParam([t,e,s]){const i=this.get(`sensor.sf_${this.config.panel}_${t}`);if(!i)return q;const o=i.attributes.unit_of_measurement||"",a=t.startsWith("soil_avg_")&&It(i),r=a?"Offline":this.hass?.formatEntityState?this.hass.formatEntityState(i).replace(o,"").trim():i.state,n=t.startsWith("soil_avg_")?t.slice(9):null,l=!!n&&this.soilProbeRows(n).length>1,c=l&&this.soilOpen===n;let d;const h=this.paramOpen===t;if(a)d=null;else{const e=parseFloat(i.state);if(Number.isFinite(e)){const s="targets"!==this.colorSource?this.outOfRange(At[t],e):null,i="alarms"!==this.colorSource||"leaf_vpd"===t?this.targetOutOfRange(t,e):null;d=this.colorForOor(s??i)}else d=null}const p=!a&&!l;let u=c||h?`box-shadow:inset 0 0 0 1px ${this.accent()}`:"",f="";a?(u=`background:${Rt};box-shadow:inset 0 0 0 1px ${Tt}`,f=`color:${Tt}`):d&&"text"===d.mode?f=`color:${d.color}`:d&&"tile"===d.mode&&(u=`background:${Et(d.color)};box-shadow:inset 0 0 0 1px ${d.color}`);const g=l||p;return W`
      <div class="tile ${g?"clickable":""} ${c||h?"active":""}"
        style=${u||q}
        role=${g?"button":q}
    ...
    </div>`}renderLightBody(t,e){const s=this.config.panel,i=t.suffix,o="on"===e.state,a=`select.sf_${s}_${i}_mode`,r=this.get(a),n=this.modeOf(a),l=this.get(`sensor.sf_${s}_${i}_brightness`),c=this.get(`sensor.sf_${s}_ppfd`),d=l&&Number.isFinite(Number(l.state))?`${Math.round(Number(l.state))}%`:"—",h=c&&Number.isFinite(Number(c.state))?`${Math.round(Number(c.state))} µmol`:"—",p=`text.sf_${s}_${i}_apply`,u=`number.sf_${s}_${i}_go_dark`,f=`number.sf_${s}_${i}_turn_off`,g=[];if(r&&g.push(this.liveModeRow("Mode",a)),g.push(this.powerRow(t.id,"light",t.label,o)),"Manual"===n){const s=Math.round((e.attributes.brightness??0)/255*100),i={[a]:"mode",[u]:"dim_threshold",[f]:"off_threshold"};g.push(this.brightnessRow(t,o?s:0)),g.push(this.infoRow("Current PPFD",h)),g.push(this.optSelectRow("Go dark",u,this.tempThresholdOpts())),g.push(this.optSelectRow("Turn off",f,this.tempThresholdOpts())),g.push(this.deviceBar(p,i,t))}else if("Time Slot"===n){const e=`text.sf_${s}_${i}_schedule_start`,o=`text.sf_${s}_${i}_schedule_stop`,r=`number.sf_${s}_${i}_schedule_brightness`,n=`number.sf_${s}_${i}_fade`,l={[a]:"mode",[e]:"schedule_start",[o]:"schedule_end",[r]:"schedule_brightness",[n]:"fade_minutes",[u]:"dim_threshold",[f]:"off_threshold"};g.push(this.infoRow("Current",`${d} · ${h}`));const c=this.durationText(e,o);c&&g.push(this.infoRow("Light duration",c)),g.push(this.stagedPeriodRow(e,o,"Lighting period")),g.push(this.optSelectRow("Target Brightness",r,this.numOpts(11,100,1,t=>`${t}%`))),g.push(this.optSelectRow("Simulate Sunrise/Sunset",n,this.offOpts(1,60,1,t=>`${t} min`))),g.push(this.optSelectRow("Go dark",u,this.tempThresholdOpts())),g.push(this.optSelectRow("Turn off",f,this.tempThresholdOpts())),g.push(this.deviceBar(p,l,t))}else if("PPFD"===n){const e=`text.sf_${s}_${i}_ppfd_start`,o=`text.sf_${s}_${i}_ppfd_stop`,r=`number.sf_${s}_${i}_ppfd_target`,n=`number.sf_${s}_${i}_ppfd_fade`,l=`number.sf_${s}_${i}_ppfd_min`,c=`number.sf_${s}_${i}_ppfd_max`,m={[a]:"mode",[e]:"ppfd_start",[o]:"ppfd_end",[r]:"ppfd_target",[n]:"ppfd_fade_minutes",[l]:"ppfd_min",[c]:"ppfd_max",[u]:"dim_threshold",[f]:"off_threshold"};g.push(this.infoRow("Current",`${d} · ${h}`));const v=this.durationText(e,o),b=this.durMinutes(e,o),$=Number(this.get(r)?.state);if(v&&null!=b&&Number.isFinite($)){const t=$*b*60/1e6;g.push(this.infoRow("DLI · duration",`${t.toFixed(2)} mol/m²/day · ${v}`))}else v&&g.push(this.infoRow("Light duration",v));g.push(this.stagedPeriodRow(e,o,"Lighting period")),g.push(W`<div class="dev-row ${r in this.draft?"staged":""}">
      ...
      </div>`),g.push(this.optSelectRow("Dimming Range Min",l,this.numOpts(11,100,1,t=>`${t}%`))),g.push(this.optSelectRow("Dimming Range Max",c,this.numOpts(11,100,1,t=>`${t}%`))),g.push(this.optSelectRow("Simulate Sunrise/Sunset",n,this.offOpts(1,60,1,t=>`${t} min`))),g.push(this.optSelectRow("Go dark",u,this.tempThresholdOpts())),g.push(this.optSelectRow("Turn off",f,this.tempThresholdOpts())),g.push(this.deviceBar(p,m,t))}return g}renderFanBody(t,e){const s=this.config.panel,i="on"===e.state,o=`select.sf_${s}_fan_mode_set`,a=this.get(o),r=this.modeOf(o),n=`number.sf_${s}_fan_oscillation`,l=`number.sf_${s}_fan_schedule_gear`,c=`number.sf_${s}_fan_standby_speed`,d=`switch.sf_${s}_fan_natural_wind`,h=()=>this.optSelectRow("Gear",l,this.numOpts(1,10,1,t=>`L${t}`)),p=Math.max(1,Math.round(Number(this.draftVal(l))||1)),u=()=>this.optSelectRow("Standby Speed",c,this.offOpts(1,p-1)),f=()=>this.optSelectRow("Oscillation",n,this.offOpts(1,10)),g=`text.sf_${s}_fan_apply`,m=[];if(a&&m.push(this.liveModeRow("Mode",o)),m.push(this.powerRow(t.id,"fan",t.label,i)),"Manual"===r){const s=Math.round(e.attributes.percentage??0);m.push(this.speedRow(t,i?s:0,0,10)),m.push(f()),m.push(this.ctlRow("Natural Wind",d)),m.push(this.deviceBar(g,{[o]:"mode"},t))}else if("Time Slot"===r){const e={[o]:"mode",[`text.sf_${s}_fan_schedule_start`]:"schedule_start",[`text.sf_${s}_fan_schedule_stop`]:"schedule_end",[l]:"schedule_speed",[c]:"standby_speed"};m.push(this.stagedPeriodRow(`text.sf_${s}_fan_schedule_start`,`text.sf_${s}_fan_schedule_stop`,"Schedule")),m.push(h()),m.push(u()),m.push(f()),m.push(this.ctlRow("Natural Wind",d)),m.push(this.deviceBar(g,e,t))}else if("Cycle"===r){const e=`text.sf_${s}_fan_cycle_start`,i=`text.sf_${s}_fan_cycle_run`,a=`text.sf_${s}_fan_cycle_off`,r=`number.sf_${s}_fan_cycle_times`,n={[o]:"mode",[e]:"cycle_start",[i]:"cycle_run",[a]:"cycle_off",[r]:"cycle_times",[l]:"schedule_speed",[c]:"standby_speed"};m.push(this.stagedRow("Start Time",e,"time")),m.push(this.stagedRow("Run Duration",i,"duration")),m.push(this.stagedRow("Off Duration",a,"duration")),m.push(this.stagedRangeRow("Execution Times",r)),m.push(h()),m.push(u()),m.push(f()),m.push(this.ctlRow("Natural Wind",d)),m.push(this.deviceBar(g,n,t))}else if("Environment"===r){const e=`select.sf_${s}_fan_run_mode`,i={[o]:"mode",[e]:"env_submode",[l]:"schedule_speed",[c]:"standby_speed"};m.push(this.stagedRow("Run Mode",e)),m.push(h()),m.push(u()),m.push(f()),m.push(this.ctlRow("Natural Wind",d)),m.push(this.deviceBar(g,i,t))}return m}renderBlowerBody(t,e){const s=this.config.panel,i="on"===e.state,o=`select.sf_${s}_blower_mode_set`,a=this.get(o),r=this.modeOf(o),n=`number.sf_${s}_blower_running_speed`,l=`number.sf_${s}_blower_standby_speed`,c=`switch.sf_${s}_blower_close_co2`,d=`text.sf_${s}_blower_apply`,h=()=>this.optSelectRow("Running Speed",n,this.numOpts(25,100,1,t=>`${t}%`)),p=Math.max(25,Math.round(Number(this.draftVal(n))||25)),u=()=>this.optSelectRow("Standby Speed",l,this.offOpts(25,p-1)),f=[];if(a&&f.push(this.liveModeRow("Mode",o)),f.push(this.powerRow(t.id,"fan",t.label,i)),"Manual"===r){const s=Math.round(e.attributes.percentage??0);f.push(this.speedRow(t,i?s:0,25)),f.push(this.ctlRow("Close CO2 Device",c)),f.push(this.deviceBar(d,{[o]:"mode"},t))}else if("Time Slot"===r){const e={[o]:"mode",[`text.sf_${s}_blower_schedule_start`]:"schedule_start",[`text.sf_${s}_blower_schedule_stop`]:"schedule_end",[n]:"schedule_speed",[l]:"standby_speed"};f.push(this.stagedPeriodRow(`text.sf_${s}_blower_schedule_start`,`text.sf_${s}_blower_schedule_stop`,"Schedule")),f.push(h()),f.push(u()),f.push(this.ctlRow("Close CO2 Device",c)),f.push(this.deviceBar(d,e,t))}else if("Cycle"===r){const e=`text.sf_${s}_blower_cycle_start`,i=`text.sf_${s}_blower_cycle_run`,a=`text.sf_${s}_blower_cycle_off`,r=`number.sf_${s}_blower_cycle_times`,p={[o]:"mode",[e]:"cycle_start",[i]:"cycle_run",[a]:"cycle_off",[r]:"cycle_times",[n]:"schedule_speed",[l]:"standby_speed"};f.push(this.stagedRow("Start Time",e,"time")),f.push(this.stagedRow("Run Duration",i,"duration")),f.push(this.stagedRow("Off Duration",a,"duration")),f.push(this.stagedRangeRow("Execution Times",r)),f.push(h()),f.push(u()),f.push(this.ctlRow("Close CO2 Device",c)),f.push(this.deviceBar(d,p,t))}else if("Environment"===r){const e=`select.sf_${s}_blower_run_mode`,i={[o]:"mode",[e]:"env_submode",[n]:"schedule_speed",[l]:"standby_speed"};f.push(this.stagedRow("Run Mode",e)),f.push(h()),f.push(u()),f.push(this.ctlRow("Close CO2 Device",c)),f.push(this.deviceBar(d,i,t))}return f}cycleIsDay(){const t=this.config.panel,e=this.get(`binary_sensor.sf_${t}_daytime_schedule`);if(e&&("on"===e.state||"off"===e.state))return"on"===e.state;const s=Ht(this.get(`text.sf_${t}_env_day_start`)?.state),i=Ht(this.get(`text.sf_${t}_env_day_end`)?.state);if(null==s||null==i)return null;const o=new Date,a=60*o.getHours()+o.getMinutes();return s<=i?a>=s&&a<i:a>=s||a<i}lightLeak(){if(!1!==this.cycleIsDay())return{on:!1,text:""};const t=this.config.panel,e=this.get(`sensor.sf_${t}_ppfd`);if(e){const t=Number(e.state);return Number.isFinite(t)&&t>1?{on:!0,text:`Light detected · ${Math.round(t)} µmol`}:{on:!1,text:""}}const s=this.get(`binary_sensor.sf_${t}_daytime_light_sensor`);return s&&"on"===s.state?{on:!0,text:"Light detected"}:{on:!1,text:""}}renderParamsHead(){const t=this.cycleIsDay(),e=this.lightLeak(),s=null===t?q:W`<span class="cycle-badge"
      ...
      <span class="dev-lbl">${t}</span>
      <div class="ctl-input">
        <select .value=${o} @change=${t=>{const s=t.target.value;this.modePick={...this.modePick,[e]:s},this.modePickAt={...this.modePickAt,[e]:Date.now()},this.draft={[e]:s}}}>
          ${i.map(t=>W`
      ...
      </div>`:q}renderLeafVpdTargets(){const t=this.get(this.eid("number","leaf_vpd_min")),e=this.get(this.eid("number","leaf_vpd_max"));if(!t||!e)return q;const s=(t,e)=>{const s=parseFloat(e);Number.isFinite(s)&&this.hass?.callService("number","set_value",{entity_id:this.eid("number",t),value:s})},i=(t,e,i)=>W`
      <div class="ctl">
        <div class="ctl-label">${i}</div>
        <div class="ctl-input">
          <span class="num-box">
            <input type="number" step="0.05" min="0" max="4" .value=${t.state}
              @change=${t=>s(e,t.target.value)} />
      ...
      <div class="env-row">
        ...
        <div class="leaf-tgt-grid">
          ${i(t,"leaf_vpd_min","Min")}
          ${i(e,"leaf_vpd_max","Max")}
        </div>
      ...
      <div class="soil-pop" style="--sf-accent:${this.accent()}">
        ...
        ${this.applyBar(g,{extraDirty:m||v||b,onApply:()=>{if(u){if(this.hass?.callService("sf","set_outlet_config",{entity_id:o,mode:l,config:this.outletCfgDraft[f]??{}}),this.clearOutletCfgDraft(s,i),o in this.draft){const t={...this.draft};delete t[o],this.draft=t}this.modePick={...this.modePick,[o]:l},this.modePickAt={...this.modePickAt,[o]:Date.now()}}this.saveOutlet(s,i),this.commitOutletName(s,i)},onDiscard:()=>{if(this.clearOutletDraft(s,i),this.clearOutletNameDraft(s,i),this.clearOutletCfgDraft(s,i),o in this.draft){const t={...this.draft};delete t[o],this.draft=t}}})}
      ...
      <details class="leaf-cal">
        ...
        <div class="leaf-cal-foot">
          ...
          <button class="leaf-apply" ?disabled=${null==l}
            @click=${()=>null!=l&&(t=>"night"===m?f(t):d(t))(l)}>
            Use for ${"night"===m?"night":"day"}</button>
        </div>
      </details>`}renderSettings(){const t=this.accent(),e=this.colorDraft,s=e?.mode??this.colorMode,i=e?.modeIn??this.colorModeIn,o=e?.hi??this.colHi,a=e?.lo??this.colLo,r=e?.in??this.colIn,n=e?.warn??this.colWarn,l=e?.showTrend??this.showTrend,c=e?.showBand??this.showBand,d=e?.showTargets??this.showTargets,h=e?.customNames??this.customOutletNames,p=e?.customLayout??this.customLayout,u=e?.scale??this.cardScale,f=e?.cols??this.tileCols,g=!!this.get(this.eid("light","light_2")),m=e?.omode??this.outletColorMode,v=e?.ocManual??this.ocManual,b=e?.ocSched??this.ocSched,$=e?.ocEnv??this.ocEnv,_=e?.ocDrip??this.ocDrip,x=this.hasOutlets(),y=e?.dmode??this.deviceColorMode,w=e?.dcManual??this.dcManual,S=e?.dcSched??this.dcSched,O=e?.dcAuto??this.dcAuto,k=this.overviewDevices().length>0,C=!!e&&(void 0!==e.mode&&e.mode!==this.colorMode||void 0!==e.modeIn&&e.modeIn!==this.colorModeIn||void 0!==e.source&&e.source!==this.colorSource||void 0!==e.warn&&e.warn!==this.colWarn||void 0!==e.showTrend&&e.showTrend!==this.showTrend||void 0!==e.showBand&&e.showBand!==this.showBand||void 0!==e.showTargets&&e.showTargets!==this.showTargets||void 0!==e.hi&&e.hi!==this.colHi||void 0!==e.lo&&e.lo!==this.colLo||void 0!==e.in&&e.in!==this.colIn||void 0!==e.hide2&&e.hide2!==this.hideLight2||void 0!==e.customNames&&e.customNames!==this.customOutletNames||void 0!==e.customLayout&&e.customLayout!==this.customLayout||void 0!==e.scale&&e.scale!==this.cardScale||void 0!==e.cols&&e.cols!==this.tileCols||void 0!==e.omode&&e.omode!==this.outletColorMode||void 0!==e.ocManual&&e.ocManual!==this.ocManual||void 0!==e.ocSched&&e.ocSched!==this.ocSched||void 0!==e.ocEnv&&e.ocEnv!==this.ocEnv||void 0!==e.ocDrip&&e.ocDrip!==this.ocDrip||void 0!==e.dmode&&e.dmode!==this.deviceColorMode||void 0!==e.dcManual&&e.dcManual!==this.dcManual||void 0!==e.dcSched&&e.dcSched!==this.dcSched||void 0!==e.dcAuto&&e.dcAuto!==this.dcAuto),D=t=>this.colorDraft={...this.colorDraft??{},...t},M=(e,s,i,o,a)=>W`
      <button class="seg ${e===s?"on":""}"
        style=${e===s?`border-color:${t};color:${t}`:q}
        @click=${a}>
        <ha-icon icon=${o}></ha-icon><span>${i}</span>
      </button>`,A=e?.source??this.colorSource,N=(e,s,i)=>W`
      <button class="seg ${A===e?"on":""}"
        style=${A===e?`border-color:${t};color:${t}`:q}
        @click=${()=>D({source:e})}>
      ...
      <div class="seg-row">
        ${N("alarms","Alarms","mdi:bell-outline")}
        ${N("targets","Targets","mdi:target")}
        ${N("both","Both","mdi:set-center")}
      </div>
      ...
      <div class="seg-row">
        ${M(s,"off","No color","mdi:circle-off-outline",()=>D({mode:"off"}))}
        ${M(s,"tile","Tile color","mdi:square-rounded",()=>D({mode:"tile"}))}
        ${M(s,"text","Text color","mdi:format-color-text",()=>D({mode:"text"}))}
      </div>
      <div class="color-row">
        ${T("Above max",o,t=>D({hi:t}))}
        ${T("Below min",a,t=>D({lo:t}))}
        ${T("Near edge",n,t=>D({warn:t}))}
      </div>
      ...
      <div class="seg-row">
        ${M(i,"off","No color","mdi:circle-off-outline",()=>D({modeIn:"off"}))}
        ${M(i,"tile","Tile color","mdi:square-rounded",()=>D({modeIn:"tile"}))}
        ${M(i,"text","Text color","mdi:format-color-text",()=>D({modeIn:"text"}))}
      </div>
      <div class="color-row">
        ${T("In range",r,t=>D({in:t}))}
      </div>
      ...
      ${x?W`
            ...
            <div class="set-note">
              ...
              <span style="color:${v}">Manual</span>,
              <span style="color:${b}">Scheduled</span>,
              <span style="color:${$}">Environment</span>,
              <span style="color:${_}">Drip</span>. Off outlets stay neutral.
            </div>
            <div class="seg-row">
              ${M(m,"off","No color","mdi:circle-off-outline",()=>D({omode:"off"}))}
              ${M(m,"tile","Tile color","mdi:square-rounded",()=>D({omode:"tile"}))}
              ${M(m,"text","Text color","mdi:format-color-text",()=>D({omode:"text"}))}
            </div>
            <div class="color-row">
              ${T("Manual",v,t=>D({ocManual:t}))}
              ${T("Scheduled",b,t=>D({ocSched:t}))}
            </div>
            <div class="color-row">
              ${T("Environment",$,t=>D({ocEnv:t}))}
              ${T("Drip",_,t=>D({ocDrip:t}))}
            </div>`:q}
      ...
      ${k?W`
            ...
            <div class="set-note">
              ...
              <span style="color:${O}">Auto</span> (Environment / PPFD). A
              <span style="color:${Tt}">fault</span> always overrides.
            </div>
            <div class="seg-row">
              ${M(y,"off","No color","mdi:circle-off-outline",()=>D({dmode:"off"}))}
              ${M(y,"tile","Tile color","mdi:square-rounded",()=>D({dmode:"tile"}))}
              ${M(y,"text","Text color","mdi:format-color-text",()=>D({dmode:"text"}))}
            </div>
            <div class="color-row">
              ${T("Manual",w,t=>D({dcManual:t}))}
              ${T("Scheduled",S,t=>D({dcSched:t}))}
              ${T("Auto",O,t=>D({dcAuto:t}))}
            </div>`:q}
      ...
      <div class="toggle-row">
        ...
        <button class="toggle ${p?"on":""}"
          ...
          @click=${()=>D({customLayout:!p})}></button>
      </div>
      ${p?W`
        <div class="set-note" style="margin-top:10px;display:flex;justify-content:space-between">
          <span>Scale</span><span style="color:${t};font-weight:500">${u}%</span>
        </div>
        <input type="range" min="70" max="150" step="5" .value=${String(u)}
          style="width:100%"
      ...
      ${jt(t,C,()=>{const t=this.colorDraft;t&&(void 0!==t.mode&&t.mode!==this.colorMode&&(this.colorMode=t.mode,this.persistColorOption("colors",t.mode)),void 0!==t.modeIn&&t.modeIn!==this.colorModeIn&&(this.colorModeIn=t.modeIn,this.persistColorOption("colors_in",t.modeIn)),void 0!==t.source&&t.source!==this.colorSource&&(this.colorSource=t.source,this.persistColorOption("color_source",t.source)),void 0!==t.warn&&t.warn!==this.colWarn&&(this.colWarn=t.warn,this.persistColorOption("color_warn",t.warn)),void 0!==t.showTrend&&t.showTrend!==this.showTrend&&(this.showTrend=t.showTrend,this.persistColorOption("show_trend",t.showTrend?"1":"0")),void 0!==t.showBand&&t.showBand!==this.showBand&&(this.showBand=t.showBand,this.persistColorOption("show_band",t.showBand?"1":"0")),void 0!==t.showTargets&&t.showTargets!==this.showTargets&&(this.showTargets=t.showTargets,this.persistColorOption("show_targets",t.showTargets?"1":"0")),void 0!==t.hi&&t.hi!==this.colHi&&(this.colHi=t.hi,this.persistColorOption("color_hi",t.hi)),void 0!==t.lo&&t.lo!==this.colLo&&(this.colLo=t.lo,this.persistColorOption("color_lo",t.lo)),void 0!==t.in&&t.in!==this.colIn&&(this.colIn=t.in,this.persistColorOption("color_in",t.in)),void 0!==t.hide2&&t.hide2!==this.hideLight2&&(this.hideLight2=t.hide2,this.persistColorOption("hide_light2",t.hide2?"1":"0")),void 0!==t.customNames&&t.customNames!==this.customOutletNames&&(this.customOutletNames=t.customNames,this.persistColorOption("custom_outlet_names",t.customNames?"1":"0")),void 0!==t.customLayout&&t.customLayout!==this.customLayout&&(this.customLayout=t.customLayout,this.persistColorOption("custom_layout",t.customLayout?"1":"0")),void 0!==t.scale&&t.scale!==this.cardScale&&(this.cardScale=t.scale,this.persistColorOption("card_scale",String(t.scale))),void 0!==t.cols&&t.cols!==this.tileCols&&(this.tileCols=t.cols,this.persistColorOption("tile_cols",String(t.cols))),void 0!==t.omode&&t.omode!==this.outletColorMode&&(this.outletColorMode=t.omode,this.persistColorOption("outlet_colors",t.omode)),void 0!==t.ocManual&&t.ocManual!==this.ocManual&&(this.ocManual=t.ocManual,this.persistColorOption("oc_manual",t.ocManual)),void 0!==t.ocSched&&t.ocSched!==this.ocSched&&(this.ocSched=t.ocSched,this.persistColorOption("oc_sched",t.ocSched)),void 0!==t.ocEnv&&t.ocEnv!==this.ocEnv&&(this.ocEnv=t.ocEnv,this.persistColorOption("oc_env",t.ocEnv)),void 0!==t.ocDrip&&t.ocDrip!==this.ocDrip&&(this.ocDrip=t.ocDrip,this.persistColorOption("oc_drip",t.ocDrip)),void 0!==t.dmode&&t.dmode!==this.deviceColorMode&&(this.deviceColorMode=t.dmode,this.persistColorOption("device_colors",t.dmode)),void 0!==t.dcManual&&t.dcManual!==this.dcManual&&(this.dcManual=t.dcManual,this.persistColorOption("dc_manual",t.dcManual)),void 0!==t.dcSched&&t.dcSched!==this.dcSched&&(this.dcSched=t.dcSched,this.persistColorOption("dc_sched",t.dcSched)),void 0!==t.dcAuto&&t.dcAuto!==this.dcAuto&&(this.dcAuto=t.dcAuto,this.persistColorOption("dc_auto",t.dcAuto)),this._colorSynced=!0,this.cacheColors()),this.colorDraft=null},()=>this.colorDraft=null,"apply-bar")}`}}qt.styles=r`
    ${yt}
      ...
      <ha-card>
        ...
        <div class="gauge">
          <svg viewBox="0 0 200 190" aria-hidden="true">
            ...
            ${c&&p>0?V`<path d=${_t(100,100,78,0,p)} fill="none"
