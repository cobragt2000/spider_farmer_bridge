/*! spider-farmer-card v0.20.68 | MIT */
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const w=globalThis,S=t=>t,k=w.trustedTypes,M=k?k.createPolicy("lit-html",{createHTML:t=>t}):void 0,C="$lit$",O=`lit$${Math.random().toFixed(9).slice(2)}$`,D="?"+O,N=`<${D}>`,A=document,T=()=>A.createComment(""),E=t=>null===t||"object"!=typeof t&&"function"!=typeof t,L=Array.isArray,P="[ \t\n\f\r]",R=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,z=/-->/g,F=/>/g,I=RegExp(`>|${P}(?:([^\\s"'>=/]+)(${P}*=${P}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),B=/'/g,H=/"/g,W=/^(?:script|style|textarea|title)$/i,j=t=>(e,...s)=>({_$litType$:t,strings:e,values:s}),V=j(1),U=j(2),G=Symbol.for("lit-noChange"),K=Symbol.for("lit-nothing"),q=new WeakMap,J=A.createTreeWalker(A,129);function Y(t,e){if(!L(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==M?M.createHTML(e):e}const X=(t,e)=>{const s=t.length-1,i=[];let o,a=2===e?"<svg>":3===e?"<math>":"",n=R;for(let e=0;e<s;e++){const s=t[e];let r,l,c=-1,d=0;for(;d<s.length&&(n.lastIndex=d,l=n.exec(s),null!==l);)d=n.lastIndex,n===R?"!--"===l[1]?n=z:void 0!==l[1]?n=F:void 0!==l[2]?(W.test(l[2])&&(o=RegExp("</"+l[2],"g")),n=I):void 0!==l[3]&&(n=I):n===I?">"===l[0]?(n=o??R,c=-1):void 0===l[1]?c=-2:(c=n.lastIndex-l[2].length,r=l[1],n=void 0===l[3]?I:'"'===l[3]?H:B):n===H||n===B?n=I:n===z||n===F?n=R:(n=I,o=void 0);const h=n===I&&t[e+1].startsWith("/>")?" ":"";a+=n===R?s+N:c>=0?(i.push(r),s.slice(0,c)+C+s.slice(c)+O+h):s+O+(-2===c?e:h)}return[Y(t,a+(t[s]||"<?>")+(2===e?"</svg>":3===e?"</math>":"")),i]};class Z{constructor({strings:t,_$litType$:e},s){let i;this.parts=[];let o=0,a=0;const n=t.length-1,r=this.parts,[l,c]=X(t,e);if(this.el=Z.createElement(l,s),J.currentNode=this.el.content,2===e||3===e){const t=this.el.content.firstChild;t.replaceWith(...t.childNodes)}for(;null!==(i=J.nextNode())&&r.length<n;){if(1===i.nodeType){if(i.hasAttributes())for(const t of i.getAttributeNames())if(t.endsWith(C)){const e=c[a++],s=i.getAttribute(t).split(O),n=/([.?@])?(.*)/.exec(e);r.push({type:1,index:o,name:n[2],strings:s,ctor:"."===n[1]?it:"?"===n[1]?ot:"@"===n[1]?at:st}),i.removeAttribute(t)}else t.startsWith(O)&&(r.push({type:6,index:o}),i.removeAttribute(t));if(W.test(i.tagName)){const t=i.textContent.split(O),e=t.length-1;if(e>0){i.textContent=k?k.emptyScript:"";for(let s=0;s<e;s++)i.append(t[s],T()),J.nextNode(),r.push({type:2,index:++o});i.append(t[e],T())}}}else if(8===i.nodeType)if(i.data===D)r.push({type:2,index:o});else{let t=-1;for(;-1!==(t=i.data.indexOf(O,t+1));)r.push({type:7,index:o}),t+=O.length-1}o++}}static createElement(t,e){const s=A.createElement("template");return s.innerHTML=t,s}}function Q(t,e,s=t,i){if(e===G)return e;let o=void 0!==i?s._$Co?.[i]:s._$Cl;const a=E(e)?void 0:e._$litDirective$;return o?.constructor!==a&&(o?._$AO?.(!1),void 0===a?o=void 0:(o=new a(t),o._$AT(t,s,i)),void 0!==i?(s._$Co??=[])[i]=o:s._$Cl=o),void 0!==o&&(e=Q(t,o._$AS(t,e.values),o,i)),e}class tt{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:e},parts:s}=this._$AD,i=(t?.creationScope??A).importNode(e,!0);J.currentNode=i;let o=J.nextNode(),a=0,n=0,r=s[0];for(;void 0!==r;){if(a===r.index){let e;2===r.type?e=new et(o,o.nextSibling,this,t):1===r.type?e=new r.ctor(o,r.name,r.strings,this,t):6===r.type&&(e=new nt(o,this,t)),this._$AV.push(e),r=s[++n]}a!==r?.index&&(o=J.nextNode(),a++)}return J.currentNode=A,i}p(t){let e=0;for(const s of this._$AV)void 0!==s&&(void 0!==s.strings?(s._$AI(t,s,e),e+=s.strings.length-2):s._$AI(t[e])),e++}}class et{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,e,s,i){this.type=2,this._$AH=K,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=s,this.options=i,this._$Cv=i?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode;const e=this._$AM;return void 0!==e&&11===t?.nodeType&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=Q(this,t,e),E(t)?t===K||null==t||""===t?(this._$AH!==K&&this._$AR(),this._$AH=K):t!==this._$AH&&t!==G&&this._(t):void 0!==t._$litType$?this.$(t):void 0!==t.nodeType?this.T(t):(t=>L(t)||"function"==typeof t?.[Symbol.iterator])(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==K&&E(this._$AH)?this._$AA.nextSibling.data=t:this.T(A.createTextNode(t)),this._$AH=t}$(t){const{values:e,_$litType$:s}=t,i="number"==typeof s?this._$AC(t):(void 0===s.el&&(s.el=Z.createElement(Y(s.h,s.h[0]),this.options)),s);if(this._$AH?._$AD===i)this._$AH.p(e);else{const t=new tt(i,this),s=t.u(this.options);t.p(e),this.T(s),this._$AH=t}}_$AC(t){let e=q.get(t.strings);return void 0===e&&q.set(t.strings,e=new Z(t)),e}k(t){L(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let s,i=0;for(const o of t)i===e.length?e.push(s=new et(this.O(T()),this.O(T()),this,this.options)):s=e[i],s._$AI(o),i++;i<e.length&&(this._$AR(s&&s._$AB.nextSibling,i),e.length=i)}_$AR(t=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);t!==this._$AB;){const e=S(t).nextSibling;S(t).remove(),t=e}}setConnected(t){void 0===this._$AM&&(this._$Cv=t,this._$AP?.(t))}}class st{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,s,i,o){this.type=1,this._$AH=K,this._$AN=void 0,this.element=t,this.name=e,this._$AM=i,this.options=o,s.length>2||""!==s[0]||""!==s[1]?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=K}_$AI(t,e=this,s,i){const o=this.strings;let a=!1;if(void 0===o)t=Q(this,t,e,0),a=!E(t)||t!==this._$AH&&t!==G,a&&(this._$AH=t);else{const i=t;let n,r;for(t=o[0],n=0;n<o.length-1;n++)r=Q(this,i[s+n],e,n),r===G&&(r=this._$AH[n]),a||=!E(r)||r!==this._$AH[n],r===K?t=K:t!==K&&(t+=(r??"")+o[n+1]),this._$AH[n]=r}a&&!i&&this.j(t)}j(t){t===K?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class it extends st{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===K?void 0:t}}class ot extends st{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==K)}}class at extends st{constructor(t,e,s,i,o){super(t,e,s,i,o),this.type=5}_$AI(t,e=this){if((t=Q(this,t,e,0)??K)===G)return;const s=this._$AH,i=t===K&&s!==K||t.capture!==s.capture||t.once!==s.once||t.passive!==s.passive,o=t!==K&&(s===K||i);i&&this.element.removeEventListener(this.name,this,s),o&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){"function"==typeof this._$AH?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}}class nt{constructor(t,e,s){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(t){Q(this,t)}}const rt=w.litHtmlPolyfillSupport;rt?.(Z,et),(w.litHtmlVersions??=[]).push("3.3.3");const lt=globalThis;
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`;function wt(t){const e=new Set;for(const s of Object.keys(t.states)){const t=bt(s).match(vt);t&&e.add(t[1])}return[...e].sort()}function St(t){return wt(t).filter(e=>e.startsWith("st")&&!!t.states[`switch.sf_${e}_outlet_1`]||Object.keys(t.states).some(t=>{const s=bt(t);return s===`sf_${e}_temperature`||s===`sf_${e}_soil_avg_temperature`||s===`sf_${e}_light_1`||s===`sf_${e}_fan`||s===`sf_${e}_blower`}))}function kt(t,e){const s=`sf_${e}_`,i=Object.keys(t.states);return i.find(t=>bt(t)===`sf_${e}_temperature`)??i.find(t=>{const i=bt(t);return i.startsWith(s)&&!i.startsWith(`sf_${e}_env_`)})}function Mt(t,e){const s=kt(t,e);return s?t.entities?.[s]?.device_id:void 0}function Ct(t,e){if(!e)return[];const s=Mt(t,e);return s?function(t){return wt(t).filter(e=>!!t.states[`switch.sf_${e}_outlet_1`])}(t).filter(i=>{if(i===e)return!1;const o=Mt(t,i),a=o?t.devices?.[o]:void 0;return a?.via_device_id===s}):[]}function Ot(t,e){if(!t||!e)return"";const s=kt(t,e);if(!s)return"";const i=t.entities?.[s]?.device_id,o=i?t.devices?.[i]:void 0;if(o)return o.name_by_user||o.name||"";const a=(t.states[s].attributes.friendly_name||"").match(/^(SF .+? [0-9A-Fa-f]{4})\b/);return a?a[1]:""}const Dt=[["temperature","Air Temp","mdi:thermometer"],["humidity","Air Humi","mdi:water-percent"],["vpd","Air VPD","mdi:water-opacity"],["leaf_vpd","Leaf VPD","mdi:leaf"],["co2","CO2","mdi:molecule-co2"],["ppfd","PPFD","mdi:white-balance-sunny"],["soil_avg_temperature","Soil Temp","mdi:thermometer"],["soil_avg_moisture","Moisture","mdi:water"],["soil_avg_ec","Soil EC","mdi:flash"]],Nt={temperature:"temp",humidity:"humi",vpd:"vpd",co2:"co2",ppfd:"ppfd",soil_avg_temperature:"tempSoil",soil_avg_moisture:"humiSoil",soil_avg_ec:"ECSoil"},At={temperature:"temp",humidity:"humi",co2:"co2"},Tt="#ff6b6b",Et="rgba(255,107,107,0.16)",Lt=(t,e=.16)=>{const s=/^#?([0-9a-fA-F]{6})$/.exec((t||"").trim());if(!s)return`rgba(255,107,107,${e})`;const i=parseInt(s[1],16);return`rgba(${i>>16&255},${i>>8&255},${255&i},${e})`},Pt=t=>"string"==typeof t&&/^#[0-9a-fA-F]{6}$/.test(t),Rt=t=>"alarms"===t||"targets"===t||"both"===t,zt=ft,Ft={"Time Slot":["ts_type","ts_start","ts_stop"],Cycle:["cycle_start","cycle_run","cycle_off","cycle_times"],Temperature:["temp_device"],Humidity:["humidity_device"],CO2:["co2_device"],"Drip Irrigation":["drip_soil","drip_avg"],Manual:[]},It=ft,Bt=t=>!!t&&("unavailable"===t.state||"unknown"===t.state),Ht=t=>{const e=(t||"").match(/^(\d{1,2}):(\d{2})$/);if(!e)return null;const s=+e[1],i=+e[2];return s<=23&&i<=59?60*s+i:null},Wt=(t,e,s,i,o="")=>V`<div class="save-bar ${o}">
  ${((t,e,s,i)=>V`
  ...
  <button class="discard-btn" ?disabled=${!e}
    @click=${i}>Discard</button>`)(t,e,s,i)}
      ...
      </div>`}renderParam([t,e,s]){const i=this.get(`sensor.sf_${this.config.panel}_${t}`);if(!i)return K;const o=i.attributes.unit_of_measurement||"",a=t.startsWith("soil_avg_")&&Bt(i),n=["temperature","humidity","vpd","leaf_vpd"].includes(t)&&this.cleaningActive(),r=n?"--":a?"Offline":this.hass?.formatEntityState?this.hass.formatEntityState(i).replace(o,"").trim():i.state,l=t.startsWith("soil_avg_")?t.slice(9):null,c=!!l&&this.soilProbeRows(l).length>1,d=c&&this.soilOpen===l;let h;const p=this.paramOpen===t;if(a||n)h=null;else{const e=parseFloat(i.state);if(Number.isFinite(e)){const s="targets"!==this.colorSource?this.outOfRange(Nt[t],e):null,i="alarms"!==this.colorSource||"leaf_vpd"===t?this.targetOutOfRange(t,e):null;h=this.colorForOor(s??i)}else h=null}const u=!a&&!c;let g=d||p?`box-shadow:inset 0 0 0 1px ${this.accent()}`:"",f="";a?(g=`background:${Et};box-shadow:inset 0 0 0 1px ${Tt}`,f=`color:${Tt}`):h&&"text"===h.mode?f=`color:${h.color}`:h&&"tile"===h.mode&&(g=`background:${Lt(h.color)};box-shadow:inset 0 0 0 1px ${h.color}`);const m=c||u;return V`
      <div class="tile ${m?"clickable":""} ${d||p?"active":""}"
        ...
        <div class="tile-label">
          ...
          <span class="tl-right">
            ${n?V`<ha-icon icon="mdi:broom" title="Sensor cleaning"
              style="--mdc-icon-size:15px;color:var(--warning-color,#ff9800)"></ha-icon>`:K}
            ${this.trendIcon(t)}
            ${c?V`<ha-icon class="tile-more"
                  icon=${d?"mdi:chevron-up":"mdi:chevron-down"}></ha-icon>`:u?V`<ha-icon class="tile-more"
                  icon=${p?"mdi:chevron-up":"mdi:chart-line"}></ha-icon>`:K}
          </span>
        </div>
        <ha-icon icon="${s}" style="color:${this.accent()}"></ha-icon>
        <div class="tile-val" style=${f||K}>${r}${a||n?K:V`<span class="unit">${o}</span>`}</div>
        ${n?V`<div class="tile-target" style="color:var(--warning-color,#ff9800)">${this.cleaningLabel()}${this.cleaningRemaining()?" · "+this.cleaningRemaining():""}</div>`:a?K:this.targetSubline(t,o)}
        ${a||n?K:this.renderBand(t,parseFloat(i.state))}
      </div>`}soilProbeRows(t){const e=new RegExp(`^sf_${this.config.panel}_(soil\\d+)_${t}$`),s=[];for(const i of Object.keys(this.hass?.states??{})){const o=bt(i).match(e);o&&s.push({slot:o[1],name:this.soilSensorName(i,t),e:this.hass.states[i]})}return s.sort((t,e)=>Number(t.slot.replace(/\D/g,""))-Number(e.slot.replace(/\D/g,""))),s.map(({name:t,e:e})=>({name:t,e:e}))}soilSensorName(t,e){let s=this.hass?.states[t]?.attributes.friendly_name??"";const i=Ot(this.hass,this.config.panel);i&&s.startsWith(i)&&(s=s.slice(i.length).trim());const o="temperature"===e?"Temperature":"moisture"===e?"Moisture":"EC";return s=s.replace(new RegExp(`\\s*${o}\\s*$`,"i"),"").trim(),s||bt(t)}renderSoilPop(){const t=this.soilOpen;if(!t)return K;const e=this.soilProbeRows(t);if(!e.length)return K;return V`
      <div class="soil-pop">
      ...
      <div class="tile clickable ${e?"active":""}" style=${o||K}
        ...
        <div class="tile-val" style=${i?`color:${Tt}`:K}>${a}</div>
      </div>`}renderSoilAllTable(){const t=this.soilProbeSlots();return t.length<2||!this.soilAllOpen?K:V`
      <div class="soil-all">
        ...
        ${t.map(t=>V`
            <div class="soil-all-row ${this.probeOffline(t)?"offline":""}">
              ...
              <span class="sa-v" style=${this.soilCellStyle(t,"temperature")||K}>${this.soilCellValue(t,"temperature")}</span>
              <span class="sa-v" style=${this.soilCellStyle(t,"moisture")||K}>${this.soilCellValue(t,"moisture")}</span>
              <span class="sa-v" style=${this.soilCellStyle(t,"ec")||K}>${this.soilCellValue(t,"ec")}</span>
            </div>`)}
      </div>`}overviewDevices(){const t=[],e=(e,s)=>{for(const[i,o,a]of s){const s=this.eid(e,i);this.get(s)&&t.push({domain:e,suffix:i,id:s,label:o,icon:a})}};return e("light",jt),e("fan",Vt),e("switch",Ut),this.hideLight2?t.filter(t=>"light_2"!==t.suffix):t}deviceStateText(t,e){if("unavailable"===e.state||"unknown"===e.state)return"Offline";if("light"===t.domain)return"on"!==e.state?"Off":`${Math.round((e.attributes.brightness??0)/255*100)}%`;if("fan"===t.domain){if("on"!==e.state)return"Off";const t=Math.round(e.attributes.percentage??0);return t?`${t}%`:"On"}if("on"!==e.state)return"Off";const s=this.config.panel;if("dehumidifier"===t.suffix){const t=this.get(`sensor.sf_${s}_dehumidifier_level`)?.state;return t&&"Off"!==t&&"unknown"!==t?t:"On"}if("heater"===t.suffix||"humidifier"===t.suffix){const e=this.get(`sensor.sf_${s}_${t.suffix}_level`)?.state;return e&&"0"!==e&&"unknown"!==e?`L${e}`:"On"}return"On"}deviceFault(t){const e=this.config.panel,s=t=>this.get(`sensor.sf_${e}_${t}`)?.state;return"humidifier"===t&&"Empty"===s("humidifier_tank")?"EMPTY":"dehumidifier"===t&&"Full"===s("dehumidifier_tank")?"FULL":"heater"===t&&"Alarm"===s("heater_status")?"Alarm":null}deviceMode(t){const e=this.config.panel,s="light"===t.domain?`select.sf_${e}_${t.suffix}_mode`:`select.sf_${e}_${t.suffix}_mode_set`;return this.get(s)?this.modeOf(s):""}deviceColorFor(t){switch((t=>"Time Slot"===t||"Cycle"===t?"sched":"Environment"===t||"Temperature"===t||"Humidity"===t||"PPFD"===t?"auto":"manual")(t)){case"sched":return this.dcSched;case"auto":return this.dcAuto;default:return this.dcManual}}deviceTile(t){const e=this.get(t.id);if(!e)return K;const s="on"===e.state,i=`${t.domain}:${t.suffix}`,o=this.deviceOpen===i,a=this.accent(),n=this.deviceFault(t.suffix),r=!n&&s&&"off"!==this.deviceColorMode?this.deviceColorFor(this.deviceMode(t)):"",l=n?Tt:r||(s?a:"var(--secondary-text-color)");let c="";return n?c=`background:${Et};box-shadow:inset 0 0 0 1px ${Tt}`:r&&"tile"===this.deviceColorMode&&(c=`background:${Lt(r)};box-shadow:inset 0 0 0 1px ${r}`),o&&!n&&(c=`box-shadow:inset 0 0 0 1px ${a}`+(r&&"tile"===this.deviceColorMode?`;background:${Lt(r)}`:"")),V`
      ...
      <div class="soil-pop" style="--sf-accent:${this.accent()}">
        ...
        ${i}
      </div>`}devOn(t,e){const s=`power:${t}`;return s in this.draft?"on"===this.draft[s]:e}powerRow(t,e,s,i){const o=`power:${t}`,a=this.devOn(t,i),n=this.accent();return V`
      ...
      <div class="params-head">
        ...
        <span class="ph-mid">${e.on?V`<span class="leak-badge">
              <ha-icon icon="mdi:alert"></ha-icon>${e.text}</span>`:K}</span>
        ${s}
      </div>`}renderOverview(){const t=Dt.map(t=>this.renderParam(t)).filter(t=>t!==K),e=this.soilStatsTile(),s=this.overviewDevices();return V`
      ${t.length||e!==K?V`${this.renderParamsHead()}
            <div class="grid">${t}${e}</div>
            ${this.renderParamGraph()}
            ${this.renderSoilPop()}
            ${this.renderSoilAllTable()}`:K}
      ${s.length?V`<div class="section-label">Devices</div>
            <div class="grid">${s.map(t=>this.deviceTile(t))}</div>
            ${this.renderDevicePop()}`:K}`}draftVal(t){if(t in this.draft)return this.draft[t];const e=this.get(t);return e&&"unknown"!==e.state&&"unavailable"!==e.state?e.state:""}stage(t,e){this.draft={...this.draft,[t]:e}}clearDraft(){Object.keys(this.draft).length&&(this.draft={})}discardEdits(){this.clearDraft(),Object.keys(this.modePick).length&&(this.modePick={})}toggleDevice(t){this.clearDraft(),Object.keys(this.modePick).length&&(this.modePick={}),this.deviceOpen=t}modeOf(t,e="Manual"){return this.modePick[t]??this.get(t)?.state??e}stagedInput(t,e){const s=this.get(t);if(!s)return K;const i=t.split(".")[0],o=this.draftVal(t);if(!e&&"number"===i){const e=s.attributes.min??0,i=s.attributes.max??100,a=s.attributes.step??1,n=s.attributes.unit_of_measurement??"";return V`<span class="num-box">
        <input type="number" min=${e} max=${i} step=${a} .value=${o}
          @input=${e=>this.stage(t,e.target.value)} />
        <span class="unit">${n}</span></span>`}if(!e&&"select"===i){const e=s.attributes.options??[];return V`<select @change=${e=>this.stage(t,e.target.value)}>
      ...
      @change=${e=>this.stage(t,e.target.value)} />`}durationInput(t){const e=(this.draftVal(t)||"").trim(),s=/^(\d+):(\d{1,2})(?::(\d{1,2}))?$/.exec(e),i=s?+s[1]:0,o=s?+s[2]:0,a=s?+(s[3]??0):0,n=t=>String(t).padStart(2,"0"),r=(e,s,i)=>this.stage(t,`${n(Math.max(0,Math.min(99,e)))}:${n(Math.max(0,Math.min(59,s)))}:${n(Math.max(0,Math.min(59,i)))}`),l=(t,e,s,i)=>V`
      <span class="dur-box">
      ...
      ${l(a,59,"s",t=>r(i,o,t))}
    </span>`}numOpts(t,e,s=1,i=String){const o=[],a=(String(s).split(".")[1]||"").length,n=s>0?Math.round((e-t)/s):0;for(let e=0;e<=n;e++){const n=Number((t+e*s).toFixed(a));o.push({label:i(n),value:String(n)})}return o}offOpts(t,e,s=1,i){return[{label:"Off",value:"0"},...this.numOpts(t,e,s,i)]}autoOpts(t,e,s=1,i){return[{label:"Automatic",value:"0"},...this.numOpts(t,e,s,i)]}optSelect(t,e,s=!1){if(!this.get(t))return K;const i=this.draftVal(t),o=e.find(t=>Number(t.value)===Number(i))?.value??e.find(t=>t.value===i)?.value??i;return V`<select @change=${e=>{const i=e.target.value;s?this.hass?.callService("number","set_value",{entity_id:t,value:Number(i)}):this.stage(t,i)}}>
      ${e.map(t=>V`
        <option value=${t.value} .selected=${String(t.value)===String(o)}>${t.label}</option>`)}
    </select>`}optSelectRow(t,e,s,i=!1){if(!this.get(e))return K;const o=!i&&e in this.draft?"dev-row staged":"dev-row";return V`<div class=${o}>
      <span class="dev-lbl">${t}</span>
      <div class="ctl-input">${this.optSelect(e,s,i)}</div>
    </div>`}stagedRow(t,e,s){if(!this.get(e))return K;const i=e in this.draft?"dev-row staged":"dev-row";return V`<div class=${i}>
      <span class="dev-lbl">${t}</span>
      <div class="ctl-input">${this.stagedInput(e,s)}</div>
    </div>`}stagedRangeRow(t,e,s){const i=this.get(e);if(!i)return K;const o=Math.round(Number(i.attributes.min??1)),a=Math.round(Number(i.attributes.max??100)),n=Math.max(1,Math.round(Number(i.attributes.step??1)));return this.optSelectRow(t,e,this.numOpts(o,a,n,s))}stagedPeriodRow(t,e,s){const i=this.get(t),o=this.get(e);if(!i&&!o)return K;const a=t in this.draft||e in this.draft;return V`<div class="dev-row period-row ${a?"staged":""}">
      <span class="dev-lbl">${s}</span>
      <div class="period-times">
        ${i?this.stagedInput(t,"time"):K}
        <span class="dash">–</span>
        ${o?this.stagedInput(e,"time"):K}
      </div>
    </div>`}liveModeRow(t,e){const s=this.get(e);if(!s)return K;const i=s.attributes.options??[],o=this.modeOf(e,s.state);return V`<div class="dev-row ${e in this.draft?"staged":""}">
      <span class="dev-lbl">${t}</span>
      <div class="ctl-input">
      ...
      @click=${()=>this.stage(t,e?"off":"on")} aria-label="Toggle"></button>`}stagedCtl(t,e,s){const i=this.get(t);if(!i)return K;const o=e??i.attributes.friendly_name??t.split(".")[1],a="switch"===t.split(".")[0]?this.stagedSwitch(t):this.stagedInput(t,s),n=t in this.draft;return V`
      <div class="ctl ${n?"staged":""}">
        <div class="ctl-label">${o}</div>
        <div class="ctl-input">${a}</div>
      </div>`}applyStaged(t){for(const e of t){if(!(e in this.draft))continue;const t=this.draft[e];switch(e.split(".")[0]){case"number":this.hass?.callService("number","set_value",{entity_id:e,value:Number(t)});break;case"text":this.hass?.callService("text","set_value",{entity_id:e,value:t});break;case"select":this.hass?.callService("select","select_option",{entity_id:e,option:t});break;case"switch":this.hass?.callService("switch","on"===t?"turn_on":"turn_off",{entity_id:e})}}const e={...this.draft};for(const s of t)delete e[s];this.draft=e}discardStaged(t){const e={...this.draft};let s=!1;for(const i of t)i in e&&(delete e[i],s=!0);s&&(this.draft=e)}applyBar(t,e={}){const s=!!e.extraDirty||t.some(t=>t in this.draft);return Wt(this.accent(),s,()=>{this.applyStaged(t),e.onApply?.()},()=>{this.discardStaged(t),e.onDiscard?.()},"apply-bar")}envIds(){const t=this.config.panel,e=[];for(const s of[`text.sf_${t}_env_day_start`,`text.sf_${t}_env_day_end`])this.get(s)&&e.push(s);for(const[,s,i,o]of Gt)for(const a of[i,s,o]){const s=`number.sf_${t}_${a}`;this.get(s)&&e.push(s)}for(const s of["leaf_vpd_min","leaf_vpd_max"]){const i=`number.sf_${t}_${s}`;this.get(i)&&e.push(i)}return e}caliIds(){const t=this.config.panel,e=[];for(const s of["cal_air_temp","cal_air_humidity","cal_ppfd","cal_co2"]){const i=`number.sf_${t}_${s}`;this.get(i)&&e.push(i)}for(const s of this.caliSoilSlots()){for(const i of["cal_temp","cal_moisture","cal_ec"]){const o=`number.sf_${t}_${s}_${i}`;this.get(o)&&e.push(o)}const i=`select.sf_${t}_${s}_substrate`;this.get(i)&&e.push(i)}for(const s of[`number.sf_${t}_leaf_offset`,`number.sf_${t}_leaf_offset_night`])this.get(s)&&e.push(s);return e}hasEnv(){return!!this.get(`number.sf_${this.config.panel}_env_temp_day`)}outletSlots(){const t=this.config.panel??"",e=this.config.outlets??[];if(!this.hass)return e;const s=[];t&&this.get(`switch.sf_${t}_outlet_1`)&&s.push(t);const i=new Set(Ct(this.hass,t));for(const o of e)o!==t&&i.has(o)&&s.push(o);return s}hasOutlets(){return this.outletSlots().some(t=>{for(let e=1;e<=10;e++)if(this.get(`select.sf_${t}_outlet_${e}_mode`))return!0;return!1})}rangeSelect(t){const e=this.get(t);if(!e)return K;const s=Number(e.attributes.min??0),i=Number(e.attributes.max??100),o=Number(e.attributes.step??1)||1,a=e.attributes.unit_of_measurement??"";return this.optSelect(t,this.numOpts(s,i,o,t=>`${t}${a}`),!1)}envControl(t,e){return this.get(t)?V`
      <div class="ctl">
        <div class="ctl-label">${e}</div>
        <div class="ctl-input">${this.rangeSelect(t)}</div>
      </div>`:K}planEntity(){return this.get(`sensor.sf_${this.config.panel}_plan`)}hasPlan(){return!!this.planEntity()}planInfo(){const t=this.planEntity(),e=t?.attributes??{};return{active:!!e.active,stages:Array.isArray(e.stages)?e.stages:[],progress:e.progress&&"object"==typeof e.progress?e.progress:{}}}renderEnv(){if(!this.hasEnv())return V`<div class="cali-empty">No environment targets reported for this device yet.</div>`;if(!this.hasPlan())return this.renderEnvBody(!0);const t=this.planInfo(),e=this.envSubView??(t.active?"plan":"env"),s=this.accent(),i=(t,i)=>V`
      ...
      ${t?V`<div class="section-label">Environment</div>`:K}
      ...
      ${this.applyBar(this.envIds())}`}renderPlan(t){if(null!=this.planEditStage&&this.planDraft)return this.renderStageEditor(this.planEditStage);const e=this.accent(),s=`switch.sf_${this.config.panel}_plan_enabled`,i=!!this.get(s),o=t.stages,a=t.progress||{},n=t=>{const e=Math.max(0,o.findIndex(e=>e.stageId===t)),s=this.planShowAll?o.map((t,e)=>e):[e];return V`
        ...
        ${o.length>1?V`<button class="plan-editbtn" style="margin:2px 0 6px"
          ...
          ${this.planShowAll?"Show less":`Show all ${o.length} stages`}</button>`:K}
        <button class="plan-btn" @click=${()=>this.addPlanStage()}>+ Add stage</button>`},r=(t,i)=>V`
      <button class="plan-btn ${i?"stop":"start"}"
        ...
        ${n(null)}
        ${i?V`<div class="plan-actions">${r("Start Plan",!1)}</div>`:K}`:V`
          ...
          </div>`;const l=o.find(t=>t.stageId===a.stageId)||o[0],c=Number(a.progress),d=Number.isFinite(c),h=[];return null!=a.planted&&h.push(`${this.fmtNum(a.planted)} planted`),null!=a.remain&&h.push(`${this.fmtNum(a.remain)} left`),null!=a.totalDays&&h.push(`${this.fmtNum(a.totalDays)} total`),V`
      <div class="plan-banner">
        ...
        ${d?V`<div class="plan-pct" style="color:${e}">${Math.round(c)}%</div>`:K}
      </div>
      ${d?V`<div class="plan-bar"><div class="plan-bar-fill"
            style="width:${Math.max(0,Math.min(100,c))}%;background:${e}"></div></div>`:K}
      ${n(a.stageId)}
      ${i?V`<div class="plan-actions">${r("Stop Plan",!0)}</div>`:K}
      <div class="plan-note">
      ...
      <div class="pe-light">
        ...
        ${h?V`<div class="pe-durrow">Light Duration · ${h}</div>`:K}
        ${l?V`
      ...
      .value=${String(i[t]??"")} @change=${e=>o(t,e.target.value)}>`,n=(t,e,s,a)=>V`
      ...
      ${this.planEnvHas("temp")?n("Temp "+s,"temp",this.envOptsFor("env_temp_day"),this.envOptsFor("env_temp_deadband")):K}
      ${this.planEnvHas("humi")?n("Humidity","humi",this.envOptsFor("env_humi_day"),this.envOptsFor("env_humi_deadband")):K}
      ${this.planEnvHas("co2")?n("CO₂","co2",this.envOptsFor("env_co2_day"),this.envOptsFor("env_co2_deadband")):K}
      ${this.planLightHas("light1")?this.renderStageLight(t,"light1"):K}
      ${this.planLightHas("light2")?this.renderStageLight(t,"light2"):K}
      ...
      <div class="plan-stage ${o?"current":""}"
        ...
        <div class="plan-stage-head">
          ...
          ${o?V`<span class="plan-stage-badge" style="color:${i};border-color:${i}">Current</span>`:K}
          ${s>=0?V`<ha-icon icon="mdi:pencil" class="plan-stage-edit"
            @click=${()=>this.editStage(s)}></ha-icon>`:K}
        </div>
        ${a?V`<div class="plan-stage-dates">${a}</div>`:K}
        <div class="plan-stage-grid">
          ${this.planEnvHas("temp")?n("Temp",this.fmtTemp(t.temp_night),this.fmtTemp(t.temp_day)):K}
          ${this.planEnvHas("humi")?n("Humidity",t.humi_night,t.humi_day,"%"):K}
          ${this.planEnvHas("co2")?n("CO₂",t.co2_night,t.co2_day,""):K}
        </div>
      ...
      </div>`:K}renderLeafVpdTargets(){const t=this.get(this.eid("number","leaf_vpd_min")),e=this.get(this.eid("number","leaf_vpd_max"));if(!t||!e)return K;const s=(t,e)=>{const s=this.eid("number",t);return V`
      ...
      <span style="display:inline-flex;align-items:center;gap:6px;font-size:12px;font-weight:400">
        ...
        <button class="toggle sm ${i?"on":""}"
          style=${i?`background:${o}`:K}
          title="Indicator Light"
          aria-label="Indicator Light"
          @click=${()=>this.hass?.callService("switch","toggle",{entity_id:e})}></button>
      </span>`}renderOutlets(){const t=this.outletSlots().filter(t=>this.outletNums(t).length>0);if(!t.length)return K;const e=this.outletOpen?this.outletOpen.slice(0,this.outletOpen.lastIndexOf("_")):null;return V`
      ${t.map(t=>{const s=Ot(this.hass,t)||(t.startsWith("st")?"S-Station":`${t.toUpperCase()} Power Strip`);return V`
      ...
      <div class="olog-row" role="button" aria-expanded=${r?"true":"false"}
        ...
        <div class="olog-tl">
          ${p?V`<span class="olog-load">Loading…</span>`:u.map(t=>V`<span class="olog-seg"
      ...
      <div class="tile clickable ${a?"active":""}"
        ...
        <div class="tile-val" style=${s?`color:${l}`:K}>${s?"On":"Off"}</div>
        <div class="tile-sub">${i}</div>
        ${(()=>{const s=this.outletModeDetail(t,e,i);return s?V`<div class="tile-sub2 ${s.cls}">${s.text}</div>`:K})()}
      </div>`}clearOutletCfgDraft(t,e){const s=this.outletKey(t,e);if(!(s in this.outletCfgDraft))return;const i={...this.outletCfgDraft};delete i[s],this.outletCfgDraft=i}renderOutletModeConfig(t,e,s){const i=this.outletKey(t,e),o=this.outletCfgDraft[i]??{},a=(t,e)=>this.outletCfgDraft={...this.outletCfgDraft,[i]:{...o,[t]:e}},n=(t,e,s,i)=>V`
      <div class="dev-row ${e in o?"staged":""}">
        <span class="dev-lbl">${t}</span>
        <span class="num-box">
          <input type="number" min="0" max="1440" .value=${o[e]??String(s)}
            @change=${t=>a(e,t.target.value)} />
          ${i?V`<span class="unit">${i}</span>`:K}
        </span>
      </div>`,r=(t,e,s)=>V`
      <div class="dev-row ${e in o?"staged":""}">
        <span class="dev-lbl">${t}</span>
        ...
        ${l="Start",c="cycle_start",d="12:00",V`
      <div class="dev-row ${c in o?"staged":""}">
        ...
        ${n("Execution Times","cycle_times",1,"")}`;case"Temperature":return r("Device","temp_device",["Heating","Cooling"]);case"Humidity":return r("Device","humidity_device",["Humidifying","Dehumidifying"]);case"CO2":return r("Device","co2_device",["Aeration","Exhaust"]);default:return K}var l,c,d}renderOutletPop(){const t=this.outletOpen;if(!t)return K;const e=t.lastIndexOf("_");if(e<0)return K;const s=t.slice(0,e),i=Number(t.slice(e+1));if(!s||!Number.isFinite(i))return K;const o=`select.sf_${s}_outlet_${i}_mode`;if(!this.get(o))return K;const a=`switch.sf_${s}_outlet_${i}`,n=this.get(a),r=`sf_${s}_outlet_${i}_`,l=this.draftVal(o)||this.get(o)?.state||"",c="Time Slot"===l,d=new Set((Ft[l]||[]).map(t=>`${r}${t}`)),h=Object.keys(this.hass?.states??{}).filter(t=>{const e=t.split(".")[1]??"";return!!d.has(e)&&(!c||e!==`${r}ts_type`&&e!==`${r}ts_start`&&e!==`${r}ts_stop`)}).sort(),p=this.get(o)?.state||"",u=l!==p&&"Manual"!==l&&!c&&(Ft[l]||[]).length>0&&0===h.length,g=this.outletKey(s,i),f=[...u?[]:[o],...n?[a]:[],...h.filter(t=>/^(switch|number|select|text)\./.test(t))],m=!!this.outletDraft[this.outletKey(s,i)],v=this.outletNameDirty(s,i),b=u;return V`
      <div class="soil-pop" style="--sf-accent:${this.accent()}">
        <div class="soil-pop-head">
        ...
        ${n&&!u?this.stagedCtl(a,"Power"):K}
        ${u?this.renderOutletModeConfig(s,i,l):K}
        ${h.map(t=>this.stagedCtl(t))}
        ${c?this.renderOutletSchedule(s,i):K}
        ${this.applyBar(f,{extraDirty:m||v||b,onApply:()=>{if(u){if(this.hass?.callService("sf","set_outlet_config",{entity_id:o,mode:l,config:this.outletCfgDraft[g]??{}}),this.clearOutletCfgDraft(s,i),o in this.draft){const t={...this.draft};delete t[o],this.draft=t}this.modePick={...this.modePick,[o]:l}}this.saveOutlet(s,i),this.commitOutletName(s,i)},onDiscard:()=>{if(this.clearOutletDraft(s,i),this.clearOutletNameDraft(s,i),this.clearOutletCfgDraft(s,i),o in this.draft){const t={...this.draft};delete t[o],this.draft=t}}})}
      ...
      </div>`}caliSoilSlots(){const t=new RegExp(`^sf_${this.config.panel}_(soil\\d+)_cal_temp$`),e=new Set;for(const s of Object.keys(this.hass?.states??{})){const i=bt(s).match(t);i&&e.add(i[1])}return[...e].sort((t,e)=>Number(t.replace(/\D/g,""))-Number(e.replace(/\D/g,"")))}hasCali(){return!!this.get(`number.sf_${this.config.panel}_cal_air_temp`)||this.caliSoilSlots().length>0}probeName(t){const e=this.get(`number.sf_${this.config.panel}_${t}_cal_temp`);let s=e?.attributes.friendly_name??"";const i=Ot(this.hass,this.config.panel);return i&&s.startsWith(i)&&(s=s.slice(i.length).trim()),s=s.replace(/\s*Temp Calibration\s*$/i,"").trim(),s||t.replace(/^soil(\d+)$/,"Soil $1")}renderCali(){const t=this.config.panel,e=[[`number.sf_${t}_cal_air_temp`,"Air Temp"],[`number.sf_${t}_cal_air_humidity`,"Air Humidity"],[`number.sf_${t}_cal_ppfd`,"PPFD"],[`number.sf_${t}_cal_co2`,"CO2"]].map(([t,e])=>this.envControl(t,e)).filter(t=>t!==K),s=this.caliSoilSlots().map(e=>{const s=[this.envControl(`number.sf_${t}_${e}_cal_temp`,"Temp"),this.envControl(`number.sf_${t}_${e}_cal_moisture`,"Moisture"),this.envControl(`number.sf_${t}_${e}_cal_ec`,"EC")].filter(t=>t!==K),i=this.stagedCtl(`select.sf_${t}_${e}_substrate`,"Substrate");return V`
        <div class="env-row">
          <div class="env-row-head">
            <ha-icon icon="mdi:sprout" style="color:${this.accent()}"></ha-icon>
            <span>${this.probeName(e)}</span>
          </div>
          <div class="cali-soil-grid">${s}${i!==K?i:K}</div>
        </div>`}),i=this.renderLeafVpdCalibration();return e.length||s.length||i!==K?V`
      ${e.length?V`<div class="section-label">Air Calibration</div>
            <div class="cali-air">${e}</div>`:K}
      ${s.length?V`<div class="section-label">Soil Calibration</div>${s}`:K}
      ${i}
      ...
      ${Wt(s,e,()=>this.saveAlerts(),()=>this.alertsDraft=null,"apply-bar")}`}renderAlertGroup(t,e,s){const i=t[e]||[];return i.length?V`
      <div class="section-label">${s}</div>
      ${i.map((t,s)=>this.renderAlertMetric(e,s,t))}`:K}tempUnit(){return this.hass?.config?.unit_system?.temperature||"°F"}isCelsius(){return this.tempUnit().includes("C")}tempThresholdOpts(){const t=this.isCelsius();return this.offOpts(t?15:59,t?50:122,1,t=>`${t}${this.tempUnit()}`)}alertBounds(t){switch(t){case"temp":case"tempSoil":return this.isCelsius()?[0,50]:[32,122];case"humi":case"humiSoil":default:return[0,100];case"vpd":return[0,6];case"co2":return[0,5e3];case"ppfd":return[0,4e3];case"ECSoil":return[0,10]}}renderAlertMetric(t,e,s){const i=this.accent(),[o,a]=this.alertBounds(s.key),n=Number(s.step??1)||1,r="ppfd"===s.key?Math.max(o,a-100):a,l=(i,l)=>{const c=this.numOpts(o,"min"===l?r:a,n);return V`
      <label class="av">
      ...
      <div class="alert-row ${s.enabled?"":"off"}">
        ...
        <div class="alert-vals">
          ${"range"===s.kind?l("Min","min"):K}
          ${l("Max","max")}
        </div>
      </div>`}renderAlertOther(t){const e=t.other||[];if(!e.length)return K;const s=this.accent();return V`
      ...
      ${o.length?V`
            ...
            </div>`:V`<div class="cali-empty">No log entries on this date.</div>`}`}render(){if(!this.hass||!this.config)return K;const t=this.hasOutlets();let e=this.tab;"outlets"!==e||t||(e="overview"),"olog"!==e||t&&this.showOutletsLog||(e="overview");const s=this.accent(),i=(t,i)=>V`<button class="tab ${e===t?"active":""}"
        style=${e===t?`color:${s};border-color:${s}`:""}
        @click=${()=>this.tab=t}>${i}</button>`,o=Ot(this.hass,this.config.panel);return V`
      <ha-card style=${this.layoutStyle()||K}>
        <div class="header">
          <span class="title">${this.config.title||"Spider Farmer"}</span>
          ${o?V`<span class="device">${o}</span>`:K}
          ${this.renderConn()}
        </div>
        ${V`<div class="tabs">
              ${i("overview","Overview")}
              ${i("env","Environment")}
              ${t?i("outlets","Outlets"):K}
              ${t&&this.showOutletsLog?i("olog","Outlets Log"):K}
              ${i("cali","Calibration")}
              ${i("alerts","Alerts")}
              ${i("log","Log")}
              ${i("settings","Settings")}
            </div>`}
        ${"env"===e?this.renderEnv():"outlets"===e?this.renderOutlets():"olog"===e?this.renderOutletsLog():"cali"===e?this.renderCali():"alerts"===e?this.renderAlerts():"log"===e?this.renderLog():"settings"===e?this.renderSettings():this.renderOverview()}
      </ha-card>`}setLeafSpot(t,e){const s=[...this.leafSpots];s[t]=parseFloat(e),this.leafSpots=s}renderLeafVpdCalibration(){const t=this.eid("number","leaf_offset"),e=this.get(t);if(!e)return K;const s=e.attributes.unit_of_measurement||"°",i=this.get(this.eid("sensor","temperature")),o=i&&Number.isFinite(+i.state)?+i.state:null;if(5!==this.leafSpots.length){const t=o??0;this.leafSpots=Array(5).fill(Math.round(10*t)/10)}const a=this.leafSpots,n=a.filter(t=>Number.isFinite(t)),r=n.length?n.reduce((t,e)=>t+e,0)/n.length:null,l=null!=r&&null!=o?r-o:null,c=t in this.draft,d=e=>this.stage(t,String(Math.round(10*e)/10)),h=this.eid("number","leaf_offset_night"),p=!!this.get(h),u=h in this.draft,g=t=>this.stage(h,String(Math.round(10*t)/10)),f=this.accent(),m=p?this.leafCalTarget:"day";return V`
      ...
      </details>`}renderSettings(){const t=this.accent(),e=this.colorDraft,s=e?.mode??this.colorMode,i=e?.modeIn??this.colorModeIn,o=e?.hi??this.colHi,a=e?.lo??this.colLo,n=e?.in??this.colIn,r=e?.warn??this.colWarn,l=e?.showTrend??this.showTrend,c=e?.showBand??this.showBand,d=e?.showTargets??this.showTargets,h=e?.tileSummary??this.tileSummary,p=e?.hour12??this.hour12,u=e?.showConn??this.showConn,g=e?.connCustom??this.connCustom,f=e?.connSignal??this.connSignal,m=e?.showOutletsLog??this.showOutletsLog,v=e?.customNames??this.customOutletNames,b=e?.customLayout??this.customLayout,_=e?.scale??this.cardScale,$=e?.cols??this.tileCols,x=!!this.get(this.eid("light","light_2")),y=e?.omode??this.outletColorMode,w=e?.ocManual??this.ocManual,S=e?.ocSched??this.ocSched,k=e?.ocEnv??this.ocEnv,M=e?.ocDrip??this.ocDrip,C=this.hasOutlets(),O=e?.dmode??this.deviceColorMode,D=e?.dcManual??this.dcManual,N=e?.dcSched??this.dcSched,A=e?.dcAuto??this.dcAuto,T=this.overviewDevices().length>0,E=!!e&&(void 0!==e.mode&&e.mode!==this.colorMode||void 0!==e.modeIn&&e.modeIn!==this.colorModeIn||void 0!==e.source&&e.source!==this.colorSource||void 0!==e.warn&&e.warn!==this.colWarn||void 0!==e.showTrend&&e.showTrend!==this.showTrend||void 0!==e.showBand&&e.showBand!==this.showBand||void 0!==e.showTargets&&e.showTargets!==this.showTargets||void 0!==e.tileSummary&&e.tileSummary!==this.tileSummary||void 0!==e.hour12&&e.hour12!==this.hour12||void 0!==e.showConn&&e.showConn!==this.showConn||void 0!==e.connCustom&&e.connCustom!==this.connCustom||void 0!==e.connSignal&&e.connSignal!==this.connSignal||void 0!==e.showOutletsLog&&e.showOutletsLog!==this.showOutletsLog||void 0!==e.hi&&e.hi!==this.colHi||void 0!==e.lo&&e.lo!==this.colLo||void 0!==e.in&&e.in!==this.colIn||void 0!==e.hide2&&e.hide2!==this.hideLight2||void 0!==e.customNames&&e.customNames!==this.customOutletNames||void 0!==e.customLayout&&e.customLayout!==this.customLayout||void 0!==e.scale&&e.scale!==this.cardScale||void 0!==e.cols&&e.cols!==this.tileCols||void 0!==e.omode&&e.omode!==this.outletColorMode||void 0!==e.ocManual&&e.ocManual!==this.ocManual||void 0!==e.ocSched&&e.ocSched!==this.ocSched||void 0!==e.ocEnv&&e.ocEnv!==this.ocEnv||void 0!==e.ocDrip&&e.ocDrip!==this.ocDrip||void 0!==e.dmode&&e.dmode!==this.deviceColorMode||void 0!==e.dcManual&&e.dcManual!==this.dcManual||void 0!==e.dcSched&&e.dcSched!==this.dcSched||void 0!==e.dcAuto&&e.dcAuto!==this.dcAuto),L=t=>this.colorDraft={...this.colorDraft??{},...t},P=(e,s,i,o,a)=>V`
      <button class="seg ${e===s?"on":""}"
        style=${e===s?`border-color:${t};color:${t}`:K}
        @click=${a}>
        <ha-icon icon=${o}></ha-icon><span>${i}</span>
      </button>`,R=e?.source??this.colorSource,z=(e,s,i)=>V`
      <button class="seg ${R===e?"on":""}"
        style=${R===e?`border-color:${t};color:${t}`:K}
        @click=${()=>L({source:e})}>
      ...
      <div class="seg-row">
        ${z("alarms","Alarms","mdi:bell-outline")}
        ${z("targets","Targets","mdi:target")}
        ${z("both","Both","mdi:set-center")}
      </div>
      ...
      <div class="seg-row">
        ${P(s,"off","No color","mdi:circle-off-outline",()=>L({mode:"off"}))}
        ${P(s,"tile","Tile color","mdi:square-rounded",()=>L({mode:"tile"}))}
        ${P(s,"text","Text color","mdi:format-color-text",()=>L({mode:"text"}))}
      </div>
      <div class="color-row">
        ${F("Above max",o,t=>L({hi:t}))}
        ${F("Below min",a,t=>L({lo:t}))}
        ${F("Near edge",r,t=>L({warn:t}))}
      </div>
      ...
      <div class="seg-row">
        ${P(i,"off","No color","mdi:circle-off-outline",()=>L({modeIn:"off"}))}
        ${P(i,"tile","Tile color","mdi:square-rounded",()=>L({modeIn:"tile"}))}
        ${P(i,"text","Text color","mdi:format-color-text",()=>L({modeIn:"text"}))}
      </div>
      <div class="color-row">
        ${F("In range",n,t=>L({in:t}))}
      </div>
      ...
      ${C?V`
            ...
            <div class="set-note">
              ...
              <span style="color:${w}">Manual</span>,
              <span style="color:${S}">Scheduled</span>,
              <span style="color:${k}">Environment</span>,
              <span style="color:${M}">Drip</span>. Off outlets stay neutral.
            </div>
            <div class="seg-row">
              ${P(y,"off","No color","mdi:circle-off-outline",()=>L({omode:"off"}))}
              ${P(y,"tile","Tile color","mdi:square-rounded",()=>L({omode:"tile"}))}
              ${P(y,"text","Text color","mdi:format-color-text",()=>L({omode:"text"}))}
            </div>
            <div class="color-row">
              ${F("Manual",w,t=>L({ocManual:t}))}
              ${F("Scheduled",S,t=>L({ocSched:t}))}
            </div>
            <div class="color-row">
              ${F("Environment",k,t=>L({ocEnv:t}))}
              ${F("Drip",M,t=>L({ocDrip:t}))}
            </div>`:K}
      ...
      ${T?V`
            ...
            <div class="set-note">
              ...
              <span style="color:${D}">Manual</span>,
              <span style="color:${N}">Scheduled</span>,
              <span style="color:${A}">Auto</span> (Environment / PPFD). A
              <span style="color:${Tt}">fault</span> always overrides.
            </div>
            <div class="seg-row">
              ${P(O,"off","No color","mdi:circle-off-outline",()=>L({dmode:"off"}))}
              ${P(O,"tile","Tile color","mdi:square-rounded",()=>L({dmode:"tile"}))}
              ${P(O,"text","Text color","mdi:format-color-text",()=>L({dmode:"text"}))}
            </div>
            <div class="color-row">
              ${F("Manual",D,t=>L({dcManual:t}))}
              ${F("Scheduled",N,t=>L({dcSched:t}))}
              ${F("Auto",A,t=>L({dcAuto:t}))}
            </div>`:K}
      ...
      <div class="toggle-row">
        ...
        <button class="toggle ${d?"on":""}"
          style=${d?`background:${t}`:K}
          @click=${()=>L({showTargets:!d})}></button>
      </div>
      <div class="toggle-row" style="margin-top:8px">
        <span>Trend arrows</span>
        <button class="toggle ${l?"on":""}"
          style=${l?`background:${t}`:K}
          @click=${()=>L({showTrend:!l})}></button>
      </div>
      <div class="toggle-row" style="margin-top:8px">
        <span>Dead-zone band</span>
        <button class="toggle ${c?"on":""}"
          style=${c?`background:${t}`:K}
          @click=${()=>L({showBand:!c})}></button>
      </div>
      <div class="toggle-row" style="margin-top:8px">
        <span>Device mode summary</span>
        <button class="toggle ${h?"on":""}"
          style=${h?`background:${t}`:K}
          @click=${()=>L({tileSummary:!h})}></button>
      </div>
      <div class="set-note">
      ...
      <div class="toggle-row" style="margin-top:8px">
        ...
        <button class="toggle ${p?"on":""}"
          style=${p?`background:${t}`:K}
          @click=${()=>L({hour12:!p})}></button>
      </div>
      <div class="set-note">
      ...
      <div class="toggle-row" style="margin-top:8px">
        ...
        <button class="toggle ${u?"on":""}"
          style=${u?`background:${t}`:K}
          @click=${()=>L({showConn:!u})}></button>
      </div>
      ${u?V`
        <div class="toggle-row" style="margin-top:8px">
          <span>Use a custom signal source</span>
          <button class="toggle ${g?"on":""}"
            style=${g?`background:${t}`:K}
            @click=${()=>L({connCustom:!g})}></button>
        </div>
        <div class="set-note">
        ...
        ${g?V`
          <div class="toggle-row" style="margin-top:6px">
            ...
            <select style="max-width:60%"
              @change=${t=>L({connSignal:t.target.value})}>
              <option value="" ?selected=${!f}>— none —</option>
              ${this.signalEntityOptions().map(t=>V`
      ...
      <div class="toggle-row">
        ...
        <button class="toggle ${v?"on":""}"
          style=${v?`background:${t}`:K}
          @click=${()=>L({customNames:!v})}></button>
      </div>
      <div class="toggle-row" style="margin-top:8px">
        <span>Show Outlets Log tab</span>
        <button class="toggle ${m?"on":""}"
          style=${m?`background:${t}`:K}
          @click=${()=>L({showOutletsLog:!m})}></button>
      </div>
      <div class="set-note">
      ...
      <div class="toggle-row">
        ...
        <button class="toggle ${b?"on":""}"
          style=${b?`background:${t}`:K}
          @click=${()=>L({customLayout:!b})}></button>
      </div>
      ${b?V`
        <div class="set-note" style="margin-top:10px;display:flex;justify-content:space-between">
          <span>Scale</span><span style="color:${t};font-weight:500">${_}%</span>
        </div>
        <input type="range" min="70" max="150" step="5" .value=${String(_)}
          style="width:100%"
          @input=${t=>L({scale:Number(t.target.value)})} />
        <div class="set-note" style="margin-top:10px">Tiles per row</div>
        <div class="seg-row" style="grid-template-columns:repeat(4,1fr)">
          ${[2,3,4,5].map(e=>V`
            <button class="seg ${$===e?"on":""}"
              style=${$===e?`border-color:${t};color:${t}`:K}
              @click=${()=>L({cols:e})}><span>${e}</span></button>`)}
        </div>`:K}
      ${Wt(t,E,()=>{const t=this.colorDraft;t&&(void 0!==t.mode&&t.mode!==this.colorMode&&(this.colorMode=t.mode,this.persistColorOption("colors",t.mode)),void 0!==t.modeIn&&t.modeIn!==this.colorModeIn&&(this.colorModeIn=t.modeIn,this.persistColorOption("colors_in",t.modeIn)),void 0!==t.source&&t.source!==this.colorSource&&(this.colorSource=t.source,this.persistColorOption("color_source",t.source)),void 0!==t.warn&&t.warn!==this.colWarn&&(this.colWarn=t.warn,this.persistColorOption("color_warn",t.warn)),void 0!==t.showTrend&&t.showTrend!==this.showTrend&&(this.showTrend=t.showTrend,this.persistColorOption("show_trend",t.showTrend?"1":"0")),void 0!==t.showBand&&t.showBand!==this.showBand&&(this.showBand=t.showBand,this.persistColorOption("show_band",t.showBand?"1":"0")),void 0!==t.showTargets&&t.showTargets!==this.showTargets&&(this.showTargets=t.showTargets,this.persistColorOption("show_targets",t.showTargets?"1":"0")),void 0!==t.tileSummary&&t.tileSummary!==this.tileSummary&&(this.tileSummary=t.tileSummary,this.persistColorOption("tile_summary",t.tileSummary?"1":"0")),void 0!==t.showConn&&t.showConn!==this.showConn&&(this.showConn=t.showConn,this.persistColorOption("show_conn",t.showConn?"1":"0")),void 0!==t.connCustom&&t.connCustom!==this.connCustom&&(this.connCustom=t.connCustom,this.persistColorOption("conn_custom",t.connCustom?"1":"0")),void 0!==t.connSignal&&t.connSignal!==this.connSignal&&(this.connSignal=t.connSignal,this.persistColorOption("conn_signal",t.connSignal)),void 0!==t.showOutletsLog&&t.showOutletsLog!==this.showOutletsLog&&(this.showOutletsLog=t.showOutletsLog,this.persistColorOption("outlets_log",t.showOutletsLog?"1":"0")),void 0!==t.hour12&&t.hour12!==this.hour12&&(this.hour12=t.hour12,this.persistColorOption("time_12h",t.hour12?"1":"0")),void 0!==t.hi&&t.hi!==this.colHi&&(this.colHi=t.hi,this.persistColorOption("color_hi",t.hi)),void 0!==t.lo&&t.lo!==this.colLo&&(this.colLo=t.lo,this.persistColorOption("color_lo",t.lo)),void 0!==t.in&&t.in!==this.colIn&&(this.colIn=t.in,this.persistColorOption("color_in",t.in)),void 0!==t.hide2&&t.hide2!==this.hideLight2&&(this.hideLight2=t.hide2,this.persistColorOption("hide_light2",t.hide2?"1":"0")),void 0!==t.customNames&&t.customNames!==this.customOutletNames&&(this.customOutletNames=t.customNames,this.persistColorOption("custom_outlet_names",t.customNames?"1":"0")),void 0!==t.customLayout&&t.customLayout!==this.customLayout&&(this.customLayout=t.customLayout,this.persistColorOption("custom_layout",t.customLayout?"1":"0")),void 0!==t.scale&&t.scale!==this.cardScale&&(this.cardScale=t.scale,this.persistColorOption("card_scale",String(t.scale))),void 0!==t.cols&&t.cols!==this.tileCols&&(this.tileCols=t.cols,this.persistColorOption("tile_cols",String(t.cols))),void 0!==t.omode&&t.omode!==this.outletColorMode&&(this.outletColorMode=t.omode,this.persistColorOption("outlet_colors",t.omode)),void 0!==t.ocManual&&t.ocManual!==this.ocManual&&(this.ocManual=t.ocManual,this.persistColorOption("oc_manual",t.ocManual)),void 0!==t.ocSched&&t.ocSched!==this.ocSched&&(this.ocSched=t.ocSched,this.persistColorOption("oc_sched",t.ocSched)),void 0!==t.ocEnv&&t.ocEnv!==this.ocEnv&&(this.ocEnv=t.ocEnv,this.persistColorOption("oc_env",t.ocEnv)),void 0!==t.ocDrip&&t.ocDrip!==this.ocDrip&&(this.ocDrip=t.ocDrip,this.persistColorOption("oc_drip",t.ocDrip)),void 0!==t.dmode&&t.dmode!==this.deviceColorMode&&(this.deviceColorMode=t.dmode,this.persistColorOption("device_colors",t.dmode)),void 0!==t.dcManual&&t.dcManual!==this.dcManual&&(this.dcManual=t.dcManual,this.persistColorOption("dc_manual",t.dcManual)),void 0!==t.dcSched&&t.dcSched!==this.dcSched&&(this.dcSched=t.dcSched,this.persistColorOption("dc_sched",t.dcSched)),void 0!==t.dcAuto&&t.dcAuto!==this.dcAuto&&(this.dcAuto=t.dcAuto,this.persistColorOption("dc_auto",t.dcAuto)),this._colorSynced=!0,this.cacheColors()),this.colorDraft=null},()=>this.colorDraft=null,"apply-bar")}`}}Kt.styles=n`
    ${yt}
  ...
  `,t([ut({attribute:!1})],Kt.prototype,"hass",void 0),t([gt()],Kt.prototype,"config",void 0),t([gt()],Kt.prototype,"tab",void 0),t([gt()],Kt.prototype,"envSubView",void 0),t([gt()],Kt.prototype,"planDraft",void 0),t([gt()],Kt.prototype,"planEditStage",void 0),t([gt()],Kt.prototype,"planShowAll",void 0),t([gt()],Kt.prototype,"planDelArm",void 0),t([gt()],Kt.prototype,"colorMode",void 0),t([gt()],Kt.prototype,"colHi",void 0),t([gt()],Kt.prototype,"colLo",void 0),t([gt()],Kt.prototype,"colorModeIn",void 0),t([gt()],Kt.prototype,"colIn",void 0),t([gt()],Kt.prototype,"colWarn",void 0),t([gt()],Kt.prototype,"colorSource",void 0),t([gt()],Kt.prototype,"showTrend",void 0),t([gt()],Kt.prototype,"showBand",void 0),t([gt()],Kt.prototype,"showTargets",void 0),t([gt()],Kt.prototype,"tileSummary",void 0),t([gt()],Kt.prototype,"hour12",void 0),t([gt()],Kt.prototype,"customOutletNames",void 0),t([gt()],Kt.prototype,"outletNames",void 0),t([gt()],Kt.prototype,"showConn",void 0),t([gt()],Kt.prototype,"connCustom",void 0),t([gt()],Kt.prototype,"connSignal",void 0),t([gt()],Kt.prototype,"showOutletsLog",void 0),t([gt()],Kt.prototype,"ologRange",void 0),t([gt()],Kt.prototype,"ologOpen",void 0),t([gt()],Kt.prototype,"_ologVer",void 0),t([gt()],Kt.prototype,"customLayout",void 0),t([gt()],Kt.prototype,"cardScale",void 0),t([gt()],Kt.prototype,"tileCols",void 0),t([gt()],Kt.prototype,"paramOpen",void 0),t([gt()],Kt.prototype,"_graphVer",void 0),t([gt()],Kt.prototype,"hideLight2",void 0),t([gt()],Kt.prototype,"outletColorMode",void 0),t([gt()],Kt.prototype,"ocManual",void 0),t([gt()],Kt.prototype,"ocSched",void 0),t([gt()],Kt.prototype,"ocEnv",void 0),t([gt()],Kt.prototype,"ocDrip",void 0),t([gt()],Kt.prototype,"deviceColorMode",void 0),t([gt()],Kt.prototype,"dcManual",void 0),t([gt()],Kt.prototype,"dcSched",void 0),t([gt()],Kt.prototype,"dcAuto",void 0),t([gt()],Kt.prototype,"colorDraft",void 0),t([gt()],Kt.prototype,"alertsDraft",void 0),t([gt()],Kt.prototype,"soilOpen",void 0),t([gt()],Kt.prototype,"soilAllOpen",void 0),t([gt()],Kt.prototype,"deviceOpen",void 0),t([gt()],Kt.prototype,"outletOpen",void 0),t([gt()],Kt.prototype,"draft",void 0),t([gt()],Kt.prototype,"modePick",void 0),t([gt()],Kt.prototype,"outletDraft",void 0),t([gt()],Kt.prototype,"outletNameDraft",void 0),t([gt()],Kt.prototype,"outletCfgDraft",void 0),t([gt()],Kt.prototype,"leafSpots",void 0),t([gt()],Kt.prototype,"leafCalTarget",void 0),t([gt()],Kt.prototype,"logDate",void 0),t([gt()],Kt.prototype,"logDev",void 0),t([gt()],Kt.prototype,"logType",void 0);class qt extends ct{constructor(){super(...arguments),this._config={type:"custom:spider-farmer-card"}}setConfig(t){this._config={...t}}_emit(t){this._config=t,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}_panelChanged(t){const e=t.target.value,s={...this._config};e?s.panel=e:delete s.panel,this._emit(s)}_titleChanged(t){const e=t.target.value.trim(),s={...this._config};e?s.title=e:delete s.title,this._emit(s)}_tabChanged(t){const e=t.target.value;this._emit({...this._config,default_tab:e})}_outletToggled(t,e){const s=e.target.checked,i=new Set(this._config.outlets??[]);s?i.add(t):i.delete(t);const o=[...i].sort(),a={...this._config};o.length?a.outlets=o:delete a.outlets,this._emit(a)}render(){if(!this.hass)return K;const t=this._config,e=t.default_tab,s=St(this.hass),i=Ct(this.hass,t.panel),o=/^(ac|st)\d+/.test(t.panel||"")||i.length>0,a=!(!t.panel||"1"!==this.hass.states[`sensor.sf_${t.panel}_alarm_settings`]?.attributes?.card_options?.outlets_log),n=t=>{const e=Ot(this.hass,t);return e?`${t} — ${e}`:t};return V`
      <div class="form">
        <label class="field">
          <span class="flabel">Panel device</span>
          <select @change=${this._panelChanged}>
            ${s.length?K:V`<option value="">(no devices found yet)</option>`}
            ${t.panel?K:V`<option value="" selected>— choose a device —</option>`}
            ${s.map(e=>V`<option value=${e} ?selected=${e===t.panel}>${n(e)}</option>`)}
            ${t.panel&&!s.includes(t.panel)?V`<option value=${t.panel} selected>${t.panel} (not found)</option>`:K}
          </select>
        ...
        <label class="field">
          ...
          <select @change=${this._tabChanged}>
            ...
            ${o?V`<option value="outlets" ?selected=${"outlets"===e}>Outlets</option>`:K}
            ${o&&a?V`<option value="outlets_log" ?selected=${"outlets_log"===e}>Outlets Log</option>`:K}
  ...
  `,t([ut({attribute:!1})],qt.prototype,"hass",void 0),t([gt()],qt.prototype,"_config",void 0);const Jt=/^sf_(se\d+)_light$/;function Yt(t){const e=new Set;for(const s of Object.keys(t.states)){if(!s.startsWith("light."))continue;const t=bt(s).match(Jt);t&&e.add(t[1])}return[...e].sort((t,e)=>Number(t.replace(/\D/g,""))-Number(e.replace(/\D/g,"")))}class Xt extends ct{constructor(){super(...arguments),this.draft=null,this.ctlDraft={}}setConfig(t){this.config=t}getCardSize(){return 7}static getStubConfig(t){const e=t?Yt(t):[];return{type:"custom:spider-light-card",...e[0]?{light:e[0]}:{}}}accent(){return this.config.accent||ft}seSlot(){return this.config.light||(this.hass?Yt(this.hass)[0]:"")||"se1"}get(t){return this.hass?.states[t]}shouldUpdate(t){return t.has("config")||t.has("hass")||t.has("draft")||t.has("ctlDraft")}cur(t,e){return t in this.ctlDraft?this.ctlDraft[t]:e}stageCtl(t,e){this.ctlDraft={...this.ctlDraft,[t]:e}}isDirty(){return Object.keys(this.ctlDraft).length>0||null!==this.draft}applyAll(t){const e=this.ctlDraft,s=`light.sf_${t}_light`;if("bri"in e){const t=Number(e.bri);t>0?this.hass?.callService("light","turn_on",{entity_id:s,brightness_pct:t}):this.hass?.callService("light","turn_off",{entity_id:s})}"mode"in e&&this.hass?.callService("select","select_option",{entity_id:`select.sf_${t}_mode`,option:e.mode});for(const t of Object.keys(e))t.includes(".")&&(t.startsWith("number.")?this.hass?.callService("number","set_value",{entity_id:t,value:Number(e[t])}):t.startsWith("text.")&&this.hass?.callService("text","set_value",{entity_id:t,value:e[t]}));if("power"in e){const t="on"===e.power;t&&"bri"in e||this.hass?.callService("light",t?"turn_on":"turn_off",{entity_id:s})}this.draft&&this.saveSchedule(t),this.ctlDraft={}}discardAll(){Object.keys(this.ctlDraft).length&&(this.ctlDraft={}),null!==this.draft&&(this.draft=null)}render(){if(!this.hass||!this.config)return K;const t=this.seSlot(),e=this.get(`light.sf_${t}_light`);if(!e)return V`<ha-card>
      ...
      <ha-card>
        ...
        <div class="gauge">
          <svg viewBox="0 0 200 190" aria-hidden="true">
            ...
            ${c&&p>0?U`<path d=${$t(100,100,78,0,p)} fill="none"
                  stroke-linecap="round" stroke=${h} stroke-width="15"></path>`:K}
            ${c?U`<circle cx=${u.toFixed(2)} cy=${g.toFixed(2)} r="10"
                  fill="#fff" stroke=${h} stroke-width="3"></circle>`:K}
        ...
        ${"Automatic"===a?this.renderSchedule(t):K}
        ${Wt(h,this.isDirty(),()=>this.applyAll(t),()=>this.discardAll(),"apply-bar")}
      ...
      ${i?this.numRow(`number.sf_${t}_schedule_brightness`,"Brightness",i):K}
      ${o?this.numRow(`number.sf_${t}_sunrise_sunset_fade`,"Sunrise / sunset fade",o):K}`:K}timeField(t,e){const s=this.get(t);if(!s)return K;const i="unknown"===s.state||"unavailable"===s.state?"":s.state,o=this.cur(t,i);return V`<div class="tf">
      <span class="tf-lbl">${e}</span>
      <input type="time" .value=${o}
        @change=${e=>this.stageCtl(t,e.target.value)} />
    </div>`}numRow(t,e,s){const i=s.attributes.min??0,o=s.attributes.max??100,a=s.attributes.step??1,n=s.attributes.unit_of_measurement??"",r="unknown"===s.state||"unavailable"===s.state?"":s.state,l=this.cur(t,r);return V`<div class="num-row">
      ...
      <div id="w">
        ...
        ${"view"===this.tab?V`
          <div class="stats">
            ...
            <div class="stat"><div class="sl">DLI @ ${t.photo}h</div><div class="sv">${o}<span class="su">mol/m²/d</span></div></div>
          </div>
          <div class="leg"><span>Low</span><div class="legbar"></div><span>High PPFD</span></div>
          <div class="zone">
            <span class="zbadge" style="background:${a.color}22;color:${a.color};border:1px solid ${a.color}44">${a.label}</span>
            ${this.fmtSmall(s)} light-to-canopy · ${t.dim}% brightness
          </div>
          <div class="div"></div>
          <div class="sec">Light &amp; plants</div>
          <div class="ctrls">
            <div class="r3">
              <div class="cg"><span class="cl">Light height <span class="cv">${this.fmtSmall(t.hin)}</span></span><input type="range" min="8" max=${r} step="1" .value=${String(t.hin)} @input=${t=>this.onSlider("hin",t)}></div>
              <div class="cg"><span class="cl">Plant height <span class="cv">${this.fmtSmall(t.plantIn)}</span></span><input type="range" min="1" max=${r} step="1" .value=${String(t.plantIn)} @input=${t=>this.onSlider("plantIn",t)}></div>
            ...
            <div class="r2">
              <div class="cg"><span class="cl">Photoperiod <span class="cv">${t.photo}h</span></span><input type="range" min="12" max="24" step="1" .value=${String(t.photo)} @input=${t=>this.onSlider("photo",t)}></div>
            </div>
          </div>
        `:V`
          ...
          <div class="set">
            ...
            <div class="cg"><span class="cl">Light source</span>
              <select .value=${this.brightSrc} @change=${this.onBrightSrc}>
                ...
                ${d.map(t=>V`<option value=${t.id} ?selected=${this.brightSrc===t.id}>${t.name}</option>`)}
              </select>
            </div>
            <div class="hint">
              ${this.auto&&this.brightSrc?V`Reading ${this.hass?.states[this.brightSrc]?.attributes.friendly_name||this.brightSrc}: ${t.dim}%`:"Pick a Spider Farmer light (live brightness) or a Schedule Brightness (target) and the value tracks it live."}
            </div>
          </div>
          <div class="div"></div>
          <div class="sec">Plants</div>
          <div class="ctrls">
            <div class="r3">
          ...
          <div class="ctrls">
            <div class="r3">
              <div class="cg"><span class="cl">Width (${l})</span><input type="number" min=${this.s.metric?"0.3":"1"} max=${this.s.metric?"3.0":"10"} step="0.1" .value=${this.fmtTentDim(t.tW/.3048)} @change=${t=>this.onTent("tW",t)}></div>
              <div class="cg"><span class="cl">Length (${l})</span><input type="number" min=${this.s.metric?"0.3":"1"} max=${this.s.metric?"3.6":"12"} step="0.1" .value=${this.fmtTentDim(t.tL/.3048)} @change=${t=>this.onTent("tL",t)}></div>
              <div class="cg"><span class="cl">Height (${l})</span><input type="number" min=${this.s.metric?"0.9":"3"} max=${this.s.metric?"3.6":"12"} step="0.1" .value=${this.fmtTentDim(t.tH/.3048)} @change=${t=>this.onTent("tH",t)}></div>
            </div>
          </div>
          ${Wt("var(--primary-color, #03a9f4)",this.settingsDirty(),()=>this.applySettings(),()=>this.discardSettings(),"ppfd-apply")}
        `}
      </div>
    `}}ee.SET_FIELDS=["auto","src","numPlants","tW","tL","tH"],ee.styles=n`
    :host { display: block; }
  ...
  `,t([ut({attribute:!1})],ee.prototype,"hass",void 0),t([gt()],ee.prototype,"config",void 0),t([gt()],ee.prototype,"tab",void 0),t([gt()],ee.prototype,"rev",void 0),customElements.get("spider-farmer-card")||customElements.define("spider-farmer-card",Kt),customElements.get("spider-farmer-card-editor")||customElements.define("spider-farmer-card-editor",qt),customElements.get("spider-light-card")||customElements.define("spider-light-card",Xt),customElements.get("ppfd-3d-card")||customElements.define("ppfd-3d-card",ee);const se=window.customCards=window.customCards||[],ie=t=>{se.some(e=>e&&e.type===t.type)||se.push(t)};ie({type:"spider-farmer-card",name:"Spider Farmer Card",description:"Tent overview + config for the Spider Farmer Bridge integration",preview:!0,documentationURL:"https://github.com/cobragt2000/spider_farmer_bridge"}),ie({type:"spider-light-card",name:"Spider Light Card",description:"Brightness dial, mode, and schedule for a Spider Farmer SE-series light",preview:!0,documentationURL:"https://github.com/cobragt2000/spider_farmer_bridge"}),ie({type:"ppfd-3d-card",name:"PPFD 3D Grow Light Card",description:"3D PPFD visualizer for Spider Farmer SE4500, SE5000, SF2000, SF7000 & G1000W",preview:!0,documentationURL:"https://github.com/cobragt2000/spider_farmer_bridge"}),console.info("%c SPIDER-FARMER-CARD %c v0.20.68 ","color:#fff;background:#ff7a1a;border-radius:3px 0 0 3px;padding:2px 4px","color:#ff7a1a;background:#222;border-radius:0 3px 3px 0;padding:2px 4px"),(()=>{const t=["spider-farmer-card","spider-light-card","ppfd-3d-card"],e=new Set([...t,...t.map(t=>`custom:${t}`)]),s=()=>{const t=[["spider-farmer-card",Kt],["spider-farmer-card-editor",qt],["spider-light-card",Xt],["ppfd-3d-card",ee]];for(const[e,s]of t)if(!customElements.get(e))try{customElements.define(e,s)}catch{}},i=()=>{let t=0;for(const s of(()=>{const t=[],e=new Set,s=i=>{if(!i||e.has(i))return;e.add(i);let o=[];try{o=i.querySelectorAll("hui-error-card")}catch{return}o.forEach(e=>t.push(e));let a=[];try{a=i.querySelectorAll("*")}catch{return}a.forEach(t=>{const e=t.shadowRoot;e&&s(e)})};return s(document),t})()){const i=s._config||{},o=i.origConfig&&i.origConfig.type||i.type||"";e.has(o)&&(s.dispatchEvent(new CustomEvent("ll-rebuild",{bubbles:!0,composed:!0})),t++)}return t};let o=0;const a=()=>{s(),i(),++o<12&&setTimeout(a,250)},n=()=>{s(),a()};"complete"===document.readyState?n():window.addEventListener("load",n,{once:!0})})();export{Kt as SpiderFarmerCard,qt as SpiderFarmerCardEditor,Xt as SpiderLightCard,ee as SpiderPpfdCard};
