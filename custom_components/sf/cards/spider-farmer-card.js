/*! spider-farmer-card v0.17.29 | MIT */
 ...
 */
const e=globalThis,s=e.ShadowRoot&&(void 0===e.ShadyCSS||e.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,i=Symbol(),o=new WeakMap;let r=class{constructor(t,e,s){if(this._$cssResult$=!0,s!==i)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=e}get styleSheet(){let t=this.o;const e=this.t;if(s&&void 0===t){const s=void 0!==e&&1===e.length;s&&(t=o.get(e)),void 0===t&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),s&&o.set(e,t))}return t}toString(){return this.cssText}};const n=(t,...e)=>{const s=1===t.length?t[0]:e.reduce((e,s,i)=>e+(t=>{if(!0===t._$cssResult$)return t.cssText;if("number"==typeof t)return t;throw Error("Value passed to 'css' function must be a 'css' function result: "+t+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(s)+t[i+1],t[0]);return new r(s,t,i)},a=s?t=>t:t=>t instanceof CSSStyleSheet?(t=>{let e="";for(const s of t.cssRules)e+=s.cssText;return(t=>new r("string"==typeof t?t:t+"",void 0,i))(e)})(t):t,{is:l,defineProperty:d,getOwnPropertyDescriptor:c,getOwnPropertyNames:h,getOwnPropertySymbols:p,getPrototypeOf:u}=Object,f=globalThis,g=f.trustedTypes,m=g?g.emptyScript:"",v=f.reactiveElementPolyfillSupport,b=(t,e)=>t,_={toAttribute(t,e){switch(e){case Boolean:t=t?m:null;break;case Object:case Array:t=null==t?t:JSON.stringify(t)}return t},fromAttribute(t,e){let s=t;switch(e){case Boolean:s=null!==t;break;case Number:s=null===t?null:Number(t);break;case Object:case Array:try{s=JSON.parse(t)}catch(t){s=null}}return s}},$=(t,e)=>!l(t,e),x={attribute:!0,type:String,converter:_,reflect:!1,useDefault:!1,hasChanged:$};
/**
 * @license
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const w=globalThis,S=t=>t,k=w.trustedTypes,O=k?k.createPolicy("lit-html",{createHTML:t=>t}):void 0,A="$lit$",C=`lit$${Math.random().toFixed(9).slice(2)}$`,R="?"+C,D=`<${R}>`,E=document,M=()=>E.createComment(""),N=t=>null===t||"object"!=typeof t&&"function"!=typeof t,T=Array.isArray,P="[ \t\n\f\r]",z=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,I=/-->/g,L=/>/g,B=RegExp(`>|${P}(?:([^\\s"'>=/]+)(${P}*=${P}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),H=/'/g,F=/"/g,j=/^(?:script|style|textarea|title)$/i,U=t=>(e,...s)=>({_$litType$:t,strings:e,values:s}),W=U(1),V=U(2),G=Symbol.for("lit-noChange"),q=Symbol.for("lit-nothing"),J=new WeakMap,K=E.createTreeWalker(E,129);function Z(t,e){if(!T(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==O?O.createHTML(e):e}const X=(t,e)=>{const s=t.length-1,i=[];let o,r=2===e?"<svg>":3===e?"<math>":"",n=z;for(let e=0;e<s;e++){const s=t[e];let a,l,d=-1,c=0;for(;c<s.length&&(n.lastIndex=c,l=n.exec(s),null!==l);)c=n.lastIndex,n===z?"!--"===l[1]?n=I:void 0!==l[1]?n=L:void 0!==l[2]?(j.test(l[2])&&(o=RegExp("</"+l[2],"g")),n=B):void 0!==l[3]&&(n=B):n===B?">"===l[0]?(n=o??z,d=-1):void 0===l[1]?d=-2:(d=n.lastIndex-l[2].length,a=l[1],n=void 0===l[3]?B:'"'===l[3]?F:H):n===F||n===H?n=B:n===I||n===L?n=z:(n=B,o=void 0);const h=n===B&&t[e+1].startsWith("/>")?" ":"";r+=n===z?s+D:d>=0?(i.push(a),s.slice(0,d)+A+s.slice(d)+C+h):s+C+(-2===d?e:h)}return[Z(t,r+(t[s]||"<?>")+(2===e?"</svg>":3===e?"</math>":"")),i]};class Y{constructor({strings:t,_$litType$:e},s){let i;this.parts=[];let o=0,r=0;const n=t.length-1,a=this.parts,[l,d]=X(t,e);if(this.el=Y.createElement(l,s),K.currentNode=this.el.content,2===e||3===e){const t=this.el.content.firstChild;t.replaceWith(...t.childNodes)}for(;null!==(i=K.nextNode())&&a.length<n;){if(1===i.nodeType){if(i.hasAttributes())for(const t of i.getAttributeNames())if(t.endsWith(A)){const e=d[r++],s=i.getAttribute(t).split(C),n=/([.?@])?(.*)/.exec(e);a.push({type:1,index:o,name:n[2],strings:s,ctor:"."===n[1]?it:"?"===n[1]?ot:"@"===n[1]?rt:st}),i.removeAttribute(t)}else t.startsWith(C)&&(a.push({type:6,index:o}),i.removeAttribute(t));if(j.test(i.tagName)){const t=i.textContent.split(C),e=t.length-1;if(e>0){i.textContent=k?k.emptyScript:"";for(let s=0;s<e;s++)i.append(t[s],M()),K.nextNode(),a.push({type:2,index:++o});i.append(t[e],M())}}}else if(8===i.nodeType)if(i.data===R)a.push({type:2,index:o});else{let t=-1;for(;-1!==(t=i.data.indexOf(C,t+1));)a.push({type:7,index:o}),t+=C.length-1}o++}}static createElement(t,e){const s=E.createElement("template");return s.innerHTML=t,s}}function Q(t,e,s=t,i){if(e===G)return e;let o=void 0!==i?s._$Co?.[i]:s._$Cl;const r=N(e)?void 0:e._$litDirective$;return o?.constructor!==r&&(o?._$AO?.(!1),void 0===r?o=void 0:(o=new r(t),o._$AT(t,s,i)),void 0!==i?(s._$Co??=[])[i]=o:s._$Cl=o),void 0!==o&&(e=Q(t,o._$AS(t,e.values),o,i)),e}class tt{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:e},parts:s}=this._$AD,i=(t?.creationScope??E).importNode(e,!0);K.currentNode=i;let o=K.nextNode(),r=0,n=0,a=s[0];for(;void 0!==a;){if(r===a.index){let e;2===a.type?e=new et(o,o.nextSibling,this,t):1===a.type?e=new a.ctor(o,a.name,a.strings,this,t):6===a.type&&(e=new nt(o,this,t)),this._$AV.push(e),a=s[++n]}r!==a?.index&&(o=K.nextNode(),r++)}return K.currentNode=E,i}p(t){let e=0;for(const s of this._$AV)void 0!==s&&(void 0!==s.strings?(s._$AI(t,s,e),e+=s.strings.length-2):s._$AI(t[e])),e++}}class et{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,e,s,i){this.type=2,this._$AH=q,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=s,this.options=i,this._$Cv=i?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode;const e=this._$AM;return void 0!==e&&11===t?.nodeType&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=Q(this,t,e),N(t)?t===q||null==t||""===t?(this._$AH!==q&&this._$AR(),this._$AH=q):t!==this._$AH&&t!==G&&this._(t):void 0!==t._$litType$?this.$(t):void 0!==t.nodeType?this.T(t):(t=>T(t)||"function"==typeof t?.[Symbol.iterator])(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==q&&N(this._$AH)?this._$AA.nextSibling.data=t:this.T(E.createTextNode(t)),this._$AH=t}$(t){const{values:e,_$litType$:s}=t,i="number"==typeof s?this._$AC(t):(void 0===s.el&&(s.el=Y.createElement(Z(s.h,s.h[0]),this.options)),s);if(this._$AH?._$AD===i)this._$AH.p(e);else{const t=new tt(i,this),s=t.u(this.options);t.p(e),this.T(s),this._$AH=t}}_$AC(t){let e=J.get(t.strings);return void 0===e&&J.set(t.strings,e=new Y(t)),e}k(t){T(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let s,i=0;for(const o of t)i===e.length?e.push(s=new et(this.O(M()),this.O(M()),this,this.options)):s=e[i],s._$AI(o),i++;i<e.length&&(this._$AR(s&&s._$AB.nextSibling,i),e.length=i)}_$AR(t=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);t!==this._$AB;){const e=S(t).nextSibling;S(t).remove(),t=e}}setConnected(t){void 0===this._$AM&&(this._$Cv=t,this._$AP?.(t))}}class st{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,s,i,o){this.type=1,this._$AH=q,this._$AN=void 0,this.element=t,this.name=e,this._$AM=i,this.options=o,s.length>2||""!==s[0]||""!==s[1]?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=q}_$AI(t,e=this,s,i){const o=this.strings;let r=!1;if(void 0===o)t=Q(this,t,e,0),r=!N(t)||t!==this._$AH&&t!==G,r&&(this._$AH=t);else{const i=t;let n,a;for(t=o[0],n=0;n<o.length-1;n++)a=Q(this,i[s+n],e,n),a===G&&(a=this._$AH[n]),r||=!N(a)||a!==this._$AH[n],a===q?t=q:t!==q&&(t+=(a??"")+o[n+1]),this._$AH[n]=a}r&&!i&&this.j(t)}j(t){t===q?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class it extends st{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===q?void 0:t}}class ot extends st{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==q)}}class rt extends st{constructor(t,e,s,i,o){super(t,e,s,i,o),this.type=5}_$AI(t,e=this){if((t=Q(this,t,e,0)??q)===G)return;const s=this._$AH,i=t===q&&s!==q||t.capture!==s.capture||t.once!==s.once||t.passive!==s.passive,o=t!==q&&(s===q||i);i&&this.element.removeEventListener(this.name,this,s),o&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){"function"==typeof this._$AH?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}}class nt{constructor(t,e,s){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(t){Q(this,t)}}const at=w.litHtmlPolyfillSupport;at?.(Y,et),(w.litHtmlVersions??=[]).push("3.3.3");const lt=globalThis;
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function ft(t){return ut({...t,state:!0,attribute:!1})}const gt="#ff7a1a",mt=["S","M","T","W","T","F","S"],vt=/^sf_(dp\d+|ac5|ac10)_/;function bt(t){return t.split(".")[1]??""}function _t(t,e,s,i){const o=i*Math.PI/180;return[t+s*Math.cos(o),e+s*Math.sin(o)]}function $t(t,e,s,i,o){const r=135+270*i,n=135+270*o,[a,l]=_t(t,e,s,r),[d,c]=_t(t,e,s,n),h=n-r>180?1:0;return`M ${a.toFixed(2)} ${l.toFixed(2)} A ${s} ${s} 0 ${h} 1 ${d.toFixed(2)} ${c.toFixed(2)}`}function xt(t){const e=t.currentTarget,s=e.parentElement?.querySelector(".sl-bub");if(!s)return;const i=Number(e.min||"0"),o=Number(e.max||"100"),r=Number(e.value),n=o>i?(r-i)/(o-i):0,a=function(t){const e=String(t),s=e.indexOf(".");return s>=0?e.length-s-1:0}(Number(e.step||"1")),l=Number.isFinite(r)?r.toFixed(a):e.value;s.textContent="1"===e.dataset.off&&r<=i?"off":`${l}${e.dataset.unit??""}`,s.style.left=`calc(${n} * (100% - 18px) + 9px)`}const yt=n`
  .sl-live {
...
`;function wt(t){const e=new Set;for(const s of Object.keys(t.states)){const t=bt(s).match(vt);t&&e.add(t[1])}return[...e].sort()}function St(t){return wt(t).filter(e=>Object.keys(t.states).some(t=>{const s=bt(t);return s===`sf_${e}_temperature`||s===`sf_${e}_soil_avg_temperature`||s===`sf_${e}_light_1`||s===`sf_${e}_fan`||s===`sf_${e}_blower`}))}function kt(t,e){const s=`sf_${e}_`,i=Object.keys(t.states);return i.find(t=>bt(t)===`sf_${e}_temperature`)??i.find(t=>{const i=bt(t);return i.startsWith(s)&&!i.startsWith(`sf_${e}_env_`)})}function Ot(t,e){const s=kt(t,e);return s?t.entities?.[s]?.device_id:void 0}function At(t,e){if(!e)return[];const s=Ot(t,e);return function(t){return wt(t).filter(e=>!!t.states[`switch.sf_${e}_outlet_1`])}(t).filter(i=>{if(i===e)return!0;if(!s)return!1;const o=Ot(t,i),r=o?t.devices?.[o]:void 0;return r?.via_device_id===s})}function Ct(t,e){if(!t||!e)return"";const s=kt(t,e);if(!s)return"";const i=t.entities?.[s]?.device_id,o=i?t.devices?.[i]:void 0;if(o)return o.name_by_user||o.name||"";const r=(t.states[s].attributes.friendly_name||"").match(/^(SF .+? [0-9A-Fa-f]{4})\b/);return r?r[1]:""}const Rt=[["temperature","Air Temp","mdi:thermometer"],["humidity","Air Humi","mdi:water-percent"],["vpd","VPD","mdi:water-opacity"],["co2","CO2","mdi:molecule-co2"],["ppfd","PPFD","mdi:white-balance-sunny"],["soil_avg_temperature","Soil Temp","mdi:thermometer"],["soil_avg_moisture","Moisture","mdi:water"],["soil_avg_ec","Soil EC","mdi:flash"]],Dt={temperature:"temp",humidity:"humi",vpd:"vpd",co2:"co2",ppfd:"ppfd",soil_avg_temperature:"tempSoil",soil_avg_moisture:"humiSoil",soil_avg_ec:"ECSoil"},Et="#ff6b6b",Mt="rgba(255,107,107,0.16)",Nt=t=>"string"==typeof t&&/^#[0-9a-fA-F]{6}$/.test(t),Tt=t=>!!t&&("unavailable"===t.state||"unknown"===t.state),Pt=t=>{const e=(t||"").match(/^(\d{1,2}):(\d{2})$/);if(!e)return null;const s=+e[1],i=+e[2];return s<=23&&i<=59?60*s+i:null},zt=(t,e,s,i,o="")=>W`<div class="save-bar ${o}">
  ...
  <button class="discard-btn" ?disabled=${!e}
    @click=${i}>Discard</button>`)(t,e,s,i)}
</div>`,It=[["light_1","Light 1","mdi:lightbulb"],["light_2","Light 2","mdi:lightbulb"]],Lt=[["fan","Fan","mdi:fan"],["blower","Blower","mdi:weather-windy"]],Bt=[["heater","Heater","mdi:radiator"],["humidifier","Humidifier","mdi:air-humidifier"],["dehumidifier","Dehumidifier","mdi:air-humidifier-off"]],Ht=[["Temperature","env_temp_day","env_temp_night","env_temp_deadband","mdi:thermometer"],["Humidity","env_humi_day","env_humi_night","env_humi_deadband","mdi:water-percent"],["CO2","env_co2_day","env_co2_night","env_co2_deadband","mdi:molecule-co2"]];class Ft extends dt{constructor(){super(...arguments),this.tab="overview",this.colorMode="off",this.colHi=Et,this.colLo="#45b6ff",this.colorModeIn="off",this.colIn="#4caf7d",this.hideLight2=!1,this._colorSynced=!1,this.colorDraft=null,this.alertsDraft=null,this.soilOpen=null,this.soilAllOpen=!1,this.deviceOpen=null,this.outletOpen=null,this.draft={},this.modePick={},this.outletDraft={},this.logDate=null,this.logDev="all",this.logType="all"}setConfig(t){if(!t.panel)throw new Error('spider-farmer-card: "panel" is required (e.g. panel: dp1)');this.config=t;const e=t.default_tab;this.tab="environment"===e||"config"===e?"env":"outlets"===e?"outlets":"calibration"===e||"cali"===e?"cali":"alerts"===e?"alerts":"log"===e?"log":"overview";const s=t.alarm_colors;let i="tile"===s||"text"===s?s:"off";try{const e=localStorage.getItem(`sf-colors-${t.panel}`);if("off"===e||"tile"===e||"text"===e)i=e;else if(e){const t=JSON.parse(e);"off"!==t.mode&&"tile"!==t.mode&&"text"!==t.mode||(i=t.mode),"off"!==t.modeIn&&"tile"!==t.modeIn&&"text"!==t.modeIn||(this.colorModeIn=t.modeIn),Nt(t.hi)&&(this.colHi=t.hi),Nt(t.lo)&&(this.colLo=t.lo),Nt(t.in)&&(this.colIn=t.in),"boolean"==typeof t.hide2&&(this.hideLight2=t.hide2)}}catch{}this.colorMode=i,this._colorSynced=!1}serverColors(){const t=this.get(`sensor.sf_${this.config.panel}_alarm_settings`)?.attributes.card_options;if(!t)return{};const e=t=>"off"===t||"tile"===t||"text"===t,s={};return t.colors&&e(t.colors)&&(s.mode=t.colors),t.colors_in&&e(t.colors_in)&&(s.modeIn=t.colors_in),Nt(t.color_hi)&&(s.hi=t.color_hi),Nt(t.color_lo)&&(s.lo=t.color_lo),Nt(t.color_in)&&(s.in=t.color_in),"1"!==t.hide_light2&&"0"!==t.hide_light2||(s.hide2="1"===t.hide_light2),s}persistColorOption(t,e){const s=`sensor.sf_${this.config.panel}_alarm_settings`;this.get(s)&&this.hass?.callService("sf","set_card_option",{entity_id:s,key:t,value:e})}cacheColors(){try{localStorage.setItem(`sf-colors-${this.config.panel}`,JSON.stringify({mode:this.colorMode,modeIn:this.colorModeIn,hi:this.colHi,lo:this.colLo,in:this.colIn,hide2:this.hideLight2}))}catch{}}outOfRange(t,e){const s=this.alertsSettings();if(!s||!Number.isFinite(e))return null;const i=[...s.climate||[],...s.substrate||[]].find(e=>e&&e.key===t);if(!i||!i.enabled)return null;const o=Number(i.max),r=Number(i.min);return Number.isFinite(o)&&e>o?"above":Number.isFinite(r)&&e<r?"below":null}readingColor(t,e){const s=parseFloat(e);if(!Number.isFinite(s))return null;const i=t?this.outOfRange(t,s):null;return"above"===i?"off"===this.colorMode?null:{mode:this.colorMode,color:this.colHi,state:"above"}:"below"===i?"off"===this.colorMode?null:{mode:this.colorMode,color:this.colLo,state:"below"}:"off"===this.colorModeIn?null:{mode:this.colorModeIn,color:this.colIn,state:"in"}}soilCellStyle(t,e){const s=this.get(`sensor.sf_${this.config.panel}_${t}_${e}`);if(!s||Tt(s))return"";const i="temperature"===e?"tempSoil":"moisture"===e?"humiSoil":"ECSoil",o=this.readingColor(i,s.state);return o?`color:${o.color}`:""}getCardSize(){return 8}static getConfigElement(){return document.createElement("spider-farmer-card-editor")}static getStubConfig(t){const e=(t?St(t):[])[0]||"dp1",s=t?At(t,e):[];return{type:"custom:spider-farmer-card",panel:e,...s.length?{outlets:s}:{}}}eid(t,e){return`${t}.sf_${this.config.panel}_${e}`}get(t){return this.hass?.states[t]}accent(){return this.config.accent||gt}shouldUpdate(t){return t.has("config")||t.has("hass")||t.has("tab")||t.has("soilOpen")||t.has("soilAllOpen")||t.has("outletDraft")||t.has("alertsDraft")||t.has("deviceOpen")||t.has("outletOpen")||t.has("draft")||t.has("modePick")||t.has("logDate")||t.has("logDev")||t.has("logType")||t.has("colorMode")||t.has("colorModeIn")||t.has("colHi")||t.has("colLo")||t.has("colIn")||t.has("hideLight2")||t.has("colorDraft")}willUpdate(t){if(!this._colorSynced){const t=this.serverColors();Object.keys(t).length&&(t.mode&&(this.colorMode=t.mode),t.modeIn&&(this.colorModeIn=t.modeIn),t.hi&&(this.colHi=t.hi),t.lo&&(this.colLo=t.lo),t.in&&(this.colIn=t.in),void 0!==t.hide2&&(this.hideLight2=t.hide2),this._colorSynced=!0,this.cacheColors())}if(t.has("hass")&&Object.keys(this.modePick).length){let t=null;for(const[e,s]of Object.entries(this.modePick))this.get(e)?.state===s&&(t=t??{...this.modePick},delete t[e]);t&&(this.modePick=t)}}renderParam([t,e,s]){const i=this.get(`sensor.sf_${this.config.panel}_${t}`);if(!i)return q;const o=i.attributes.unit_of_measurement||"",r=t.startsWith("soil_avg_")&&Tt(i),n=r?"Offline":this.hass?.formatEntityState?this.hass.formatEntityState(i).replace(o,"").trim():i.state,a=t.startsWith("soil_avg_")?t.slice(9):null,l=!!a&&this.soilProbeRows(a).length>1,d=l&&this.soilOpen===a,c=r?null:this.readingColor(Dt[t],i.state);let h=d?`box-shadow:inset 0 0 0 1px ${this.accent()}`:"",p="";return r?(h=`background:${Mt};box-shadow:inset 0 0 0 1px ${Et}`,p=`color:${Et}`):c&&"text"===c.mode?p=`color:${c.color}`:c&&"tile"===c.mode&&(h=`background:${((t,e=.16)=>{const s=/^#?([0-9a-fA-F]{6})$/.exec((t||"").trim());if(!s)return`rgba(255,107,107,${e})`;const i=parseInt(s[1],16);return`rgba(${i>>16&255},${i>>8&255},${255&i},${e})`})(c.color)};box-shadow:inset 0 0 0 1px ${c.color}`),W`
      <div class="tile ${l?"clickable":""} ${d?"active":""}"
        style=${h||q}
        role=${l?"button":q}
        @click=${l?()=>this.soilOpen=d?null:a:void 0}>
        <div class="tile-label">
          ${e}${l?W`<ha-icon class="tile-more"
                icon=${d?"mdi:chevron-up":"mdi:chevron-down"}></ha-icon>`:q}
        </div>
        <ha-icon icon="${s}" style="color:${this.accent()}"></ha-icon>
        <div class="tile-val" style=${p||q}>${n}${r?q:W`<span class="unit">${o}</span>`}</div>
      ...
      </div>`}overviewDevices(){const t=[],e=(e,s)=>{for(const[i,o,r]of s){const s=this.eid(e,i);this.get(s)&&t.push({domain:e,suffix:i,id:s,label:o,icon:r})}};return e("light",It),e("fan",Lt),e("switch",Bt),this.hideLight2?t.filter(t=>"light_2"!==t.suffix):t}deviceStateText(t,e){if("unavailable"===e.state||"unknown"===e.state)return"Offline";if("light"===t)return"on"!==e.state?"Off":`${Math.round((e.attributes.brightness??0)/255*100)}%`;if("fan"===t){if("on"!==e.state)return"Off";const t=Math.round(e.attributes.percentage??0);return t?`${t}%`:"On"}return"on"===e.state?"On":"Off"}deviceFault(t){const e=this.config.panel,s=t=>this.get(`sensor.sf_${e}_${t}`)?.state;return"humidifier"===t&&"Empty"===s("humidifier_tank")?"EMPTY":"dehumidifier"===t&&"Full"===s("dehumidifier_tank")?"FULL":"heater"===t&&"Alarm"===s("heater_status")?"Alarm":null}deviceTile(t){const e=this.get(t.id);if(!e)return q;const s="on"===e.state,i=`${t.domain}:${t.suffix}`,o=this.deviceOpen===i,r=this.accent(),n=this.deviceFault(t.suffix),a=n?Et:s?r:"var(--secondary-text-color)";return W`
      <div class="tile clickable ${o?"active":""}"
        style=${(n?`background:${Mt};box-shadow:inset 0 0 0 1px ${Et}`:o?`box-shadow:inset 0 0 0 1px ${r}`:"")||q}
      ...
      </div>`}renderHeaterBody(t,e){const s=this.config.panel,i="on"===e.state,o=`select.sf_${s}_heater_mode_set`,r=this.get(o),n=this.modeOf(o),a=`number.sf_${s}_heater_level`,l=`text.sf_${s}_heater_apply`,d=this.numOpts(1,10,1,t=>`L${t}`),c=[];if(r&&c.push(this.liveModeRow("Mode",o)),c.push(this.powerRow(t.id,"switch",t.label,i)),"Manual"===n)c.push(this.optSelectRow("Gear",a,d)),c.push(this.deviceBar(l,{[o]:"mode"},t));else if("Time Slot"===n){const e=`text.sf_${s}_heater_schedule_start`,i=`text.sf_${s}_heater_schedule_stop`,r={[o]:"mode",[e]:"schedule_start",[i]:"schedule_end",[a]:"gear"};c.push(this.stagedPeriodRow(e,i,"Schedule")),c.push(this.optSelectRow("Gear",a,d)),c.push(this.deviceBar(l,r,t))}else if("Cycle"===n){const e=`text.sf_${s}_heater_cycle_start`,i=`text.sf_${s}_heater_cycle_run`,r=`text.sf_${s}_heater_cycle_off`,n=`number.sf_${s}_heater_cycle_times`,h={[o]:"mode",[e]:"cycle_start",[i]:"cycle_run",[r]:"cycle_off",[n]:"cycle_times",[a]:"gear"};c.push(this.stagedRow("Start Time",e,"time")),c.push(this.stagedRow("Run Time",i,"duration")),c.push(this.stagedRow("Closing Time",r,"duration")),c.push(this.stagedRangeRow("Execution Times",n)),c.push(this.optSelectRow("Gear",a,d)),c.push(this.deviceBar(l,h,t))}else if("Temperature"===n){const e={[o]:"mode",[a]:"gear"};c.push(this.optSelectRow("Gear",a,d)),c.push(this.infoRow("Runs on the tent's day/night temperature targets","")),c.push(this.deviceBar(l,e,t))}return c}renderDehumidifierBody(t,e){const s=this.config.panel,i="on"===e.state,o=`select.sf_${s}_dehumidifier_mode_set`,r=this.get(o),n=this.modeOf(o),a=`select.sf_${s}_dehumidifier_level`,l=`text.sf_${s}_dehumidifier_apply`,d=[];if(r&&d.push(this.liveModeRow("Mode",o)),d.push(this.powerRow(t.id,"switch",t.label,i)),"Manual"===n)d.push(this.ctlRow("Wind Speed",a)),d.push(this.deviceBar(l,{[o]:"mode"},t));else if("Time Slot"===n){const e=`text.sf_${s}_dehumidifier_schedule_start`,i=`text.sf_${s}_dehumidifier_schedule_stop`,r={[o]:"mode",[e]:"schedule_start",[i]:"schedule_end",[a]:"wind"};d.push(this.stagedPeriodRow(e,i,"Schedule")),d.push(this.stagedRow("Wind Speed",a)),d.push(this.deviceBar(l,r,t))}else if("Cycle"===n){const e=`text.sf_${s}_dehumidifier_cycle_start`,i=`text.sf_${s}_dehumidifier_cycle_run`,r=`text.sf_${s}_dehumidifier_cycle_off`,n=`number.sf_${s}_dehumidifier_cycle_times`,c={[o]:"mode",[e]:"cycle_start",[i]:"cycle_run",[r]:"cycle_off",[n]:"cycle_times",[a]:"wind"};d.push(this.stagedRow("Start Time",e,"time")),d.push(this.stagedRow("Run Time",i,"duration")),d.push(this.stagedRow("Closing Time",r,"duration")),d.push(this.stagedRangeRow("Execution Times",n)),d.push(this.stagedRow("Wind Speed",a)),d.push(this.deviceBar(l,c,t))}else if("Humidity"===n){const e={[o]:"mode",[a]:"wind"};d.push(this.stagedRow("Wind Speed",a)),d.push(this.infoRow("Runs on the tent's day/night humidity targets","")),d.push(this.deviceBar(l,e,t))}return d}renderHumidifierBody(t,e){const s=this.config.panel,i="on"===e.state,o=`select.sf_${s}_humidifier_mode_set`,r=this.get(o),n=this.modeOf(o),a=`number.sf_${s}_humidifier_level`,l=`text.sf_${s}_humidifier_apply`,d=this.numOpts(1,4,1,t=>`L${t}`),c=[];if(r&&c.push(this.liveModeRow("Mode",o)),c.push(this.powerRow(t.id,"switch",t.label,i)),"Manual"===n)c.push(this.optSelectRow("Gear",a,d)),c.push(this.deviceBar(l,{[o]:"mode"},t));else if("Time Slot"===n){const e=`text.sf_${s}_humidifier_schedule_start`,i=`text.sf_${s}_humidifier_schedule_stop`,r={[o]:"mode",[e]:"schedule_start",[i]:"schedule_end",[a]:"gear"};c.push(this.stagedPeriodRow(e,i,"Schedule")),c.push(this.optSelectRow("Gear",a,d)),c.push(this.deviceBar(l,r,t))}else if("Cycle"===n){const e=`text.sf_${s}_humidifier_cycle_start`,i=`text.sf_${s}_humidifier_cycle_run`,r=`text.sf_${s}_humidifier_cycle_off`,n=`number.sf_${s}_humidifier_cycle_times`,h={[o]:"mode",[e]:"cycle_start",[i]:"cycle_run",[r]:"cycle_off",[n]:"cycle_times",[a]:"gear"};c.push(this.stagedRow("Start Time",e,"time")),c.push(this.stagedRow("Run Time",i,"duration")),c.push(this.stagedRow("Closing Time",r,"duration")),c.push(this.stagedRangeRow("Execution Times",n)),c.push(this.optSelectRow("Gear",a,d)),c.push(this.deviceBar(l,h,t))}else if("Humidity"===n){const e={[o]:"mode",[a]:"gear"};c.push(this.optSelectRow("Gear",a,d)),c.push(this.infoRow("Runs on the tent's day/night humidity targets","")),c.push(this.deviceBar(l,e,t))}return c}textState(t){const e=this.get(t);return e&&"unknown"!==e.state&&"unavailable"!==e.state?e.state:""}durMinutes(t,e){const s=t=>{const e=/^(\d{1,2}):(\d{2})/.exec(t);return e?60*Number(e[1])+Number(e[2]):null},i=s(this.textState(t)),o=s(this.textState(e));if(null==i||null==o)return null;let r=(o-i+1440)%1440;return 0===r&&(r=1440),r}durationText(t,e){const s=this.durMinutes(t,e);return null==s?null:`${Math.floor(s/60)}h ${String(s%60).padStart(2,"0")}min`}infoRow(t,e){return W`<div class="dev-row">
    ...
    </div>`}renderLightBody(t,e){const s=this.config.panel,i=t.suffix,o="on"===e.state,r=`select.sf_${s}_${i}_mode`,n=this.get(r),a=this.modeOf(r),l=this.get(`sensor.sf_${s}_${i}_brightness`),d=this.get(`sensor.sf_${s}_ppfd`),c=l&&Number.isFinite(Number(l.state))?`${Math.round(Number(l.state))}%`:"—",h=d&&Number.isFinite(Number(d.state))?`${Math.round(Number(d.state))} µmol`:"—",p=`text.sf_${s}_${i}_apply`,u=`number.sf_${s}_${i}_go_dark`,f=`number.sf_${s}_${i}_turn_off`,g=[];if(n&&g.push(this.liveModeRow("Mode",r)),g.push(this.powerRow(t.id,"light",t.label,o)),"Manual"===a){const s=Math.round((e.attributes.brightness??0)/255*100),i={[r]:"mode",[u]:"dim_threshold",[f]:"off_threshold"};g.push(this.brightnessRow(t,o?s:0)),g.push(this.infoRow("Current PPFD",h)),g.push(this.optSelectRow("Go dark",u,this.tempThresholdOpts())),g.push(this.optSelectRow("Turn off",f,this.tempThresholdOpts())),g.push(this.deviceBar(p,i,t))}else if("Time Slot"===a){const e=`text.sf_${s}_${i}_schedule_start`,o=`text.sf_${s}_${i}_schedule_stop`,n=`number.sf_${s}_${i}_schedule_brightness`,a=`number.sf_${s}_${i}_fade`,l={[r]:"mode",[e]:"schedule_start",[o]:"schedule_end",[n]:"schedule_brightness",[a]:"fade_minutes",[u]:"dim_threshold",[f]:"off_threshold"};g.push(this.infoRow("Current",`${c} · ${h}`));const d=this.durationText(e,o);d&&g.push(this.infoRow("Light duration",d)),g.push(this.stagedPeriodRow(e,o,"Lighting period")),g.push(this.optSelectRow("Target Brightness",n,this.numOpts(11,100,1,t=>`${t}%`))),g.push(this.optSelectRow("Simulate Sunrise/Sunset",a,this.offOpts(1,60,1,t=>`${t} min`))),g.push(this.optSelectRow("Go dark",u,this.tempThresholdOpts())),g.push(this.optSelectRow("Turn off",f,this.tempThresholdOpts())),g.push(this.deviceBar(p,l,t))}else if("PPFD"===a){const e=`text.sf_${s}_${i}_ppfd_start`,o=`text.sf_${s}_${i}_ppfd_stop`,n=`number.sf_${s}_${i}_ppfd_target`,a=`number.sf_${s}_${i}_ppfd_fade`,l=`number.sf_${s}_${i}_ppfd_min`,d=`number.sf_${s}_${i}_ppfd_max`,m={[r]:"mode",[e]:"ppfd_start",[o]:"ppfd_end",[n]:"ppfd_target",[a]:"ppfd_fade_minutes",[l]:"ppfd_min",[d]:"ppfd_max",[u]:"dim_threshold",[f]:"off_threshold"};g.push(this.infoRow("Current",`${c} · ${h}`));const v=this.durationText(e,o),b=this.durMinutes(e,o),_=Number(this.get(n)?.state);if(v&&null!=b&&Number.isFinite(_)){const t=_*b*60/1e6;g.push(this.infoRow("DLI · duration",`${t.toFixed(2)} mol/m²/day · ${v}`))}else v&&g.push(this.infoRow("Light duration",v));g.push(this.stagedPeriodRow(e,o,"Lighting period")),g.push(W`<div class="dev-row ${n in this.draft?"staged":""}">
      ...
      </div>`),g.push(this.optSelectRow("Dimming Range Min",l,this.numOpts(11,100,1,t=>`${t}%`))),g.push(this.optSelectRow("Dimming Range Max",d,this.numOpts(11,100,1,t=>`${t}%`))),g.push(this.optSelectRow("Simulate Sunrise/Sunset",a,this.offOpts(1,60,1,t=>`${t} min`))),g.push(this.optSelectRow("Go dark",u,this.tempThresholdOpts())),g.push(this.optSelectRow("Turn off",f,this.tempThresholdOpts())),g.push(this.deviceBar(p,m,t))}return g}renderFanBody(t,e){const s=this.config.panel,i="on"===e.state,o=`select.sf_${s}_fan_mode_set`,r=this.get(o),n=this.modeOf(o),a=`number.sf_${s}_fan_oscillation`,l=`number.sf_${s}_fan_schedule_gear`,d=`number.sf_${s}_fan_standby_speed`,c=`switch.sf_${s}_fan_natural_wind`,h=()=>this.optSelectRow("Gear",l,this.numOpts(1,10,1,t=>`L${t}`)),p=Math.max(1,Math.round(Number(this.draftVal(l))||1)),u=()=>this.optSelectRow("Standby Speed",d,this.offOpts(1,p-1)),f=()=>this.optSelectRow("Oscillation",a,this.offOpts(1,10)),g=`text.sf_${s}_fan_apply`,m=[];if(r&&m.push(this.liveModeRow("Mode",o)),m.push(this.powerRow(t.id,"fan",t.label,i)),"Manual"===n){const s=Math.round(e.attributes.percentage??0);m.push(this.speedRow(t,i?s:0)),m.push(f()),m.push(this.ctlRow("Natural Wind",c)),m.push(this.deviceBar(g,{[o]:"mode"},t))}else if("Time Slot"===n){const e={[o]:"mode",[`text.sf_${s}_fan_schedule_start`]:"schedule_start",[`text.sf_${s}_fan_schedule_stop`]:"schedule_end",[l]:"schedule_speed",[d]:"standby_speed"};m.push(this.stagedPeriodRow(`text.sf_${s}_fan_schedule_start`,`text.sf_${s}_fan_schedule_stop`,"Schedule")),m.push(h()),m.push(u()),m.push(f()),m.push(this.ctlRow("Natural Wind",c)),m.push(this.deviceBar(g,e,t))}else if("Cycle"===n){const e=`text.sf_${s}_fan_cycle_start`,i=`text.sf_${s}_fan_cycle_run`,r=`text.sf_${s}_fan_cycle_off`,n=`number.sf_${s}_fan_cycle_times`,a={[o]:"mode",[e]:"cycle_start",[i]:"cycle_run",[r]:"cycle_off",[n]:"cycle_times",[l]:"schedule_speed",[d]:"standby_speed"};m.push(this.stagedRow("Start Time",e,"time")),m.push(this.stagedRow("Run Duration",i,"duration")),m.push(this.stagedRow("Off Duration",r,"duration")),m.push(this.stagedRangeRow("Execution Times",n)),m.push(h()),m.push(u()),m.push(f()),m.push(this.ctlRow("Natural Wind",c)),m.push(this.deviceBar(g,a,t))}else if("Environment"===n){const e=`select.sf_${s}_fan_run_mode`,i={[o]:"mode",[e]:"env_submode",[l]:"schedule_speed",[d]:"standby_speed"};m.push(this.stagedRow("Run Mode",e)),m.push(h()),m.push(u()),m.push(f()),m.push(this.ctlRow("Natural Wind",c)),m.push(this.deviceBar(g,i,t))}return m}renderBlowerBody(t,e){const s=this.config.panel,i="on"===e.state,o=`select.sf_${s}_blower_mode_set`,r=this.get(o),n=this.modeOf(o),a=`number.sf_${s}_blower_running_speed`,l=`number.sf_${s}_blower_standby_speed`,d=`switch.sf_${s}_blower_close_co2`,c=`text.sf_${s}_blower_apply`,h=()=>this.optSelectRow("Running Speed",a,this.numOpts(25,100,1,t=>`${t}%`)),p=Math.max(25,Math.round(Number(this.draftVal(a))||25)),u=()=>this.optSelectRow("Standby Speed",l,this.offOpts(25,p-1)),f=[];if(r&&f.push(this.liveModeRow("Mode",o)),f.push(this.powerRow(t.id,"fan",t.label,i)),"Manual"===n){const s=Math.round(e.attributes.percentage??0);f.push(this.speedRow(t,i?s:0)),f.push(this.ctlRow("Close CO2 Device",d)),f.push(this.deviceBar(c,{[o]:"mode"},t))}else if("Time Slot"===n){const e={[o]:"mode",[`text.sf_${s}_blower_schedule_start`]:"schedule_start",[`text.sf_${s}_blower_schedule_stop`]:"schedule_end",[a]:"schedule_speed",[l]:"standby_speed"};f.push(this.stagedPeriodRow(`text.sf_${s}_blower_schedule_start`,`text.sf_${s}_blower_schedule_stop`,"Schedule")),f.push(h()),f.push(u()),f.push(this.ctlRow("Close CO2 Device",d)),f.push(this.deviceBar(c,e,t))}else if("Cycle"===n){const e=`text.sf_${s}_blower_cycle_start`,i=`text.sf_${s}_blower_cycle_run`,r=`text.sf_${s}_blower_cycle_off`,n=`number.sf_${s}_blower_cycle_times`,p={[o]:"mode",[e]:"cycle_start",[i]:"cycle_run",[r]:"cycle_off",[n]:"cycle_times",[a]:"schedule_speed",[l]:"standby_speed"};f.push(this.stagedRow("Start Time",e,"time")),f.push(this.stagedRow("Run Duration",i,"duration")),f.push(this.stagedRow("Off Duration",r,"duration")),f.push(this.stagedRangeRow("Execution Times",n)),f.push(h()),f.push(u()),f.push(this.ctlRow("Close CO2 Device",d)),f.push(this.deviceBar(c,p,t))}else if("Environment"===n){const e=`select.sf_${s}_blower_run_mode`,i={[o]:"mode",[e]:"env_submode",[a]:"schedule_speed",[l]:"standby_speed"};f.push(this.stagedRow("Run Mode",e)),f.push(h()),f.push(u()),f.push(this.ctlRow("Close CO2 Device",d)),f.push(this.deviceBar(c,i,t))}return f}cycleIsDay(){const t=this.config.panel,e=this.get(`binary_sensor.sf_${t}_daytime_schedule`);if(e&&("on"===e.state||"off"===e.state))return"on"===e.state;const s=Pt(this.get(`text.sf_${t}_env_day_start`)?.state),i=Pt(this.get(`text.sf_${t}_env_day_end`)?.state);if(null==s||null==i)return null;const o=new Date,r=60*o.getHours()+o.getMinutes();return s<=i?r>=s&&r<i:r>=s||r<i}lightLeak(){if(!1!==this.cycleIsDay())return{on:!1,text:""};const t=this.config.panel,e=this.get(`sensor.sf_${t}_ppfd`);if(e){const t=Number(e.state);return Number.isFinite(t)&&t>1?{on:!0,text:`Light detected · ${Math.round(t)} µmol`}:{on:!1,text:""}}const s=this.get(`binary_sensor.sf_${t}_daytime_light_sensor`);return s&&"on"===s.state?{on:!0,text:"Light detected"}:{on:!1,text:""}}renderParamsHead(){const t=this.cycleIsDay(),e=this.lightLeak(),s=null===t?q:W`<span class="cycle-badge"
      ...
      <div class="params-head">
        ...
        ${s}
      </div>`}renderOverview(){const t=Rt.map(t=>this.renderParam(t)).filter(t=>t!==q),e=this.soilStatsTile(),s=this.overviewDevices();return W`
      ...
      ${Ht.map(([e,s,i,o,r])=>this.get(`number.sf_${t}_${s}`)?W`
          <div class="env-row">
      ...
      </div>`}renderOutletPop(){const t=this.outletOpen;if(!t)return q;const e=t.lastIndexOf("_");if(e<0)return q;const s=t.slice(0,e),i=Number(t.slice(e+1));if(!s||!Number.isFinite(i))return q;const o=`select.sf_${s}_outlet_${i}_mode`;if(!this.get(o))return q;const r=`switch.sf_${s}_outlet_${i}`,n=this.get(r),a=`sf_${s}_outlet_${i}_`,l="Time Slot"===(this.draftVal(o)||this.get(o)?.state||"")&&!!this.get(`sensor.${a}ts_schedule`),d=Object.keys(this.hass?.states??{}).filter(t=>{const e=t.split(".")[1]??"";return!(!e.startsWith(a)||e===`${a}mode`)&&(e!==`${a}ts_schedule`&&(!l||e!==`${a}ts_type`&&e!==`${a}ts_start`&&e!==`${a}ts_stop`))}).sort(),c=[...n?[r]:[],o,...d.filter(t=>/^(switch|number|select|text)\./.test(t))],h=!!this.outletDraft[this.outletKey(s,i)];return W`
      <div class="soil-pop" style="--sf-accent:${this.accent()}">
        <div class="soil-pop-head">
          <span>Outlet ${i}</span>
          <ha-icon icon="mdi:close" role="button" aria-label="Close"
        ...
        ${d.map(t=>this.stagedCtl(t))}
        ${l?this.renderOutletSchedule(s,i):q}
        ${this.applyBar(c,{extraDirty:h,onApply:()=>this.saveOutlet(s,i),onDiscard:()=>this.clearOutletDraft(s,i)})}
      ...
      ${o.length?W`
        ...
        @click=${()=>this.tab=t}>${e}</button>`,d=Ct(this.hass,this.config.panel);return W`
      <ha-card>
        <div class="header">
      ...
      </ha-card>`}renderSettings(){const t=this.accent(),e=this.colorDraft,s=e?.mode??this.colorMode,i=e?.modeIn??this.colorModeIn,o=e?.hi??this.colHi,r=e?.lo??this.colLo,n=e?.in??this.colIn,a=e?.hide2??this.hideLight2,l=!!this.get(this.eid("light","light_2")),d=!!e&&(void 0!==e.mode&&e.mode!==this.colorMode||void 0!==e.modeIn&&e.modeIn!==this.colorModeIn||void 0!==e.hi&&e.hi!==this.colHi||void 0!==e.lo&&e.lo!==this.colLo||void 0!==e.in&&e.in!==this.colIn||void 0!==e.hide2&&e.hide2!==this.hideLight2),c=t=>this.colorDraft={...this.colorDraft??{},...t},h=(e,s,i,o,r)=>W`
      ...
      <div class="seg-row">
        ${h(s,"off","No color","mdi:circle-off-outline",()=>c({mode:"off"}))}
        ${h(s,"tile","Tile color","mdi:square-rounded",()=>c({mode:"tile"}))}
        ${h(s,"text","Text color","mdi:format-color-text",()=>c({mode:"text"}))}
      </div>
      <div class="color-row">
        ${p("Above max",o,t=>c({hi:t}))}
        ${p("Below min",r,t=>c({lo:t}))}
      </div>
      ...
      <div class="seg-row">
        ${h(i,"off","No color","mdi:circle-off-outline",()=>c({modeIn:"off"}))}
        ${h(i,"tile","Tile color","mdi:square-rounded",()=>c({modeIn:"tile"}))}
        ${h(i,"text","Text color","mdi:format-color-text",()=>c({modeIn:"text"}))}
      </div>
      <div class="color-row">
        ${p("In range",n,t=>c({in:t}))}
      </div>

      ${l?W`
            <div class="section-label" style="margin-top:16px">Devices</div>
            <div class="set-note">
              Hide Light 2 if that port has an inline adapter (or nothing) rather
              than a real light, so the phantom tile stops showing.
            </div>
            <div class="toggle-row">
              <span>Hide Light 2</span>
              <button class="toggle ${a?"on":""}"
                style=${a?`background:${t}`:q}
                @click=${()=>c({hide2:!a})}
                aria-label="Hide Light 2"></button>
            </div>`:q}
      ${zt(t,d,()=>{const t=this.colorDraft;t&&(void 0!==t.mode&&t.mode!==this.colorMode&&(this.colorMode=t.mode,this.persistColorOption("colors",t.mode)),void 0!==t.modeIn&&t.modeIn!==this.colorModeIn&&(this.colorModeIn=t.modeIn,this.persistColorOption("colors_in",t.modeIn)),void 0!==t.hi&&t.hi!==this.colHi&&(this.colHi=t.hi,this.persistColorOption("color_hi",t.hi)),void 0!==t.lo&&t.lo!==this.colLo&&(this.colLo=t.lo,this.persistColorOption("color_lo",t.lo)),void 0!==t.in&&t.in!==this.colIn&&(this.colIn=t.in,this.persistColorOption("color_in",t.in)),void 0!==t.hide2&&t.hide2!==this.hideLight2&&(this.hideLight2=t.hide2,this.persistColorOption("hide_light2",t.hide2?"1":"0")),this._colorSynced=!0,this.cacheColors()),this.colorDraft=null},()=>this.colorDraft=null,"apply-bar")}`}}Ft.styles=n`
    ${yt}
  ...
  `,t([ut({attribute:!1})],Ft.prototype,"hass",void 0),t([ft()],Ft.prototype,"config",void 0),t([ft()],Ft.prototype,"tab",void 0),t([ft()],Ft.prototype,"colorMode",void 0),t([ft()],Ft.prototype,"colHi",void 0),t([ft()],Ft.prototype,"colLo",void 0),t([ft()],Ft.prototype,"colorModeIn",void 0),t([ft()],Ft.prototype,"colIn",void 0),t([ft()],Ft.prototype,"hideLight2",void 0),t([ft()],Ft.prototype,"colorDraft",void 0),t([ft()],Ft.prototype,"alertsDraft",void 0),t([ft()],Ft.prototype,"soilOpen",void 0),t([ft()],Ft.prototype,"soilAllOpen",void 0),t([ft()],Ft.prototype,"deviceOpen",void 0),t([ft()],Ft.prototype,"outletOpen",void 0),t([ft()],Ft.prototype,"draft",void 0),t([ft()],Ft.prototype,"modePick",void 0),t([ft()],Ft.prototype,"outletDraft",void 0),t([ft()],Ft.prototype,"logDate",void 0),t([ft()],Ft.prototype,"logDev",void 0),t([ft()],Ft.prototype,"logType",void 0);class jt extends dt{constructor(){super(...arguments),this._config={type:"custom:spider-farmer-card"}}setConfig(t){this._config={...t}}_emit(t){this._config=t,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}_panelChanged(t){const e=t.target.value,s={...this._config};e?s.panel=e:delete s.panel,this._emit(s)}_titleChanged(t){const e=t.target.value.trim(),s={...this._config};e?s.title=e:delete s.title,this._emit(s)}_tabChanged(t){const e=t.target.value;this._emit({...this._config,default_tab:e})}_outletToggled(t,e){const s=e.target.checked,i=new Set(this._config.outlets??[]);s?i.add(t):i.delete(t);const o=[...i].sort(),r={...this._config};o.length?r.outlets=o:delete r.outlets,this._emit(r)}render(){if(!this.hass)return q;const t=this._config,e=t.default_tab,s=St(this.hass),i=At(this.hass,t.panel),o=t=>{const e=Ct(this.hass,t);return e?`${t} — ${e}`:t};return W`
      <div class="form">
        <label class="field">
  ...
  `,t([ut({attribute:!1})],jt.prototype,"hass",void 0),t([ft()],jt.prototype,"_config",void 0);const Ut=/^sf_(se\d+)_light$/;function Wt(t){const e=new Set;for(const s of Object.keys(t.states)){if(!s.startsWith("light."))continue;const t=bt(s).match(Ut);t&&e.add(t[1])}return[...e].sort((t,e)=>Number(t.replace(/\D/g,""))-Number(e.replace(/\D/g,"")))}class Vt extends dt{constructor(){super(...arguments),this.draft=null,this.ctlDraft={}}setConfig(t){this.config=t}getCardSize(){return 7}static getStubConfig(t){const e=t?Wt(t):[];return{type:"custom:spider-light-card",...e[0]?{light:e[0]}:{}}}accent(){return this.config.accent||gt}seSlot(){return this.config.light||(this.hass?Wt(this.hass)[0]:"")||"se1"}get(t){return this.hass?.states[t]}shouldUpdate(t){return t.has("config")||t.has("hass")||t.has("draft")||t.has("ctlDraft")}cur(t,e){return t in this.ctlDraft?this.ctlDraft[t]:e}stageCtl(t,e){this.ctlDraft={...this.ctlDraft,[t]:e}}isDirty(){return Object.keys(this.ctlDraft).length>0||null!==this.draft}applyAll(t){const e=this.ctlDraft,s=`light.sf_${t}_light`;if("bri"in e){const t=Number(e.bri);t>0?this.hass?.callService("light","turn_on",{entity_id:s,brightness_pct:t}):this.hass?.callService("light","turn_off",{entity_id:s})}"mode"in e&&this.hass?.callService("select","select_option",{entity_id:`select.sf_${t}_mode`,option:e.mode});for(const t of Object.keys(e))t.includes(".")&&(t.startsWith("number.")?this.hass?.callService("number","set_value",{entity_id:t,value:Number(e[t])}):t.startsWith("text.")&&this.hass?.callService("text","set_value",{entity_id:t,value:e[t]}));if("power"in e){const t="on"===e.power;t&&"bri"in e||this.hass?.callService("light",t?"turn_on":"turn_off",{entity_id:s})}this.draft&&this.saveSchedule(t),this.ctlDraft={}}discardAll(){Object.keys(this.ctlDraft).length&&(this.ctlDraft={}),null!==this.draft&&(this.draft=null)}render(){if(!this.hass||!this.config)return q;const t=this.seSlot(),e=this.get(`light.sf_${t}_light`);if(!e)return W`<ha-card>
      ...
      <ha-card>
        ...
        <div class="gauge">
          ...
          <button class="power ${a?"on":""}"
            style=${a?`background:${h}`:""}
            @click=${()=>this.stageCtl("power",a?"off":"on")}
        ...
        ${zt(h,this.isDirty(),()=>this.applyAll(t),()=>this.discardAll(),"apply-bar")}
    ...
    </div>`}numRow(t,e,s){const i=s.attributes.min??0,o=s.attributes.max??100,r=s.attributes.step??1,n=s.attributes.unit_of_measurement??"",a="unknown"===s.state||"unavailable"===s.state?"":s.state,l=this.cur(t,a);return W`<div class="num-row">
    ...
    .discard-btn[disabled] { opacity: 0.5; cursor: default; }
  `,t([ut({attribute:!1})],Vt.prototype,"hass",void 0),t([ft()],Vt.prototype,"config",void 0),t([ft()],Vt.prototype,"draft",void 0),t([ft()],Vt.prototype,"ctlDraft",void 0),customElements.get("spider-farmer-card")||customElements.define("spider-farmer-card",Ft),customElements.get("spider-farmer-card-editor")||customElements.define("spider-farmer-card-editor",jt),customElements.get("spider-light-card")||customElements.define("spider-light-card",Vt),window.customCards=window.customCards||[],window.customCards.push({type:"spider-farmer-card",name:"Spider Farmer Card",description:"Tent overview + config for the Spider Farmer Bridge integration",preview:!0,documentationURL:"https://github.com/cobragt2000/spider_farmer_bridge"}),window.customCards.push({type:"spider-light-card",name:"Spider Light Card",description:"Brightness dial, mode, and schedule for a Spider Farmer SE-series light",preview:!0,documentationURL:"https://github.com/cobragt2000/spider_farmer_bridge"}),console.info("%c SPIDER-FARMER-CARD %c v0.17.29 ","color:#fff;background:#ff7a1a;border-radius:3px 0 0 3px;padding:2px 4px","color:#ff7a1a;background:#222;border-radius:0 3px 3px 0;padding:2px 4px"),(()=>{const t=["spider-farmer-card","spider-light-card"],e=new Set([...t,...t.map(t=>`custom:${t}`)]),s=()=>{const t=[["spider-farmer-card",Ft],["spider-farmer-card-editor",jt],["spider-light-card",Vt]];for(const[e,s]of t)if(!customElements.get(e))try{customElements.define(e,s)}catch{}},i=()=>{let t=0;for(const s of(()=>{const t=[],e=new Set,s=i=>{if(!i||e.has(i))return;e.add(i);let o=[];try{o=i.querySelectorAll("hui-error-card")}catch{return}o.forEach(e=>t.push(e));let r=[];try{r=i.querySelectorAll("*")}catch{return}r.forEach(t=>{const e=t.shadowRoot;e&&s(e)})};return s(document),t})()){const i=s._config||{},o=i.origConfig&&i.origConfig.type||i.type||"";e.has(o)&&(s.dispatchEvent(new CustomEvent("ll-rebuild",{bubbles:!0,composed:!0})),t++)}return t};let o=0;const r=()=>{s(),i(),++o<12&&setTimeout(r,250)},n=()=>{s(),r()};"complete"===document.readyState?n():window.addEventListener("load",n,{once:!0})})();export{Ft as SpiderFarmerCard,jt as SpiderFarmerCardEditor,Vt as SpiderLightCard};
