/*! spider-farmer-card v0.20.11 | MIT */
...
`;function wt(t){const e=new Set;for(const s of Object.keys(t.states)){const t=bt(s).match(vt);t&&e.add(t[1])}return[...e].sort()}function St(t){return wt(t).filter(e=>Object.keys(t.states).some(t=>{const s=bt(t);return s===`sf_${e}_temperature`||s===`sf_${e}_soil_avg_temperature`||s===`sf_${e}_light_1`||s===`sf_${e}_fan`||s===`sf_${e}_blower`}))}function Ot(t,e){const s=`sf_${e}_`,i=Object.keys(t.states);return i.find(t=>bt(t)===`sf_${e}_temperature`)??i.find(t=>{const i=bt(t);return i.startsWith(s)&&!i.startsWith(`sf_${e}_env_`)})}function kt(t,e){const s=Ot(t,e);return s?t.entities?.[s]?.device_id:void 0}function Ct(t,e){if(!e)return[];const s=kt(t,e);return function(t){return wt(t).filter(e=>!!t.states[`switch.sf_${e}_outlet_1`])}(t).filter(i=>{if(i===e)return!0;if(!s)return!1;const o=kt(t,i),a=o?t.devices?.[o]:void 0;return a?.via_device_id===s})}function Mt(t,e){if(!t||!e)return"";const s=Ot(t,e);if(!s)return"";const i=t.entities?.[s]?.device_id,o=i?t.devices?.[i]:void 0;if(o)return o.name_by_user||o.name||"";const a=(t.states[s].attributes.friendly_name||"").match(/^(SF .+? [0-9A-Fa-f]{4})\b/);return a?a[1]:""}const At=[["temperature","Air Temp","mdi:thermometer"],["humidity","Air Humi","mdi:water-percent"],["vpd","Air VPD","mdi:water-opacity"],["leaf_vpd","Leaf VPD","mdi:leaf"],["co2","CO2","mdi:molecule-co2"],["ppfd","PPFD","mdi:white-balance-sunny"],["soil_avg_temperature","Soil Temp","mdi:thermometer"],["soil_avg_moisture","Moisture","mdi:water"],["soil_avg_ec","Soil EC","mdi:flash"]],Nt={temperature:"temp",humidity:"humi",vpd:"vpd",co2:"co2",ppfd:"ppfd",soil_avg_temperature:"tempSoil",soil_avg_moisture:"humiSoil",soil_avg_ec:"ECSoil"},Dt={temperature:"temp",humidity:"humi",co2:"co2"},Tt="#ff6b6b",Rt="rgba(255,107,107,0.16)",Et=(t,e=.16)=>{const s=/^#?([0-9a-fA-F]{6})$/.exec((t||"").trim());if(!s)return`rgba(255,107,107,${e})`;const i=parseInt(s[1],16);return`rgba(${i>>16&255},${i>>8&255},${255&i},${e})`},Pt=t=>"string"==typeof t&&/^#[0-9a-fA-F]{6}$/.test(t),Lt=t=>"alarms"===t||"targets"===t||"both"===t,Ft=mt,zt={"Time Slot":["ts_type","ts_start","ts_stop"],Cycle:["cycle_start","cycle_run","cycle_off","cycle_times"],Temperature:["temp_device"],Humidity:["humidity_device"],CO2:["co2_device"],"Drip Irrigation":["drip_soil","drip_avg"],Manual:[]},Bt=mt,It=t=>!!t&&("unavailable"===t.state||"unknown"===t.state),Ht=t=>{const e=(t||"").match(/^(\d{1,2}):(\d{2})$/);if(!e)return null;const s=+e[1],i=+e[2];return s<=23&&i<=59?60*s+i:null},jt=(t,e,s,i,o="")=>W`<div class="save-bar ${o}">
  ...
  <button class="discard-btn" ?disabled=${!e}
    @click=${i}>Discard</button>`)(t,e,s,i)}
      ...
      <div class="params-head">
        ...
        ${s}
      </div>`}renderOverview(){const t=At.map(t=>this.renderParam(t)).filter(t=>t!==q),e=this.soilStatsTile(),s=this.overviewDevices();return W`
      ...
      ${t.map(t=>{const s=Mt(this.hass,t)||`${t.toUpperCase()} Power Strip`;return W`
      ...
      <div class="soil-pop" style="--sf-accent:${this.accent()}">
        ...
        ${r?this.stagedCtl(a,"Power"):q}
        ${h.map(t=>this.stagedCtl(t))}
        ${c?this.renderOutletSchedule(s,i):q}
        ${this.applyBar(p,{extraDirty:u||f,onApply:()=>{this.saveOutlet(s,i),this.commitOutletName(s,i)},onDiscard:()=>{this.clearOutletDraft(s,i),this.clearOutletNameDraft(s,i)}})}
      ...
      <div class="seg-row">
        ${D("alarms","Alarms","mdi:bell-outline")}
        ${D("targets","Targets","mdi:target")}
        ${D("both","Both","mdi:set-center")}
      </div>
      ...
      <div class="seg-row">
        ${A(s,"off","No color","mdi:circle-off-outline",()=>M({mode:"off"}))}
        ${A(s,"tile","Tile color","mdi:square-rounded",()=>M({mode:"tile"}))}
        ${A(s,"text","Text color","mdi:format-color-text",()=>M({mode:"text"}))}
      </div>
      <div class="color-row">
        ${T("Above max",o,t=>M({hi:t}))}
        ${T("Below min",a,t=>M({lo:t}))}
        ${T("Near edge",n,t=>M({warn:t}))}
      </div>
      ...
      <div class="seg-row">
        ${A(i,"off","No color","mdi:circle-off-outline",()=>M({modeIn:"off"}))}
        ${A(i,"tile","Tile color","mdi:square-rounded",()=>M({modeIn:"tile"}))}
        ${A(i,"text","Text color","mdi:format-color-text",()=>M({modeIn:"text"}))}
      </div>
      <div class="color-row">
        ${T("In range",r,t=>M({in:t}))}
      </div>
      ...
      ${x?W`
            ...
            <div class="seg-row">
              ${A(g,"off","No color","mdi:circle-off-outline",()=>M({omode:"off"}))}
              ${A(g,"tile","Tile color","mdi:square-rounded",()=>M({omode:"tile"}))}
              ${A(g,"text","Text color","mdi:format-color-text",()=>M({omode:"text"}))}
            </div>
            <div class="color-row">
              ${T("Manual",v,t=>M({ocManual:t}))}
              ${T("Scheduled",b,t=>M({ocSched:t}))}
            </div>
            <div class="color-row">
              ${T("Environment",$,t=>M({ocEnv:t}))}
              ${T("Drip",_,t=>M({ocDrip:t}))}
            </div>`:q}
      ...
      ${k?W`
            ...
            <div class="seg-row">
              ${A(y,"off","No color","mdi:circle-off-outline",()=>M({dmode:"off"}))}
              ${A(y,"tile","Tile color","mdi:square-rounded",()=>M({dmode:"tile"}))}
              ${A(y,"text","Text color","mdi:format-color-text",()=>M({dmode:"text"}))}
            </div>
            <div class="color-row">
              ${T("Manual",w,t=>M({dcManual:t}))}
              ${T("Scheduled",S,t=>M({dcSched:t}))}
              ${T("Auto",O,t=>M({dcAuto:t}))}
            </div>`:q}
      ...
      ${p?W`
        ...
        <input type="range" min="70" max="150" step="5" .value=${String(u)}
          style="width:100%"
          @input=${t=>M({scale:Number(t.target.value)})} />
        ...
        <div class="seg-row" style="grid-template-columns:repeat(4,1fr)">
          ${[2,3,4,5].map(e=>W`
            <button class="seg ${f===e?"on":""}"
              ...
              @click=${()=>M({cols:e})}><span>${e}</span></button>`)}
        </div>`:q}
  ...
  `,t([ut({attribute:!1})],Kt.prototype,"hass",void 0),t([ft()],Kt.prototype,"_config",void 0);const Jt=/^sf_(se\d+)_light$/;function Zt(t){const e=new Set;for(const s of Object.keys(t.states)){if(!s.startsWith("light."))continue;const t=bt(s).match(Jt);t&&e.add(t[1])}return[...e].sort((t,e)=>Number(t.replace(/\D/g,""))-Number(e.replace(/\D/g,"")))}class Xt extends ct{constructor(){super(...arguments),this.draft=null,this.ctlDraft={}}setConfig(t){this.config=t}getCardSize(){return 7}static getStubConfig(t){const e=t?Zt(t):[];return{type:"custom:spider-light-card",...e[0]?{light:e[0]}:{}}}accent(){return this.config.accent||mt}seSlot(){return this.config.light||(this.hass?Zt(this.hass)[0]:"")||"se1"}get(t){return this.hass?.states[t]}shouldUpdate(t){return t.has("config")||t.has("hass")||t.has("draft")||t.has("ctlDraft")}cur(t,e){return t in this.ctlDraft?this.ctlDraft[t]:e}stageCtl(t,e){this.ctlDraft={...this.ctlDraft,[t]:e}}isDirty(){return Object.keys(this.ctlDraft).length>0||null!==this.draft}applyAll(t){const e=this.ctlDraft,s=`light.sf_${t}_light`;if("bri"in e){const t=Number(e.bri);t>0?this.hass?.callService("light","turn_on",{entity_id:s,brightness_pct:t}):this.hass?.callService("light","turn_off",{entity_id:s})}"mode"in e&&this.hass?.callService("select","select_option",{entity_id:`select.sf_${t}_mode`,option:e.mode});for(const t of Object.keys(e))t.includes(".")&&(t.startsWith("number.")?this.hass?.callService("number","set_value",{entity_id:t,value:Number(e[t])}):t.startsWith("text.")&&this.hass?.callService("text","set_value",{entity_id:t,value:e[t]}));if("power"in e){const t="on"===e.power;t&&"bri"in e||this.hass?.callService("light",t?"turn_on":"turn_off",{entity_id:s})}this.draft&&this.saveSchedule(t),this.ctlDraft={}}discardAll(){Object.keys(this.ctlDraft).length&&(this.ctlDraft={}),null!==this.draft&&(this.draft=null)}render(){if(!this.hass||!this.config)return q;const t=this.seSlot(),e=this.get(`light.sf_${t}_light`);if(!e)return W`<ha-card>
      ...
      </ha-card>`;const s="on"===e.state,i=s?Math.max(0,Math.min(100,Math.round((e.attributes.brightness??0)/255*100))):0,o=this.get(`select.sf_${t}_mode`),a=this.cur("mode",o?.state??""),r="bri"in this.ctlDraft,n="on"===this.cur("power",s?"on":"off"),l=r?Number(this.ctlDraft.bri):n?i:0,c=r?l>0:n,d=Mt(this.hass,t),h=this.accent(),p=l/100,[u,f]=$t(100,100,78,135+270*p);return W`
      <ha-card>
        <div class="header">
