/*! spider-farmer-card v0.20.28 | MIT */
 ...
 */
const e=globalThis,s=e.ShadowRoot&&(void 0===e.ShadyCSS||e.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,i=Symbol(),o=new WeakMap;let a=class{constructor(t,e,s){if(this._$cssResult$=!0,s!==i)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=e}get styleSheet(){let t=this.o;const e=this.t;if(s&&void 0===t){const s=void 0!==e&&1===e.length;s&&(t=o.get(e)),void 0===t&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),s&&o.set(e,t))}return t}toString(){return this.cssText}};const r=(t,...e)=>{const s=1===t.length?t[0]:e.reduce((e,s,i)=>e+(t=>{if(!0===t._$cssResult$)return t.cssText;if("number"==typeof t)return t;throw Error("Value passed to 'css' function must be a 'css' function result: "+t+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(s)+t[i+1],t[0]);return new a(s,t,i)},n=s?t=>t:t=>t instanceof CSSStyleSheet?(t=>{let e="";for(const s of t.cssRules)e+=s.cssText;return(t=>new a("string"==typeof t?t:t+"",void 0,i))(e)})(t):t,{is:l,defineProperty:c,getOwnPropertyDescriptor:d,getOwnPropertyNames:h,getOwnPropertySymbols:p,getPrototypeOf:u}=Object,f=globalThis,m=f.trustedTypes,g=m?m.emptyScript:"",v=f.reactiveElementPolyfillSupport,$=(t,e)=>t,_={toAttribute(t,e){switch(e){case Boolean:t=t?g:null;break;case Object:case Array:t=null==t?t:JSON.stringify(t)}return t},fromAttribute(t,e){let s=t;switch(e){case Boolean:s=null!==t;break;case Number:s=null===t?null:Number(t);break;case Object:case Array:try{s=JSON.parse(t)}catch(t){s=null}}return s}},b=(t,e)=>!l(t,e),x={attribute:!0,type:String,converter:_,reflect:!1,useDefault:!1,hasChanged:b};
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */Symbol.metadata??=Symbol("metadata"),f.litPropertyMetadata??=new WeakMap;let y=class extends HTMLElement{static addInitializer(t){this._$Ei(),(this.l??=[]).push(t)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(t,e=x){if(e.state&&(e.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(t)&&((e=Object.create(e)).wrapped=!0),this.elementProperties.set(t,e),!e.noAccessor){const s=Symbol(),i=this.getPropertyDescriptor(t,s,e);void 0!==i&&c(this.prototype,t,i)}}static getPropertyDescriptor(t,e,s){const{get:i,set:o}=d(this.prototype,t)??{get(){return this[e]},set(t){this[e]=t}};return{get:i,set(e){const a=i?.call(this);o?.call(this,e),this.requestUpdate(t,a,s)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this.elementProperties.get(t)??x}static _$Ei(){if(this.hasOwnProperty($("elementProperties")))return;const t=u(this);t.finalize(),void 0!==t.l&&(this.l=[...t.l]),this.elementProperties=new Map(t.elementProperties)}static finalize(){if(this.hasOwnProperty($("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty($("properties"))){const t=this.properties,e=[...h(t),...p(t)];for(const s of e)this.createProperty(s,t[s])}const t=this[Symbol.metadata];if(null!==t){const e=litPropertyMetadata.get(t);if(void 0!==e)for(const[t,s]of e)this.elementProperties.set(t,s)}this._$Eh=new Map;for(const[t,e]of this.elementProperties){const s=this._$Eu(t,e);void 0!==s&&this._$Eh.set(s,t)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(t){const e=[];if(Array.isArray(t)){const s=new Set(t.flat(1/0).reverse());for(const t of s)e.unshift(n(t))}else void 0!==t&&e.push(n(t));return e}static _$Eu(t,e){const s=e.attribute;return!1===s?void 0:"string"==typeof s?s:"string"==typeof t?t.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(t=>this.enableUpdating=t),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(t=>t(this))}addController(t){(this._$EO??=new Set).add(t),void 0!==this.renderRoot&&this.isConnected&&t.hostConnected?.()}removeController(t){this._$EO?.delete(t)}_$E_(){const t=new Map,e=this.constructor.elementProperties;for(const s of e.keys())this.hasOwnProperty(s)&&(t.set(s,this[s]),delete this[s]);t.size>0&&(this._$Ep=t)}createRenderRoot(){const t=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return((t,i)=>{if(s)t.adoptedStyleSheets=i.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet);else for(const s of i){const i=document.createElement("style"),o=e.litNonce;void 0!==o&&i.setAttribute("nonce",o),i.textContent=s.cssText,t.appendChild(i)}})(t,this.constructor.elementStyles),t}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(t=>t.hostConnected?.())}enableUpdating(t){}disconnectedCallback(){this._$EO?.forEach(t=>t.hostDisconnected?.())}attributeChangedCallback(t,e,s){this._$AK(t,s)}_$ET(t,e){const s=this.constructor.elementProperties.get(t),i=this.constructor._$Eu(t,s);if(void 0!==i&&!0===s.reflect){const o=(void 0!==s.converter?.toAttribute?s.converter:_).toAttribute(e,s.type);this._$Em=t,null==o?this.removeAttribute(i):this.setAttribute(i,o),this._$Em=null}}_$AK(t,e){const s=this.constructor,i=s._$Eh.get(t);if(void 0!==i&&this._$Em!==i){const t=s.getPropertyOptions(i),o="function"==typeof t.converter?{fromAttribute:t.converter}:void 0!==t.converter?.fromAttribute?t.converter:_;this._$Em=i;const a=o.fromAttribute(e,t.type);this[i]=a??this._$Ej?.get(i)??a,this._$Em=null}}requestUpdate(t,e,s,i=!1,o){if(void 0!==t){const a=this.constructor;if(!1===i&&(o=this[t]),s??=a.getPropertyOptions(t),!((s.hasChanged??b)(o,e)||s.useDefault&&s.reflect&&o===this._$Ej?.get(t)&&!this.hasAttribute(a._$Eu(t,s))))return;this.C(t,e,s)}!1===this.isUpdatePending&&(this._$ES=this._$EP())}C(t,e,{useDefault:s,reflect:i,wrapped:o},a){s&&!(this._$Ej??=new Map).has(t)&&(this._$Ej.set(t,a??e??this[t]),!0!==o||void 0!==a)||(this._$AL.has(t)||(this.hasUpdated||s||(e=void 0),this._$AL.set(t,e)),!0===i&&this._$Em!==t&&(this._$Eq??=new Set).add(t))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(t){Promise.reject(t)}const t=this.scheduleUpdate();return null!=t&&await t,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(const[t,e]of this._$Ep)this[t]=e;this._$Ep=void 0}const t=this.constructor.elementProperties;if(t.size>0)for(const[e,s]of t){const{wrapped:t}=s,i=this[e];!0!==t||this._$AL.has(e)||void 0===i||this.C(e,void 0,s,i)}}let t=!1;const e=this._$AL;try{t=this.shouldUpdate(e),t?(this.willUpdate(e),this._$EO?.forEach(t=>t.hostUpdate?.()),this.update(e)):this._$EM()}catch(e){throw t=!1,this._$EM(),e}t&&this._$AE(e)}willUpdate(t){}_$AE(t){this._$EO?.forEach(t=>t.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(t)),this.updated(t)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(t){return!0}update(t){this._$Eq&&=this._$Eq.forEach(t=>this._$ET(t,this[t])),this._$EM()}updated(t){}firstUpdated(t){}};y.elementStyles=[],y.shadowRootOptions={mode:"open"},y[$("elementProperties")]=new Map,y[$("finalized")]=new Map,v?.({ReactiveElement:y}),(f.reactiveElementVersions??=[]).push("2.1.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const w=globalThis,S=t=>t,O=w.trustedTypes,k=O?O.createPolicy("lit-html",{createHTML:t=>t}):void 0,C="$lit$",M=`lit$${Math.random().toFixed(9).slice(2)}$`,D="?"+M,A=`<${D}>`,N=document,T=()=>N.createComment(""),R=t=>null===t||"object"!=typeof t&&"function"!=typeof t,E=Array.isArray,P="[ \t\n\f\r]",L=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,F=/-->/g,z=/>/g,B=RegExp(`>|${P}(?:([^\\s"'>=/]+)(${P}*=${P}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),I=/'/g,H=/"/g,j=/^(?:script|style|textarea|title)$/i,U=t=>(e,...s)=>({_$litType$:t,strings:e,values:s}),W=U(1),V=U(2),G=Symbol.for("lit-noChange"),q=Symbol.for("lit-nothing"),K=new WeakMap,J=N.createTreeWalker(N,129);function Z(t,e){if(!E(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==k?k.createHTML(e):e}const X=(t,e)=>{const s=t.length-1,i=[];let o,a=2===e?"<svg>":3===e?"<math>":"",r=L;for(let e=0;e<s;e++){const s=t[e];let n,l,c=-1,d=0;for(;d<s.length&&(r.lastIndex=d,l=r.exec(s),null!==l);)d=r.lastIndex,r===L?"!--"===l[1]?r=F:void 0!==l[1]?r=z:void 0!==l[2]?(j.test(l[2])&&(o=RegExp("</"+l[2],"g")),r=B):void 0!==l[3]&&(r=B):r===B?">"===l[0]?(r=o??L,c=-1):void 0===l[1]?c=-2:(c=r.lastIndex-l[2].length,n=l[1],r=void 0===l[3]?B:'"'===l[3]?H:I):r===H||r===I?r=B:r===F||r===z?r=L:(r=B,o=void 0);const h=r===B&&t[e+1].startsWith("/>")?" ":"";a+=r===L?s+A:c>=0?(i.push(n),s.slice(0,c)+C+s.slice(c)+M+h):s+M+(-2===c?e:h)}return[Z(t,a+(t[s]||"<?>")+(2===e?"</svg>":3===e?"</math>":"")),i]};class Y{constructor({strings:t,_$litType$:e},s){let i;this.parts=[];let o=0,a=0;const r=t.length-1,n=this.parts,[l,c]=X(t,e);if(this.el=Y.createElement(l,s),J.currentNode=this.el.content,2===e||3===e){const t=this.el.content.firstChild;t.replaceWith(...t.childNodes)}for(;null!==(i=J.nextNode())&&n.length<r;){if(1===i.nodeType){if(i.hasAttributes())for(const t of i.getAttributeNames())if(t.endsWith(C)){const e=c[a++],s=i.getAttribute(t).split(M),r=/([.?@])?(.*)/.exec(e);n.push({type:1,index:o,name:r[2],strings:s,ctor:"."===r[1]?it:"?"===r[1]?ot:"@"===r[1]?at:st}),i.removeAttribute(t)}else t.startsWith(M)&&(n.push({type:6,index:o}),i.removeAttribute(t));if(j.test(i.tagName)){const t=i.textContent.split(M),e=t.length-1;if(e>0){i.textContent=O?O.emptyScript:"";for(let s=0;s<e;s++)i.append(t[s],T()),J.nextNode(),n.push({type:2,index:++o});i.append(t[e],T())}}}else if(8===i.nodeType)if(i.data===D)n.push({type:2,index:o});else{let t=-1;for(;-1!==(t=i.data.indexOf(M,t+1));)n.push({type:7,index:o}),t+=M.length-1}o++}}static createElement(t,e){const s=N.createElement("template");return s.innerHTML=t,s}}function Q(t,e,s=t,i){if(e===G)return e;let o=void 0!==i?s._$Co?.[i]:s._$Cl;const a=R(e)?void 0:e._$litDirective$;return o?.constructor!==a&&(o?._$AO?.(!1),void 0===a?o=void 0:(o=new a(t),o._$AT(t,s,i)),void 0!==i?(s._$Co??=[])[i]=o:s._$Cl=o),void 0!==o&&(e=Q(t,o._$AS(t,e.values),o,i)),e}class tt{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:e},parts:s}=this._$AD,i=(t?.creationScope??N).importNode(e,!0);J.currentNode=i;let o=J.nextNode(),a=0,r=0,n=s[0];for(;void 0!==n;){if(a===n.index){let e;2===n.type?e=new et(o,o.nextSibling,this,t):1===n.type?e=new n.ctor(o,n.name,n.strings,this,t):6===n.type&&(e=new rt(o,this,t)),this._$AV.push(e),n=s[++r]}a!==n?.index&&(o=J.nextNode(),a++)}return J.currentNode=N,i}p(t){let e=0;for(const s of this._$AV)void 0!==s&&(void 0!==s.strings?(s._$AI(t,s,e),e+=s.strings.length-2):s._$AI(t[e])),e++}}class et{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,e,s,i){this.type=2,this._$AH=q,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=s,this.options=i,this._$Cv=i?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode;const e=this._$AM;return void 0!==e&&11===t?.nodeType&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=Q(this,t,e),R(t)?t===q||null==t||""===t?(this._$AH!==q&&this._$AR(),this._$AH=q):t!==this._$AH&&t!==G&&this._(t):void 0!==t._$litType$?this.$(t):void 0!==t.nodeType?this.T(t):(t=>E(t)||"function"==typeof t?.[Symbol.iterator])(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==q&&R(this._$AH)?this._$AA.nextSibling.data=t:this.T(N.createTextNode(t)),this._$AH=t}$(t){const{values:e,_$litType$:s}=t,i="number"==typeof s?this._$AC(t):(void 0===s.el&&(s.el=Y.createElement(Z(s.h,s.h[0]),this.options)),s);if(this._$AH?._$AD===i)this._$AH.p(e);else{const t=new tt(i,this),s=t.u(this.options);t.p(e),this.T(s),this._$AH=t}}_$AC(t){let e=K.get(t.strings);return void 0===e&&K.set(t.strings,e=new Y(t)),e}k(t){E(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let s,i=0;for(const o of t)i===e.length?e.push(s=new et(this.O(T()),this.O(T()),this,this.options)):s=e[i],s._$AI(o),i++;i<e.length&&(this._$AR(s&&s._$AB.nextSibling,i),e.length=i)}_$AR(t=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);t!==this._$AB;){const e=S(t).nextSibling;S(t).remove(),t=e}}setConnected(t){void 0===this._$AM&&(this._$Cv=t,this._$AP?.(t))}}class st{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,s,i,o){this.type=1,this._$AH=q,this._$AN=void 0,this.element=t,this.name=e,this._$AM=i,this.options=o,s.length>2||""!==s[0]||""!==s[1]?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=q}_$AI(t,e=this,s,i){const o=this.strings;let a=!1;if(void 0===o)t=Q(this,t,e,0),a=!R(t)||t!==this._$AH&&t!==G,a&&(this._$AH=t);else{const i=t;let r,n;for(t=o[0],r=0;r<o.length-1;r++)n=Q(this,i[s+r],e,r),n===G&&(n=this._$AH[r]),a||=!R(n)||n!==this._$AH[r],n===q?t=q:t!==q&&(t+=(n??"")+o[r+1]),this._$AH[r]=n}a&&!i&&this.j(t)}j(t){t===q?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class it extends st{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===q?void 0:t}}class ot extends st{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==q)}}class at extends st{constructor(t,e,s,i,o){super(t,e,s,i,o),this.type=5}_$AI(t,e=this){if((t=Q(this,t,e,0)??q)===G)return;const s=this._$AH,i=t===q&&s!==q||t.capture!==s.capture||t.once!==s.once||t.passive!==s.passive,o=t!==q&&(s===q||i);i&&this.element.removeEventListener(this.name,this,s),o&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){"function"==typeof this._$AH?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}}class rt{constructor(t,e,s){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(t){Q(this,t)}}const nt=w.litHtmlPolyfillSupport;nt?.(Y,et),(w.litHtmlVersions??=[]).push("3.3.3");const lt=globalThis;
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`;function wt(t){const e=new Set;for(const s of Object.keys(t.states)){const t=$t(s).match(vt);t&&e.add(t[1])}return[...e].sort()}function St(t){return wt(t).filter(e=>e.startsWith("st")&&!!t.states[`switch.sf_${e}_outlet_1`]||Object.keys(t.states).some(t=>{const s=$t(t);return s===`sf_${e}_temperature`||s===`sf_${e}_soil_avg_temperature`||s===`sf_${e}_light_1`||s===`sf_${e}_fan`||s===`sf_${e}_blower`}))}function Ot(t,e){const s=`sf_${e}_`,i=Object.keys(t.states);return i.find(t=>$t(t)===`sf_${e}_temperature`)??i.find(t=>{const i=$t(t);return i.startsWith(s)&&!i.startsWith(`sf_${e}_env_`)})}function kt(t,e){const s=Ot(t,e);return s?t.entities?.[s]?.device_id:void 0}function Ct(t,e){if(!e)return[];const s=kt(t,e);return s?function(t){return wt(t).filter(e=>!!t.states[`switch.sf_${e}_outlet_1`])}(t).filter(i=>{if(i===e)return!1;const o=kt(t,i),a=o?t.devices?.[o]:void 0;return a?.via_device_id===s}):[]}function Mt(t,e){if(!t||!e)return"";const s=Ot(t,e);if(!s)return"";const i=t.entities?.[s]?.device_id,o=i?t.devices?.[i]:void 0;if(o)return o.name_by_user||o.name||"";const a=(t.states[s].attributes.friendly_name||"").match(/^(SF .+? [0-9A-Fa-f]{4})\b/);return a?a[1]:""}const Dt=[["temperature","Air Temp","mdi:thermometer"],["humidity","Air Humi","mdi:water-percent"],["vpd","Air VPD","mdi:water-opacity"],["leaf_vpd","Leaf VPD","mdi:leaf"],["co2","CO2","mdi:molecule-co2"],["ppfd","PPFD","mdi:white-balance-sunny"],["soil_avg_temperature","Soil Temp","mdi:thermometer"],["soil_avg_moisture","Moisture","mdi:water"],["soil_avg_ec","Soil EC","mdi:flash"]],At={temperature:"temp",humidity:"humi",vpd:"vpd",co2:"co2",ppfd:"ppfd",soil_avg_temperature:"tempSoil",soil_avg_moisture:"humiSoil",soil_avg_ec:"ECSoil"},Nt={temperature:"temp",humidity:"humi",co2:"co2"},Tt="#ff6b6b",Rt="rgba(255,107,107,0.16)",Et=(t,e=.16)=>{const s=/^#?([0-9a-fA-F]{6})$/.exec((t||"").trim());if(!s)return`rgba(255,107,107,${e})`;const i=parseInt(s[1],16);return`rgba(${i>>16&255},${i>>8&255},${255&i},${e})`},Pt=t=>"string"==typeof t&&/^#[0-9a-fA-F]{6}$/.test(t),Lt=t=>"alarms"===t||"targets"===t||"both"===t,Ft=mt,zt={"Time Slot":["ts_type","ts_start","ts_stop"],Cycle:["cycle_start","cycle_run","cycle_off","cycle_times"],Temperature:["temp_device"],Humidity:["humidity_device"],CO2:["co2_device"],"Drip Irrigation":["drip_soil","drip_avg"],Manual:[]},Bt=mt,It=t=>!!t&&("unavailable"===t.state||"unknown"===t.state),Ht=t=>{const e=(t||"").match(/^(\d{1,2}):(\d{2})$/);if(!e)return null;const s=+e[1],i=+e[2];return s<=23&&i<=59?60*s+i:null},jt=(t,e,s,i,o="")=>W`<div class="save-bar ${o}">
  ${((t,e,s,i)=>W`
  ...
  <button class="discard-btn" ?disabled=${!e}
    @click=${i}>Discard</button>`)(t,e,s,i)}
      ...
      <div class="pg-stats">
        ...
        ${p?W`<span>band <b>${h(p.bandLo)}–${h(p.bandHi)}</b> ${i}</span>`:q}
      </div>
      <div class="pg-plot">
        <div class="pg-yax"><span>${h(b)}</span><span>${h(_)}</span></div>
        <svg viewBox="0 0 ${m} ${g}" preserveAspectRatio="none" class="pg-svg">
          ${p?V`
            <rect x="0" y=${w(p.warnHi).toFixed(1)} width=${m} height=${(w(p.bandHi)-w(p.warnHi)).toFixed(1)} fill=${Et(this.colWarn,.16)}></rect>
            <rect x="0" y=${w(p.bandLo).toFixed(1)} width=${m} height=${(w(p.warnLo)-w(p.bandLo)).toFixed(1)} fill=${Et(this.colWarn,.16)}></rect>
            <rect x="0" y=${w(p.bandHi).toFixed(1)} width=${m} height=${(w(p.bandLo)-w(p.bandHi)).toFixed(1)} fill=${Et(this.colIn,.2)}></rect>
            ${A(p.bandHi,this.colIn)}${A(p.bandLo,this.colIn)}`:q}
          <path d=${O} fill=${Et(k,.12)} stroke="none"></path>
          <path d=${S} fill="none" stroke=${k} stroke-width="2"></path>
          <circle cx=${y(o[C].t).toFixed(1)} cy=${w(r).toFixed(1)} r="2.5" fill=${this.colLo}></circle>
          <circle cx=${y(o[M].t).toFixed(1)} cy=${w(n).toFixed(1)} r="2.5" fill=${this.colHi}></circle>
    ...
    </div>`}soilCellStyle(t,e){const s=this.get(`sensor.sf_${this.config.panel}_${t}_${e}`);if(!s||It(s))return"";const i="temperature"===e?"tempSoil":"moisture"===e?"humiSoil":"ECSoil",o=this.readingColor(i,s.state);return o?`color:${o.color}`:""}getCardSize(){return 8}static getConfigElement(){return document.createElement("spider-farmer-card-editor")}static getStubConfig(t){const e=(t?St(t):[])[0]||"dp1",s=t?Ct(t,e):[];return{type:"custom:spider-farmer-card",panel:e,...s.length?{outlets:s}:{}}}eid(t,e){return`${t}.sf_${this.config.panel}_${e}`}get(t){return this.hass?.states[t]}accent(){return this.config.accent||mt}shouldUpdate(t){return t.has("config")||t.has("hass")||t.has("tab")||t.has("soilOpen")||t.has("soilAllOpen")||t.has("outletDraft")||t.has("outletNameDraft")||t.has("outletCfgDraft")||t.has("alertsDraft")||t.has("deviceOpen")||t.has("outletOpen")||t.has("draft")||t.has("modePick")||t.has("logDate")||t.has("logDev")||t.has("logType")||t.has("colorMode")||t.has("colorModeIn")||t.has("colHi")||t.has("colLo")||t.has("colIn")||t.has("hideLight2")||t.has("colorDraft")||t.has("outletColorMode")||t.has("ocManual")||t.has("ocSched")||t.has("ocEnv")||t.has("ocDrip")||t.has("deviceColorMode")||t.has("dcManual")||t.has("dcSched")||t.has("dcAuto")||t.has("colorSource")||t.has("colWarn")||t.has("showTrend")||t.has("showBand")||t.has("paramOpen")||t.has("_graphVer")||t.has("showTargets")||t.has("tileSummary")||t.has("leafSpots")||t.has("leafCalTarget")||t.has("customOutletNames")||t.has("outletNames")||t.has("customLayout")||t.has("cardScale")||t.has("tileCols")}willUpdate(t){if(!this._colorSynced){const t=this.serverColors();Object.keys(t).length&&(t.mode&&(this.colorMode=t.mode),t.modeIn&&(this.colorModeIn=t.modeIn),t.source&&(this.colorSource=t.source),t.warn&&(this.colWarn=t.warn),void 0!==t.showTrend&&(this.showTrend=t.showTrend),void 0!==t.showBand&&(this.showBand=t.showBand),void 0!==t.showTargets&&(this.showTargets=t.showTargets),void 0!==t.tileSummary&&(this.tileSummary=t.tileSummary),t.hi&&(this.colHi=t.hi),t.lo&&(this.colLo=t.lo),t.in&&(this.colIn=t.in),void 0!==t.hide2&&(this.hideLight2=t.hide2),t.omode&&(this.outletColorMode=t.omode),t.ocManual&&(this.ocManual=t.ocManual),t.ocSched&&(this.ocSched=t.ocSched),t.ocEnv&&(this.ocEnv=t.ocEnv),t.ocDrip&&(this.ocDrip=t.ocDrip),t.dmode&&(this.deviceColorMode=t.dmode),t.dcManual&&(this.dcManual=t.dcManual),t.dcSched&&(this.dcSched=t.dcSched),t.dcAuto&&(this.dcAuto=t.dcAuto),void 0!==t.customNames&&(this.customOutletNames=t.customNames),void 0!==t.customLayout&&(this.customLayout=t.customLayout),t.scale&&(this.cardScale=t.scale),t.cols&&(this.tileCols=t.cols),this._colorSynced=!0,this.cacheColors());const e=this.serverOutletNames();Object.keys(e).length&&(this.outletNames=e)}if(t.has("tab")&&(null!==this.colorDraft&&(this.colorDraft=null),null!==this.alertsDraft&&(this.alertsDraft=null),Object.keys(this.draft).length&&(this.draft={}),Object.keys(this.outletDraft).length&&(this.outletDraft={}),Object.keys(this.outletNameDraft).length&&(this.outletNameDraft={}),Object.keys(this.outletCfgDraft).length&&(this.outletCfgDraft={}),Object.keys(this.modePick).length&&(this.modePick={})),t.has("hass")&&this.recordHistory(),t.has("hass")&&Object.keys(this.modePick).length){let t=null;for(const[e,s]of Object.entries(this.modePick))this.get(e)?.state===s&&(t=t??{...this.modePick},delete t[e]);t&&(this.modePick=t)}}renderParam([t,e,s]){const i=this.get(`sensor.sf_${this.config.panel}_${t}`);if(!i)return q;const o=i.attributes.unit_of_measurement||"",a=t.startsWith("soil_avg_")&&It(i),r=a?"Offline":this.hass?.formatEntityState?this.hass.formatEntityState(i).replace(o,"").trim():i.state,n=t.startsWith("soil_avg_")?t.slice(9):null,l=!!n&&this.soilProbeRows(n).length>1,c=l&&this.soilOpen===n;let d;const h=this.paramOpen===t;if(a)d=null;else{const e=parseFloat(i.state);if(Number.isFinite(e)){const s="targets"!==this.colorSource?this.outOfRange(At[t],e):null,i="alarms"!==this.colorSource||"leaf_vpd"===t?this.targetOutOfRange(t,e):null;d=this.colorForOor(s??i)}else d=null}const p=!a&&!l;let u=c||h?`box-shadow:inset 0 0 0 1px ${this.accent()}`:"",f="";a?(u=`background:${Rt};box-shadow:inset 0 0 0 1px ${Tt}`,f=`color:${Tt}`):d&&"text"===d.mode?f=`color:${d.color}`:d&&"tile"===d.mode&&(u=`background:${Et(d.color)};box-shadow:inset 0 0 0 1px ${d.color}`);const m=l||p;return W`
      <div class="tile ${m?"clickable":""} ${c||h?"active":""}"
        style=${u||q}
        role=${m?"button":q}
        @click=${l?()=>this.soilOpen=c?null:n:p?()=>this.toggleGraph(t):void 0}>
        <div class="tile-label">
          <span class="tl-name">${e}</span>
          <span class="tl-right">
            ${this.trendIcon(t)}
            ${l?W`<ha-icon class="tile-more"
                  icon=${c?"mdi:chevron-up":"mdi:chevron-down"}></ha-icon>`:p?W`<ha-icon class="tile-more"
                  icon=${h?"mdi:chevron-up":"mdi:chart-line"}></ha-icon>`:q}
          </span>
        </div>
        <ha-icon icon="${s}" style="color:${this.accent()}"></ha-icon>
        <div class="tile-val" style=${f||q}>${r}${a?q:W`<span class="unit">${o}</span>`}</div>
        ${a?q:this.targetSubline(t,o)}
        ${a?q:this.renderBand(t,parseFloat(i.state))}
      </div>`}soilProbeRows(t){const e=new RegExp(`^sf_${this.config.panel}_(soil\\d+)_${t}$`),s=[];for(const i of Object.keys(this.hass?.states??{})){const o=$t(i).match(e);o&&s.push({slot:o[1],name:this.soilSensorName(i,t),e:this.hass.states[i]})}return s.sort((t,e)=>Number(t.slot.replace(/\D/g,""))-Number(e.slot.replace(/\D/g,""))),s.map(({name:t,e:e})=>({name:t,e:e}))}soilSensorName(t,e){let s=this.hass?.states[t]?.attributes.friendly_name??"";const i=Mt(this.hass,this.config.panel);i&&s.startsWith(i)&&(s=s.slice(i.length).trim());const o="temperature"===e?"Temperature":"moisture"===e?"Moisture":"EC";return s=s.replace(new RegExp(`\\s*${o}\\s*$`,"i"),"").trim(),s||$t(t)}renderSoilPop(){const t=this.soilOpen;if(!t)return q;const e=this.soilProbeRows(t);if(!e.length)return q;return W`
      <div class="soil-pop">
        ...
        ${e.map(({name:e,e:s})=>{const i=It(s),o=s.attributes.unit_of_measurement||"",a=this.hass?.formatEntityState?this.hass.formatEntityState(s).replace(o,"").trim():s.state,r="temperature"===t?"tempSoil":"moisture"===t?"humiSoil":"ECSoil",n=i?null:this.readingColor(r,s.state);return W`
            <div class="soil-pop-row ${i?"offline":""}">
              <span class="spn">${e}</span>
              <span class="spv" style=${n?`color:${n.color}`:q}>${i?W`Offline`:W`${a}<span class="unit">${o}</span>`}</span>
            </div>`})}
      </div>`}soilProbeSlots(){const t=new RegExp(`^sf_${this.config.panel}_(soil\\d+)_(temperature|moisture|ec)$`),e=new Set;for(const s of Object.keys(this.hass?.states??{})){const i=$t(s).match(t);i&&e.add(i[1])}return[...e].sort((t,e)=>Number(t.replace(/\D/g,""))-Number(e.replace(/\D/g,"")))}probeOffline(t){const e=this.get(`sensor.sf_${this.config.panel}_${t}_temperature`)??this.get(`sensor.sf_${this.config.panel}_${t}_moisture`)??this.get(`sensor.sf_${this.config.panel}_${t}_ec`);return It(e)}soilCellValue(t,e){const s=this.get(`sensor.sf_${this.config.panel}_${t}_${e}`);return s&&"unknown"!==s.state&&"unavailable"!==s.state?this.hass?.formatEntityState?this.hass.formatEntityState(s):`${s.state}${s.attributes.unit_of_measurement??""}`:"—"}probeNameForSlot(t){for(const e of["temperature","moisture","ec"]){const s=`sensor.sf_${this.config.panel}_${t}_${e}`;if(this.hass?.states[s])return this.soilSensorName(s,e)}return t.replace(/^soil(\d+)$/,"Soil $1")}soilStatsTile(){const t=this.soilProbeSlots();if(t.length<2)return q;const e=this.soilAllOpen,s=this.accent(),i=t.filter(t=>this.probeOffline(t)).length,o=i?`background:${Rt};box-shadow:inset 0 0 0 1px ${Tt}`:e?`box-shadow:inset 0 0 0 1px ${s}`:"",a=i?`${i} offline`:`${t.length} probes`;return W`
      ...
      </div>`}deviceSummaryRow(t){const e=this.deviceSummaryLines(t);return e.length?W`<div class="tile-summary">
          ${e.map(t=>W`<span>${t}</span>`)}
        </div>`:q}shortDur(t){const e=/^(\d+):(\d{2})(?::(\d{2}))?$/.exec((t||"").trim());if(!e)return t||"";const s=+e[1],i=+e[2],o=+(e[3]??0);return s?i?`${s}h${i}m`:`${s}h`:i?o?`${i}m${o}s`:`${i}m`:`${o}s`}deviceSummaryLines(t){const e=this.config.panel,s=t.suffix,i=t=>{const e=this.get(t);return e&&"unknown"!==e.state&&"unavailable"!==e.state?e.state:""},o={"Prioritize temperature":"Pri Temp","Prioritize humidity":"Pri Humid","Temperature only":"Temp","Humidity only":"Humid","Temperature & humidity":"Temp/Humid"},a=[];if("light"===t.domain){const t=this.modeOf(`select.sf_${e}_${s}_mode`)||"";if(!t||"unavailable"===t||"unknown"===t)return[];a.push(t);const o=i(`text.sf_${e}_${s}_schedule_start`),r=i(`text.sf_${e}_${s}_schedule_stop`);return o&&r&&("00:00"!==o||"00:00"!==r)&&a.push(`${o}–${r}`),a}if("blower"===s||"fan"===s){const t=this.modeOf(`select.sf_${e}_${s}_mode_set`)||"";if(!t||"unavailable"===t||"unknown"===t)return[];if("Manual"===t)return a.push("Manual"),a;const r=t=>"blower"===s?`${t}%`:`L${t}`,n=i("blower"===s?`number.sf_${e}_blower_running_speed`:`number.sf_${e}_fan_schedule_gear`),l=i(`number.sf_${e}_${s}_standby_speed`),c="0"===n?"Auto":n?r(n):"",d=l&&"0"!==l?r(l):"Off",h=c?`${c} · Stby ${d}`:"";if("Environment"===t){const t=this.modeOf(`select.sf_${e}_${s}_run_mode`);a.push(t?`Enviro · ${o[t]??t}`:"Enviro"),h&&a.push(h)}else if("Time Slot"===t){a.push("Schedule");const t=i(`text.sf_${e}_${s}_schedule_start`),o=i(`text.sf_${e}_${s}_schedule_stop`);t&&o&&a.push(`${t}–${o}`),h&&a.push(h)}else if("Cycle"===t){a.push("Cycle");const t=i(`text.sf_${e}_${s}_cycle_run`),o=i(`text.sf_${e}_${s}_cycle_off`);t&&o&&a.push(`${this.shortDur(t)} on · ${this.shortDur(o)} off`),h&&a.push(h)}return a}if("heater"===s||"humidifier"===s||"dehumidifier"===s){const t=this.modeOf(`select.sf_${e}_${s}_mode_set`)||"";if(!t||"unavailable"===t||"unknown"===t)return[];if("Manual"===t)return a.push("Manual"),a;if("Time Slot"===t){a.push("Schedule");const t=i(`text.sf_${e}_${s}_schedule_start`),o=i(`text.sf_${e}_${s}_schedule_stop`);t&&o&&a.push(`${t}–${o}`)}else if("Cycle"===t){a.push("Cycle");const t=i(`text.sf_${e}_${s}_cycle_run`),o=i(`text.sf_${e}_${s}_cycle_off`);t&&o&&a.push(`${this.shortDur(t)} on · ${this.shortDur(o)} off`)}else{const o="Temperature"===t?"Temp":"Humidity"===t?"Humid":t;let r="";if("humidifier"===s){const t=i(`select.sf_${e}_humidifier_gear`);r=t?"Automatic"===t?"Auto":`L${t}`:""}else if("heater"===s){const t=i(`select.sf_${e}_heater_gear`);r=t?"Automatic"===t?"Auto":`L${t}`:""}else r=i(`select.sf_${e}_dehumidifier_gear`)||i(`select.sf_${e}_dehumidifier_level_set`)||"";a.push(r?`${o} · ${r}`:o)}return a}return[]}relatedControls(t,e){const s=this.config.panel,i=new RegExp(`^(number|select|switch|text)\\.sf_${s}_${t}(_|$)`),o=`switch.sf_${s}_${t}`,a=`number.sf_${s}_${t}_speed`,r=Mt(this.hass,this.config.panel);return Object.keys(this.hass?.states??{}).filter(t=>i.test(t)&&t!==o&&!("fan"===e&&t===a)).sort().map(t=>{let e=this.hass?.states[t]?.attributes.friendly_name??"";return r&&e.startsWith(r)&&(e=e.slice(r.length).trim()),this.ctlRow(e||t,t)})}renderDevicePop(){const t=this.deviceOpen;if(!t)return q;const e=this.overviewDevices().find(e=>`${e.domain}:${e.suffix}`===t);if(!e)return q;const s=this.get(e.id);if(!s)return q;const i="light"===e.domain?this.renderLightBody(e,s):"fan"===e.suffix?this.renderFanBody(e,s):"blower"===e.suffix?this.renderBlowerBody(e,s):"heater"===e.suffix?this.renderHeaterBody(e,s):"dehumidifier"===e.suffix?this.renderDehumidifierBody(e,s):"humidifier"===e.suffix?this.renderHumidifierBody(e,s):this.renderGenericBody(e,s);return W`
      <div class="soil-pop" style="--sf-accent:${this.accent()}">
        ...
        ${i}
      </div>`}devOn(t,e){const s=`power:${t}`;return s in this.draft?"on"===this.draft[s]:e}powerRow(t,e,s,i){const o=`power:${t}`,a=this.devOn(t,i),r=this.accent();return W`
      ...
      <div class="params-head">
        ...
        ${s}
      </div>`}renderOverview(){const t=Dt.map(t=>this.renderParam(t)).filter(t=>t!==q),e=this.soilStatsTile(),s=this.overviewDevices();return W`
      ...
      @change=${e=>this.stage(t,e.target.value)} />`}durationInput(t){const e=(this.draftVal(t)||"").trim(),s=/^(\d+):(\d{1,2})(?::(\d{1,2}))?$/.exec(e),i=s?+s[1]:0,o=s?+s[2]:0,a=s?+(s[3]??0):0,r=t=>String(t).padStart(2,"0"),n=(e,s,i)=>this.stage(t,`${r(Math.max(0,Math.min(99,e)))}:${r(Math.max(0,Math.min(59,s)))}:${r(Math.max(0,Math.min(59,i)))}`),l=(t,e,s,i)=>W`
      <span class="dur-box">
      ...
      ${l(a,59,"s",t=>n(i,o,t))}
    </span>`}numOpts(t,e,s=1,i=String){const o=[],a=(String(s).split(".")[1]||"").length,r=s>0?Math.round((e-t)/s):0;for(let e=0;e<=r;e++){const r=Number((t+e*s).toFixed(a));o.push({label:i(r),value:String(r)})}return o}offOpts(t,e,s=1,i){return[{label:"Off",value:"0"},...this.numOpts(t,e,s,i)]}autoOpts(t,e,s=1,i){return[{label:"Automatic",value:"0"},...this.numOpts(t,e,s,i)]}optSelect(t,e,s=!1){if(!this.get(t))return q;const i=this.draftVal(t),o=e.find(t=>Number(t.value)===Number(i))?.value??e.find(t=>t.value===i)?.value??i;return W`<select @change=${e=>{const i=e.target.value;s?this.hass?.callService("number","set_value",{entity_id:t,value:Number(i)}):this.stage(t,i)}}>
      ${e.map(t=>W`
      ...
      @click=${()=>this.stage(t,e?"off":"on")} aria-label="Toggle"></button>`}stagedCtl(t,e,s){const i=this.get(t);if(!i)return q;const o=e??i.attributes.friendly_name??t.split(".")[1],a="switch"===t.split(".")[0]?this.stagedSwitch(t):this.stagedInput(t,s),r=t in this.draft;return W`
      ...
      </div>`:q}renderEnv(){const t=this.config.panel;if(!this.hasEnv())return W`<div class="cali-empty">No environment targets reported for this device yet.</div>`;const e=`text.sf_${t}_env_day_start`,s=`text.sf_${t}_env_day_end`,i=this.get(e)||this.get(s);return W`
      <div class="section-label">Environment</div>
      ${i?W`<div class="env-cycle">
            ${this.stagedCtl(e,"Day Cycle Start","time")}
            ${this.stagedCtl(s,"Day Cycle Stop","time")}
          </div>`:q}
      ${Gt.map(([e,s,i,o,a])=>this.get(`number.sf_${t}_${s}`)?W`
          <div class="env-row">
      ...
      </div>`:q}renderLeafVpdTargets(){const t=this.get(this.eid("number","leaf_vpd_min")),e=this.get(this.eid("number","leaf_vpd_max"));if(!t||!e)return q;const s=(t,e)=>{const s=this.eid("number",t);return W`
      ...
      </span>`}renderOutlets(){const t=this.outletSlots().filter(t=>this.outletNums(t).length>0);if(!t.length)return q;const e=this.outletOpen?this.outletOpen.slice(0,this.outletOpen.lastIndexOf("_")):null;return W`
      ${t.map(t=>{const s=Mt(this.hass,t)||(t.startsWith("st")?"S-Station":`${t.toUpperCase()} Power Strip`);return W`
      ...
      </div>`}clearOutletCfgDraft(t,e){const s=this.outletKey(t,e);if(!(s in this.outletCfgDraft))return;const i={...this.outletCfgDraft};delete i[s],this.outletCfgDraft=i}renderOutletModeConfig(t,e,s){const i=this.outletKey(t,e),o=this.outletCfgDraft[i]??{},a=(t,e)=>this.outletCfgDraft={...this.outletCfgDraft,[i]:{...o,[t]:e}},r=(t,e,s,i)=>W`
      <div class="dev-row ${e in o?"staged":""}">
        <span class="dev-lbl">${t}</span>
        <span class="num-box">
          <input type="number" min="0" max="1440" .value=${o[e]??String(s)}
            @change=${t=>a(e,t.target.value)} />
          ${i?W`<span class="unit">${i}</span>`:q}
        </span>
      </div>`,n=(t,e,s)=>W`
      <div class="dev-row ${e in o?"staged":""}">
        <span class="dev-lbl">${t}</span>
      ...
      <div class="ts-editor">
        ...
        </div>`}),i=this.renderLeafVpdCalibration();return e.length||s.length||i!==q?W`
      ...
      ${jt(s,e,()=>this.saveAlerts(),()=>this.alertsDraft=null,"apply-bar")}`}renderAlertGroup(t,e,s){const i=t[e]||[];return i.length?W`
      ...
      ${o.length?W`
            ...
            </div>`:W`<div class="cali-empty">No log entries on this date.</div>`}`}render(){if(!this.hass||!this.config)return q;const t=this.hasOutlets();let e=this.tab;"outlets"!==e||t||(e="overview");const s=this.accent(),i=(t,i)=>W`<button class="tab ${e===t?"active":""}"
        style=${e===t?`color:${s};border-color:${s}`:""}
        @click=${()=>this.tab=t}>${i}</button>`,o=Mt(this.hass,this.config.panel);return W`
      <ha-card style=${this.layoutStyle()||q}>
        <div class="header">
          <span class="title">${this.config.title||"Spider Farmer"}</span>
          ${o?W`<span class="device">${o}</span>`:q}
        </div>
        ${W`<div class="tabs">
              ${i("overview","Overview")}
              ${i("env","Environment")}
      ...
      </details>`}renderSettings(){const t=this.accent(),e=this.colorDraft,s=e?.mode??this.colorMode,i=e?.modeIn??this.colorModeIn,o=e?.hi??this.colHi,a=e?.lo??this.colLo,r=e?.in??this.colIn,n=e?.warn??this.colWarn,l=e?.showTrend??this.showTrend,c=e?.showBand??this.showBand,d=e?.showTargets??this.showTargets,h=e?.tileSummary??this.tileSummary,p=e?.customNames??this.customOutletNames,u=e?.customLayout??this.customLayout,f=e?.scale??this.cardScale,m=e?.cols??this.tileCols,g=!!this.get(this.eid("light","light_2")),v=e?.omode??this.outletColorMode,$=e?.ocManual??this.ocManual,_=e?.ocSched??this.ocSched,b=e?.ocEnv??this.ocEnv,x=e?.ocDrip??this.ocDrip,y=this.hasOutlets(),w=e?.dmode??this.deviceColorMode,S=e?.dcManual??this.dcManual,O=e?.dcSched??this.dcSched,k=e?.dcAuto??this.dcAuto,C=this.overviewDevices().length>0,M=!!e&&(void 0!==e.mode&&e.mode!==this.colorMode||void 0!==e.modeIn&&e.modeIn!==this.colorModeIn||void 0!==e.source&&e.source!==this.colorSource||void 0!==e.warn&&e.warn!==this.colWarn||void 0!==e.showTrend&&e.showTrend!==this.showTrend||void 0!==e.showBand&&e.showBand!==this.showBand||void 0!==e.showTargets&&e.showTargets!==this.showTargets||void 0!==e.tileSummary&&e.tileSummary!==this.tileSummary||void 0!==e.hi&&e.hi!==this.colHi||void 0!==e.lo&&e.lo!==this.colLo||void 0!==e.in&&e.in!==this.colIn||void 0!==e.hide2&&e.hide2!==this.hideLight2||void 0!==e.customNames&&e.customNames!==this.customOutletNames||void 0!==e.customLayout&&e.customLayout!==this.customLayout||void 0!==e.scale&&e.scale!==this.cardScale||void 0!==e.cols&&e.cols!==this.tileCols||void 0!==e.omode&&e.omode!==this.outletColorMode||void 0!==e.ocManual&&e.ocManual!==this.ocManual||void 0!==e.ocSched&&e.ocSched!==this.ocSched||void 0!==e.ocEnv&&e.ocEnv!==this.ocEnv||void 0!==e.ocDrip&&e.ocDrip!==this.ocDrip||void 0!==e.dmode&&e.dmode!==this.deviceColorMode||void 0!==e.dcManual&&e.dcManual!==this.dcManual||void 0!==e.dcSched&&e.dcSched!==this.dcSched||void 0!==e.dcAuto&&e.dcAuto!==this.dcAuto),D=t=>this.colorDraft={...this.colorDraft??{},...t},A=(e,s,i,o,a)=>W`
      <button class="seg ${e===s?"on":""}"
        style=${e===s?`border-color:${t};color:${t}`:q}
        @click=${a}>
        <ha-icon icon=${o}></ha-icon><span>${i}</span>
      </button>`,N=e?.source??this.colorSource,T=(e,s,i)=>W`
      <button class="seg ${N===e?"on":""}"
        style=${N===e?`border-color:${t};color:${t}`:q}
        @click=${()=>D({source:e})}>
      ...
      <div class="seg-row">
        ${T("alarms","Alarms","mdi:bell-outline")}
        ${T("targets","Targets","mdi:target")}
        ${T("both","Both","mdi:set-center")}
      </div>
      ...
      <div class="seg-row">
        ${A(s,"off","No color","mdi:circle-off-outline",()=>D({mode:"off"}))}
        ${A(s,"tile","Tile color","mdi:square-rounded",()=>D({mode:"tile"}))}
        ${A(s,"text","Text color","mdi:format-color-text",()=>D({mode:"text"}))}
      </div>
      <div class="color-row">
        ${R("Above max",o,t=>D({hi:t}))}
        ${R("Below min",a,t=>D({lo:t}))}
        ${R("Near edge",n,t=>D({warn:t}))}
      </div>
      ...
      <div class="seg-row">
        ${A(i,"off","No color","mdi:circle-off-outline",()=>D({modeIn:"off"}))}
        ${A(i,"tile","Tile color","mdi:square-rounded",()=>D({modeIn:"tile"}))}
        ${A(i,"text","Text color","mdi:format-color-text",()=>D({modeIn:"text"}))}
      </div>
      <div class="color-row">
        ${R("In range",r,t=>D({in:t}))}
      </div>
      ...
      ${y?W`
            ...
            <div class="set-note">
              ...
              <span style="color:${$}">Manual</span>,
              <span style="color:${_}">Scheduled</span>,
              <span style="color:${b}">Environment</span>,
              <span style="color:${x}">Drip</span>. Off outlets stay neutral.
            </div>
            <div class="seg-row">
              ${A(v,"off","No color","mdi:circle-off-outline",()=>D({omode:"off"}))}
              ${A(v,"tile","Tile color","mdi:square-rounded",()=>D({omode:"tile"}))}
              ${A(v,"text","Text color","mdi:format-color-text",()=>D({omode:"text"}))}
            </div>
            <div class="color-row">
              ${R("Manual",$,t=>D({ocManual:t}))}
              ${R("Scheduled",_,t=>D({ocSched:t}))}
            </div>
            <div class="color-row">
              ${R("Environment",b,t=>D({ocEnv:t}))}
              ${R("Drip",x,t=>D({ocDrip:t}))}
            </div>`:q}
      ...
      ${C?W`
            ...
            <div class="set-note">
              ...
              <span style="color:${S}">Manual</span>,
              <span style="color:${O}">Scheduled</span>,
              <span style="color:${k}">Auto</span> (Environment / PPFD). A
              <span style="color:${Tt}">fault</span> always overrides.
            </div>
            <div class="seg-row">
              ${A(w,"off","No color","mdi:circle-off-outline",()=>D({dmode:"off"}))}
              ${A(w,"tile","Tile color","mdi:square-rounded",()=>D({dmode:"tile"}))}
              ${A(w,"text","Text color","mdi:format-color-text",()=>D({dmode:"text"}))}
            </div>
            <div class="color-row">
              ${R("Manual",S,t=>D({dcManual:t}))}
              ${R("Scheduled",O,t=>D({dcSched:t}))}
              ${R("Auto",k,t=>D({dcAuto:t}))}
            </div>`:q}
      ...
      <div class="toggle-row">
        ...
        <button class="toggle ${u?"on":""}"
          ...
          @click=${()=>D({customLayout:!u})}></button>
      </div>
      ${u?W`
        <div class="set-note" style="margin-top:10px;display:flex;justify-content:space-between">
          <span>Scale</span><span style="color:${t};font-weight:500">${f}%</span>
        </div>
        <input type="range" min="70" max="150" step="5" .value=${String(f)}
          style="width:100%"
          @input=${t=>D({scale:Number(t.target.value)})} />
        ...
        <div class="seg-row" style="grid-template-columns:repeat(4,1fr)">
          ${[2,3,4,5].map(e=>W`
            <button class="seg ${m===e?"on":""}"
              style=${m===e?`border-color:${t};color:${t}`:q}
              @click=${()=>D({cols:e})}><span>${e}</span></button>`)}
        </div>`:q}
      ${jt(t,M,()=>{const t=this.colorDraft;t&&(void 0!==t.mode&&t.mode!==this.colorMode&&(this.colorMode=t.mode,this.persistColorOption("colors",t.mode)),void 0!==t.modeIn&&t.modeIn!==this.colorModeIn&&(this.colorModeIn=t.modeIn,this.persistColorOption("colors_in",t.modeIn)),void 0!==t.source&&t.source!==this.colorSource&&(this.colorSource=t.source,this.persistColorOption("color_source",t.source)),void 0!==t.warn&&t.warn!==this.colWarn&&(this.colWarn=t.warn,this.persistColorOption("color_warn",t.warn)),void 0!==t.showTrend&&t.showTrend!==this.showTrend&&(this.showTrend=t.showTrend,this.persistColorOption("show_trend",t.showTrend?"1":"0")),void 0!==t.showBand&&t.showBand!==this.showBand&&(this.showBand=t.showBand,this.persistColorOption("show_band",t.showBand?"1":"0")),void 0!==t.showTargets&&t.showTargets!==this.showTargets&&(this.showTargets=t.showTargets,this.persistColorOption("show_targets",t.showTargets?"1":"0")),void 0!==t.tileSummary&&t.tileSummary!==this.tileSummary&&(this.tileSummary=t.tileSummary,this.persistColorOption("tile_summary",t.tileSummary?"1":"0")),void 0!==t.hi&&t.hi!==this.colHi&&(this.colHi=t.hi,this.persistColorOption("color_hi",t.hi)),void 0!==t.lo&&t.lo!==this.colLo&&(this.colLo=t.lo,this.persistColorOption("color_lo",t.lo)),void 0!==t.in&&t.in!==this.colIn&&(this.colIn=t.in,this.persistColorOption("color_in",t.in)),void 0!==t.hide2&&t.hide2!==this.hideLight2&&(this.hideLight2=t.hide2,this.persistColorOption("hide_light2",t.hide2?"1":"0")),void 0!==t.customNames&&t.customNames!==this.customOutletNames&&(this.customOutletNames=t.customNames,this.persistColorOption("custom_outlet_names",t.customNames?"1":"0")),void 0!==t.customLayout&&t.customLayout!==this.customLayout&&(this.customLayout=t.customLayout,this.persistColorOption("custom_layout",t.customLayout?"1":"0")),void 0!==t.scale&&t.scale!==this.cardScale&&(this.cardScale=t.scale,this.persistColorOption("card_scale",String(t.scale))),void 0!==t.cols&&t.cols!==this.tileCols&&(this.tileCols=t.cols,this.persistColorOption("tile_cols",String(t.cols))),void 0!==t.omode&&t.omode!==this.outletColorMode&&(this.outletColorMode=t.omode,this.persistColorOption("outlet_colors",t.omode)),void 0!==t.ocManual&&t.ocManual!==this.ocManual&&(this.ocManual=t.ocManual,this.persistColorOption("oc_manual",t.ocManual)),void 0!==t.ocSched&&t.ocSched!==this.ocSched&&(this.ocSched=t.ocSched,this.persistColorOption("oc_sched",t.ocSched)),void 0!==t.ocEnv&&t.ocEnv!==this.ocEnv&&(this.ocEnv=t.ocEnv,this.persistColorOption("oc_env",t.ocEnv)),void 0!==t.ocDrip&&t.ocDrip!==this.ocDrip&&(this.ocDrip=t.ocDrip,this.persistColorOption("oc_drip",t.ocDrip)),void 0!==t.dmode&&t.dmode!==this.deviceColorMode&&(this.deviceColorMode=t.dmode,this.persistColorOption("device_colors",t.dmode)),void 0!==t.dcManual&&t.dcManual!==this.dcManual&&(this.dcManual=t.dcManual,this.persistColorOption("dc_manual",t.dcManual)),void 0!==t.dcSched&&t.dcSched!==this.dcSched&&(this.dcSched=t.dcSched,this.persistColorOption("dc_sched",t.dcSched)),void 0!==t.dcAuto&&t.dcAuto!==this.dcAuto&&(this.dcAuto=t.dcAuto,this.persistColorOption("dc_auto",t.dcAuto)),this._colorSynced=!0,this.cacheColors()),this.colorDraft=null},()=>this.colorDraft=null,"apply-bar")}`}}qt.styles=r`
    ${yt}
    ...
    .grid { display: grid; grid-template-columns: repeat(var(--sf-cols, 3), minmax(0, 1fr)); gap: 8px; }
    ...
    /* Mode summary block right under the tile's expand arrow: 2-3 short,
       centred lines kept light so the tile stays readable. */
    .tile-summary {
      display: flex; flex-direction: column; align-items: center; gap: 0;
      margin: 1px 0 2px; width: 100%;
    }
    .tile-summary span {
    ...
    /* Soil calibration: temp / moisture / ec (+ substrate) share one row. */
    .cali-soil-grid {
      display: grid; grid-template-columns: repeat(4, minmax(0, 1fr)); gap: 8px;
    }
  ...
  `,t([ut({attribute:!1})],Kt.prototype,"hass",void 0),t([ft()],Kt.prototype,"_config",void 0);const Jt=/^sf_(se\d+)_light$/;function Zt(t){const e=new Set;for(const s of Object.keys(t.states)){if(!s.startsWith("light."))continue;const t=$t(s).match(Jt);t&&e.add(t[1])}return[...e].sort((t,e)=>Number(t.replace(/\D/g,""))-Number(e.replace(/\D/g,"")))}class Xt extends ct{constructor(){super(...arguments),this.draft=null,this.ctlDraft={}}setConfig(t){this.config=t}getCardSize(){return 7}static getStubConfig(t){const e=t?Zt(t):[];return{type:"custom:spider-light-card",...e[0]?{light:e[0]}:{}}}accent(){return this.config.accent||mt}seSlot(){return this.config.light||(this.hass?Zt(this.hass)[0]:"")||"se1"}get(t){return this.hass?.states[t]}shouldUpdate(t){return t.has("config")||t.has("hass")||t.has("draft")||t.has("ctlDraft")}cur(t,e){return t in this.ctlDraft?this.ctlDraft[t]:e}stageCtl(t,e){this.ctlDraft={...this.ctlDraft,[t]:e}}isDirty(){return Object.keys(this.ctlDraft).length>0||null!==this.draft}applyAll(t){const e=this.ctlDraft,s=`light.sf_${t}_light`;if("bri"in e){const t=Number(e.bri);t>0?this.hass?.callService("light","turn_on",{entity_id:s,brightness_pct:t}):this.hass?.callService("light","turn_off",{entity_id:s})}"mode"in e&&this.hass?.callService("select","select_option",{entity_id:`select.sf_${t}_mode`,option:e.mode});for(const t of Object.keys(e))t.includes(".")&&(t.startsWith("number.")?this.hass?.callService("number","set_value",{entity_id:t,value:Number(e[t])}):t.startsWith("text.")&&this.hass?.callService("text","set_value",{entity_id:t,value:e[t]}));if("power"in e){const t="on"===e.power;t&&"bri"in e||this.hass?.callService("light",t?"turn_on":"turn_off",{entity_id:s})}this.draft&&this.saveSchedule(t),this.ctlDraft={}}discardAll(){Object.keys(this.ctlDraft).length&&(this.ctlDraft={}),null!==this.draft&&(this.draft=null)}render(){if(!this.hass||!this.config)return q;const t=this.seSlot(),e=this.get(`light.sf_${t}_light`);if(!e)return W`<ha-card>
      ...
      <ha-card>
        ...
        <div class="gauge">
          <svg viewBox="0 0 200 190" aria-hidden="true">
            ...
            ${c&&p>0?V`<path d=${bt(100,100,78,0,p)} fill="none"
    ...
    </div>`}numRow(t,e,s){const i=s.attributes.min??0,o=s.attributes.max??100,a=s.attributes.step??1,r=s.attributes.unit_of_measurement??"",n="unknown"===s.state||"unavailable"===s.state?"":s.state,l=this.cur(t,n);return W`<div class="num-row">
