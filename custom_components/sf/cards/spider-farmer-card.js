/*! spider-farmer-card v0.17.34 | MIT */
  ...
  <button class="discard-btn" ?disabled=${!e}
    @click=${i}>Discard</button>`)(t,e,s,i)}
      ...
      ${n?W`
            ...
            <div class="set-note">
              A phantom Light 2 tile? Hide it in the integration:
              Settings → Devices &amp; services → Spider Farmer Bridge →
              Configure → “Hide Light 2”. HA then skips the entity entirely.
            </div>`:q}
