/*! spider-farmer-card v0.20.6 | MIT */
...
`;function wt(t){const e=new Set;for(const s of Object.keys(t.states)){const t=bt(s).match(vt);t&&e.add(t[1])}return[...e].sort()}function St(t){return wt(t).filter(e=>Object.keys(t.states).some(t=>{const s=bt(t);return s===`sf_${e}_temperature`||s===`sf_${e}_soil_avg_temperature`||s===`sf_${e}_light_1`||s===`sf_${e}_fan`||s===`sf_${e}_blower`}))}function kt(t,e){const s=`sf_${e}_`,i=Object.keys(t.states);return i.find(t=>bt(t)===`sf_${e}_temperature`)??i.find(t=>{const i=bt(t);return i.startsWith(s)&&!i.startsWith(`sf_${e}_env_`)})}function Ot(t,e){const s=kt(t,e);return s?t.entities?.[s]?.device_id:void 0}function Ct(t,e){if(!e)return[];const s=Ot(t,e);return function(t){return wt(t).filter(e=>!!t.states[`switch.sf_${e}_outlet_1`])}(t).filter(i=>{if(i===e)return!0;if(!s)return!1;const o=Ot(t,i),r=o?t.devices?.[o]:void 0;return r?.via_device_id===s})}function Mt(t,e){if(!t||!e)return"";const s=kt(t,e);if(!s)return"";const i=t.entities?.[s]?.device_id,o=i?t.devices?.[i]:void 0;if(o)return o.name_by_user||o.name||"";const r=(t.states[s].attributes.friendly_name||"").match(/^(SF .+? [0-9A-Fa-f]{4})\b/);return r?r[1]:""}const At=[["temperature","Air Temp","mdi:thermometer"],["humidity","Air Humi","mdi:water-percent"],["vpd","Air VPD","mdi:water-opacity"],["leaf_vpd","Leaf VPD","mdi:leaf"],["co2","CO2","mdi:molecule-co2"],["ppfd","PPFD","mdi:white-balance-sunny"],["soil_avg_temperature","Soil Temp","mdi:thermometer"],["soil_avg_moisture","Moisture","mdi:water"],["soil_avg_ec","Soil EC","mdi:flash"]],Dt={temperature:"temp",humidity:"humi",vpd:"vpd",co2:"co2",ppfd:"ppfd",soil_avg_temperature:"tempSoil",soil_avg_moisture:"humiSoil",soil_avg_ec:"ECSoil"},Tt={temperature:"temp",humidity:"humi",co2:"co2"},Rt="#ff6b6b",Et="rgba(255,107,107,0.16)",Nt=(t,e=.16)=>{const s=/^#?([0-9a-fA-F]{6})$/.exec((t||"").trim());if(!s)return`rgba(255,107,107,${e})`;const i=parseInt(s[1],16);return`rgba(${i>>16&255},${i>>8&255},${255&i},${e})`},Pt=t=>"string"==typeof t&&/^#[0-9a-fA-F]{6}$/.test(t),Ft=t=>"alarms"===t||"targets"===t||"both"===t,zt=gt,Lt={"Time Slot":["ts_type","ts_start","ts_stop"],Cycle:["cycle_start","cycle_run","cycle_off","cycle_times"],Temperature:["temp_device"],Humidity:["humidity_device"],CO2:["co2_device"],"Drip Irrigation":["drip_soil","drip_avg"],Manual:[]},Bt=gt,It=t=>!!t&&("unavailable"===t.state||"unknown"===t.state),Ht=t=>{const e=(t||"").match(/^(\d{1,2}):(\d{2})$/);if(!e)return null;const s=+e[1],i=+e[2];return s<=23&&i<=59?60*s+i:null},jt=(t,e,s,i,o="")=>W`<div class="save-bar ${o}">
  ${((t,e,s,i)=>W`
  ...
  <button class="discard-btn" ?disabled=${!e}
    @click=${i}>Discard</button>`)(t,e,s,i)}
      ...
      <div class="pg-stats">
        <span>min <b>${h(a)}</b></span><span>avg <b>${h(l)}</b></span>
      ...
      <div class="pg-plot">
        ...
        <svg viewBox="0 0 ${g} ${m}" preserveAspectRatio="none" class="pg-svg">
          ${p?V`
            <rect x="0" y=${w(p.warnHi).toFixed(1)} width=${g} height=${(w(p.bandHi)-w(p.warnHi)).toFixed(1)} fill=${Nt(this.colWarn,.16)}></rect>
            <rect x="0" y=${w(p.bandLo).toFixed(1)} width=${g} height=${(w(p.warnLo)-w(p.bandLo)).toFixed(1)} fill=${Nt(this.colWarn,.16)}></rect>
            <rect x="0" y=${w(p.bandHi).toFixed(1)} width=${g} height=${(w(p.bandLo)-w(p.bandHi)).toFixed(1)} fill=${Nt(this.colIn,.2)}></rect>
            ${D(p.bandHi,this.colIn)}${D(p.bandLo,this.colIn)}`:q}
          <path d=${k} fill=${Nt(O,.12)} stroke="none"></path>
          <path d=${S} fill="none" stroke=${O} stroke-width="2"></path>
          <circle cx=${y(o[C].t).toFixed(1)} cy=${w(a).toFixed(1)} r="2.5" fill=${this.colLo}></circle>
    ...
    </div>`}soilCellStyle(t,e){const s=this.get(`sensor.sf_${this.config.panel}_${t}_${e}`);if(!s||It(s))return"";const i="temperature"===e?"tempSoil":"moisture"===e?"humiSoil":"ECSoil",o=this.readingColor(i,s.state);return o?`color:${o.color}`:""}getCardSize(){return 8}static getConfigElement(){return document.createElement("spider-farmer-card-editor")}static getStubConfig(t){const e=(t?St(t):[])[0]||"dp1",s=t?Ct(t,e):[];return{type:"custom:spider-farmer-card",panel:e,...s.length?{outlets:s}:{}}}eid(t,e){return`${t}.sf_${this.config.panel}_${e}`}get(t){return this.hass?.states[t]}accent(){return this.config.accent||gt}shouldUpdate(t){return t.has("config")||t.has("hass")||t.has("tab")||t.has("soilOpen")||t.has("soilAllOpen")||t.has("outletDraft")||t.has("alertsDraft")||t.has("deviceOpen")||t.has("outletOpen")||t.has("draft")||t.has("modePick")||t.has("logDate")||t.has("logDev")||t.has("logType")||t.has("colorMode")||t.has("colorModeIn")||t.has("colHi")||t.has("colLo")||t.has("colIn")||t.has("hideLight2")||t.has("colorDraft")||t.has("outletColorMode")||t.has("ocManual")||t.has("ocSched")||t.has("ocEnv")||t.has("ocDrip")||t.has("deviceColorMode")||t.has("dcManual")||t.has("dcSched")||t.has("dcAuto")||t.has("colorSource")||t.has("colWarn")||t.has("showTrend")||t.has("showBand")||t.has("paramOpen")||t.has("_graphVer")||t.has("showTargets")||t.has("leafSpots")||t.has("leafCalTarget")}willUpdate(t){if(!this._colorSynced){const t=this.serverColors();Object.keys(t).length&&(t.mode&&(this.colorMode=t.mode),t.modeIn&&(this.colorModeIn=t.modeIn),t.source&&(this.colorSource=t.source),t.warn&&(this.colWarn=t.warn),void 0!==t.showTrend&&(this.showTrend=t.showTrend),void 0!==t.showBand&&(this.showBand=t.showBand),void 0!==t.showTargets&&(this.showTargets=t.showTargets),t.hi&&(this.colHi=t.hi),t.lo&&(this.colLo=t.lo),t.in&&(this.colIn=t.in),void 0!==t.hide2&&(this.hideLight2=t.hide2),t.omode&&(this.outletColorMode=t.omode),t.ocManual&&(this.ocManual=t.ocManual),t.ocSched&&(this.ocSched=t.ocSched),t.ocEnv&&(this.ocEnv=t.ocEnv),t.ocDrip&&(this.ocDrip=t.ocDrip),t.dmode&&(this.deviceColorMode=t.dmode),t.dcManual&&(this.dcManual=t.dcManual),t.dcSched&&(this.dcSched=t.dcSched),t.dcAuto&&(this.dcAuto=t.dcAuto),this._colorSynced=!0,this.cacheColors())}if(t.has("tab")&&(null!==this.colorDraft&&(this.colorDraft=null),null!==this.alertsDraft&&(this.alertsDraft=null),Object.keys(this.draft).length&&(this.draft={}),Object.keys(this.outletDraft).length&&(this.outletDraft={}),Object.keys(this.modePick).length&&(this.modePick={})),t.has("hass")&&this.recordHistory(),t.has("hass")&&Object.keys(this.modePick).length){let t=null;for(const[e,s]of Object.entries(this.modePick))this.get(e)?.state===s&&(t=t??{...this.modePick},delete t[e]);t&&(this.modePick=t)}}renderParam([t,e,s]){const i=this.get(`sensor.sf_${this.config.panel}_${t}`);if(!i)return q;const o=i.attributes.unit_of_measurement||"",r=t.startsWith("soil_avg_")&&It(i),a=r?"Offline":this.hass?.formatEntityState?this.hass.formatEntityState(i).replace(o,"").trim():i.state,n=t.startsWith("soil_avg_")?t.slice(9):null,l=!!n&&this.soilProbeRows(n).length>1,d=l&&this.soilOpen===n;let c;const h=this.paramOpen===t;if(r)c=null;else{const e=parseFloat(i.state);if(Number.isFinite(e)){const s="targets"!==this.colorSource?this.outOfRange(Dt[t],e):null,i="alarms"!==this.colorSource||"leaf_vpd"===t?this.targetOutOfRange(t,e):null;c=this.colorForOor(s??i)}else c=null}const p=!r&&!l;let u=d||h?`box-shadow:inset 0 0 0 1px ${this.accent()}`:"",f="";r?(u=`background:${Et};box-shadow:inset 0 0 0 1px ${Rt}`,f=`color:${Rt}`):c&&"text"===c.mode?f=`color:${c.color}`:c&&"tile"===c.mode&&(u=`background:${Nt(c.color)};box-shadow:inset 0 0 0 1px ${c.color}`);const g=l||p;return W`
      <div class="tile ${g?"clickable":""} ${d||h?"active":""}"
        style=${u||q}
        role=${g?"button":q}
        ...
        <div class="tile-label">
          ...
          <span class="tl-right">
            ...
            ${l?W`<ha-icon class="tile-more"
                  icon=${d?"mdi:chevron-up":"mdi:chevron-down"}></ha-icon>`:p?W`<ha-icon class="tile-more"
                  icon=${h?"mdi:chevron-up":"mdi:chart-line"}></ha-icon>`:q}
          </span>
        </div>
        <ha-icon icon="${s}" style="color:${this.accent()}"></ha-icon>
        <div class="tile-val" style=${f||q}>${a}${r?q:W`<span class="unit">${o}</span>`}</div>
        ${r?q:this.targetSubline(t,o)}
        ${r?q:this.renderBand(t,parseFloat(i.state))}
      ...
      <div class="soil-pop">
        ...
        ${e.map(({name:e,e:s})=>{const i=It(s),o=s.attributes.unit_of_measurement||"",r=this.hass?.formatEntityState?this.hass.formatEntityState(s).replace(o,"").trim():s.state,a="temperature"===t?"tempSoil":"moisture"===t?"humiSoil":"ECSoil",n=i?null:this.readingColor(a,s.state);return W`
      ...
      <div class="tile clickable ${e?"active":""}" style=${o||q}
        ...
        <ha-icon icon="mdi:sprout" style="color:${i?Rt:s}"></ha-icon>
        <div class="tile-val" style=${i?`color:${Rt}`:q}>${r}</div>
      ...
      </div>`}renderHeaterBody(t,e){const s=this.config.panel,i="on"===e.state,o=`select.sf_${s}_heater_mode_set`,r=this.get(o),a=this.modeOf(o),n=`number.sf_${s}_heater_level`,l=`text.sf_${s}_heater_apply`,d=this.numOpts(1,10,1,t=>`L${t}`),c=[];if(r&&c.push(this.liveModeRow("Mode",o)),c.push(this.powerRow(t.id,"switch",t.label,i)),"Manual"===a)c.push(this.optSelectRow("Gear",n,d)),c.push(this.deviceBar(l,{[o]:"mode"},t));else if("Time Slot"===a){const e=`text.sf_${s}_heater_schedule_start`,i=`text.sf_${s}_heater_schedule_stop`,r={[o]:"mode",[e]:"schedule_start",[i]:"schedule_end",[n]:"gear"};c.push(this.stagedPeriodRow(e,i,"Schedule")),c.push(this.optSelectRow("Gear",n,d)),c.push(this.deviceBar(l,r,t))}else if("Cycle"===a){const e=`text.sf_${s}_heater_cycle_start`,i=`text.sf_${s}_heater_cycle_run`,r=`text.sf_${s}_heater_cycle_off`,a=`number.sf_${s}_heater_cycle_times`,h={[o]:"mode",[e]:"cycle_start",[i]:"cycle_run",[r]:"cycle_off",[a]:"cycle_times",[n]:"gear"};c.push(this.stagedRow("Start Time",e,"time")),c.push(this.stagedRow("Run Time",i,"duration")),c.push(this.stagedRow("Closing Time",r,"duration")),c.push(this.stagedRangeRow("Execution Times",a)),c.push(this.optSelectRow("Gear",n,d)),c.push(this.deviceBar(l,h,t))}else if("Temperature"===a){const e={[o]:"mode",[n]:"gear"};c.push(this.optSelectRow("Gear",n,d)),c.push(this.infoRow("Runs on the tent's day/night temperature targets","")),c.push(this.deviceBar(l,e,t))}return c}renderDehumidifierBody(t,e){const s=this.config.panel,i="on"===e.state,o=`select.sf_${s}_dehumidifier_mode_set`,r=this.get(o),a=this.modeOf(o),n=`select.sf_${s}_dehumidifier_level`,l=`text.sf_${s}_dehumidifier_apply`,d=[];if(r&&d.push(this.liveModeRow("Mode",o)),d.push(this.powerRow(t.id,"switch",t.label,i)),"Manual"===a)d.push(this.ctlRow("Wind Speed",n)),d.push(this.deviceBar(l,{[o]:"mode"},t));else if("Time Slot"===a){const e=`text.sf_${s}_dehumidifier_schedule_start`,i=`text.sf_${s}_dehumidifier_schedule_stop`,r={[o]:"mode",[e]:"schedule_start",[i]:"schedule_end",[n]:"wind"};d.push(this.stagedPeriodRow(e,i,"Schedule")),d.push(this.stagedRow("Wind Speed",n)),d.push(this.deviceBar(l,r,t))}else if("Cycle"===a){const e=`text.sf_${s}_dehumidifier_cycle_start`,i=`text.sf_${s}_dehumidifier_cycle_run`,r=`text.sf_${s}_dehumidifier_cycle_off`,a=`number.sf_${s}_dehumidifier_cycle_times`,c={[o]:"mode",[e]:"cycle_start",[i]:"cycle_run",[r]:"cycle_off",[a]:"cycle_times",[n]:"wind"};d.push(this.stagedRow("Start Time",e,"time")),d.push(this.stagedRow("Run Time",i,"duration")),d.push(this.stagedRow("Closing Time",r,"duration")),d.push(this.stagedRangeRow("Execution Times",a)),d.push(this.stagedRow("Wind Speed",n)),d.push(this.deviceBar(l,c,t))}else if("Humidity"===a){const e={[o]:"mode",[n]:"wind"};d.push(this.stagedRow("Wind Speed",n)),d.push(this.infoRow("Runs on the tent's day/night humidity targets","")),d.push(this.deviceBar(l,e,t))}return d}renderHumidifierBody(t,e){const s=this.config.panel,i="on"===e.state,o=`select.sf_${s}_humidifier_mode_set`,r=this.get(o),a=this.modeOf(o),n=`number.sf_${s}_humidifier_level`,l=`text.sf_${s}_humidifier_apply`,d=this.numOpts(1,4,1,t=>`L${t}`),c=[];if(r&&c.push(this.liveModeRow("Mode",o)),c.push(this.powerRow(t.id,"switch",t.label,i)),"Manual"===a)c.push(this.optSelectRow("Gear",n,d)),c.push(this.deviceBar(l,{[o]:"mode"},t));else if("Time Slot"===a){const e=`text.sf_${s}_humidifier_schedule_start`,i=`text.sf_${s}_humidifier_schedule_stop`,r={[o]:"mode",[e]:"schedule_start",[i]:"schedule_end",[n]:"gear"};c.push(this.stagedPeriodRow(e,i,"Schedule")),c.push(this.optSelectRow("Gear",n,d)),c.push(this.deviceBar(l,r,t))}else if("Cycle"===a){const e=`text.sf_${s}_humidifier_cycle_start`,i=`text.sf_${s}_humidifier_cycle_run`,r=`text.sf_${s}_humidifier_cycle_off`,a=`number.sf_${s}_humidifier_cycle_times`,h={[o]:"mode",[e]:"cycle_start",[i]:"cycle_run",[r]:"cycle_off",[a]:"cycle_times",[n]:"gear"};c.push(this.stagedRow("Start Time",e,"time")),c.push(this.stagedRow("Run Time",i,"duration")),c.push(this.stagedRow("Closing Time",r,"duration")),c.push(this.stagedRangeRow("Execution Times",a)),c.push(this.optSelectRow("Gear",n,d)),c.push(this.deviceBar(l,h,t))}else if("Humidity"===a){const e={[o]:"mode",[n]:"gear"};c.push(this.optSelectRow("Gear",n,d)),c.push(this.infoRow("Runs on the tent's day/night humidity targets","")),c.push(this.deviceBar(l,e,t))}return c}textState(t){const e=this.get(t);return e&&"unknown"!==e.state&&"unavailable"!==e.state?e.state:""}durMinutes(t,e){const s=t=>{const e=/^(\d{1,2}):(\d{2})/.exec(t);return e?60*Number(e[1])+Number(e[2]):null},i=s(this.textState(t)),o=s(this.textState(e));if(null==i||null==o)return null;let r=(o-i+1440)%1440;return 0===r&&(r=1440),r}durationText(t,e){const s=this.durMinutes(t,e);return null==s?null:`${Math.floor(s/60)}h ${String(s%60).padStart(2,"0")}min`}infoRow(t,e){return W`<div class="dev-row">
      ...
      </div>`),g.push(this.optSelectRow("Dimming Range Min",l,this.numOpts(11,100,1,t=>`${t}%`))),g.push(this.optSelectRow("Dimming Range Max",d,this.numOpts(11,100,1,t=>`${t}%`))),g.push(this.optSelectRow("Simulate Sunrise/Sunset",n,this.offOpts(1,60,1,t=>`${t} min`))),g.push(this.optSelectRow("Go dark",u,this.tempThresholdOpts())),g.push(this.optSelectRow("Turn off",f,this.tempThresholdOpts())),g.push(this.deviceBar(p,m,t))}return g}renderFanBody(t,e){const s=this.config.panel,i="on"===e.state,o=`select.sf_${s}_fan_mode_set`,r=this.get(o),a=this.modeOf(o),n=`number.sf_${s}_fan_oscillation`,l=`number.sf_${s}_fan_schedule_gear`,d=`number.sf_${s}_fan_standby_speed`,c=`switch.sf_${s}_fan_natural_wind`,h=()=>this.optSelectRow("Gear",l,this.numOpts(1,10,1,t=>`L${t}`)),p=Math.max(1,Math.round(Number(this.draftVal(l))||1)),u=()=>this.optSelectRow("Standby Speed",d,this.offOpts(1,p-1)),f=()=>this.optSelectRow("Oscillation",n,this.offOpts(1,10)),g=`text.sf_${s}_fan_apply`,m=[];if(r&&m.push(this.liveModeRow("Mode",o)),m.push(this.powerRow(t.id,"fan",t.label,i)),"Manual"===a){const s=Math.round(e.attributes.percentage??0);m.push(this.speedRow(t,i?s:0)),m.push(f()),m.push(this.ctlRow("Natural Wind",c)),m.push(this.deviceBar(g,{[o]:"mode"},t))}else if("Time Slot"===a){const e={[o]:"mode",[`text.sf_${s}_fan_schedule_start`]:"schedule_start",[`text.sf_${s}_fan_schedule_stop`]:"schedule_end",[l]:"schedule_speed",[d]:"standby_speed"};m.push(this.stagedPeriodRow(`text.sf_${s}_fan_schedule_start`,`text.sf_${s}_fan_schedule_stop`,"Schedule")),m.push(h()),m.push(u()),m.push(f()),m.push(this.ctlRow("Natural Wind",c)),m.push(this.deviceBar(g,e,t))}else if("Cycle"===a){const e=`text.sf_${s}_fan_cycle_start`,i=`text.sf_${s}_fan_cycle_run`,r=`text.sf_${s}_fan_cycle_off`,a=`number.sf_${s}_fan_cycle_times`,n={[o]:"mode",[e]:"cycle_start",[i]:"cycle_run",[r]:"cycle_off",[a]:"cycle_times",[l]:"schedule_speed",[d]:"standby_speed"};m.push(this.stagedRow("Start Time",e,"time")),m.push(this.stagedRow("Run Duration",i,"duration")),m.push(this.stagedRow("Off Duration",r,"duration")),m.push(this.stagedRangeRow("Execution Times",a)),m.push(h()),m.push(u()),m.push(f()),m.push(this.ctlRow("Natural Wind",c)),m.push(this.deviceBar(g,n,t))}else if("Environment"===a){const e=`select.sf_${s}_fan_run_mode`,i={[o]:"mode",[e]:"env_submode",[l]:"schedule_speed",[d]:"standby_speed"};m.push(this.stagedRow("Run Mode",e)),m.push(h()),m.push(u()),m.push(f()),m.push(this.ctlRow("Natural Wind",c)),m.push(this.deviceBar(g,i,t))}return m}renderBlowerBody(t,e){const s=this.config.panel,i="on"===e.state,o=`select.sf_${s}_blower_mode_set`,r=this.get(o),a=this.modeOf(o),n=`number.sf_${s}_blower_running_speed`,l=`number.sf_${s}_blower_standby_speed`,d=`switch.sf_${s}_blower_close_co2`,c=`text.sf_${s}_blower_apply`,h=()=>this.optSelectRow("Running Speed",n,this.numOpts(25,100,1,t=>`${t}%`)),p=Math.max(25,Math.round(Number(this.draftVal(n))||25)),u=()=>this.optSelectRow("Standby Speed",l,this.offOpts(25,p-1)),f=[];if(r&&f.push(this.liveModeRow("Mode",o)),f.push(this.powerRow(t.id,"fan",t.label,i)),"Manual"===a){const s=Math.round(e.attributes.percentage??0);f.push(this.speedRow(t,i?s:0)),f.push(this.ctlRow("Close CO2 Device",d)),f.push(this.deviceBar(c,{[o]:"mode"},t))}else if("Time Slot"===a){const e={[o]:"mode",[`text.sf_${s}_blower_schedule_start`]:"schedule_start",[`text.sf_${s}_blower_schedule_stop`]:"schedule_end",[n]:"schedule_speed",[l]:"standby_speed"};f.push(this.stagedPeriodRow(`text.sf_${s}_blower_schedule_start`,`text.sf_${s}_blower_schedule_stop`,"Schedule")),f.push(h()),f.push(u()),f.push(this.ctlRow("Close CO2 Device",d)),f.push(this.deviceBar(c,e,t))}else if("Cycle"===a){const e=`text.sf_${s}_blower_cycle_start`,i=`text.sf_${s}_blower_cycle_run`,r=`text.sf_${s}_blower_cycle_off`,a=`number.sf_${s}_blower_cycle_times`,p={[o]:"mode",[e]:"cycle_start",[i]:"cycle_run",[r]:"cycle_off",[a]:"cycle_times",[n]:"schedule_speed",[l]:"standby_speed"};f.push(this.stagedRow("Start Time",e,"time")),f.push(this.stagedRow("Run Duration",i,"duration")),f.push(this.stagedRow("Off Duration",r,"duration")),f.push(this.stagedRangeRow("Execution Times",a)),f.push(h()),f.push(u()),f.push(this.ctlRow("Close CO2 Device",d)),f.push(this.deviceBar(c,p,t))}else if("Environment"===a){const e=`select.sf_${s}_blower_run_mode`,i={[o]:"mode",[e]:"env_submode",[n]:"schedule_speed",[l]:"standby_speed"};f.push(this.stagedRow("Run Mode",e)),f.push(h()),f.push(u()),f.push(this.ctlRow("Close CO2 Device",d)),f.push(this.deviceBar(c,i,t))}return f}cycleIsDay(){const t=this.config.panel,e=this.get(`binary_sensor.sf_${t}_daytime_schedule`);if(e&&("on"===e.state||"off"===e.state))return"on"===e.state;const s=Ht(this.get(`text.sf_${t}_env_day_start`)?.state),i=Ht(this.get(`text.sf_${t}_env_day_end`)?.state);if(null==s||null==i)return null;const o=new Date,r=60*o.getHours()+o.getMinutes();return s<=i?r>=s&&r<i:r>=s||r<i}lightLeak(){if(!1!==this.cycleIsDay())return{on:!1,text:""};const t=this.config.panel,e=this.get(`sensor.sf_${t}_ppfd`);if(e){const t=Number(e.state);return Number.isFinite(t)&&t>1?{on:!0,text:`Light detected · ${Math.round(t)} µmol`}:{on:!1,text:""}}const s=this.get(`binary_sensor.sf_${t}_daytime_light_sensor`);return s&&"on"===s.state?{on:!0,text:"Light detected"}:{on:!1,text:""}}renderParamsHead(){const t=this.cycleIsDay(),e=this.lightLeak(),s=null===t?q:W`<span class="cycle-badge"
      ...
      ${Gt.map(([e,s,i,o,r])=>this.get(`number.sf_${t}_${s}`)?W`
          <div class="env-row">
      ...
      </div>`}toggleOutlet(t){this.outletOpen=t}outletNums(t){const e=[];for(let s=1;s<=10;s++)this.get(`select.sf_${t}_outlet_${s}_mode`)&&e.push(s);return e}ledToggle(t){const e=`switch.sf_${t}_indicator_light`,s=this.get(e);if(!s)return q;const i="on"===s.state,o=this.accent();return W`
      ...
      </ha-card>`}setLeafSpot(t,e){const s=[...this.leafSpots];s[t]=parseFloat(e),this.leafSpots=s}renderLeafVpdCalibration(){const t=this.eid("number","leaf_offset"),e=this.get(t);if(!e)return q;const s=e.attributes.unit_of_measurement||"°",i=this.get(this.eid("sensor","temperature")),o=i&&Number.isFinite(+i.state)?+i.state:null;if(5!==this.leafSpots.length){const t=o??0;this.leafSpots=Array(5).fill(Math.round(10*t)/10)}const r=this.leafSpots,a=r.filter(t=>Number.isFinite(t)),n=a.length?a.reduce((t,e)=>t+e,0)/a.length:null,l=null!=n&&null!=o?n-o:null,d=t in this.draft,c=e=>this.stage(t,String(Math.round(10*e)/10)),h=this.eid("number","leaf_offset_night"),p=!!this.get(h),u=h in this.draft,f=t=>this.stage(h,String(Math.round(10*t)/10)),g=this.accent(),m=p?this.leafCalTarget:"day";return W`
      ...
      <details class="leaf-cal">
        ...
        <div class="leaf-spots">
          ${r.map((t,e)=>W`<input type="number" step="0.1"
        ...
        <div class="leaf-cal-foot">
          ...
          <button class="leaf-apply" ?disabled=${null==l}
            @click=${()=>null!=l&&(t=>"night"===m?f(t):c(t))(l)}>
            Use for ${"night"===m?"night":"day"}</button>
        </div>
      </details>`}renderSettings(){const t=this.accent(),e=this.colorDraft,s=e?.mode??this.colorMode,i=e?.modeIn??this.colorModeIn,o=e?.hi??this.colHi,r=e?.lo??this.colLo,a=e?.in??this.colIn,n=e?.warn??this.colWarn,l=e?.showTrend??this.showTrend,d=e?.showBand??this.showBand,c=e?.showTargets??this.showTargets,h=!!this.get(this.eid("light","light_2")),p=e?.omode??this.outletColorMode,u=e?.ocManual??this.ocManual,f=e?.ocSched??this.ocSched,g=e?.ocEnv??this.ocEnv,m=e?.ocDrip??this.ocDrip,v=this.hasOutlets(),b=e?.dmode??this.deviceColorMode,$=e?.dcManual??this.dcManual,_=e?.dcSched??this.dcSched,x=e?.dcAuto??this.dcAuto,y=this.overviewDevices().length>0,w=!!e&&(void 0!==e.mode&&e.mode!==this.colorMode||void 0!==e.modeIn&&e.modeIn!==this.colorModeIn||void 0!==e.source&&e.source!==this.colorSource||void 0!==e.warn&&e.warn!==this.colWarn||void 0!==e.showTrend&&e.showTrend!==this.showTrend||void 0!==e.showBand&&e.showBand!==this.showBand||void 0!==e.showTargets&&e.showTargets!==this.showTargets||void 0!==e.hi&&e.hi!==this.colHi||void 0!==e.lo&&e.lo!==this.colLo||void 0!==e.in&&e.in!==this.colIn||void 0!==e.hide2&&e.hide2!==this.hideLight2||void 0!==e.omode&&e.omode!==this.outletColorMode||void 0!==e.ocManual&&e.ocManual!==this.ocManual||void 0!==e.ocSched&&e.ocSched!==this.ocSched||void 0!==e.ocEnv&&e.ocEnv!==this.ocEnv||void 0!==e.ocDrip&&e.ocDrip!==this.ocDrip||void 0!==e.dmode&&e.dmode!==this.deviceColorMode||void 0!==e.dcManual&&e.dcManual!==this.dcManual||void 0!==e.dcSched&&e.dcSched!==this.dcSched||void 0!==e.dcAuto&&e.dcAuto!==this.dcAuto),S=t=>this.colorDraft={...this.colorDraft??{},...t},k=(e,s,i,o,r)=>W`
      <button class="seg ${e===s?"on":""}"
        style=${e===s?`border-color:${t};color:${t}`:q}
        @click=${r}>
        <ha-icon icon=${o}></ha-icon><span>${i}</span>
      </button>`,O=e?.source??this.colorSource,C=(e,s,i)=>W`
      <button class="seg ${O===e?"on":""}"
        style=${O===e?`border-color:${t};color:${t}`:q}
        @click=${()=>S({source:e})}>
      ...
      <div class="seg-row">
        ${C("alarms","Alarms","mdi:bell-outline")}
        ${C("targets","Targets","mdi:target")}
        ${C("both","Both","mdi:set-center")}
      </div>
      ...
      <div class="seg-row">
        ${k(s,"off","No color","mdi:circle-off-outline",()=>S({mode:"off"}))}
        ${k(s,"tile","Tile color","mdi:square-rounded",()=>S({mode:"tile"}))}
        ${k(s,"text","Text color","mdi:format-color-text",()=>S({mode:"text"}))}
      </div>
      <div class="color-row">
        ${M("Above max",o,t=>S({hi:t}))}
        ${M("Below min",r,t=>S({lo:t}))}
        ${M("Near edge",n,t=>S({warn:t}))}
      </div>
      ...
      <div class="seg-row">
        ${k(i,"off","No color","mdi:circle-off-outline",()=>S({modeIn:"off"}))}
        ${k(i,"tile","Tile color","mdi:square-rounded",()=>S({modeIn:"tile"}))}
        ${k(i,"text","Text color","mdi:format-color-text",()=>S({modeIn:"text"}))}
      </div>
      <div class="color-row">
        ${M("In range",a,t=>S({in:t}))}
      </div>
      ...
      ${v?W`
            ...
            <div class="set-note">
              ...
              <span style="color:${u}">Manual</span>,
              <span style="color:${f}">Scheduled</span>,
              <span style="color:${g}">Environment</span>,
              <span style="color:${m}">Drip</span>. Off outlets stay neutral.
            </div>
            <div class="seg-row">
              ${k(p,"off","No color","mdi:circle-off-outline",()=>S({omode:"off"}))}
              ${k(p,"tile","Tile color","mdi:square-rounded",()=>S({omode:"tile"}))}
              ${k(p,"text","Text color","mdi:format-color-text",()=>S({omode:"text"}))}
            </div>
            <div class="color-row">
              ${M("Manual",u,t=>S({ocManual:t}))}
              ${M("Scheduled",f,t=>S({ocSched:t}))}
            </div>
            <div class="color-row">
              ${M("Environment",g,t=>S({ocEnv:t}))}
              ${M("Drip",m,t=>S({ocDrip:t}))}
            </div>`:q}
      ...
      ${y?W`
            ...
            <div class="set-note">
              ...
              <span style="color:${x}">Auto</span> (Environment / PPFD). A
              <span style="color:${Rt}">fault</span> always overrides.
            </div>
            <div class="seg-row">
              ${k(b,"off","No color","mdi:circle-off-outline",()=>S({dmode:"off"}))}
              ${k(b,"tile","Tile color","mdi:square-rounded",()=>S({dmode:"tile"}))}
              ${k(b,"text","Text color","mdi:format-color-text",()=>S({dmode:"text"}))}
            </div>
            <div class="color-row">
              ${M("Manual",$,t=>S({dcManual:t}))}
              ${M("Scheduled",_,t=>S({dcSched:t}))}
              ${M("Auto",x,t=>S({dcAuto:t}))}
            </div>`:q}
      <div class="section-label" style="margin-top:16px">Overview extras</div>
      <div class="set-note">
      ...
      <div class="toggle-row">
        ...
        <button class="toggle ${c?"on":""}"
          ...
          @click=${()=>S({showTargets:!c})}></button>
      </div>
      <div class="toggle-row" style="margin-top:8px">
        <span>Trend arrows</span>
        <button class="toggle ${l?"on":""}"
          style=${l?`background:${t}`:q}
          @click=${()=>S({showTrend:!l})}></button>
      </div>
      <div class="toggle-row" style="margin-top:8px">
        <span>Dead-zone band</span>
        <button class="toggle ${d?"on":""}"
          style=${d?`background:${t}`:q}
          @click=${()=>S({showBand:!d})}></button>
      </div>
      ${jt(t,w,()=>{const t=this.colorDraft;t&&(void 0!==t.mode&&t.mode!==this.colorMode&&(this.colorMode=t.mode,this.persistColorOption("colors",t.mode)),void 0!==t.modeIn&&t.modeIn!==this.colorModeIn&&(this.colorModeIn=t.modeIn,this.persistColorOption("colors_in",t.modeIn)),void 0!==t.source&&t.source!==this.colorSource&&(this.colorSource=t.source,this.persistColorOption("color_source",t.source)),void 0!==t.warn&&t.warn!==this.colWarn&&(this.colWarn=t.warn,this.persistColorOption("color_warn",t.warn)),void 0!==t.showTrend&&t.showTrend!==this.showTrend&&(this.showTrend=t.showTrend,this.persistColorOption("show_trend",t.showTrend?"1":"0")),void 0!==t.showBand&&t.showBand!==this.showBand&&(this.showBand=t.showBand,this.persistColorOption("show_band",t.showBand?"1":"0")),void 0!==t.showTargets&&t.showTargets!==this.showTargets&&(this.showTargets=t.showTargets,this.persistColorOption("show_targets",t.showTargets?"1":"0")),void 0!==t.hi&&t.hi!==this.colHi&&(this.colHi=t.hi,this.persistColorOption("color_hi",t.hi)),void 0!==t.lo&&t.lo!==this.colLo&&(this.colLo=t.lo,this.persistColorOption("color_lo",t.lo)),void 0!==t.in&&t.in!==this.colIn&&(this.colIn=t.in,this.persistColorOption("color_in",t.in)),void 0!==t.hide2&&t.hide2!==this.hideLight2&&(this.hideLight2=t.hide2,this.persistColorOption("hide_light2",t.hide2?"1":"0")),void 0!==t.omode&&t.omode!==this.outletColorMode&&(this.outletColorMode=t.omode,this.persistColorOption("outlet_colors",t.omode)),void 0!==t.ocManual&&t.ocManual!==this.ocManual&&(this.ocManual=t.ocManual,this.persistColorOption("oc_manual",t.ocManual)),void 0!==t.ocSched&&t.ocSched!==this.ocSched&&(this.ocSched=t.ocSched,this.persistColorOption("oc_sched",t.ocSched)),void 0!==t.ocEnv&&t.ocEnv!==this.ocEnv&&(this.ocEnv=t.ocEnv,this.persistColorOption("oc_env",t.ocEnv)),void 0!==t.ocDrip&&t.ocDrip!==this.ocDrip&&(this.ocDrip=t.ocDrip,this.persistColorOption("oc_drip",t.ocDrip)),void 0!==t.dmode&&t.dmode!==this.deviceColorMode&&(this.deviceColorMode=t.dmode,this.persistColorOption("device_colors",t.dmode)),void 0!==t.dcManual&&t.dcManual!==this.dcManual&&(this.dcManual=t.dcManual,this.persistColorOption("dc_manual",t.dcManual)),void 0!==t.dcSched&&t.dcSched!==this.dcSched&&(this.dcSched=t.dcSched,this.persistColorOption("dc_sched",t.dcSched)),void 0!==t.dcAuto&&t.dcAuto!==this.dcAuto&&(this.dcAuto=t.dcAuto,this.persistColorOption("dc_auto",t.dcAuto)),this._colorSynced=!0,this.cacheColors()),this.colorDraft=null},()=>this.colorDraft=null,"apply-bar")}`}}qt.styles=a`
    ${yt}
  ...
  `,t([ut({attribute:!1})],qt.prototype,"hass",void 0),t([ft()],qt.prototype,"config",void 0),t([ft()],qt.prototype,"tab",void 0),t([ft()],qt.prototype,"colorMode",void 0),t([ft()],qt.prototype,"colHi",void 0),t([ft()],qt.prototype,"colLo",void 0),t([ft()],qt.prototype,"colorModeIn",void 0),t([ft()],qt.prototype,"colIn",void 0),t([ft()],qt.prototype,"colWarn",void 0),t([ft()],qt.prototype,"colorSource",void 0),t([ft()],qt.prototype,"showTrend",void 0),t([ft()],qt.prototype,"showBand",void 0),t([ft()],qt.prototype,"showTargets",void 0),t([ft()],qt.prototype,"paramOpen",void 0),t([ft()],qt.prototype,"_graphVer",void 0),t([ft()],qt.prototype,"hideLight2",void 0),t([ft()],qt.prototype,"outletColorMode",void 0),t([ft()],qt.prototype,"ocManual",void 0),t([ft()],qt.prototype,"ocSched",void 0),t([ft()],qt.prototype,"ocEnv",void 0),t([ft()],qt.prototype,"ocDrip",void 0),t([ft()],qt.prototype,"deviceColorMode",void 0),t([ft()],qt.prototype,"dcManual",void 0),t([ft()],qt.prototype,"dcSched",void 0),t([ft()],qt.prototype,"dcAuto",void 0),t([ft()],qt.prototype,"colorDraft",void 0),t([ft()],qt.prototype,"alertsDraft",void 0),t([ft()],qt.prototype,"soilOpen",void 0),t([ft()],qt.prototype,"soilAllOpen",void 0),t([ft()],qt.prototype,"deviceOpen",void 0),t([ft()],qt.prototype,"outletOpen",void 0),t([ft()],qt.prototype,"draft",void 0),t([ft()],qt.prototype,"modePick",void 0),t([ft()],qt.prototype,"outletDraft",void 0),t([ft()],qt.prototype,"leafSpots",void 0),t([ft()],qt.prototype,"leafCalTarget",void 0),t([ft()],qt.prototype,"logDate",void 0),t([ft()],qt.prototype,"logDev",void 0),t([ft()],qt.prototype,"logType",void 0);class Jt extends dt{constructor(){super(...arguments),this._config={type:"custom:spider-farmer-card"}}setConfig(t){this._config={...t}}_emit(t){this._config=t,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}_panelChanged(t){const e=t.target.value,s={...this._config};e?s.panel=e:delete s.panel,this._emit(s)}_titleChanged(t){const e=t.target.value.trim(),s={...this._config};e?s.title=e:delete s.title,this._emit(s)}_tabChanged(t){const e=t.target.value;this._emit({...this._config,default_tab:e})}_outletToggled(t,e){const s=e.target.checked,i=new Set(this._config.outlets??[]);s?i.add(t):i.delete(t);const o=[...i].sort(),r={...this._config};o.length?r.outlets=o:delete r.outlets,this._emit(r)}render(){if(!this.hass)return q;const t=this._config,e=t.default_tab,s=St(this.hass),i=Ct(this.hass,t.panel),o=t=>{const e=Mt(this.hass,t);return e?`${t} — ${e}`:t};return W`
      <div class="form">
        <label class="field">
  ...
  `,t([ut({attribute:!1})],Jt.prototype,"hass",void 0),t([ft()],Jt.prototype,"_config",void 0);const Kt=/^sf_(se\d+)_light$/;function Zt(t){const e=new Set;for(const s of Object.keys(t.states)){if(!s.startsWith("light."))continue;const t=bt(s).match(Kt);t&&e.add(t[1])}return[...e].sort((t,e)=>Number(t.replace(/\D/g,""))-Number(e.replace(/\D/g,"")))}class Xt extends dt{constructor(){super(...arguments),this.draft=null,this.ctlDraft={}}setConfig(t){this.config=t}getCardSize(){return 7}static getStubConfig(t){const e=t?Zt(t):[];return{type:"custom:spider-light-card",...e[0]?{light:e[0]}:{}}}accent(){return this.config.accent||gt}seSlot(){return this.config.light||(this.hass?Zt(this.hass)[0]:"")||"se1"}get(t){return this.hass?.states[t]}shouldUpdate(t){return t.has("config")||t.has("hass")||t.has("draft")||t.has("ctlDraft")}cur(t,e){return t in this.ctlDraft?this.ctlDraft[t]:e}stageCtl(t,e){this.ctlDraft={...this.ctlDraft,[t]:e}}isDirty(){return Object.keys(this.ctlDraft).length>0||null!==this.draft}applyAll(t){const e=this.ctlDraft,s=`light.sf_${t}_light`;if("bri"in e){const t=Number(e.bri);t>0?this.hass?.callService("light","turn_on",{entity_id:s,brightness_pct:t}):this.hass?.callService("light","turn_off",{entity_id:s})}"mode"in e&&this.hass?.callService("select","select_option",{entity_id:`select.sf_${t}_mode`,option:e.mode});for(const t of Object.keys(e))t.includes(".")&&(t.startsWith("number.")?this.hass?.callService("number","set_value",{entity_id:t,value:Number(e[t])}):t.startsWith("text.")&&this.hass?.callService("text","set_value",{entity_id:t,value:e[t]}));if("power"in e){const t="on"===e.power;t&&"bri"in e||this.hass?.callService("light",t?"turn_on":"turn_off",{entity_id:s})}this.draft&&this.saveSchedule(t),this.ctlDraft={}}discardAll(){Object.keys(this.ctlDraft).length&&(this.ctlDraft={}),null!==this.draft&&(this.draft=null)}render(){if(!this.hass||!this.config)return q;const t=this.seSlot(),e=this.get(`light.sf_${t}_light`);if(!e)return W`<ha-card>
      ...
      <ha-card>
        ...
        <div class="gauge">
          <svg viewBox="0 0 200 190" aria-hidden="true">
            ...
            ${d&&p>0?V`<path d=${_t(100,100,78,0,p)} fill="none"
                  stroke-linecap="round" stroke=${h} stroke-width="15"></path>`:q}
            ${d?V`<circle cx=${u.toFixed(2)} cy=${f.toFixed(2)} r="10"
    ...
    .discard-btn[disabled] { opacity: 0.5; cursor: default; }
  `,t([ut({attribute:!1})],Xt.prototype,"hass",void 0),t([ft()],Xt.prototype,"config",void 0),t([ft()],Xt.prototype,"draft",void 0),t([ft()],Xt.prototype,"ctlDraft",void 0),customElements.get("spider-farmer-card")||customElements.define("spider-farmer-card",qt),customElements.get("spider-farmer-card-editor")||customElements.define("spider-farmer-card-editor",Jt),customElements.get("spider-light-card")||customElements.define("spider-light-card",Xt),window.customCards=window.customCards||[],window.customCards.push({type:"spider-farmer-card",name:"Spider Farmer Card",description:"Tent overview + config for the Spider Farmer Bridge integration",preview:!0,documentationURL:"https://github.com/cobragt2000/spider_farmer_bridge"}),window.customCards.push({type:"spider-light-card",name:"Spider Light Card",description:"Brightness dial, mode, and schedule for a Spider Farmer SE-series light",preview:!0,documentationURL:"https://github.com/cobragt2000/spider_farmer_bridge"}),console.info("%c SPIDER-FARMER-CARD %c v0.20.6 ","color:#fff;background:#ff7a1a;border-radius:3px 0 0 3px;padding:2px 4px","color:#ff7a1a;background:#222;border-radius:0 3px 3px 0;padding:2px 4px"),(()=>{const t=["spider-farmer-card","spider-light-card"],e=new Set([...t,...t.map(t=>`custom:${t}`)]),s=()=>{const t=[["spider-farmer-card",qt],["spider-farmer-card-editor",Jt],["spider-light-card",Xt]];for(const[e,s]of t)if(!customElements.get(e))try{customElements.define(e,s)}catch{}},i=()=>{let t=0;for(const s of(()=>{const t=[],e=new Set,s=i=>{if(!i||e.has(i))return;e.add(i);let o=[];try{o=i.querySelectorAll("hui-error-card")}catch{return}o.forEach(e=>t.push(e));let r=[];try{r=i.querySelectorAll("*")}catch{return}r.forEach(t=>{const e=t.shadowRoot;e&&s(e)})};return s(document),t})()){const i=s._config||{},o=i.origConfig&&i.origConfig.type||i.type||"";e.has(o)&&(s.dispatchEvent(new CustomEvent("ll-rebuild",{bubbles:!0,composed:!0})),t++)}return t};let o=0;const r=()=>{s(),i(),++o<12&&setTimeout(r,250)},a=()=>{s(),r()};"complete"===document.readyState?a():window.addEventListener("load",a,{once:!0})})();export{qt as SpiderFarmerCard,Jt as SpiderFarmerCardEditor,Xt as SpiderLightCard};
