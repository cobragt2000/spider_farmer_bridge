/*! spider-farmer-card v0.20.71 | MIT */
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const w=globalThis,S=t=>t,k=w.trustedTypes,O=k?k.createPolicy("lit-html",{createHTML:t=>t}):void 0,C="$lit$",M=`lit$${Math.random().toFixed(9).slice(2)}$`,D="?"+M,N=`<${D}>`,A=document,T=()=>A.createComment(""),E=t=>null===t||"object"!=typeof t&&"function"!=typeof t,L=Array.isArray,R="[ \t\n\f\r]",P=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,z=/-->/g,F=/>/g,I=RegExp(`>|${R}(?:([^\\s"'>=/]+)(${R}*=${R}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),B=/'/g,H=/"/g,W=/^(?:script|style|textarea|title)$/i,j=t=>(e,...s)=>({_$litType$:t,strings:e,values:s}),V=j(1),U=j(2),G=Symbol.for("lit-noChange"),Q=Symbol.for("lit-nothing"),q=new WeakMap,K=A.createTreeWalker(A,129);function J(t,e){if(!L(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==O?O.createHTML(e):e}const Y=(t,e)=>{const s=t.length-1,i=[];let o,a=2===e?"<svg>":3===e?"<math>":"",n=P;for(let e=0;e<s;e++){const s=t[e];let r,l,c=-1,d=0;for(;d<s.length&&(n.lastIndex=d,l=n.exec(s),null!==l);)d=n.lastIndex,n===P?"!--"===l[1]?n=z:void 0!==l[1]?n=F:void 0!==l[2]?(W.test(l[2])&&(o=RegExp("</"+l[2],"g")),n=I):void 0!==l[3]&&(n=I):n===I?">"===l[0]?(n=o??P,c=-1):void 0===l[1]?c=-2:(c=n.lastIndex-l[2].length,r=l[1],n=void 0===l[3]?I:'"'===l[3]?H:B):n===H||n===B?n=I:n===z||n===F?n=P:(n=I,o=void 0);const h=n===I&&t[e+1].startsWith("/>")?" ":"";a+=n===P?s+N:c>=0?(i.push(r),s.slice(0,c)+C+s.slice(c)+M+h):s+M+(-2===c?e:h)}return[J(t,a+(t[s]||"<?>")+(2===e?"</svg>":3===e?"</math>":"")),i]};class X{constructor({strings:t,_$litType$:e},s){let i;this.parts=[];let o=0,a=0;const n=t.length-1,r=this.parts,[l,c]=Y(t,e);if(this.el=X.createElement(l,s),K.currentNode=this.el.content,2===e||3===e){const t=this.el.content.firstChild;t.replaceWith(...t.childNodes)}for(;null!==(i=K.nextNode())&&r.length<n;){if(1===i.nodeType){if(i.hasAttributes())for(const t of i.getAttributeNames())if(t.endsWith(C)){const e=c[a++],s=i.getAttribute(t).split(M),n=/([.?@])?(.*)/.exec(e);r.push({type:1,index:o,name:n[2],strings:s,ctor:"."===n[1]?it:"?"===n[1]?ot:"@"===n[1]?at:st}),i.removeAttribute(t)}else t.startsWith(M)&&(r.push({type:6,index:o}),i.removeAttribute(t));if(W.test(i.tagName)){const t=i.textContent.split(M),e=t.length-1;if(e>0){i.textContent=k?k.emptyScript:"";for(let s=0;s<e;s++)i.append(t[s],T()),K.nextNode(),r.push({type:2,index:++o});i.append(t[e],T())}}}else if(8===i.nodeType)if(i.data===D)r.push({type:2,index:o});else{let t=-1;for(;-1!==(t=i.data.indexOf(M,t+1));)r.push({type:7,index:o}),t+=M.length-1}o++}}static createElement(t,e){const s=A.createElement("template");return s.innerHTML=t,s}}function Z(t,e,s=t,i){if(e===G)return e;let o=void 0!==i?s._$Co?.[i]:s._$Cl;const a=E(e)?void 0:e._$litDirective$;return o?.constructor!==a&&(o?._$AO?.(!1),void 0===a?o=void 0:(o=new a(t),o._$AT(t,s,i)),void 0!==i?(s._$Co??=[])[i]=o:s._$Cl=o),void 0!==o&&(e=Z(t,o._$AS(t,e.values),o,i)),e}class tt{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:e},parts:s}=this._$AD,i=(t?.creationScope??A).importNode(e,!0);K.currentNode=i;let o=K.nextNode(),a=0,n=0,r=s[0];for(;void 0!==r;){if(a===r.index){let e;2===r.type?e=new et(o,o.nextSibling,this,t):1===r.type?e=new r.ctor(o,r.name,r.strings,this,t):6===r.type&&(e=new nt(o,this,t)),this._$AV.push(e),r=s[++n]}a!==r?.index&&(o=K.nextNode(),a++)}return K.currentNode=A,i}p(t){let e=0;for(const s of this._$AV)void 0!==s&&(void 0!==s.strings?(s._$AI(t,s,e),e+=s.strings.length-2):s._$AI(t[e])),e++}}class et{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,e,s,i){this.type=2,this._$AH=Q,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=s,this.options=i,this._$Cv=i?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode;const e=this._$AM;return void 0!==e&&11===t?.nodeType&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=Z(this,t,e),E(t)?t===Q||null==t||""===t?(this._$AH!==Q&&this._$AR(),this._$AH=Q):t!==this._$AH&&t!==G&&this._(t):void 0!==t._$litType$?this.$(t):void 0!==t.nodeType?this.T(t):(t=>L(t)||"function"==typeof t?.[Symbol.iterator])(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==Q&&E(this._$AH)?this._$AA.nextSibling.data=t:this.T(A.createTextNode(t)),this._$AH=t}$(t){const{values:e,_$litType$:s}=t,i="number"==typeof s?this._$AC(t):(void 0===s.el&&(s.el=X.createElement(J(s.h,s.h[0]),this.options)),s);if(this._$AH?._$AD===i)this._$AH.p(e);else{const t=new tt(i,this),s=t.u(this.options);t.p(e),this.T(s),this._$AH=t}}_$AC(t){let e=q.get(t.strings);return void 0===e&&q.set(t.strings,e=new X(t)),e}k(t){L(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let s,i=0;for(const o of t)i===e.length?e.push(s=new et(this.O(T()),this.O(T()),this,this.options)):s=e[i],s._$AI(o),i++;i<e.length&&(this._$AR(s&&s._$AB.nextSibling,i),e.length=i)}_$AR(t=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);t!==this._$AB;){const e=S(t).nextSibling;S(t).remove(),t=e}}setConnected(t){void 0===this._$AM&&(this._$Cv=t,this._$AP?.(t))}}class st{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,s,i,o){this.type=1,this._$AH=Q,this._$AN=void 0,this.element=t,this.name=e,this._$AM=i,this.options=o,s.length>2||""!==s[0]||""!==s[1]?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=Q}_$AI(t,e=this,s,i){const o=this.strings;let a=!1;if(void 0===o)t=Z(this,t,e,0),a=!E(t)||t!==this._$AH&&t!==G,a&&(this._$AH=t);else{const i=t;let n,r;for(t=o[0],n=0;n<o.length-1;n++)r=Z(this,i[s+n],e,n),r===G&&(r=this._$AH[n]),a||=!E(r)||r!==this._$AH[n],r===Q?t=Q:t!==Q&&(t+=(r??"")+o[n+1]),this._$AH[n]=r}a&&!i&&this.j(t)}j(t){t===Q?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class it extends st{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===Q?void 0:t}}class ot extends st{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==Q)}}class at extends st{constructor(t,e,s,i,o){super(t,e,s,i,o),this.type=5}_$AI(t,e=this){if((t=Z(this,t,e,0)??Q)===G)return;const s=this._$AH,i=t===Q&&s!==Q||t.capture!==s.capture||t.once!==s.once||t.passive!==s.passive,o=t!==Q&&(s===Q||i);i&&this.element.removeEventListener(this.name,this,s),o&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){"function"==typeof this._$AH?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}}class nt{constructor(t,e,s){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(t){Z(this,t)}}const rt=w.litHtmlPolyfillSupport;rt?.(X,et),(w.litHtmlVersions??=[]).push("3.3.3");const lt=globalThis;
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`;function wt(t){const e=new Set;for(const s of Object.keys(t.states)){const t=bt(s).match(vt);t&&e.add(t[1])}return[...e].sort()}function St(t){return wt(t).filter(e=>e.startsWith("st")&&!!t.states[`switch.sf_${e}_outlet_1`]||Object.keys(t.states).some(t=>{const s=bt(t);return s===`sf_${e}_temperature`||s===`sf_${e}_soil_avg_temperature`||s===`sf_${e}_light_1`||s===`sf_${e}_fan`||s===`sf_${e}_blower`}))}function kt(t){return wt(t).filter(e=>!!t.states[`switch.sf_${e}_outlet_1`])}function Ot(t,e){const s=`sf_${e}_`,i=Object.keys(t.states);return i.find(t=>bt(t)===`sf_${e}_temperature`)??i.find(t=>{const i=bt(t);return i.startsWith(s)&&!i.startsWith(`sf_${e}_env_`)})}function Ct(t,e){const s=Ot(t,e);return s?t.entities?.[s]?.device_id:void 0}function Mt(t,e){if(!e)return[];const s=Ct(t,e);return s?kt(t).filter(i=>{if(i===e)return!1;const o=Ct(t,i),a=o?t.devices?.[o]:void 0;return a?.via_device_id===s}):[]}function Dt(t,e){if(!t||!e)return"";const s=Ot(t,e);if(!s)return"";const i=t.entities?.[s]?.device_id,o=i?t.devices?.[i]:void 0;if(o)return o.name_by_user||o.name||"";const a=(t.states[s].attributes.friendly_name||"").match(/^(SF .+? [0-9A-Fa-f]{4})\b/);return a?a[1]:""}const Nt=[["temperature","Air Temp","mdi:thermometer"],["humidity","Air Humi","mdi:water-percent"],["vpd","Air VPD","mdi:water-opacity"],["leaf_vpd","Leaf VPD","mdi:leaf"],["co2","CO2","mdi:molecule-co2"],["ppfd","PPFD","mdi:white-balance-sunny"],["soil_avg_temperature","Soil Temp","mdi:thermometer"],["soil_avg_moisture","Moisture","mdi:water"],["soil_avg_ec","Soil EC","mdi:flash"]],At={temperature:"temp",humidity:"humi",vpd:"vpd",co2:"co2",ppfd:"ppfd",soil_avg_temperature:"tempSoil",soil_avg_moisture:"humiSoil",soil_avg_ec:"ECSoil"},Tt={temperature:"temp",humidity:"humi",co2:"co2"},Et="#ff6b6b",Lt="rgba(255,107,107,0.16)",Rt=(t,e=.16)=>{const s=/^#?([0-9a-fA-F]{6})$/.exec((t||"").trim());if(!s)return`rgba(255,107,107,${e})`;const i=parseInt(s[1],16);return`rgba(${i>>16&255},${i>>8&255},${255&i},${e})`},Pt=t=>"string"==typeof t&&/^#[0-9a-fA-F]{6}$/.test(t),zt=t=>"alarms"===t||"targets"===t||"both"===t,Ft=mt,It={"Time Slot":["ts_type","ts_start","ts_stop"],Cycle:["cycle_start","cycle_run","cycle_off","cycle_times"],Temperature:["temp_device"],Humidity:["humidity_device"],CO2:["co2_device"],"Drip Irrigation":["drip_soil","drip_avg"],Manual:[]},Bt=mt,Ht=t=>!!t&&("unavailable"===t.state||"unknown"===t.state),Wt=t=>{const e=(t||"").match(/^(\d{1,2}):(\d{2})$/);if(!e)return null;const s=+e[1],i=+e[2];return s<=23&&i<=59?60*s+i:null},jt=(t,e,s,i,o="",a=!1)=>V`<div class="save-bar ${o}">
  ...
  <button class="discard-btn" ?disabled=${!e||o}
    @click=${i}>Discard</button>`)(t,e,s,i,a)}
      ...
      <div class="pg-plot">
        ...
        <svg viewBox="0 0 ${m} ${f}" preserveAspectRatio="none" class="pg-svg">
          ${p?U`
      ...
      </div>`}renderParam([t,e,s]){const i=this.get(`sensor.sf_${this.config.panel}_${t}`);if(!i)return Q;const o=i.attributes.unit_of_measurement||"",a=t.startsWith("soil_avg_")&&Ht(i),n=["temperature","humidity","vpd","leaf_vpd"].includes(t)&&this.cleaningActive(),r=n?"--":a?"Offline":this.hass?.formatEntityState?this.hass.formatEntityState(i).replace(o,"").trim():i.state,l=t.startsWith("soil_avg_")?t.slice(9):null,c=!!l&&this.soilProbeRows(l).length>1,d=c&&this.soilOpen===l;let h;const p=this.paramOpen===t;if(a||n)h=null;else{const e=parseFloat(i.state);if(Number.isFinite(e)){const s="targets"!==this.colorSource?this.outOfRange(At[t],e):null,i="alarms"!==this.colorSource||"leaf_vpd"===t?this.targetOutOfRange(t,e):null;h=this.colorForOor(s??i)}else h=null}const u=!a&&!c;let g=d||p?`box-shadow:inset 0 0 0 1px ${this.accent()}`:"",m="";a?(g=`background:${Lt};box-shadow:inset 0 0 0 1px ${Et}`,m=`color:${Et}`):h&&"text"===h.mode?m=`color:${h.color}`:h&&"tile"===h.mode&&(g=`background:${Rt(h.color)};box-shadow:inset 0 0 0 1px ${h.color}`);const f=c||u;return V`
      <div class="tile ${f?"clickable":""} ${d||p?"active":""}"
        ...
        <div class="tile-val" style=${m||Q}>${r}${a||n?Q:V`<span class="unit">${o}</span>`}</div>
        ${n?V`<div class="tile-target" style="color:var(--warning-color,#ff9800)">${this.cleaningLabel()}${this.cleaningRemaining()?" · "+this.cleaningRemaining():""}</div>`:a?Q:this.targetSubline(t,o)}
        ${a||n?Q:this.renderBand(t,parseFloat(i.state))}
      ...
      <div class="tile clickable ${e?"active":""}" style=${o||Q}
        ...
        <div class="tile-val" style=${i?`color:${Et}`:Q}>${a}</div>
      ...
      </div>`}overviewDevices(){const t=[],e=(e,s)=>{for(const[i,o,a]of s){const s=this.eid(e,i);this.get(s)&&t.push({domain:e,suffix:i,id:s,label:o,icon:a})}};return e("light",Vt),e("fan",Ut),e("switch",Gt),this.hideLight2?t.filter(t=>"light_2"!==t.suffix):t}deviceStateText(t,e){if("unavailable"===e.state||"unknown"===e.state)return"Offline";if("light"===t.domain)return"on"!==e.state?"Off":`${Math.round((e.attributes.brightness??0)/255*100)}%`;if("fan"===t.domain){if("on"!==e.state)return"Off";const t=Math.round(e.attributes.percentage??0);return t?`${t}%`:"On"}if("on"!==e.state)return"Off";const s=this.config.panel;if("dehumidifier"===t.suffix){const t=this.get(`sensor.sf_${s}_dehumidifier_level`)?.state;return t&&"Off"!==t&&"unknown"!==t?t:"On"}if("heater"===t.suffix||"humidifier"===t.suffix){const e=this.get(`sensor.sf_${s}_${t.suffix}_level`)?.state;return e&&"0"!==e&&"unknown"!==e?`L${e}`:"On"}return"On"}deviceFault(t){const e=this.config.panel,s=t=>this.get(`sensor.sf_${e}_${t}`)?.state;return"humidifier"===t&&"Empty"===s("humidifier_tank")?"EMPTY":"dehumidifier"===t&&"Full"===s("dehumidifier_tank")?"FULL":"heater"===t&&"Alarm"===s("heater_status")?"Alarm":null}deviceMode(t){const e=this.config.panel,s="light"===t.domain?`select.sf_${e}_${t.suffix}_mode`:`select.sf_${e}_${t.suffix}_mode_set`;return this.get(s)?this.modeOf(s):""}deviceColorFor(t){switch((t=>"Time Slot"===t||"Cycle"===t?"sched":"Environment"===t||"Temperature"===t||"Humidity"===t||"PPFD"===t?"auto":"manual")(t)){case"sched":return this.dcSched;case"auto":return this.dcAuto;default:return this.dcManual}}deviceTile(t){const e=this.get(t.id);if(!e)return Q;const s="on"===e.state,i=`${t.domain}:${t.suffix}`,o=this.deviceOpen===i,a=this.accent(),n=this.deviceFault(t.suffix),r=!n&&s&&"off"!==this.deviceColorMode?this.deviceColorFor(this.deviceMode(t)):"",l=n?Et:r||(s?a:"var(--secondary-text-color)");let c="";return n?c=`background:${Lt};box-shadow:inset 0 0 0 1px ${Et}`:r&&"tile"===this.deviceColorMode&&(c=`background:${Rt(r)};box-shadow:inset 0 0 0 1px ${r}`),o&&!n&&(c=`box-shadow:inset 0 0 0 1px ${a}`+(r&&"tile"===this.deviceColorMode?`;background:${Rt(r)}`:"")),V`
      <div class="tile tile-device clickable ${o?"active":""}"
        ...
        ${this.tileSummary&&!n?this.deviceSummaryRow(t):Q}
        <ha-icon icon=${t.icon} style="color:${s||n?l:"var(--secondary-text-color)"}"></ha-icon>
        <div class="tile-val" style=${n?`color:${Et}`:s?`color:${l}`:""}>
          ${n??this.deviceStateText(t,e)}
        </div>
        ${this.lightDLI(t)}
        ${this.fanBadge(t)}
      </div>`}lightSchedule(t,e){const s=this.config.panel,i=t=>{const e=this.get(t);return e&&"unknown"!==e.state&&"unavailable"!==e.state?e.state:""};let o=i(`text.sf_${s}_${t}_schedule_start`),a=i(`text.sf_${s}_${t}_schedule_stop`);if("PPFD"===e){const e=i(`text.sf_${s}_${t}_ppfd_start`),n=i(`text.sf_${s}_${t}_ppfd_stop`);e&&n&&("00:00"!==e||"00:00"!==n)&&(o=e,a=n)}return[o,a]}lightDLI(t){if("light"!==t.domain)return Q;const e=this.config.panel,s=t.suffix,i=this.modeOf(`select.sf_${e}_${s}_mode`);if("PPFD"!==i)return Q;const o=Number(this.get(`number.sf_${e}_${s}_ppfd_target`)?.state);if(!Number.isFinite(o)||o<=0)return Q;const[a,n]=this.lightSchedule(s,i),r=/^(\d{1,2}):(\d{2})/.exec(a),l=/^(\d{1,2}):(\d{2})/.exec(n);if(!r||!l)return Q;const c=(60*+l[1]+ +l[2]-(60*+r[1]+ +r[2])+1440)%1440/60;if(c<=0)return Q;const d=o*c*.0036;return V`<div class="tile-dli">
      ...
      <div class="params-head">
        ...
        ${s}
      </div>`}renderOverview(){const t=Nt.map(t=>this.renderParam(t)).filter(t=>t!==Q),e=this.soilStatsTile(),s=this.overviewDevices();return V`
      ...
      ${Qt.map(([t,s,i,o,a])=>this.get(`number.sf_${e}_${s}`)?V`
          <div class="env-row">
      ...
      <button class="plan-btn ${i?"stop":"start"}"
        ...
        ${n(null)}
        ${i?V`<div class="plan-actions">${r("Start Plan",!1)}</div>`:Q}`:V`
      ...
      @click=${()=>o("mode",t)}>${t}</button>`,l="PPFD"===i.mode,c=l?"ppfd_start":"ts_start",d=l?"ppfd_stop":"ts_stop",h=this.durText(i[c],i[d]),p=this.numOpts(11,100,1,t=>`${t}%`),u=this.numOpts(20,2e3,10,t=>`${t} µmol`),g=this.offOpts(1,60,1,t=>`${t} min`),m=(t,e)=>V`<label class="pe-cell">
      <span>${t}</span>${e}</label>`,f=t=>V`<div class="pe-cellrow">${t}</div>`,v=m("Go dark",n("go_dark",this.threshOpts())),b=m("Turn off",n("turn_off",this.threshOpts()));return V`
      <div class="pe-light">
      ...
      ${this.planEnvHas("temp")?n("Temp "+s,"temp",this.envOptsFor("env_temp_day"),this.envOptsFor("env_temp_deadband")):Q}
      ${this.planEnvHas("humi")?n("Humidity","humi",this.envOptsFor("env_humi_day"),this.envOptsFor("env_humi_deadband")):Q}
      ${this.planEnvHas("co2")?n("CO₂","co2",this.envOptsFor("env_co2_day"),this.envOptsFor("env_co2_deadband")):Q}
      ...
      ${t.map(t=>{const s=Dt(this.hass,t)||(t.startsWith("st")?"S-Station":`${t.toUpperCase()} Power Strip`);return V`
      ...
      </div>`:Q}`}renderOutletsLog(){const t=this.outletSlots().filter(t=>this.outletNums(t).length>0);if(!t.length)return V`<div class="set-note">No outlets on this controller.</div>`;const e=Date.now(),s=e-3600*this.ologRange*1e3,i=this.accent(),o=(t,e)=>V`<button class="olog-rb ${this.ologRange===t?"on":""}"
      ...
      ${t.map(i=>V`
        ${t.length>1?V`<div class="section-label">${Dt(this.hass,i)||`${i.toUpperCase()} Power Strip`}</div>`:Q}
        ${this.outletNums(i).map(t=>this.ologRow(i,t,s,e))}
      `)}
      <div class="olog-axis"><span>${this.ologRange>=168?"7d ago":"24h ago"}</span><span>now</span></div>`}applyWithSaving(t){t(),this._saving=!0,clearTimeout(this._savingT),this._savingT=setTimeout(()=>{this._saving=!1},1500)}saveBar(t,e,s,i=""){return jt(this.accent(),t,()=>this.applyWithSaving(e),s,i,this._saving)}outletSnapshot(t,e){const s=this.get(`select.sf_${t}_outlet_${e}_mode`)?.state||"Manual",i={};for(const o of It[s]||[])for(const s of["text","number","select","switch"]){const a=this.get(`${s}.sf_${t}_outlet_${e}_${o}`);if(a){i[o]=a.state;break}}return{mode:s,config:i}}copyOutletTo(t,e,s){const i=this.outletSnapshot(t,e),o="Time Slot"===i.mode?this.outletPeriods(t,e):null;for(const t of s){const e=`select.sf_${t.slot}_outlet_${t.n}_mode`;this.hass?.callService("sf","set_outlet_config",{entity_id:e,mode:i.mode,config:i.config}),o&&this.hass?.callService("sf","set_outlet_schedule",{entity_id:e,periods:o})}}renderOutletCopyPanel(t,e){const s=this.hass?kt(this.hass):[],i=[t,...s.filter(e=>e!==t)].filter((t,e,s)=>s.indexOf(t)===e),o=[];for(const s of i){const i=[];for(const o of this.outletNums(s))s===t&&o===e||i.push({slot:s,n:o,key:this.outletKey(s,o),name:this.outletName(s,o),mode:this.get(`select.sf_${s}_outlet_${o}_mode`)?.state||""});i.length&&o.push({slot:s,current:s===t,label:Dt(this.hass,s)||`${s.toUpperCase()} Power Strip`,items:i})}const a=o.flatMap(t=>t.items),n=a.filter(t=>this.outletCopySel[t.key]),r=this.get(`select.sf_${t}_outlet_${e}_mode`)?.state||"Manual";return V`<div class="oc-panel">
      <div class="oc-title">Apply ${this.outletName(t,e)}'s settings
        (<span style="color:${this.accent()}">${r}</span>) to:</div>
      ${a.length?V`<div class="oc-cols">
        ${o.map(t=>V`<div class="oc-col">
          <div class="oc-colhd">${t.label}${t.current?V`<span class="oc-cur">current</span>`:Q}</div>
          ${t.items.map(t=>V`
            <label class="oc-ck">
              ...
              <span>${t.name}${t.mode?V` <span class="oc-mode">· ${t.mode}</span>`:Q}</span>
            </label>`)}
        </div>`)}
      </div>`:V`<div class="oc-mode">No other outlets.</div>`}
      ...
      <div class="tile clickable ${a?"active":""}"
        ...
        ${(()=>{const s=this.outletModeDetail(t,e,i);return s?V`<div class="tile-sub2 ${s.cls}">${s.text}</div>`:Q})()}
      ...
      <div class="dev-row ${c in o?"staged":""}">
        ...
        ${n("Execution Times","cycle_times",1,"")}`;case"Temperature":return r("Device","temp_device",["Heating","Cooling"]);case"Humidity":return r("Device","humidity_device",["Humidifying","Dehumidifying"]);case"CO2":return r("Device","co2_device",["Aeration","Exhaust"]);default:return Q}var l,c,d}renderOutletPop(){const t=this.outletOpen;if(!t)return Q;const e=t.lastIndexOf("_");if(e<0)return Q;const s=t.slice(0,e),i=Number(t.slice(e+1));if(!s||!Number.isFinite(i))return Q;const o=`select.sf_${s}_outlet_${i}_mode`;if(!this.get(o))return Q;const a=`switch.sf_${s}_outlet_${i}`,n=this.get(a),r=`sf_${s}_outlet_${i}_`,l=this.draftVal(o)||this.get(o)?.state||"",c="Time Slot"===l,d=new Set((It[l]||[]).map(t=>`${r}${t}`)),h=Object.keys(this.hass?.states??{}).filter(t=>{const e=t.split(".")[1]??"";return!!d.has(e)&&(!c||e!==`${r}ts_type`&&e!==`${r}ts_start`&&e!==`${r}ts_stop`)}).sort(),p=this.get(o)?.state||"",u=l!==p&&"Manual"!==l&&!c&&(It[l]||[]).length>0&&0===h.length,g=this.outletKey(s,i),m=[...u?[]:[o],...n?[a]:[],...h.filter(t=>/^(switch|number|select|text)\./.test(t))],f=!!this.outletDraft[this.outletKey(s,i)],v=this.outletNameDirty(s,i),b=u;return V`
      <div class="soil-pop" style="--sf-accent:${this.accent()}">
        <div class="soil-pop-head">
          <span>${this.outletName(s,i)}</span>
          <span style="display:inline-flex;align-items:center;gap:10px">
            <button class="oc-copybtn" title="Copy settings to other outlets"
              @click=${()=>{this.outletCopyOpen=!this.outletCopyOpen,this.outletCopySel={}}}>
        ...
        ${this.outletCopyOpen?this.renderOutletCopyPanel(s,i):Q}
      ...
      ${this.saveBar(e,()=>this.saveAlerts(),()=>this.alertsDraft=null,"apply-bar")}`}renderAlertGroup(t,e,s){const i=t[e]||[];return i.length?V`
      ...
      ${o.length?V`
            ...
            </div>`:V`<div class="cali-empty">No log entries on this date.</div>`}`}render(){if(!this.hass||!this.config)return Q;const t=this.hasOutlets();let e=this.tab;"outlets"!==e||t||(e="overview"),"olog"!==e||t&&this.showOutletsLog||(e="overview");const s=this.accent(),i=(t,i)=>V`<button class="tab ${e===t?"active":""}"
        style=${e===t?`color:${s};border-color:${s}`:""}
        @click=${()=>this.tab=t}>${i}</button>`,o=Dt(this.hass,this.config.panel);return V`
      <ha-card style=${this.layoutStyle()||Q}>
        ...
        ${V`<div class="tabs">
              ...
              ${t&&this.showOutletsLog?i("olog","Outlets Log"):Q}
              ${i("cali","Calibration")}
              ${i("alerts","Alerts")}
              ${i("log","Log")}
              ${i("settings","Settings")}
      ...
      </details>`}renderSettings(){const t=this.accent(),e=this.colorDraft,s=e?.mode??this.colorMode,i=e?.modeIn??this.colorModeIn,o=e?.hi??this.colHi,a=e?.lo??this.colLo,n=e?.in??this.colIn,r=e?.warn??this.colWarn,l=e?.showTrend??this.showTrend,c=e?.showBand??this.showBand,d=e?.showTargets??this.showTargets,h=e?.tileSummary??this.tileSummary,p=e?.hour12??this.hour12,u=e?.showConn??this.showConn,g=e?.connCustom??this.connCustom,m=e?.connSignal??this.connSignal,f=e?.showOutletsLog??this.showOutletsLog,v=e?.showOutletQuick??this.showOutletQuick,b=e?.outletQuickRemember??this.outletQuickRemember,_=e?.customNames??this.customOutletNames,$=e?.customLayout??this.customLayout,x=e?.scale??this.cardScale,y=e?.cols??this.tileCols,w=!!this.get(this.eid("light","light_2")),S=e?.omode??this.outletColorMode,k=e?.ocManual??this.ocManual,O=e?.ocSched??this.ocSched,C=e?.ocEnv??this.ocEnv,M=e?.ocDrip??this.ocDrip,D=this.hasOutlets(),N=e?.dmode??this.deviceColorMode,A=e?.dcManual??this.dcManual,T=e?.dcSched??this.dcSched,E=e?.dcAuto??this.dcAuto,L=this.overviewDevices().length>0,R=!!e&&(void 0!==e.mode&&e.mode!==this.colorMode||void 0!==e.modeIn&&e.modeIn!==this.colorModeIn||void 0!==e.source&&e.source!==this.colorSource||void 0!==e.warn&&e.warn!==this.colWarn||void 0!==e.showTrend&&e.showTrend!==this.showTrend||void 0!==e.showBand&&e.showBand!==this.showBand||void 0!==e.showTargets&&e.showTargets!==this.showTargets||void 0!==e.tileSummary&&e.tileSummary!==this.tileSummary||void 0!==e.hour12&&e.hour12!==this.hour12||void 0!==e.showConn&&e.showConn!==this.showConn||void 0!==e.connCustom&&e.connCustom!==this.connCustom||void 0!==e.connSignal&&e.connSignal!==this.connSignal||void 0!==e.showOutletsLog&&e.showOutletsLog!==this.showOutletsLog||void 0!==e.showOutletQuick&&e.showOutletQuick!==this.showOutletQuick||void 0!==e.outletQuickRemember&&e.outletQuickRemember!==this.outletQuickRemember||void 0!==e.hi&&e.hi!==this.colHi||void 0!==e.lo&&e.lo!==this.colLo||void 0!==e.in&&e.in!==this.colIn||void 0!==e.hide2&&e.hide2!==this.hideLight2||void 0!==e.customNames&&e.customNames!==this.customOutletNames||void 0!==e.customLayout&&e.customLayout!==this.customLayout||void 0!==e.scale&&e.scale!==this.cardScale||void 0!==e.cols&&e.cols!==this.tileCols||void 0!==e.omode&&e.omode!==this.outletColorMode||void 0!==e.ocManual&&e.ocManual!==this.ocManual||void 0!==e.ocSched&&e.ocSched!==this.ocSched||void 0!==e.ocEnv&&e.ocEnv!==this.ocEnv||void 0!==e.ocDrip&&e.ocDrip!==this.ocDrip||void 0!==e.dmode&&e.dmode!==this.deviceColorMode||void 0!==e.dcManual&&e.dcManual!==this.dcManual||void 0!==e.dcSched&&e.dcSched!==this.dcSched||void 0!==e.dcAuto&&e.dcAuto!==this.dcAuto),P=t=>this.colorDraft={...this.colorDraft??{},...t},z=(e,s,i,o,a)=>V`
      <button class="seg ${e===s?"on":""}"
        style=${e===s?`border-color:${t};color:${t}`:Q}
        @click=${a}>
        <ha-icon icon=${o}></ha-icon><span>${i}</span>
      </button>`,F=e?.source??this.colorSource,I=(e,s,i)=>V`
      <button class="seg ${F===e?"on":""}"
        style=${F===e?`border-color:${t};color:${t}`:Q}
        @click=${()=>P({source:e})}>
      ...
      <div class="seg-row">
        ${I("alarms","Alarms","mdi:bell-outline")}
        ${I("targets","Targets","mdi:target")}
        ${I("both","Both","mdi:set-center")}
      </div>
      ...
      <div class="seg-row">
        ${z(s,"off","No color","mdi:circle-off-outline",()=>P({mode:"off"}))}
        ${z(s,"tile","Tile color","mdi:square-rounded",()=>P({mode:"tile"}))}
        ${z(s,"text","Text color","mdi:format-color-text",()=>P({mode:"text"}))}
      </div>
      <div class="color-row">
        ${B("Above max",o,t=>P({hi:t}))}
        ${B("Below min",a,t=>P({lo:t}))}
        ${B("Near edge",r,t=>P({warn:t}))}
      </div>
      ...
      <div class="seg-row">
        ${z(i,"off","No color","mdi:circle-off-outline",()=>P({modeIn:"off"}))}
        ${z(i,"tile","Tile color","mdi:square-rounded",()=>P({modeIn:"tile"}))}
        ${z(i,"text","Text color","mdi:format-color-text",()=>P({modeIn:"text"}))}
      </div>
      <div class="color-row">
        ${B("In range",n,t=>P({in:t}))}
      </div>
      ...
      ${D?V`
            ...
            <div class="set-note">
              ...
              <span style="color:${C}">Environment</span>,
              <span style="color:${M}">Drip</span>. Off outlets stay neutral.
            </div>
            <div class="seg-row">
              ${z(S,"off","No color","mdi:circle-off-outline",()=>P({omode:"off"}))}
              ${z(S,"tile","Tile color","mdi:square-rounded",()=>P({omode:"tile"}))}
              ${z(S,"text","Text color","mdi:format-color-text",()=>P({omode:"text"}))}
            </div>
            <div class="color-row">
              ${B("Manual",k,t=>P({ocManual:t}))}
              ${B("Scheduled",O,t=>P({ocSched:t}))}
            </div>
            <div class="color-row">
              ${B("Environment",C,t=>P({ocEnv:t}))}
              ${B("Drip",M,t=>P({ocDrip:t}))}
            </div>`:Q}
      ...
      ${L?V`
            ...
            <div class="set-note">
              ...
              <span style="color:${A}">Manual</span>,
              <span style="color:${T}">Scheduled</span>,
              <span style="color:${E}">Auto</span> (Environment / PPFD). A
              <span style="color:${Et}">fault</span> always overrides.
            </div>
            <div class="seg-row">
              ${z(N,"off","No color","mdi:circle-off-outline",()=>P({dmode:"off"}))}
              ${z(N,"tile","Tile color","mdi:square-rounded",()=>P({dmode:"tile"}))}
              ${z(N,"text","Text color","mdi:format-color-text",()=>P({dmode:"text"}))}
            </div>
            <div class="color-row">
              ${B("Manual",A,t=>P({dcManual:t}))}
              ${B("Scheduled",T,t=>P({dcSched:t}))}
              ${B("Auto",E,t=>P({dcAuto:t}))}
            </div>`:Q}
      ...
      <div class="toggle-row" style="margin-top:8px">
        ...
        <button class="toggle ${u?"on":""}"
          ...
          @click=${()=>P({showConn:!u})}></button>
      </div>
      ${u?V`
        <div class="toggle-row" style="margin-top:8px">
          <span>Use a custom signal source</span>
          <button class="toggle ${g?"on":""}"
            style=${g?`background:${t}`:Q}
            @click=${()=>P({connCustom:!g})}></button>
        </div>
        <div class="set-note">
        ...
        ${g?V`
          <div class="toggle-row" style="margin-top:6px">
            ...
            <select style="max-width:60%"
              @change=${t=>P({connSignal:t.target.value})}>
      ...
      <div class="toggle-row">
        ...
        <button class="toggle ${_?"on":""}"
          style=${_?`background:${t}`:Q}
          @click=${()=>P({customNames:!_})}></button>
      </div>
      <div class="toggle-row" style="margin-top:8px">
        <span>Show Outlets Log tab</span>
        <button class="toggle ${f?"on":""}"
          style=${f?`background:${t}`:Q}
          @click=${()=>P({showOutletsLog:!f})}></button>
      </div>
      <div class="set-note">
      ...
      <div class="toggle-row" style="margin-top:8px">
        ...
        <button class="toggle ${v?"on":""}"
          style=${v?`background:${t}`:Q}
          @click=${()=>P({showOutletQuick:!v})}></button>
      </div>
      <div class="set-note">
      ...
      ${v?V`
        <div class="toggle-row" style="margin-top:6px">
          ...
          <button class="toggle ${b?"on":""}"
            style=${b?`background:${t}`:Q}
            @click=${()=>P({outletQuickRemember:!b})}></button>
        </div>
        <div class="set-note">
    ...
    .oq-btn.on { border-color: #54c06a; background: rgba(84,192,106,.14); }
  ...
  `,t([ut({attribute:!1})],qt.prototype,"hass",void 0),t([gt()],qt.prototype,"config",void 0),t([gt()],qt.prototype,"tab",void 0),t([gt()],qt.prototype,"envSubView",void 0),t([gt()],qt.prototype,"planDraft",void 0),t([gt()],qt.prototype,"planEditStage",void 0),t([gt()],qt.prototype,"planShowAll",void 0),t([gt()],qt.prototype,"planDelArm",void 0),t([gt()],qt.prototype,"colorMode",void 0),t([gt()],qt.prototype,"colHi",void 0),t([gt()],qt.prototype,"colLo",void 0),t([gt()],qt.prototype,"colorModeIn",void 0),t([gt()],qt.prototype,"colIn",void 0),t([gt()],qt.prototype,"colWarn",void 0),t([gt()],qt.prototype,"colorSource",void 0),t([gt()],qt.prototype,"showTrend",void 0),t([gt()],qt.prototype,"showBand",void 0),t([gt()],qt.prototype,"showTargets",void 0),t([gt()],qt.prototype,"tileSummary",void 0),t([gt()],qt.prototype,"hour12",void 0),t([gt()],qt.prototype,"customOutletNames",void 0),t([gt()],qt.prototype,"outletNames",void 0),t([gt()],qt.prototype,"showConn",void 0),t([gt()],qt.prototype,"connCustom",void 0),t([gt()],qt.prototype,"connSignal",void 0),t([gt()],qt.prototype,"showOutletsLog",void 0),t([gt()],qt.prototype,"ologRange",void 0),t([gt()],qt.prototype,"ologOpen",void 0),t([gt()],qt.prototype,"_ologVer",void 0),t([gt()],qt.prototype,"_saving",void 0),t([gt()],qt.prototype,"outletCopyOpen",void 0),t([gt()],qt.prototype,"outletCopySel",void 0),t([gt()],qt.prototype,"showOutletQuick",void 0),t([gt()],qt.prototype,"outletQuickRemember",void 0),t([gt()],qt.prototype,"customLayout",void 0),t([gt()],qt.prototype,"cardScale",void 0),t([gt()],qt.prototype,"tileCols",void 0),t([gt()],qt.prototype,"paramOpen",void 0),t([gt()],qt.prototype,"_graphVer",void 0),t([gt()],qt.prototype,"hideLight2",void 0),t([gt()],qt.prototype,"outletColorMode",void 0),t([gt()],qt.prototype,"ocManual",void 0),t([gt()],qt.prototype,"ocSched",void 0),t([gt()],qt.prototype,"ocEnv",void 0),t([gt()],qt.prototype,"ocDrip",void 0),t([gt()],qt.prototype,"deviceColorMode",void 0),t([gt()],qt.prototype,"dcManual",void 0),t([gt()],qt.prototype,"dcSched",void 0),t([gt()],qt.prototype,"dcAuto",void 0),t([gt()],qt.prototype,"colorDraft",void 0),t([gt()],qt.prototype,"alertsDraft",void 0),t([gt()],qt.prototype,"soilOpen",void 0),t([gt()],qt.prototype,"soilAllOpen",void 0),t([gt()],qt.prototype,"deviceOpen",void 0),t([gt()],qt.prototype,"outletOpen",void 0),t([gt()],qt.prototype,"draft",void 0),t([gt()],qt.prototype,"modePick",void 0),t([gt()],qt.prototype,"outletDraft",void 0),t([gt()],qt.prototype,"outletNameDraft",void 0),t([gt()],qt.prototype,"outletCfgDraft",void 0),t([gt()],qt.prototype,"leafSpots",void 0),t([gt()],qt.prototype,"leafCalTarget",void 0),t([gt()],qt.prototype,"logDate",void 0),t([gt()],qt.prototype,"logDev",void 0),t([gt()],qt.prototype,"logType",void 0);class Kt extends ct{constructor(){super(...arguments),this._config={type:"custom:spider-farmer-card"}}setConfig(t){this._config={...t}}_emit(t){this._config=t,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:t},bubbles:!0,composed:!0}))}_panelChanged(t){const e=t.target.value,s={...this._config};e?s.panel=e:delete s.panel,this._emit(s)}_titleChanged(t){const e=t.target.value.trim(),s={...this._config};e?s.title=e:delete s.title,this._emit(s)}_tabChanged(t){const e=t.target.value;this._emit({...this._config,default_tab:e})}_outletToggled(t,e){const s=e.target.checked,i=new Set(this._config.outlets??[]);s?i.add(t):i.delete(t);const o=[...i].sort(),a={...this._config};o.length?a.outlets=o:delete a.outlets,this._emit(a)}render(){if(!this.hass)return Q;const t=this._config,e=t.default_tab,s=St(this.hass),i=Mt(this.hass,t.panel),o=/^(ac|st)\d+/.test(t.panel||"")||i.length>0,a=!(!t.panel||"1"!==this.hass.states[`sensor.sf_${t.panel}_alarm_settings`]?.attributes?.card_options?.outlets_log),n=t=>{const e=Dt(this.hass,t);return e?`${t} — ${e}`:t};return V`
      <div class="form">
        <label class="field">
        ...
        <label class="field">
          ...
          <select @change=${this._tabChanged}>
            ...
            ${o?V`<option value="outlets" ?selected=${"outlets"===e}>Outlets</option>`:Q}
            ${o&&a?V`<option value="outlets_log" ?selected=${"outlets_log"===e}>Outlets Log</option>`:Q}
  ...
  `,t([ut({attribute:!1})],Kt.prototype,"hass",void 0),t([gt()],Kt.prototype,"_config",void 0);const Jt=/^sf_(se\d+)_light$/;function Yt(t){const e=new Set;for(const s of Object.keys(t.states)){if(!s.startsWith("light."))continue;const t=bt(s).match(Jt);t&&e.add(t[1])}return[...e].sort((t,e)=>Number(t.replace(/\D/g,""))-Number(e.replace(/\D/g,"")))}class Xt extends ct{constructor(){super(...arguments),this.draft=null,this.ctlDraft={}}setConfig(t){this.config=t}getCardSize(){return 7}static getStubConfig(t){const e=t?Yt(t):[];return{type:"custom:spider-light-card",...e[0]?{light:e[0]}:{}}}accent(){return this.config.accent||mt}seSlot(){return this.config.light||(this.hass?Yt(this.hass)[0]:"")||"se1"}get(t){return this.hass?.states[t]}shouldUpdate(t){return t.has("config")||t.has("hass")||t.has("draft")||t.has("ctlDraft")}cur(t,e){return t in this.ctlDraft?this.ctlDraft[t]:e}stageCtl(t,e){this.ctlDraft={...this.ctlDraft,[t]:e}}isDirty(){return Object.keys(this.ctlDraft).length>0||null!==this.draft}applyAll(t){const e=this.ctlDraft,s=`light.sf_${t}_light`;if("bri"in e){const t=Number(e.bri);t>0?this.hass?.callService("light","turn_on",{entity_id:s,brightness_pct:t}):this.hass?.callService("light","turn_off",{entity_id:s})}"mode"in e&&this.hass?.callService("select","select_option",{entity_id:`select.sf_${t}_mode`,option:e.mode});for(const t of Object.keys(e))t.includes(".")&&(t.startsWith("number.")?this.hass?.callService("number","set_value",{entity_id:t,value:Number(e[t])}):t.startsWith("text.")&&this.hass?.callService("text","set_value",{entity_id:t,value:e[t]}));if("power"in e){const t="on"===e.power;t&&"bri"in e||this.hass?.callService("light",t?"turn_on":"turn_off",{entity_id:s})}this.draft&&this.saveSchedule(t),this.ctlDraft={}}discardAll(){Object.keys(this.ctlDraft).length&&(this.ctlDraft={}),null!==this.draft&&(this.draft=null)}render(){if(!this.hass||!this.config)return Q;const t=this.seSlot(),e=this.get(`light.sf_${t}_light`);if(!e)return V`<ha-card>
      ...
      </ha-card>`;const s="on"===e.state,i=s?Math.max(0,Math.min(100,Math.round((e.attributes.brightness??0)/255*100))):0,o=this.get(`select.sf_${t}_mode`),a=this.cur("mode",o?.state??""),n="bri"in this.ctlDraft,r="on"===this.cur("power",s?"on":"off"),l=n?Number(this.ctlDraft.bri):r?i:0,c=n?l>0:r,d=Dt(this.hass,t),h=this.accent(),p=l/100,[u,g]=_t(100,100,78,135+270*p);return V`
      <ha-card>
        <div class="header">
          <span class="title">${this.config.title||"Spider Light"}</span>
          ${d?V`<span class="device">${d}</span>`:Q}
        </div>
  ...
  `,t([ut({attribute:!1})],Xt.prototype,"hass",void 0),t([gt()],Xt.prototype,"config",void 0),t([gt()],Xt.prototype,"draft",void 0),t([gt()],Xt.prototype,"ctlDraft",void 0);const Zt={SE4500:{name:"SE4500",watts:320,isBar:!0,barCount:3,lW:1.163,lL:.369,ppfd:{8:{c:1800,a:1350,e:900},10:{c:1500,a:1150,e:780},12:{c:1250,a:960,e:650},14:{c:1060,a:820,e:545},16:{c:910,a:700,e:465},18:{c:790,a:610,e:400},20:{c:690,a:530,e:350},22:{c:610,a:470,e:305},24:{c:545,a:420,e:270},26:{c:490,a:375,e:240},28:{c:440,a:340,e:215},30:{c:400,a:305,e:195},32:{c:360,a:275,e:175},36:{c:300,a:230,e:145},42:{c:240,a:184,e:115},48:{c:195,a:149,e:93},60:{c:150,a:115,e:72},72:{c:118,a:90,e:56},84:{c:95,a:72,e:45}}},SF2000:{name:"SF2000",watts:200,isBar:!1,barCount:0,lW:.864,lL:.432,ppfd:{8:{c:1600,a:1050,e:480},10:{c:1320,a:870,e:400},12:{c:1100,a:720,e:330},14:{c:920,a:600,e:275},16:{c:780,a:505,e:230},18:{c:660,a:430,e:193},20:{c:570,a:370,e:165},22:{c:495,a:320,e:143},24:{c:435,a:280,e:125},26:{c:385,a:248,e:110},28:{c:340,a:218,e:97},30:{c:305,a:196,e:87},32:{c:274,a:176,e:78},36:{c:226,a:145,e:64},42:{c:182,a:116,e:51},48:{c:148,a:95,e:42},60:{c:97,a:62,e:27},72:{c:68,a:43,e:19},84:{c:49,a:31,e:14}}},SE5000:{name:"SE5000",watts:480,isBar:!0,barCount:4,lW:.855,lL:.85,ppfd:{8:{c:1561,a:1101,e:597},10:{c:1478,a:1041,e:631},12:{c:1402,a:986,e:661},14:{c:1332,a:935,e:686},16:{c:1267,a:889,e:708},18:{c:1206,a:845,e:727},20:{c:1150,a:805,e:744},22:{c:1098,a:767,e:752},24:{c:1049,a:732,e:718},26:{c:1003,a:700,e:686},28:{c:960,a:669,e:656},30:{c:920,a:640,e:628},32:{c:883,a:614,e:601},36:{c:814,a:565,e:554},42:{c:725,a:502,e:492},48:{c:650,a:449,e:440},60:{c:531,a:366,e:358},72:{c:442,a:303,e:297},84:{c:373,a:256,e:251}}},SF7000:{name:"SF7000",watts:650,isBar:!1,barCount:0,lW:.737,lL:.558,ppfd:{8:{c:2560,a:1105,e:314},10:{c:2298,a:1052,e:359},12:{c:2053,a:983,e:394},14:{c:1881,a:955,e:434},16:{c:1714,a:912,e:465},18:{c:1597,a:903,e:506},20:{c:1441,a:833,e:520},22:{c:1328,a:798,e:543},24:{c:1218,a:752,e:556},26:{c:1138,a:734,e:582},28:{c:1059,a:704,e:598},30:{c:987,a:677,e:613},32:{c:922,a:651,e:626},36:{c:811,a:603,e:591},42:{c:678,a:541,e:530},48:{c:575,a:488,e:478},60:{c:429,a:403,e:395},72:{c:332,a:332,e:325},84:{c:265,a:265,e:259}}},G1000W:{name:"G1000W",watts:1e3,isBar:!0,barCount:8,lW:1.153,lL:1.122,ppfd:{8:{c:2156,a:1822,e:1555},10:{c:2068,a:1769,e:1527},12:{c:1985,a:1720,e:1501},14:{c:1908,a:1672,e:1476},16:{c:1834,a:1626,e:1451},18:{c:1765,a:1582,e:1427},20:{c:1700,a:1540,e:1404},22:{c:1638,a:1499,e:1382},24:{c:1580,a:1460,e:1360},26:{c:1524,a:1422,e:1339},28:{c:1472,a:1386,e:1319},30:{c:1422,a:1352,e:1299},32:{c:1375,a:1318,e:1280},36:{c:1287,a:1255,e:1230},42:{c:1170,a:1168,e:1145},48:{c:1068,a:1068,e:1047},60:{c:901,a:901,e:883},72:{c:770,a:770,e:755},84:{c:666,a:666,e:653}}}};function te(t,e,s){const i=t.ppfd,o=Object.keys(i).map(Number).sort((t,e)=>t-e);let a=o[0],n=o[o.length-1];for(let t=0;t<o.length-1;t++)if(e>=o[t]&&e<=o[t+1]){a=o[t],n=o[t+1];break}e<=o[0]&&(a=n=o[0]),e>=o[o.length-1]&&(a=n=o[o.length-1]);const r=a===n?0:(e-a)/(n-a),l=(t,e)=>Math.round((t+(e-t)*r)*s/100);return{center:l(i[a].c,i[n].c),avg:l(i[a].a,i[n].a),edge:l(i[a].e,i[n].e)}}function ee(t,e){const s=Math.max(0,Math.min(1,t/e));let i,o,a;if(s<.2){const t=s/.2;i=0,o=Math.round(80*t),a=Math.round(160+95*t)}else if(s<.4){const t=(s-.2)/.2;i=0,o=Math.round(80+175*t),a=Math.round(255-255*t)}else if(s<.6){const t=(s-.4)/.2;i=Math.round(220*t),o=255,a=0}else if(s<.8){const t=(s-.6)/.2;i=Math.round(220+35*t),o=Math.round(255-120*t),a=0}else{const t=(s-.8)/.2;i=255,o=Math.round(135-135*t),a=0}return[i,o,a]}class se extends ct{constructor(){super(...arguments),this.tab="view",this.rev=0,this.s={tW:.61,tL:1.22,tH:1.981,model:"SE4500",hin:18,plantIn:12,numPlants:2,dim:100,photo:18,metric:!1},this.manualDim=100,this.auto=!1,this.brightSrc="",this.T=null,this.scene=null,this.camera=null,this.renderer=null,this.raf=0,this.o={},this.cam={theta:.52,phi:.36,r:3.8,drag:!1,px:0,py:0},this.dirty=!0,this.needRender=!0,this.fitDone=!1,this.serverSynced=!1,this.localApplied=!1,this.saveT=null,this.saved=null}setConfig(t){this.config=t;const e=t.defaults||{},s=t.tent||{};this.s.model=t.light_model&&Zt[t.light_model]?t.light_model:"SE4500",this.s.hin=e.height_inches??18,this.s.plantIn=e.plant_height_inches??12,this.s.numPlants=e.num_plants??2,this.s.dim=e.dimmer_percent??100,this.manualDim=this.s.dim,this.s.photo=e.photoperiod_hours??18,this.s.tW=Math.max(.3,.3048*(s.width_ft??2)),this.s.tL=Math.max(.6,.3048*(s.length_ft??4)),this.s.tH=Math.max(.9,.3048*(s.height_ft??6.5)),this.s.metric=this.resolveMetric(),this.serverSynced=!1,this.localApplied=!1,this.dirty=!0,this.fitDone=!1,this.saved=this.blob()}getCardSize(){return 11}static getStubConfig(t){let e;if(t){const s=Object.keys(t.states).filter(t=>/^sensor\.sf_[a-z0-9]+_alarm_settings$/.test(t)).sort(),i=s[0]&&/^sensor\.sf_([a-z0-9]+)_alarm_settings$/.exec(s[0]);i&&(e=i[1])}return{type:"custom:ppfd-3d-card",title:"PPFD Visualizer",light_model:"SE4500",unit_system:"auto",...e?{panel:e}:{},defaults:{height_inches:18,plant_height_inches:12,num_plants:2,dimmer_percent:100,photoperiod_hours:18},tent:{width_ft:2,length_ft:4,height_ft:6.5}}}resolveMetric(){const t=(this.config?.unit_system||"auto").toLowerCase();if("metric"===t)return!0;if("imperial"===t)return!1;const e=this.hass?.config?.unit_system;return!(!e||!e.length)&&"mi"!==e.length}fmtSmall(t){return this.s.metric?`${Math.round(2.54*t)} cm`:`${Math.round(t)}"`}fmtTentDim(t){return this.s.metric?(.3048*t).toFixed(2):(+t).toFixed(1)}tentUnit(){return this.s.metric?"m":"ft"}optKey(){const t=this.config||{};return"ppfd:"+(t.card_id||t.light_model||"main")}panelSlot(){if(this.config?.panel)return this.config.panel;if(this.hass){const t=Object.keys(this.hass.states).filter(t=>/^sensor\.sf_[a-z0-9]+_alarm_settings$/.test(t)).sort();if(t.length){const e=/^sensor\.sf_([a-z0-9]+)_alarm_settings$/.exec(t[0]);if(e)return e[1]}}return null}alarmEntity(){const t=this.panelSlot();if(!t||!this.hass)return null;const e=`sensor.sf_${t}_alarm_settings`;return this.hass.states[e]?e:null}lsKey(){return`ppfd3d:${this.panelSlot()||"nopanel"}:${this.optKey()}`}blob(){return{model:this.s.model,hin:this.s.hin,plantIn:this.s.plantIn,numPlants:this.s.numPlants,photo:this.s.photo,dim:this.manualDim,tW:this.s.tW,tL:this.s.tL,tH:this.s.tH,auto:!!this.auto,src:this.brightSrc||""}}applyBlob(t){t&&(t.model&&Zt[t.model]&&(this.s.model=t.model),null!=t.hin&&(this.s.hin=t.hin),null!=t.plantIn&&(this.s.plantIn=t.plantIn),null!=t.numPlants&&(this.s.numPlants=t.numPlants),null!=t.photo&&(this.s.photo=t.photo),null!=t.dim&&(this.manualDim=t.dim,this.s.dim=t.dim),null!=t.tW&&(this.s.tW=t.tW),null!=t.tL&&(this.s.tL=t.tL),null!=t.tH&&(this.s.tH=t.tH),this.auto=!!t.auto,this.brightSrc=t.src||"")}hydrateLocal(){if(!this.localApplied){this.localApplied=!0;try{const t=localStorage.getItem(this.lsKey());t&&(this.applyBlob(JSON.parse(t)),this.dirty=!0)}catch{}this.saved=this.blob()}}adoptServer(){if(this.serverSynced)return;const t=this.alarmEntity();if(!t)return;this.serverSynced=!0;const e=this.hass.states[t].attributes.card_options,s=this.optKey();if(e&&void 0!==e[s])try{this.applyBlob(JSON.parse(e[s])),this.dirty=!0}catch{}this.saved=this.blob()}queueSaveView(){clearTimeout(this.saveT),this.saveT=setTimeout(()=>this.saveView(),700)}saveView(){const t=this.blob();if(this.saved)for(const e of se.SET_FIELDS)t[e]=this.saved[e];this.persistBlob(t),this.saved=t}applySettings(){const t=this.blob();this.persistBlob(t),this.saved=t,this.repaint()}discardSettings(){this.saved&&(this.auto=!!this.saved.auto,this.brightSrc=this.saved.src||"",this.s.numPlants=this.saved.numPlants,this.s.tW=this.saved.tW,this.s.tL=this.saved.tL,this.s.tH=this.saved.tH,this.auto?this.readLive():this.s.dim=this.manualDim,this.dirty=!0,this.repaint())}settingsDirty(){const t=this.saved;return!!t&&(!!this.auto!=!!t.auto||(this.brightSrc||"")!==(t.src||"")||this.s.numPlants!==t.numPlants||this.s.tW!==t.tW||this.s.tL!==t.tL||this.s.tH!==t.tH)}persistBlob(t){const e=JSON.stringify(t),s=this.alarmEntity();s&&this.hass?.callService&&this.hass.callService("sf","set_card_option",{entity_id:s,key:this.optKey(),value:e});try{localStorage.setItem(this.lsKey(),e)}catch{try{const t=this.lsKey();for(const e of Object.keys(localStorage))e.startsWith("ppfd3d:")&&e!==t&&localStorage.removeItem(e);localStorage.setItem(t,e)}catch{}}}brightnessOf(t){if(!t)return 0;if(String(t.entity_id).startsWith("light.")){if("on"!==t.state)return 0;const e=t.attributes&&t.attributes.brightness;return null!=e?Math.round(e/255*100):100}const e=parseFloat(t.state);return isNaN(e)?0:Math.max(0,Math.min(100,Math.round(e)))}readLive(){if(!this.hass)return!1;let t=!1;const e=this.config?.entities||{};if(e.dimmer_percent){const s=this.hass.states[e.dimmer_percent];if(s){const e=parseFloat(s.state);if(!isNaN(e)){const s=Math.max(10,Math.min(100,e));s===this.s.dim||this.auto||(this.s.dim=s,this.manualDim=s,t=!0)}}}if(e.height_inches){const s=this.hass.states[e.height_inches];if(s){const e=parseFloat(s.state);if(!isNaN(e)){const s=Math.max(8,e);s!==this.s.hin&&(this.s.hin=s,t=!0)}}}if(this.auto&&this.brightSrc){const e=this.brightnessOf(this.hass.states[this.brightSrc]);e!==this.s.dim&&(this.s.dim=e,t=!0)}return t}willUpdate(t){if(t.has("config")&&this.hydrateLocal(),t.has("hass")&&this.hass){const t=this.resolveMetric();t!==this.s.metric&&(this.s.metric=t,this.dirty=!0),this.hydrateLocal(),this.adoptServer(),this.readLive()&&(this.dirty=!0)}}firstUpdated(){this.loadThree()}updated(){this.dirty&&(this.needRender=!0)}repaint(){this.rev++}tentInches(){return Math.round(this.s.tH/.0254)}onModel(t){this.s.model=t.target.value,this.dirty=!0,this.repaint(),this.queueSaveView()}onSlider(t,e){const s=Number(e.target.value),i=this.tentInches();"hin"===t?this.s.hin=Math.min(s,i):"plantIn"===t?this.s.plantIn=Math.min(s,i):"numPlants"===t?this.s.numPlants=isNaN(s)?1:Math.max(1,Math.min(12,Math.round(s))):"photo"===t?this.s.photo=s:"dim"===t&&(this.auto||(this.s.dim=s,this.manualDim=s)),this.dirty=!0,this.repaint(),"numPlants"!==t&&this.queueSaveView()}onTent(t,e){const s=Number(e.target.value),i=this.s.metric?1:.3048,o=isNaN(s)?this.s[t]:s*i;"tW"===t?this.s.tW=Math.max(.3,o):"tL"===t?this.s.tL=Math.max(.6,o):this.s.tH=Math.max(.9,o);const a=this.tentInches();this.s.hin>a&&(this.s.hin=a),this.s.plantIn>a&&(this.s.plantIn=a),this.dirty=!0,this.repaint()}onAuto(t){if(this.auto=t.target.checked,this.auto){if(!this.brightSrc){const t=this.brightOptions();t.length&&(this.brightSrc=t[0].id)}this.readLive()}else this.s.dim=this.manualDim;this.dirty=!0,this.repaint()}onBrightSrc(t){this.brightSrc=t.target.value,this.auto&&this.readLive(),this.dirty=!0,this.repaint()}brightOptions(){if(!this.hass)return[];return Object.keys(this.hass.states).filter(t=>!!t.startsWith("light.sf_")||!(!t.startsWith("number.sf_")||!/schedule_brightness/i.test(t))).sort().map(t=>({id:t,name:this.hass.states[t].attributes.friendly_name||t}))}loadThree(){if(window.THREE)return void this.initThree();const t=window;if(!t._ppfdCBs){t._ppfdCBs=[];const e=document.createElement("script");e.src="https://cdnjs.cloudflare.com/ajax/libs/three.js/r128/three.min.js",e.onload=()=>t._ppfdCBs.forEach(t=>t()),document.head.appendChild(e)}t._ppfdCBs.push(()=>this.initThree())}canvas(){return this.renderRoot.querySelector("#c")}initThree(){const t=this.T=window.THREE,e=this.canvas();if(!t||!e)return;const s=e.parentElement?.offsetWidth||400;e.style.height="340px";const i=this.scene=new t.Scene;i.background=new t.Color(592914),this.camera=new t.PerspectiveCamera(36,s/340,.01,40);const o=this.renderer=new t.WebGLRenderer({canvas:e,antialias:!0});o.setSize(s,340),o.setPixelRatio(Math.min(devicePixelRatio,2)),i.add(new t.AmbientLight(3359829,1.1));const a=new t.DirectionalLight(16777215,.55);a.position.set(2,5,3),i.add(a),this.attachCam(e),this.dirty=!0,this.needRender=!0;const n=()=>{this.raf=requestAnimationFrame(n),this.dirty&&(this.dirty=!1,this.rebuild(),this.needRender=!0),this.needRender&&(this.needRender=!1,this.updCam(),o.render(i,this.camera))};n()}attachCam(t){t.addEventListener("mousedown",t=>{this.cam.drag=!0,this.cam.px=t.clientX,this.cam.py=t.clientY}),window.addEventListener("mouseup",()=>{this.cam.drag=!1}),window.addEventListener("mousemove",t=>{this.cam.drag&&(this.cam.theta-=.007*(t.clientX-this.cam.px),this.cam.phi=Math.max(.05,Math.min(1.3,this.cam.phi-.005*(t.clientY-this.cam.py))),this.cam.px=t.clientX,this.cam.py=t.clientY,this.needRender=!0)}),t.addEventListener("wheel",t=>{this.cam.r=Math.max(1.2,Math.min(10,this.cam.r+.005*t.deltaY)),this.needRender=!0},{passive:!0});let e=null;t.addEventListener("touchstart",t=>{1===t.touches.length&&(e={x:t.touches[0].clientX,y:t.touches[0].clientY,t:this.cam.theta,p:this.cam.phi})}),t.addEventListener("touchmove",t=>{e&&1===t.touches.length&&(this.cam.theta=e.t-.007*(t.touches[0].clientX-e.x),this.cam.phi=Math.max(.05,Math.min(1.3,e.p-.005*(t.touches[0].clientY-e.y))),this.needRender=!0)},{passive:!0})}updCam(){if(!this.camera)return;const{theta:t,phi:e,r:s}=this.cam,i=this.s.tH;this.camera.position.set(s*Math.cos(e)*Math.sin(t),s*Math.sin(e)+.38*i,s*Math.cos(e)*Math.cos(t)),this.camera.lookAt(0,.3*i,0)}rem(t){this.o[t]&&this.scene&&this.scene.remove(this.o[t]),this.o[t]=null}sprite(t,e){const s=this.T,i=document.createElement("canvas");i.width=128,i.height=64;const o=i.getContext("2d");return o.fillStyle="rgba(255,255,255,0.92)",o.font=`bold ${e}px sans-serif`,o.textAlign="center",o.textBaseline="middle",o.fillText(t,64,32),new s.Sprite(new s.SpriteMaterial({map:new s.CanvasTexture(i),transparent:!0,depthTest:!1}))}rebuild(){const t=this.T,e=this.scene;if(!t||!e)return;const{tW:s,tL:i,tH:o,model:a,hin:n,plantIn:r,numPlants:l,dim:c}=this.s,d=Zt[a]||Zt.SE4500,h=Math.max(1,n-r),p=te(d,h,c),u=.0254*r,g=.0254*n,m=s/2,f=i/2,v=s>i;this.rem("fr");const b=new t.Group,_=[[m,0,f],[m,0,-f],[-m,0,-f],[-m,0,f],[m,o,f],[m,o,-f],[-m,o,-f],[-m,o,f]],$=[];[[0,1],[1,2],[2,3],[3,0],[4,5],[5,6],[6,7],[7,4],[0,4],[1,5],[2,6],[3,7]].forEach(([t,e])=>$.push(..._[t],..._[e]));const x=new t.BufferGeometry;x.setAttribute("position",new t.Float32BufferAttribute($,3)),b.add(new t.LineSegments(x,new t.LineBasicMaterial({color:3822178})));const y=new t.Mesh(new t.BoxGeometry(s,o,i),new t.MeshStandardMaterial({color:12304282,side:t.BackSide,transparent:!0,opacity:.055,roughness:1}));y.position.set(0,o/2,0),b.add(y),e.add(b),this.o.fr=b,this.rem("ht");const w=new t.Group,S=Math.max(1.05*p.center,700),k=30,O=[],C=[],M=[],D=(v?d.lW:d.lL)/s,N=(v?d.lL:d.lW)/i,A=v?1:.7,T=v?.7:1;for(let t=0;t<=30;t++)for(let e=0;e<=k;e++){const o=e/k*s-m,a=t/30*i-f,n=2*(e/k-.5),r=2*(t/30-.5);let l;if(d.isBar){const t=Math.max(0,Math.abs(n)-.5*D)/(1-.5*D+.01),e=Math.max(0,Math.abs(r)-.5*N)/(1-.5*N+.01);l=p.edge+(p.center-p.edge)*Math.exp(-(t*t*3.8+e*e*9))}else{const t=Math.sqrt(n*n*A+r*r*T);l=p.edge+(p.center-p.edge)*Math.exp(-t*t*2.6)}l=Math.max(0,l),O.push(o,u+.004,a);const[c,h,g]=ee(l,S);C.push(c/255,h/255,g/255)}for(let t=0;t<30;t++)for(let e=0;e<k;e++){const s=31*t+e;M.push(s,s+31,s+1,s+1,s+31,s+31+1)}const E=new t.BufferGeometry;E.setAttribute("position",new t.Float32BufferAttribute(O,3)),E.setAttribute("color",new t.Float32BufferAttribute(C,3)),E.setIndex(M),E.computeVertexNormals(),w.add(new t.Mesh(E,new t.MeshBasicMaterial({vertexColors:!0,side:t.DoubleSide,transparent:!0,opacity:.9}))),[[0,p.center],[.36*s,p.avg],[.36*-s,p.avg]].forEach(([t,e])=>{const s=this.sprite(Math.round(e)+"",22);s.position.set(t,u+.065,0),s.scale.set(.25,.12,1),w.add(s)}),e.add(w),this.o.ht=w,this.rem("li");const L=new t.Group,R=new t.MeshStandardMaterial({color:5926525,metalness:.55,roughness:.45});if(d.isBar){const e=d.barCount;for(let s=0;s<e;s++){const i=1===e?0:-d.lL/2+d.lL/(e-1)*s,o=new t.Mesh(new t.BoxGeometry(.026,.013,d.lW),R);o.position.set(i,g,0),L.add(o);const a=new t.Mesh(new t.BoxGeometry(.017,.004,.9*d.lW),new t.MeshBasicMaterial({color:16775392}));a.position.set(i,g-.006,0),L.add(a)}[-d.lW/2,d.lW/2].forEach(e=>{const s=new t.Mesh(new t.BoxGeometry(d.lL,.01,.016),new t.MeshStandardMaterial({color:4018012,metalness:.4}));s.position.set(0,g,e),L.add(s)})}else{const e=new t.Mesh(new t.BoxGeometry(d.lL,.02,d.lW),new t.MeshStandardMaterial({color:4873579,metalness:.4,roughness:.6}));e.position.set(0,g,0),L.add(e);const s=new t.MeshBasicMaterial({color:16775392});for(let e=0;e<4;e++)for(let i=0;i<8;i++){const o=new t.Mesh(new t.CircleGeometry(.013,8),s);o.rotation.x=-Math.PI/2,o.position.set(-d.lL/2+(i+.5)*(d.lL/8),g-.009,-d.lW/2+(e+.5)*(d.lW/4)),L.add(o)}}const P=Math.min(o-.02,g+.05);if(P>g+.04){const e=new t.LineBasicMaterial({color:8947848,transparent:!0,opacity:.5});[-d.lL/2+.04,d.lL/2-.04].forEach(s=>{const i=(new t.BufferGeometry).setFromPoints([new t.Vector3(s,P,0),new t.Vector3(s,g,0)]);L.add(new t.Line(i,e))})}const z=new t.PointLight(16772778,.8,2.2);if(z.position.set(0,g,0),L.add(z),L.rotation.y=v?Math.PI/2:0,e.add(L),this.o.li=L,this.rem("bm"),g>u+.01){const o=new t.Group,a=Math.min(.28,.07+p.center/6e3),n=new t.LineBasicMaterial({color:16768341,transparent:!0,opacity:a}),r=.38*d.lL,l=.38*d.lW;[[-r,-l],[r,-l],[r,l],[-r,l]].forEach(([e,a])=>{const r=Math.sign(e)*s/2*.88,l=Math.sign(a)*i/2*.88,c=(new t.BufferGeometry).setFromPoints([new t.Vector3(e,g,a),new t.Vector3(r,u+.005,l)]);o.add(new t.Line(c,n))});const c=(new t.BufferGeometry).setFromPoints([new t.Vector3(0,g+.005,0),new t.Vector3(0,u+.005,0)]);o.add(new t.Line(c,new t.LineBasicMaterial({color:16777215,transparent:!0,opacity:.2}))),o.rotation.y=v?Math.PI/2:0,e.add(o),this.o.bm=o}this.rem("pl");const F=new t.Group,I=.0254*r,B=Math.min(.25,.35*I+.08),H=new t.MeshStandardMaterial({color:1710618,roughness:.9}),W=new t.MeshStandardMaterial({color:4025128,roughness:.8}),j=new t.MeshStandardMaterial({color:3046686,roughness:.85,side:t.DoubleSide}),V=v?s:i,U=V/(l+1);for(let e=0;e<l;e++){const s=-V/2+U*(e+1),i=v?s:0,o=v?0:s,a=new t.Mesh(new t.CylinderGeometry(.06375,.075,B,12),H);a.position.set(i,B/2,o),F.add(a);const n=Math.max(.01,I-B);if(n>.015){const e=new t.Mesh(new t.CylinderGeometry(.011,.015,n,8),W);e.position.set(i,B+n/2,o),F.add(e);const s=Math.max(1,Math.floor(n/.09));for(let e=0;e<s;e++){const a=B+n*(.35+.55*e/Math.max(1,s-1)),r=Math.min(.11,.055+.16*n);for(let s=0;s<3;s++){const n=s*(2*Math.PI/3)+1.1*e,l=new t.Mesh(new t.SphereGeometry(r,6,4),j);l.scale.set(1,.2,.5),l.position.set(i+Math.cos(n)*r*.6,a,o+Math.sin(n)*r*.6),F.add(l)}}}}if(e.add(F),this.o.pl=F,this.rem("hl"),g>u+.01){const i=new t.Group,o=-s/2-.07,a=new t.LineDashedMaterial({color:16777215,transparent:!0,opacity:.45,dashSize:.04,gapSize:.03}),l=(new t.BufferGeometry).setFromPoints([new t.Vector3(o,g,0),new t.Vector3(o,u,0)]),c=new t.Line(l,a);c.computeLineDistances(),i.add(c);const d=this.sprite(this.fmtSmall(n-r),28);d.position.set(o-.11,(g+u)/2,0),d.scale.set(.24,.12,1),i.add(d);const h=new t.MeshBasicMaterial({color:16777215,transparent:!0,opacity:.5}),p=new t.Mesh(new t.ConeGeometry(.013,.035,8),h);p.position.set(o,g-.02,0),i.add(p);const m=new t.Mesh(new t.ConeGeometry(.013,.035,8),h);m.rotation.z=Math.PI,m.position.set(o,u+.02,0),i.add(m),e.add(i),this.o.hl=i}this.fitDone||(this.fitDone=!0,this.cam.r=this.fitDistance()),this.updCam()}fitDistance(){return Math.min(10,Math.max(4.2,2+1.8*Math.max(this.s.tW,this.s.tL,this.s.tH)))}disconnectedCallback(){if(super.disconnectedCallback(),this.raf&&cancelAnimationFrame(this.raf),this.renderer)try{this.renderer.dispose()}catch{}}render(){if(!this.config)return Q;const t=this.s,e=Zt[t.model]||Zt.SE4500,s=Math.max(1,t.hin-t.plantIn),i=te(e,s,t.dim),o=(i.avg*t.photo*3600/1e6).toFixed(1),a=(n=i.avg)<200?{label:"Too dim",color:"#4488dd"}:n<400?{label:"Seedling / early veg",color:"#22bbaa"}:n<600?{label:"Vegetative growth",color:"#44bb44"}:n<800?{label:"Transition / early flower",color:"#bbaa22"}:n<1e3?{label:"Peak flower zone",color:"#ee8800"}:{label:"High intensity — watch heat",color:"#dd2222"};var n;const r=this.tentInches(),l=this.tentUnit(),c=this.config.title||"PPFD visualizer",d=this.brightOptions();return V`
      <div id="w">
        ...
        `:V`
          ...
          ${jt("var(--primary-color, #03a9f4)",this.settingsDirty(),()=>this.applySettings(),()=>this.discardSettings(),"ppfd-apply")}
        `}
      </div>
    `}}se.SET_FIELDS=["auto","src","numPlants","tW","tL","tH"],se.styles=n`
    :host { display: block; }
