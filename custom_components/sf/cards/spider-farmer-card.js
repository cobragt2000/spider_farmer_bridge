/*! spider-farmer-card v0.20.59 | MIT */
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const w=globalThis,S=t=>t,M=w.trustedTypes,k=M?M.createPolicy("lit-html",{createHTML:t=>t}):void 0,D="$lit$",C=`lit$${Math.random().toFixed(9).slice(2)}$`,O="?"+C,N=`<${O}>`,A=document,T=()=>A.createComment(""),E=t=>null===t||"object"!=typeof t&&"function"!=typeof t,P=Array.isArray,L="[ \t\n\f\r]",z=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,R=/-->/g,F=/>/g,I=RegExp(`>|${L}(?:([^\\s"'>=/]+)(${L}*=${L}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),B=/'/g,H=/"/g,W=/^(?:script|style|textarea|title)$/i,j=t=>(e,...s)=>({_$litType$:t,strings:e,values:s}),U=j(1),V=j(2),G=Symbol.for("lit-noChange"),q=Symbol.for("lit-nothing"),K=new WeakMap,J=A.createTreeWalker(A,129);function Y(t,e){if(!P(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==k?k.createHTML(e):e}const X=(t,e)=>{const s=t.length-1,i=[];let o,a=2===e?"<svg>":3===e?"<math>":"",r=z;for(let e=0;e<s;e++){const s=t[e];let n,l,c=-1,d=0;for(;d<s.length&&(r.lastIndex=d,l=r.exec(s),null!==l);)d=r.lastIndex,r===z?"!--"===l[1]?r=R:void 0!==l[1]?r=F:void 0!==l[2]?(W.test(l[2])&&(o=RegExp("</"+l[2],"g")),r=I):void 0!==l[3]&&(r=I):r===I?">"===l[0]?(r=o??z,c=-1):void 0===l[1]?c=-2:(c=r.lastIndex-l[2].length,n=l[1],r=void 0===l[3]?I:'"'===l[3]?H:B):r===H||r===B?r=I:r===R||r===F?r=z:(r=I,o=void 0);const h=r===I&&t[e+1].startsWith("/>")?" ":"";a+=r===z?s+N:c>=0?(i.push(n),s.slice(0,c)+D+s.slice(c)+C+h):s+C+(-2===c?e:h)}return[Y(t,a+(t[s]||"<?>")+(2===e?"</svg>":3===e?"</math>":"")),i]};class Z{constructor({strings:t,_$litType$:e},s){let i;this.parts=[];let o=0,a=0;const r=t.length-1,n=this.parts,[l,c]=X(t,e);if(this.el=Z.createElement(l,s),J.currentNode=this.el.content,2===e||3===e){const t=this.el.content.firstChild;t.replaceWith(...t.childNodes)}for(;null!==(i=J.nextNode())&&n.length<r;){if(1===i.nodeType){if(i.hasAttributes())for(const t of i.getAttributeNames())if(t.endsWith(D)){const e=c[a++],s=i.getAttribute(t).split(C),r=/([.?@])?(.*)/.exec(e);n.push({type:1,index:o,name:r[2],strings:s,ctor:"."===r[1]?it:"?"===r[1]?ot:"@"===r[1]?at:st}),i.removeAttribute(t)}else t.startsWith(C)&&(n.push({type:6,index:o}),i.removeAttribute(t));if(W.test(i.tagName)){const t=i.textContent.split(C),e=t.length-1;if(e>0){i.textContent=M?M.emptyScript:"";for(let s=0;s<e;s++)i.append(t[s],T()),J.nextNode(),n.push({type:2,index:++o});i.append(t[e],T())}}}else if(8===i.nodeType)if(i.data===O)n.push({type:2,index:o});else{let t=-1;for(;-1!==(t=i.data.indexOf(C,t+1));)n.push({type:7,index:o}),t+=C.length-1}o++}}static createElement(t,e){const s=A.createElement("template");return s.innerHTML=t,s}}function Q(t,e,s=t,i){if(e===G)return e;let o=void 0!==i?s._$Co?.[i]:s._$Cl;const a=E(e)?void 0:e._$litDirective$;return o?.constructor!==a&&(o?._$AO?.(!1),void 0===a?o=void 0:(o=new a(t),o._$AT(t,s,i)),void 0!==i?(s._$Co??=[])[i]=o:s._$Cl=o),void 0!==o&&(e=Q(t,o._$AS(t,e.values),o,i)),e}class tt{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:e},parts:s}=this._$AD,i=(t?.creationScope??A).importNode(e,!0);J.currentNode=i;let o=J.nextNode(),a=0,r=0,n=s[0];for(;void 0!==n;){if(a===n.index){let e;2===n.type?e=new et(o,o.nextSibling,this,t):1===n.type?e=new n.ctor(o,n.name,n.strings,this,t):6===n.type&&(e=new rt(o,this,t)),this._$AV.push(e),n=s[++r]}a!==n?.index&&(o=J.nextNode(),a++)}return J.currentNode=A,i}p(t){let e=0;for(const s of this._$AV)void 0!==s&&(void 0!==s.strings?(s._$AI(t,s,e),e+=s.strings.length-2):s._$AI(t[e])),e++}}class et{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,e,s,i){this.type=2,this._$AH=q,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=s,this.options=i,this._$Cv=i?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode;const e=this._$AM;return void 0!==e&&11===t?.nodeType&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=Q(this,t,e),E(t)?t===q||null==t||""===t?(this._$AH!==q&&this._$AR(),this._$AH=q):t!==this._$AH&&t!==G&&this._(t):void 0!==t._$litType$?this.$(t):void 0!==t.nodeType?this.T(t):(t=>P(t)||"function"==typeof t?.[Symbol.iterator])(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==q&&E(this._$AH)?this._$AA.nextSibling.data=t:this.T(A.createTextNode(t)),this._$AH=t}$(t){const{values:e,_$litType$:s}=t,i="number"==typeof s?this._$AC(t):(void 0===s.el&&(s.el=Z.createElement(Y(s.h,s.h[0]),this.options)),s);if(this._$AH?._$AD===i)this._$AH.p(e);else{const t=new tt(i,this),s=t.u(this.options);t.p(e),this.T(s),this._$AH=t}}_$AC(t){let e=K.get(t.strings);return void 0===e&&K.set(t.strings,e=new Z(t)),e}k(t){P(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let s,i=0;for(const o of t)i===e.length?e.push(s=new et(this.O(T()),this.O(T()),this,this.options)):s=e[i],s._$AI(o),i++;i<e.length&&(this._$AR(s&&s._$AB.nextSibling,i),e.length=i)}_$AR(t=this._$AA.nextSibling,e){for(this._$AP?.(!1,!0,e);t!==this._$AB;){const e=S(t).nextSibling;S(t).remove(),t=e}}setConnected(t){void 0===this._$AM&&(this._$Cv=t,this._$AP?.(t))}}class st{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,e,s,i,o){this.type=1,this._$AH=q,this._$AN=void 0,this.element=t,this.name=e,this._$AM=i,this.options=o,s.length>2||""!==s[0]||""!==s[1]?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=q}_$AI(t,e=this,s,i){const o=this.strings;let a=!1;if(void 0===o)t=Q(this,t,e,0),a=!E(t)||t!==this._$AH&&t!==G,a&&(this._$AH=t);else{const i=t;let r,n;for(t=o[0],r=0;r<o.length-1;r++)n=Q(this,i[s+r],e,r),n===G&&(n=this._$AH[r]),a||=!E(n)||n!==this._$AH[r],n===q?t=q:t!==q&&(t+=(n??"")+o[r+1]),this._$AH[r]=n}a&&!i&&this.j(t)}j(t){t===q?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class it extends st{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===q?void 0:t}}class ot extends st{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==q)}}class at extends st{constructor(t,e,s,i,o){super(t,e,s,i,o),this.type=5}_$AI(t,e=this){if((t=Q(this,t,e,0)??q)===G)return;const s=this._$AH,i=t===q&&s!==q||t.capture!==s.capture||t.once!==s.once||t.passive!==s.passive,o=t!==q&&(s===q||i);i&&this.element.removeEventListener(this.name,this,s),o&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){"function"==typeof this._$AH?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}}class rt{constructor(t,e,s){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(t){Q(this,t)}}const nt=w.litHtmlPolyfillSupport;nt?.(Z,et),(w.litHtmlVersions??=[]).push("3.3.3");const lt=globalThis;
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`;function wt(t){const e=new Set;for(const s of Object.keys(t.states)){const t=bt(s).match(vt);t&&e.add(t[1])}return[...e].sort()}function St(t){return wt(t).filter(e=>e.startsWith("st")&&!!t.states[`switch.sf_${e}_outlet_1`]||Object.keys(t.states).some(t=>{const s=bt(t);return s===`sf_${e}_temperature`||s===`sf_${e}_soil_avg_temperature`||s===`sf_${e}_light_1`||s===`sf_${e}_fan`||s===`sf_${e}_blower`}))}function Mt(t,e){const s=`sf_${e}_`,i=Object.keys(t.states);return i.find(t=>bt(t)===`sf_${e}_temperature`)??i.find(t=>{const i=bt(t);return i.startsWith(s)&&!i.startsWith(`sf_${e}_env_`)})}function kt(t,e){const s=Mt(t,e);return s?t.entities?.[s]?.device_id:void 0}function Dt(t,e){if(!e)return[];const s=kt(t,e);return s?function(t){return wt(t).filter(e=>!!t.states[`switch.sf_${e}_outlet_1`])}(t).filter(i=>{if(i===e)return!1;const o=kt(t,i),a=o?t.devices?.[o]:void 0;return a?.via_device_id===s}):[]}function Ct(t,e){if(!t||!e)return"";const s=Mt(t,e);if(!s)return"";const i=t.entities?.[s]?.device_id,o=i?t.devices?.[i]:void 0;if(o)return o.name_by_user||o.name||"";const a=(t.states[s].attributes.friendly_name||"").match(/^(SF .+? [0-9A-Fa-f]{4})\b/);return a?a[1]:""}const Ot=[["temperature","Air Temp","mdi:thermometer"],["humidity","Air Humi","mdi:water-percent"],["vpd","Air VPD","mdi:water-opacity"],["leaf_vpd","Leaf VPD","mdi:leaf"],["co2","CO2","mdi:molecule-co2"],["ppfd","PPFD","mdi:white-balance-sunny"],["soil_avg_temperature","Soil Temp","mdi:thermometer"],["soil_avg_moisture","Moisture","mdi:water"],["soil_avg_ec","Soil EC","mdi:flash"]],Nt={temperature:"temp",humidity:"humi",vpd:"vpd",co2:"co2",ppfd:"ppfd",soil_avg_temperature:"tempSoil",soil_avg_moisture:"humiSoil",soil_avg_ec:"ECSoil"},At={temperature:"temp",humidity:"humi",co2:"co2"},Tt="#ff6b6b",Et="rgba(255,107,107,0.16)",Pt=(t,e=.16)=>{const s=/^#?([0-9a-fA-F]{6})$/.exec((t||"").trim());if(!s)return`rgba(255,107,107,${e})`;const i=parseInt(s[1],16);return`rgba(${i>>16&255},${i>>8&255},${255&i},${e})`},Lt=t=>"string"==typeof t&&/^#[0-9a-fA-F]{6}$/.test(t),zt=t=>"alarms"===t||"targets"===t||"both"===t,Rt=mt,Ft={"Time Slot":["ts_type","ts_start","ts_stop"],Cycle:["cycle_start","cycle_run","cycle_off","cycle_times"],Temperature:["temp_device"],Humidity:["humidity_device"],CO2:["co2_device"],"Drip Irrigation":["drip_soil","drip_avg"],Manual:[]},It=mt,Bt=t=>!!t&&("unavailable"===t.state||"unknown"===t.state),Ht=t=>{const e=(t||"").match(/^(\d{1,2}):(\d{2})$/);if(!e)return null;const s=+e[1],i=+e[2];return s<=23&&i<=59?60*s+i:null},Wt=(t,e,s,i,o="")=>U`<div class="save-bar ${o}">
  ${((t,e,s,i)=>U`
  ...
  <button class="discard-btn" ?disabled=${!e}
    @click=${i}>Discard</button>`)(t,e,s,i)}
      ...
      </div>`}renderParam([t,e,s]){const i=this.get(`sensor.sf_${this.config.panel}_${t}`);if(!i)return q;const o=i.attributes.unit_of_measurement||"",a=t.startsWith("soil_avg_")&&Bt(i),r=["temperature","humidity","vpd","leaf_vpd"].includes(t)&&this.cleaningActive(),n=r?"--":a?"Offline":this.hass?.formatEntityState?this.hass.formatEntityState(i).replace(o,"").trim():i.state,l=t.startsWith("soil_avg_")?t.slice(9):null,c=!!l&&this.soilProbeRows(l).length>1,d=c&&this.soilOpen===l;let h;const p=this.paramOpen===t;if(a||r)h=null;else{const e=parseFloat(i.state);if(Number.isFinite(e)){const s="targets"!==this.colorSource?this.outOfRange(Nt[t],e):null,i="alarms"!==this.colorSource||"leaf_vpd"===t?this.targetOutOfRange(t,e):null;h=this.colorForOor(s??i)}else h=null}const u=!a&&!c;let f=d||p?`box-shadow:inset 0 0 0 1px ${this.accent()}`:"",m="";a?(f=`background:${Et};box-shadow:inset 0 0 0 1px ${Tt}`,m=`color:${Tt}`):h&&"text"===h.mode?m=`color:${h.color}`:h&&"tile"===h.mode&&(f=`background:${Pt(h.color)};box-shadow:inset 0 0 0 1px ${h.color}`);const g=c||u;return U`
      <div class="tile ${g?"clickable":""} ${d||p?"active":""}"
        style=${f||q}
        role=${g?"button":q}
      ...
      </div>`}renderSoilAllTable(){const t=this.soilProbeSlots();return t.length<2||!this.soilAllOpen?q:U`
      <div class="soil-all">
      ...
      <div class="soil-pop" style="--sf-accent:${this.accent()}">
        ...
        ${i}
      </div>`}devOn(t,e){const s=`power:${t}`;return s in this.draft?"on"===this.draft[s]:e}powerRow(t,e,s,i){const o=`power:${t}`,a=this.devOn(t,i),r=this.accent();return U`
      ...
      </div>`}deviceBar(t,e,s){const i=Object.keys(this.draft).length>0;return Wt(this.accent(),i,()=>this.deviceApply(t,e,s),()=>this.discardEdits())}deviceApply(t,e,s){this.commitBundle(t,e);const i=`bri:${s.id}`,o=`pct:${s.id}`,a=`power:${s.id}`;i in this.draft&&this.hass?.callService("light","turn_on",{entity_id:s.id,brightness_pct:Number(this.draft[i])}),o in this.draft&&this.hass?.callService("fan","set_percentage",{entity_id:s.id,percentage:Number(this.draft[o])});for(const t of Object.keys(this.draft)){if(t.includes(":")||t in e)continue;const s=this.draft[t];switch(t.split(".")[0]){case"number":this.hass?.callService("number","set_value",{entity_id:t,value:Number(s)});break;case"select":this.hass?.callService("select","select_option",{entity_id:t,option:s});break;case"text":this.hass?.callService("text","set_value",{entity_id:t,value:s});break;case"switch":this.hass?.callService("switch","on"===s?"turn_on":"turn_off",{entity_id:t})}}if(a in this.draft){const t="on"===this.draft[a],e="light"===s.domain&&i in this.draft||"fan"===s.domain&&o in this.draft;if(!t||!e){const e="fan"===s.domain?"fan":"light"===s.domain?"light":"switch";this.hass?.callService(e,t?"turn_on":"turn_off",{entity_id:s.id})}}this.draft={}}renderGenericBody(t,e){const s="on"===e.state,i="fan"===t.domain?"fan":"switch",o=Math.round(e.attributes.percentage??0),a="fan"===t.domain?this.speedRow(t,s?o:0,0,10):q;return U`${this.powerRow(t.id,i,t.label,s)}${a}${this.relatedControls(t.suffix,t.domain)}${this.deviceBar(`text.sf_${this.config.panel}_${t.suffix}_apply`,{},t)}`}speedRow(t,e,s=0,i=0){const o=`pct:${t.id}`,a=o in this.draft?Number(this.draft[o]):e,r=i>0?Array.from({length:i},(t,e)=>{const s=e+1;return{value:Math.round(s/i*100),label:String(s),sel:Math.round(a/100*i)===s}}):(()=>{const t=[];s<=0&&t.push({value:0,label:"Off",sel:0===a});for(let e=Math.max(s,1);e<=100;e+=1)t.push({value:e,label:e+"%",sel:e===a});return t})();return U`
      <div class="dev-row ${o in this.draft?"staged":""}">
        <span class="dev-lbl">Speed</span>
        <span class="ctl-input">
          <select @change=${t=>this.stage(o,t.target.value)}>
            ${r.map(t=>U`<option value=${t.value}
              ?selected=${t.sel}>${t.label}</option>`)}
          </select>
        </span>
      </div>`}brightnessRow(t,e){const s=`bri:${t.id}`,i=s in this.draft?Number(this.draft[s]):e,o=[];for(let t=11;t<=100;t+=1)o.push(t);return U`
      <div class="dev-row ${s in this.draft?"staged":""}">
        <span class="dev-lbl">Brightness</span>
        <span class="ctl-input">
          <select @change=${t=>this.stage(s,t.target.value)}>
            ${o.map(t=>U`<option value=${t} ?selected=${t===i}>${t+"%"}</option>`)}
          </select>
        </span>
      </div>`}renderHeaterBody(t,e){const s=this.config.panel,i="on"===e.state,o=`select.sf_${s}_heater_mode_set`,a=this.get(o),r=this.modeOf(o),n=`number.sf_${s}_heater_level`,l=`text.sf_${s}_heater_apply`,c=this.numOpts(1,10,1,t=>`L${t}`),d=[];if(a&&d.push(this.liveModeRow("Mode",o)),d.push(this.powerRow(t.id,"switch",t.label,i)),"Manual"===r)d.push(this.optSelectRow("Gear",n,c)),d.push(this.deviceBar(l,{[o]:"mode"},t));else if("Time Slot"===r){const e=`text.sf_${s}_heater_schedule_start`,i=`text.sf_${s}_heater_schedule_stop`,a={[o]:"mode",[e]:"schedule_start",[i]:"schedule_end",[n]:"gear"};d.push(this.stagedPeriodRow(e,i,"Schedule")),d.push(this.optSelectRow("Gear",n,c)),d.push(this.deviceBar(l,a,t))}else if("Cycle"===r){const e=`text.sf_${s}_heater_cycle_start`,i=`text.sf_${s}_heater_cycle_run`,a=`text.sf_${s}_heater_cycle_off`,r=`number.sf_${s}_heater_cycle_times`,h={[o]:"mode",[e]:"cycle_start",[i]:"cycle_run",[a]:"cycle_off",[r]:"cycle_times",[n]:"gear"};d.push(this.stagedRow("Start Time",e,"time")),d.push(this.stagedRow("Run Time",i,"duration")),d.push(this.stagedRow("Closing Time",a,"duration")),d.push(this.stagedRangeRow("Execution Times",r)),d.push(this.optSelectRow("Gear",n,c)),d.push(this.deviceBar(l,h,t))}else if("Temperature"===r){const e=`select.sf_${s}_heater_gear`,i=!!this.get(e),a=i?{[o]:"mode",[e]:"auto_gear"}:{[o]:"mode",[n]:"gear"};d.push(i?this.stagedRow("Gear",e):this.optSelectRow("Gear",n,c)),d.push(this.infoRow("Automatic follows the day/night temperature targets; 1–10 sets a fixed level","")),d.push(this.deviceBar(l,a,t))}return d}renderDehumidifierBody(t,e){const s=this.config.panel,i="on"===e.state,o=`select.sf_${s}_dehumidifier_mode_set`,a=this.get(o),r=this.modeOf(o),n=`select.sf_${s}_dehumidifier_level`,l=`text.sf_${s}_dehumidifier_apply`,c=[];if(a&&c.push(this.liveModeRow("Mode",o)),c.push(this.powerRow(t.id,"switch",t.label,i)),"Manual"===r)c.push(this.ctlRow("Wind Speed",n)),c.push(this.deviceBar(l,{[o]:"mode"},t));else if("Time Slot"===r){const e=`text.sf_${s}_dehumidifier_schedule_start`,i=`text.sf_${s}_dehumidifier_schedule_stop`,a={[o]:"mode",[e]:"schedule_start",[i]:"schedule_end",[n]:"wind"};c.push(this.stagedPeriodRow(e,i,"Schedule")),c.push(this.stagedRow("Wind Speed",n)),c.push(this.deviceBar(l,a,t))}else if("Cycle"===r){const e=`text.sf_${s}_dehumidifier_cycle_start`,i=`text.sf_${s}_dehumidifier_cycle_run`,a=`text.sf_${s}_dehumidifier_cycle_off`,r=`number.sf_${s}_dehumidifier_cycle_times`,d={[o]:"mode",[e]:"cycle_start",[i]:"cycle_run",[a]:"cycle_off",[r]:"cycle_times",[n]:"wind"};c.push(this.stagedRow("Start Time",e,"time")),c.push(this.stagedRow("Run Time",i,"duration")),c.push(this.stagedRow("Closing Time",a,"duration")),c.push(this.stagedRangeRow("Execution Times",r)),c.push(this.stagedRow("Wind Speed",n)),c.push(this.deviceBar(l,d,t))}else if("Humidity"===r){const e=`select.sf_${s}_dehumidifier_gear`,i=!!this.get(e),a=i?{[o]:"mode",[e]:"auto_gear"}:{[o]:"mode",[n]:"wind"};c.push(this.stagedRow("Wind Speed",i?e:n)),c.push(this.infoRow("Runs on the tent's day/night humidity targets, at Low or High power","")),c.push(this.deviceBar(l,a,t))}return c}renderHumidifierBody(t,e){const s=this.config.panel,i="on"===e.state,o=`select.sf_${s}_humidifier_mode_set`,a=this.get(o),r=this.modeOf(o),n=`number.sf_${s}_humidifier_level`,l=`text.sf_${s}_humidifier_apply`,c=this.numOpts(1,4,1,t=>`L${t}`),d=[];if(a&&d.push(this.liveModeRow("Mode",o)),d.push(this.powerRow(t.id,"switch",t.label,i)),"Manual"===r)d.push(this.optSelectRow("Gear",n,c)),d.push(this.deviceBar(l,{[o]:"mode"},t));else if("Time Slot"===r){const e=`text.sf_${s}_humidifier_schedule_start`,i=`text.sf_${s}_humidifier_schedule_stop`,a={[o]:"mode",[e]:"schedule_start",[i]:"schedule_end",[n]:"gear"};d.push(this.stagedPeriodRow(e,i,"Schedule")),d.push(this.optSelectRow("Gear",n,c)),d.push(this.deviceBar(l,a,t))}else if("Cycle"===r){const e=`text.sf_${s}_humidifier_cycle_start`,i=`text.sf_${s}_humidifier_cycle_run`,a=`text.sf_${s}_humidifier_cycle_off`,r=`number.sf_${s}_humidifier_cycle_times`,h={[o]:"mode",[e]:"cycle_start",[i]:"cycle_run",[a]:"cycle_off",[r]:"cycle_times",[n]:"gear"};d.push(this.stagedRow("Start Time",e,"time")),d.push(this.stagedRow("Run Time",i,"duration")),d.push(this.stagedRow("Closing Time",a,"duration")),d.push(this.stagedRangeRow("Execution Times",r)),d.push(this.optSelectRow("Gear",n,c)),d.push(this.deviceBar(l,h,t))}else if("Humidity"===r){const e=`select.sf_${s}_humidifier_gear`,i=!!this.get(e),a=i?{[o]:"mode",[e]:"auto_gear"}:{[o]:"mode",[n]:"gear"};d.push(i?this.stagedRow("Gear",e):this.optSelectRow("Gear",n,c)),d.push(this.infoRow("Automatic follows the day/night humidity targets; 1–4 sets a fixed level","")),d.push(this.deviceBar(l,a,t))}return d}textState(t){const e=this.get(t);return e&&"unknown"!==e.state&&"unavailable"!==e.state?e.state:""}durMinutes(t,e){const s=t=>{const e=/^(\d{1,2}):(\d{2})/.exec(t);return e?60*Number(e[1])+Number(e[2]):null},i=s(this.textState(t)),o=s(this.textState(e));if(null==i||null==o)return null;let a=(o-i+1440)%1440;return 0===a&&(a=1440),a}durationText(t,e){const s=this.durMinutes(t,e);return null==s?null:`${Math.floor(s/60)}h ${String(s%60).padStart(2,"0")}min`}infoRow(t,e){return U`<div class="dev-row">
      <span class="dev-lbl">${t}</span><span class="dev-spacer"></span>
      <span class="dev-val">${e}</span>
    </div>`}ctlRow(t,e){if(!this.get(e))return q;const s="switch"===e.split(".")[0]?this.stagedSwitch(e):this.stagedInput(e);return U`<div class="dev-row ${e in this.draft?"staged":""}">
      <span class="dev-lbl">${t}</span>
      <div class="ctl-input">${s}</div>
    </div>`}renderLightBody(t,e){const s=this.config.panel,i=t.suffix,o="on"===e.state,a=`select.sf_${s}_${i}_mode`,r=this.get(a),n=this.modeOf(a),l=this.get(`sensor.sf_${s}_${i}_brightness`),c=this.get(`sensor.sf_${s}_ppfd`),d=l&&Number.isFinite(Number(l.state))?`${Math.round(Number(l.state))}%`:"—",h=c&&Number.isFinite(Number(c.state))?`${Math.round(Number(c.state))} µmol`:"—",p=`text.sf_${s}_${i}_apply`,u=`number.sf_${s}_${i}_go_dark`,f=`number.sf_${s}_${i}_turn_off`,m=[];if(r&&m.push(this.liveModeRow("Mode",a)),m.push(this.powerRow(t.id,"light",t.label,o)),"Manual"===n){const s=Math.round((e.attributes.brightness??0)/255*100),i={[a]:"mode",[u]:"dim_threshold",[f]:"off_threshold"};m.push(this.brightnessRow(t,o?s:0)),m.push(this.infoRow("Current PPFD",h)),m.push(this.optSelectRow("Go dark",u,this.tempThresholdOpts())),m.push(this.optSelectRow("Turn off",f,this.tempThresholdOpts())),m.push(this.deviceBar(p,i,t))}else if("Time Slot"===n){const e=`text.sf_${s}_${i}_schedule_start`,o=`text.sf_${s}_${i}_schedule_stop`,r=`number.sf_${s}_${i}_schedule_brightness`,n=`number.sf_${s}_${i}_fade`,l={[a]:"mode",[e]:"schedule_start",[o]:"schedule_end",[r]:"schedule_brightness",[n]:"fade_minutes",[u]:"dim_threshold",[f]:"off_threshold"};m.push(this.infoRow("Current",`${d} · ${h}`));const c=this.durationText(e,o);c&&m.push(this.infoRow("Light duration",c)),m.push(this.stagedPeriodRow(e,o,"Lighting period")),m.push(this.optSelectRow("Target Brightness",r,this.numOpts(11,100,1,t=>`${t}%`))),m.push(this.optSelectRow("Simulate Sunrise/Sunset",n,this.offOpts(1,60,1,t=>`${t} min`))),m.push(this.optSelectRow("Go dark",u,this.tempThresholdOpts())),m.push(this.optSelectRow("Turn off",f,this.tempThresholdOpts())),m.push(this.deviceBar(p,l,t))}else if("PPFD"===n){const e=`text.sf_${s}_${i}_ppfd_start`,o=`text.sf_${s}_${i}_ppfd_stop`,r=`number.sf_${s}_${i}_ppfd_target`,n=`number.sf_${s}_${i}_ppfd_fade`,l=`number.sf_${s}_${i}_ppfd_min`,c=`number.sf_${s}_${i}_ppfd_max`,g={[a]:"mode",[e]:"ppfd_start",[o]:"ppfd_end",[r]:"ppfd_target",[n]:"ppfd_fade_minutes",[l]:"ppfd_min",[c]:"ppfd_max",[u]:"dim_threshold",[f]:"off_threshold"};m.push(this.infoRow("Current",`${d} · ${h}`));const v=this.durationText(e,o),b=this.durMinutes(e,o),_=Number(this.get(r)?.state);if(v&&null!=b&&Number.isFinite(_)){const t=_*b*60/1e6;m.push(this.infoRow("DLI · duration",`${t.toFixed(2)} mol/m²/day · ${v}`))}else v&&m.push(this.infoRow("Light duration",v));m.push(this.stagedPeriodRow(e,o,"Lighting period")),m.push(U`<div class="dev-row ${r in this.draft?"staged":""}">
      ...
      </div>`),m.push(this.optSelectRow("Dimming Range Min",l,this.numOpts(11,100,1,t=>`${t}%`))),m.push(this.optSelectRow("Dimming Range Max",c,this.numOpts(11,100,1,t=>`${t}%`))),m.push(this.optSelectRow("Simulate Sunrise/Sunset",n,this.offOpts(1,60,1,t=>`${t} min`))),m.push(this.optSelectRow("Go dark",u,this.tempThresholdOpts())),m.push(this.optSelectRow("Turn off",f,this.tempThresholdOpts())),m.push(this.deviceBar(p,g,t))}return m}renderFanBody(t,e){const s=this.config.panel,i="on"===e.state,o=`select.sf_${s}_fan_mode_set`,a=this.get(o),r=this.modeOf(o),n=`number.sf_${s}_fan_oscillation`,l=`number.sf_${s}_fan_schedule_gear`,c=`number.sf_${s}_fan_standby_speed`,d=`switch.sf_${s}_fan_natural_wind`,h=()=>this.optSelectRow("Gear",l,this.numOpts(1,10,1,t=>`L${t}`)),p=Math.max(1,Math.round(Number(this.draftVal(l))||1)),u="0"===String(this.draftVal(l)),f=()=>this.optSelectRow("Standby Speed",c,this.offOpts(1,u?10:p-1)),m=()=>this.optSelectRow("Oscillation",n,this.offOpts(1,10)),g=`text.sf_${s}_fan_apply`,v=[];if(a&&v.push(this.liveModeRow("Mode",o)),v.push(this.powerRow(t.id,"fan",t.label,i)),"Manual"===r){const s=Math.round(e.attributes.percentage??0);v.push(this.speedRow(t,i?s:0,0,10)),v.push(m()),v.push(this.ctlRow("Natural Wind",d)),v.push(this.deviceBar(g,{[o]:"mode"},t))}else if("Time Slot"===r){const e={[o]:"mode",[`text.sf_${s}_fan_schedule_start`]:"schedule_start",[`text.sf_${s}_fan_schedule_stop`]:"schedule_end",[l]:"schedule_speed",[c]:"standby_speed"};v.push(this.stagedPeriodRow(`text.sf_${s}_fan_schedule_start`,`text.sf_${s}_fan_schedule_stop`,"Schedule")),v.push(h()),v.push(f()),v.push(m()),v.push(this.ctlRow("Natural Wind",d)),v.push(this.deviceBar(g,e,t))}else if("Cycle"===r){const e=`text.sf_${s}_fan_cycle_start`,i=`text.sf_${s}_fan_cycle_run`,a=`text.sf_${s}_fan_cycle_off`,r=`number.sf_${s}_fan_cycle_times`,n={[o]:"mode",[e]:"cycle_start",[i]:"cycle_run",[a]:"cycle_off",[r]:"cycle_times",[l]:"schedule_speed",[c]:"standby_speed"};v.push(this.stagedRow("Start Time",e,"time")),v.push(this.stagedRow("Run Duration",i,"duration")),v.push(this.stagedRow("Off Duration",a,"duration")),v.push(this.stagedRangeRow("Execution Times",r)),v.push(h()),v.push(f()),v.push(m()),v.push(this.ctlRow("Natural Wind",d)),v.push(this.deviceBar(g,n,t))}else if("Environment"===r){const e=`select.sf_${s}_fan_run_mode`,i={[o]:"mode",[e]:"env_submode",[l]:"schedule_speed",[c]:"standby_speed"};v.push(this.stagedRow("Run Mode",e)),v.push(this.optSelectRow("Gear",l,this.autoOpts(1,10,1,t=>`L${t}`))),v.push(f()),v.push(m()),v.push(this.ctlRow("Natural Wind",d)),v.push(this.deviceBar(g,i,t))}return v}renderBlowerBody(t,e){const s=this.config.panel,i="on"===e.state,o=`select.sf_${s}_blower_mode_set`,a=this.get(o),r=this.modeOf(o),n=`number.sf_${s}_blower_running_speed`,l=`number.sf_${s}_blower_standby_speed`,c=`switch.sf_${s}_blower_close_co2`,d=`text.sf_${s}_blower_apply`,h=()=>this.optSelectRow("Running Speed",n,this.numOpts(25,100,1,t=>`${t}%`)),p="0"===String(this.draftVal(n)),u=Math.max(25,Math.round(Number(this.draftVal(n))||25)),f=()=>this.optSelectRow("Standby Speed",l,this.offOpts(25,p?100:u-1)),m=[];if(a&&m.push(this.liveModeRow("Mode",o)),m.push(this.powerRow(t.id,"fan",t.label,i)),"Manual"===r){const s=Math.round(e.attributes.percentage??0);m.push(this.speedRow(t,i?s:0,25)),m.push(this.ctlRow("Close CO2 Device",c)),m.push(this.deviceBar(d,{[o]:"mode"},t))}else if("Time Slot"===r){const e={[o]:"mode",[`text.sf_${s}_blower_schedule_start`]:"schedule_start",[`text.sf_${s}_blower_schedule_stop`]:"schedule_end",[n]:"schedule_speed",[l]:"standby_speed"};m.push(this.stagedPeriodRow(`text.sf_${s}_blower_schedule_start`,`text.sf_${s}_blower_schedule_stop`,"Schedule")),m.push(h()),m.push(f()),m.push(this.ctlRow("Close CO2 Device",c)),m.push(this.deviceBar(d,e,t))}else if("Cycle"===r){const e=`text.sf_${s}_blower_cycle_start`,i=`text.sf_${s}_blower_cycle_run`,a=`text.sf_${s}_blower_cycle_off`,r=`number.sf_${s}_blower_cycle_times`,p={[o]:"mode",[e]:"cycle_start",[i]:"cycle_run",[a]:"cycle_off",[r]:"cycle_times",[n]:"schedule_speed",[l]:"standby_speed"};m.push(this.stagedRow("Start Time",e,"time")),m.push(this.stagedRow("Run Duration",i,"duration")),m.push(this.stagedRow("Off Duration",a,"duration")),m.push(this.stagedRangeRow("Execution Times",r)),m.push(h()),m.push(f()),m.push(this.ctlRow("Close CO2 Device",c)),m.push(this.deviceBar(d,p,t))}else if("Environment"===r){const e=`select.sf_${s}_blower_run_mode`,i={[o]:"mode",[e]:"env_submode",[n]:"schedule_speed",[l]:"standby_speed"};m.push(this.stagedRow("Run Mode",e)),m.push(this.optSelectRow("Running Speed",n,this.autoOpts(25,100,1,t=>`${t}%`))),m.push(f()),m.push(this.ctlRow("Close CO2 Device",c)),m.push(this.deviceBar(d,i,t))}return m}cycleIsDay(){const t=this.config.panel,e=this.get(`binary_sensor.sf_${t}_daytime_schedule`);if(e&&("on"===e.state||"off"===e.state))return"on"===e.state;const s=Ht(this.get(`text.sf_${t}_env_day_start`)?.state),i=Ht(this.get(`text.sf_${t}_env_day_end`)?.state);if(null==s||null==i)return null;const o=new Date,a=60*o.getHours()+o.getMinutes();return s<=i?a>=s&&a<i:a>=s||a<i}lightLeak(){if(!1!==this.cycleIsDay())return{on:!1,text:""};const t=this.config.panel,e=this.get(`sensor.sf_${t}_ppfd`);if(e){const t=Number(e.state);return Number.isFinite(t)&&t>1?{on:!0,text:`Light detected · ${Math.round(t)} µmol`}:{on:!1,text:""}}const s=this.get(`binary_sensor.sf_${t}_daytime_light_sensor`);return s&&"on"===s.state?{on:!0,text:"Light detected"}:{on:!1,text:""}}renderParamsHead(){const t=this.cycleIsDay(),e=this.lightLeak(),s=null===t?q:U`<span class="cycle-badge"
          style="color:${t?"#e0a83a":"#8f9bd4"};background:${t?"rgba(224,168,58,0.14)":"rgba(143,155,212,0.16)"}">
          <ha-icon icon=${t?"mdi:white-balance-sunny":"mdi:weather-night"}></ha-icon>${t?"Day Cycle":"Night Cycle"}</span>`;return U`
      <div class="params-head">
        <span class="ph-label">Parameters</span>
        <span class="ph-mid">${e.on?U`<span class="leak-badge">
              <ha-icon icon="mdi:alert"></ha-icon>${e.text}</span>`:q}</span>
        ${s}
      </div>`}renderOverview(){const t=Ot.map(t=>this.renderParam(t)).filter(t=>t!==q),e=this.soilStatsTile(),s=this.overviewDevices();return U`
      ${t.length||e!==q?U`${this.renderParamsHead()}
            <div class="grid">${t}${e}</div>
            ${this.renderParamGraph()}
            ${this.renderSoilPop()}
            ${this.renderSoilAllTable()}`:q}
      ${s.length?U`<div class="section-label">Devices</div>
            <div class="grid">${s.map(t=>this.deviceTile(t))}</div>
            ${this.renderDevicePop()}`:q}`}draftVal(t){if(t in this.draft)return this.draft[t];const e=this.get(t);return e&&"unknown"!==e.state&&"unavailable"!==e.state?e.state:""}stage(t,e){this.draft={...this.draft,[t]:e}}clearDraft(){Object.keys(this.draft).length&&(this.draft={})}discardEdits(){this.clearDraft(),Object.keys(this.modePick).length&&(this.modePick={})}toggleDevice(t){this.clearDraft(),Object.keys(this.modePick).length&&(this.modePick={}),this.deviceOpen=t}modeOf(t,e="Manual"){return this.modePick[t]??this.get(t)?.state??e}stagedInput(t,e){const s=this.get(t);if(!s)return q;const i=t.split(".")[0],o=this.draftVal(t);if(!e&&"number"===i){const e=s.attributes.min??0,i=s.attributes.max??100,a=s.attributes.step??1,r=s.attributes.unit_of_measurement??"";return U`<span class="num-box">
        <input type="number" min=${e} max=${i} step=${a} .value=${o}
          @input=${e=>this.stage(t,e.target.value)} />
        <span class="unit">${r}</span></span>`}if(!e&&"select"===i){const e=s.attributes.options??[];return U`<select @change=${e=>this.stage(t,e.target.value)}>
        ${e.map(t=>U`<option value=${t} .selected=${t===o}>${t}</option>`)}
      </select>`}if("duration"===e)return this.durationInput(t);const a="time"===e||/^\d{1,2}:\d{2}/.test(o);return U`<input type=${a?"time":"text"} .value=${o}
      @change=${e=>this.stage(t,e.target.value)} />`}durationInput(t){const e=(this.draftVal(t)||"").trim(),s=/^(\d+):(\d{1,2})(?::(\d{1,2}))?$/.exec(e),i=s?+s[1]:0,o=s?+s[2]:0,a=s?+(s[3]??0):0,r=t=>String(t).padStart(2,"0"),n=(e,s,i)=>this.stage(t,`${r(Math.max(0,Math.min(99,e)))}:${r(Math.max(0,Math.min(59,s)))}:${r(Math.max(0,Math.min(59,i)))}`),l=(t,e,s,i)=>U`
      <span class="dur-box">
      ...
      </span>`;return U`<span class="dur-input">
      ${l(i,99,"h",t=>n(t,o,a))}
      ${l(o,59,"min",t=>n(i,t,a))}
      ${l(a,59,"s",t=>n(i,o,t))}
    </span>`}numOpts(t,e,s=1,i=String){const o=[],a=(String(s).split(".")[1]||"").length,r=s>0?Math.round((e-t)/s):0;for(let e=0;e<=r;e++){const r=Number((t+e*s).toFixed(a));o.push({label:i(r),value:String(r)})}return o}offOpts(t,e,s=1,i){return[{label:"Off",value:"0"},...this.numOpts(t,e,s,i)]}autoOpts(t,e,s=1,i){return[{label:"Automatic",value:"0"},...this.numOpts(t,e,s,i)]}optSelect(t,e,s=!1){if(!this.get(t))return q;const i=this.draftVal(t),o=e.find(t=>Number(t.value)===Number(i))?.value??e.find(t=>t.value===i)?.value??i;return U`<select @change=${e=>{const i=e.target.value;s?this.hass?.callService("number","set_value",{entity_id:t,value:Number(i)}):this.stage(t,i)}}>
      ${e.map(t=>U`
        <option value=${t.value} .selected=${String(t.value)===String(o)}>${t.label}</option>`)}
    </select>`}optSelectRow(t,e,s,i=!1){if(!this.get(e))return q;const o=!i&&e in this.draft?"dev-row staged":"dev-row";return U`<div class=${o}>
      <span class="dev-lbl">${t}</span>
      <div class="ctl-input">${this.optSelect(e,s,i)}</div>
    </div>`}stagedRow(t,e,s){if(!this.get(e))return q;const i=e in this.draft?"dev-row staged":"dev-row";return U`<div class=${i}>
      <span class="dev-lbl">${t}</span>
      <div class="ctl-input">${this.stagedInput(e,s)}</div>
    </div>`}stagedRangeRow(t,e,s){const i=this.get(e);if(!i)return q;const o=Math.round(Number(i.attributes.min??1)),a=Math.round(Number(i.attributes.max??100)),r=Math.max(1,Math.round(Number(i.attributes.step??1)));return this.optSelectRow(t,e,this.numOpts(o,a,r,s))}stagedPeriodRow(t,e,s){const i=this.get(t),o=this.get(e);if(!i&&!o)return q;const a=t in this.draft||e in this.draft;return U`<div class="dev-row period-row ${a?"staged":""}">
    ...
    </div>`}liveModeRow(t,e){const s=this.get(e);if(!s)return q;const i=s.attributes.options??[],o=this.modeOf(e,s.state);return U`<div class="dev-row ${e in this.draft?"staged":""}">
      <span class="dev-lbl">${t}</span>
      <div class="ctl-input">
      ...
      <button class="plan-btn ${i?"stop":"start"}"
        ...
        ${t}</button>`;if(!t.active)return o.length?U`
        ...
        ${r(null)}
        ${i?U`<div class="plan-actions">${n("Start Plan",!1)}</div>`:q}`:U`
          ...
          </div>`;const l=o.find(t=>t.stageId===a.stageId)||o[0],c=Number(a.progress),d=Number.isFinite(c),h=[];return null!=a.planted&&h.push(`${this.fmtNum(a.planted)} planted`),null!=a.remain&&h.push(`${this.fmtNum(a.remain)} left`),null!=a.totalDays&&h.push(`${this.fmtNum(a.totalDays)} total`),U`
      <div class="plan-banner">
        ...
        ${d?U`<div class="plan-pct" style="color:${e}">${Math.round(c)}%</div>`:q}
      </div>
      ${d?U`<div class="plan-bar"><div class="plan-bar-fill"
            style="width:${Math.max(0,Math.min(100,c))}%;background:${e}"></div></div>`:q}
      ${r(a.stageId)}
      ${i?U`<div class="plan-actions">${n("Stop Plan",!0)}</div>`:q}
      <div class="plan-note">
      ...
      <div class="pe-light">
        ...
        ${h?U`<div class="pe-durrow">Light Duration · ${h}</div>`:q}
        ${l?U`
      ...
      </div>`}renderStageEditor(t){const e=this.accent(),s=this.tempUnitF()?"°F":"°C",i=this.planDraft[t],o=(e,s)=>this.planDraftSet(t,e,s),a=t=>U`<input type="date" class="pe-in"
      .value=${String(i[t]??"")} @change=${e=>o(t,e.target.value)}>`,r=(t,e,s,a)=>U`
      ...
      ${this.planDelArm?U`<div class="pe-head pe-delrow">
      ...
      <div class="plan-stage ${o?"current":""}"
        ...
        <div class="plan-stage-head">
          ...
          ${o?U`<span class="plan-stage-badge" style="color:${i};border-color:${i}">Current</span>`:q}
          ${s>=0?U`<ha-icon icon="mdi:pencil" class="plan-stage-edit"
            @click=${()=>this.editStage(s)}></ha-icon>`:q}
        </div>
        ${a?U`<div class="plan-stage-dates">${a}</div>`:q}
      ...
      </div>`}fmtTemp(t){if(null==t||""===t)return"–";const e=Number(t);if(!Number.isFinite(e))return"–";const s=this.get(`number.sf_${this.config.panel}_env_temp_day`),i=s?.attributes?.unit_of_measurement;return"°F"===i||"℉"===i?`${Math.round(9*e/5+32)}°`:`${Math.round(e)}°`}fmtNum(t){if(null==t||""===t)return"–";const e=Number(t);return Number.isFinite(e)?`${Math.round(e)}`:String(t)}vpdRangeFor(t,e){const s=this.get(t),i=this.get(e);if(!s||!i)return null;const o=Number(s.state),a=Number(i.state);if(!Number.isFinite(o)||!Number.isFinite(a))return null;const r=this.config.panel,n=Number(this.get(`number.sf_${r}_env_temp_deadband`)?.state??0)||0,l=Number(this.get(`number.sf_${r}_env_humi_deadband`)?.state??0)||0,c="°C"===s.attributes.unit_of_measurement,d=t=>c?t:5*(t-32)/9,h=t=>.6108*Math.exp(17.27*t/(t+237.3)),p=Math.max(0,a-l),u=Math.min(100,a+l),f=Math.max(0,h(d(o-n))*(1-u/100)),m=Math.max(0,h(d(o+n))*(1-p/100));return`${f.toFixed(2)} – ${m.toFixed(2)}`}renderVpd(){const t=this.config.panel,e=this.vpdRangeFor(`number.sf_${t}_env_temp_day`,`number.sf_${t}_env_humi_day`),s=this.vpdRangeFor(`number.sf_${t}_env_temp_night`,`number.sf_${t}_env_humi_night`);return e||s?U`
      <div class="env-row">
        <div class="env-row-head">
        ...
        <div class="vpd-grid">
          ${e?U`<div class="vpd-line">
                <span class="vpd-lbl">Daytime</span>
                <span class="vpd-val">${e}</span>
              </div>`:q}
          ${s?U`<div class="vpd-line">
                <span class="vpd-lbl">Nighttime</span>
                <span class="vpd-val">${s}</span>
              </div>`:q}
        </div>
      </div>`:q}renderLeafVpdTargets(){const t=this.get(this.eid("number","leaf_vpd_min")),e=this.get(this.eid("number","leaf_vpd_max"));if(!t||!e)return q;const s=(t,e)=>{const s=this.eid("number",t);return U`
      ...
      </span>`}renderOutlets(){const t=this.outletSlots().filter(t=>this.outletNums(t).length>0);if(!t.length)return q;const e=this.outletOpen?this.outletOpen.slice(0,this.outletOpen.lastIndexOf("_")):null;return U`
      ${t.map(t=>{const s=Ct(this.hass,t)||(t.startsWith("st")?"S-Station":`${t.toUpperCase()} Power Strip`);return U`
      ...
      </div>`}clearOutletCfgDraft(t,e){const s=this.outletKey(t,e);if(!(s in this.outletCfgDraft))return;const i={...this.outletCfgDraft};delete i[s],this.outletCfgDraft=i}renderOutletModeConfig(t,e,s){const i=this.outletKey(t,e),o=this.outletCfgDraft[i]??{},a=(t,e)=>this.outletCfgDraft={...this.outletCfgDraft,[i]:{...o,[t]:e}},r=(t,e,s,i)=>U`
      <div class="dev-row ${e in o?"staged":""}">
        <span class="dev-lbl">${t}</span>
        <span class="num-box">
          <input type="number" min="0" max="1440" .value=${o[e]??String(s)}
            @change=${t=>a(e,t.target.value)} />
          ${i?U`<span class="unit">${i}</span>`:q}
        </span>
      </div>`,n=(t,e,s)=>U`
      <div class="dev-row ${e in o?"staged":""}">
        <span class="dev-lbl">${t}</span>
        <span class="ctl-input">
          <select @change=${t=>a(e,t.target.value)}>
            ${s.map(t=>U`<option value=${t}
              ?selected=${(o[e]??s[0])===t}>${t}</option>`)}
          </select>
        </span>
      </div>`;switch(s){case"Cycle":return U`
        ${l="Start",c="cycle_start",d="12:00",U`
      <div class="dev-row ${c in o?"staged":""}">
        ...
        ${r("Execution Times","cycle_times",1,"")}`;case"Temperature":return n("Device","temp_device",["Heating","Cooling"]);case"Humidity":return n("Device","humidity_device",["Humidifying","Dehumidifying"]);case"CO2":return n("Device","co2_device",["Aeration","Exhaust"]);default:return q}var l,c,d}renderOutletPop(){const t=this.outletOpen;if(!t)return q;const e=t.lastIndexOf("_");if(e<0)return q;const s=t.slice(0,e),i=Number(t.slice(e+1));if(!s||!Number.isFinite(i))return q;const o=`select.sf_${s}_outlet_${i}_mode`;if(!this.get(o))return q;const a=`switch.sf_${s}_outlet_${i}`,r=this.get(a),n=`sf_${s}_outlet_${i}_`,l=this.draftVal(o)||this.get(o)?.state||"",c="Time Slot"===l,d=new Set((Ft[l]||[]).map(t=>`${n}${t}`)),h=Object.keys(this.hass?.states??{}).filter(t=>{const e=t.split(".")[1]??"";return!!d.has(e)&&(!c||e!==`${n}ts_type`&&e!==`${n}ts_start`&&e!==`${n}ts_stop`)}).sort(),p=this.get(o)?.state||"",u=l!==p&&"Manual"!==l&&!c&&(Ft[l]||[]).length>0&&0===h.length,f=this.outletKey(s,i),m=[...u?[]:[o],...r?[a]:[],...h.filter(t=>/^(switch|number|select|text)\./.test(t))],g=!!this.outletDraft[this.outletKey(s,i)],v=this.outletNameDirty(s,i),b=u;return U`
      <div class="soil-pop" style="--sf-accent:${this.accent()}">
        <div class="soil-pop-head">
      ...
      </div>`}renderAlertOther(t){const e=t.other||[];if(!e.length)return q;const s=this.accent();return U`
      <div class="section-label">Other Device</div>
      ${e.map((t,e)=>U`<div class="alert-bool">
      ...
      ${o.length?U`
            ...
            </div>`:U`<div class="cali-empty">No log entries on this date.</div>`}`}render(){if(!this.hass||!this.config)return q;const t=this.hasOutlets();let e=this.tab;"outlets"!==e||t||(e="overview");const s=this.accent(),i=(t,i)=>U`<button class="tab ${e===t?"active":""}"
        style=${e===t?`color:${s};border-color:${s}`:""}
        @click=${()=>this.tab=t}>${i}</button>`,o=Ct(this.hass,this.config.panel);return U`
      <ha-card style=${this.layoutStyle()||q}>
        <div class="header">
          <span class="title">${this.config.title||"Spider Farmer"}</span>
          ${o?U`<span class="device">${o}</span>`:q}
        </div>
        ${U`<div class="tabs">
              ${i("overview","Overview")}
              ${i("env","Environment")}
      ...
      <details class="leaf-cal">
        ...
        <div class="leaf-spots">
          ${a.map((t,e)=>U`<input type="number" step="0.1"
        ...
        <div class="leaf-cal-foot">
          ...
          <button class="leaf-apply" ?disabled=${null==l}
            @click=${()=>null!=l&&(t=>"night"===g?f(t):d(t))(l)}>
            Use for ${"night"===g?"night":"day"}</button>
        </div>
      </details>`}renderSettings(){const t=this.accent(),e=this.colorDraft,s=e?.mode??this.colorMode,i=e?.modeIn??this.colorModeIn,o=e?.hi??this.colHi,a=e?.lo??this.colLo,r=e?.in??this.colIn,n=e?.warn??this.colWarn,l=e?.showTrend??this.showTrend,c=e?.showBand??this.showBand,d=e?.showTargets??this.showTargets,h=e?.tileSummary??this.tileSummary,p=e?.hour12??this.hour12,u=e?.customNames??this.customOutletNames,f=e?.customLayout??this.customLayout,m=e?.scale??this.cardScale,g=e?.cols??this.tileCols,v=!!this.get(this.eid("light","light_2")),b=e?.omode??this.outletColorMode,_=e?.ocManual??this.ocManual,$=e?.ocSched??this.ocSched,x=e?.ocEnv??this.ocEnv,y=e?.ocDrip??this.ocDrip,w=this.hasOutlets(),S=e?.dmode??this.deviceColorMode,M=e?.dcManual??this.dcManual,k=e?.dcSched??this.dcSched,D=e?.dcAuto??this.dcAuto,C=this.overviewDevices().length>0,O=!!e&&(void 0!==e.mode&&e.mode!==this.colorMode||void 0!==e.modeIn&&e.modeIn!==this.colorModeIn||void 0!==e.source&&e.source!==this.colorSource||void 0!==e.warn&&e.warn!==this.colWarn||void 0!==e.showTrend&&e.showTrend!==this.showTrend||void 0!==e.showBand&&e.showBand!==this.showBand||void 0!==e.showTargets&&e.showTargets!==this.showTargets||void 0!==e.tileSummary&&e.tileSummary!==this.tileSummary||void 0!==e.hour12&&e.hour12!==this.hour12||void 0!==e.hi&&e.hi!==this.colHi||void 0!==e.lo&&e.lo!==this.colLo||void 0!==e.in&&e.in!==this.colIn||void 0!==e.hide2&&e.hide2!==this.hideLight2||void 0!==e.customNames&&e.customNames!==this.customOutletNames||void 0!==e.customLayout&&e.customLayout!==this.customLayout||void 0!==e.scale&&e.scale!==this.cardScale||void 0!==e.cols&&e.cols!==this.tileCols||void 0!==e.omode&&e.omode!==this.outletColorMode||void 0!==e.ocManual&&e.ocManual!==this.ocManual||void 0!==e.ocSched&&e.ocSched!==this.ocSched||void 0!==e.ocEnv&&e.ocEnv!==this.ocEnv||void 0!==e.ocDrip&&e.ocDrip!==this.ocDrip||void 0!==e.dmode&&e.dmode!==this.deviceColorMode||void 0!==e.dcManual&&e.dcManual!==this.dcManual||void 0!==e.dcSched&&e.dcSched!==this.dcSched||void 0!==e.dcAuto&&e.dcAuto!==this.dcAuto),N=t=>this.colorDraft={...this.colorDraft??{},...t},A=(e,s,i,o,a)=>U`
      <button class="seg ${e===s?"on":""}"
        style=${e===s?`border-color:${t};color:${t}`:q}
        @click=${a}>
        <ha-icon icon=${o}></ha-icon><span>${i}</span>
      </button>`,T=e?.source??this.colorSource,E=(e,s,i)=>U`
      ...
      <div class="color-row">
        ${P("Above max",o,t=>N({hi:t}))}
        ${P("Below min",a,t=>N({lo:t}))}
        ${P("Near edge",n,t=>N({warn:t}))}
      </div>
      ...
      ${w?U`
            ...
            <div class="color-row">
              ${P("Manual",_,t=>N({ocManual:t}))}
              ${P("Scheduled",$,t=>N({ocSched:t}))}
            </div>
            <div class="color-row">
              ${P("Environment",x,t=>N({ocEnv:t}))}
              ${P("Drip",y,t=>N({ocDrip:t}))}
            </div>`:q}
      ...
      ${C?U`
            ...
            <div class="set-note">
              ...
              <span style="color:${M}">Manual</span>,
              <span style="color:${k}">Scheduled</span>,
            ...
            <div class="color-row">
              ${P("Manual",M,t=>N({dcManual:t}))}
              ${P("Scheduled",k,t=>N({dcSched:t}))}
              ${P("Auto",D,t=>N({dcAuto:t}))}
            </div>`:q}
  ...
  `,t([ut({attribute:!1})],Kt.prototype,"hass",void 0),t([ft()],Kt.prototype,"_config",void 0);const Jt=/^sf_(se\d+)_light$/;function Yt(t){const e=new Set;for(const s of Object.keys(t.states)){if(!s.startsWith("light."))continue;const t=bt(s).match(Jt);t&&e.add(t[1])}return[...e].sort((t,e)=>Number(t.replace(/\D/g,""))-Number(e.replace(/\D/g,"")))}class Xt extends ct{constructor(){super(...arguments),this.draft=null,this.ctlDraft={}}setConfig(t){this.config=t}getCardSize(){return 7}static getStubConfig(t){const e=t?Yt(t):[];return{type:"custom:spider-light-card",...e[0]?{light:e[0]}:{}}}accent(){return this.config.accent||mt}seSlot(){return this.config.light||(this.hass?Yt(this.hass)[0]:"")||"se1"}get(t){return this.hass?.states[t]}shouldUpdate(t){return t.has("config")||t.has("hass")||t.has("draft")||t.has("ctlDraft")}cur(t,e){return t in this.ctlDraft?this.ctlDraft[t]:e}stageCtl(t,e){this.ctlDraft={...this.ctlDraft,[t]:e}}isDirty(){return Object.keys(this.ctlDraft).length>0||null!==this.draft}applyAll(t){const e=this.ctlDraft,s=`light.sf_${t}_light`;if("bri"in e){const t=Number(e.bri);t>0?this.hass?.callService("light","turn_on",{entity_id:s,brightness_pct:t}):this.hass?.callService("light","turn_off",{entity_id:s})}"mode"in e&&this.hass?.callService("select","select_option",{entity_id:`select.sf_${t}_mode`,option:e.mode});for(const t of Object.keys(e))t.includes(".")&&(t.startsWith("number.")?this.hass?.callService("number","set_value",{entity_id:t,value:Number(e[t])}):t.startsWith("text.")&&this.hass?.callService("text","set_value",{entity_id:t,value:e[t]}));if("power"in e){const t="on"===e.power;t&&"bri"in e||this.hass?.callService("light",t?"turn_on":"turn_off",{entity_id:s})}this.draft&&this.saveSchedule(t),this.ctlDraft={}}discardAll(){Object.keys(this.ctlDraft).length&&(this.ctlDraft={}),null!==this.draft&&(this.draft=null)}render(){if(!this.hass||!this.config)return q;const t=this.seSlot(),e=this.get(`light.sf_${t}_light`);if(!e)return U`<ha-card>
      ...
      <ha-card>
        ...
        ${o?U`<div class="modes">
              ${(o.attributes.options??["Manual","Automatic"]).map(t=>U`<button
      ...
      </div>`}renderPeriod(t,e,s,i){return U`
      <div class="period">
        <div class="period-head">
      ...
      </div>`}renderScheduleLegacy(t){const e=this.get(`text.sf_${t}_schedule_start`),s=this.get(`text.sf_${t}_schedule_stop`),i=this.get(`number.sf_${t}_schedule_brightness`),o=this.get(`number.sf_${t}_sunrise_sunset_fade`);return e||s||i||o?U`
      <div class="section-label">Schedule</div>
      ${e||s?U`<div class="sched-times">
      ...
      ${o?this.numRow(`number.sf_${t}_sunrise_sunset_fade`,"Sunrise / sunset fade",o):q}`:q}timeField(t,e){const s=this.get(t);if(!s)return q;const i="unknown"===s.state||"unavailable"===s.state?"":s.state,o=this.cur(t,i);return U`<div class="tf">
      <span class="tf-lbl">${e}</span>
      <input type="time" .value=${o}
        @change=${e=>this.stageCtl(t,e.target.value)} />
    </div>`}numRow(t,e,s){const i=s.attributes.min??0,o=s.attributes.max??100,a=s.attributes.step??1,r=s.attributes.unit_of_measurement??"",n="unknown"===s.state||"unavailable"===s.state?"":s.state,l=this.cur(t,n);return U`<div class="num-row">
    ...
    .discard-btn[disabled] { opacity: 0.5; cursor: default; }
  `,t([ut({attribute:!1})],Xt.prototype,"hass",void 0),t([ft()],Xt.prototype,"config",void 0),t([ft()],Xt.prototype,"draft",void 0),t([ft()],Xt.prototype,"ctlDraft",void 0);const Zt={SE4500:{name:"SE4500",watts:320,isBar:!0,barCount:3,lW:1.163,lL:.369,ppfd:{8:{c:1800,a:1350,e:900},10:{c:1500,a:1150,e:780},12:{c:1250,a:960,e:650},14:{c:1060,a:820,e:545},16:{c:910,a:700,e:465},18:{c:790,a:610,e:400},20:{c:690,a:530,e:350},22:{c:610,a:470,e:305},24:{c:545,a:420,e:270},26:{c:490,a:375,e:240},28:{c:440,a:340,e:215},30:{c:400,a:305,e:195},32:{c:360,a:275,e:175},36:{c:300,a:230,e:145},42:{c:240,a:184,e:115},48:{c:195,a:149,e:93},60:{c:150,a:115,e:72},72:{c:118,a:90,e:56},84:{c:95,a:72,e:45}}},SF2000:{name:"SF2000",watts:200,isBar:!1,barCount:0,lW:.864,lL:.432,ppfd:{8:{c:1600,a:1050,e:480},10:{c:1320,a:870,e:400},12:{c:1100,a:720,e:330},14:{c:920,a:600,e:275},16:{c:780,a:505,e:230},18:{c:660,a:430,e:193},20:{c:570,a:370,e:165},22:{c:495,a:320,e:143},24:{c:435,a:280,e:125},26:{c:385,a:248,e:110},28:{c:340,a:218,e:97},30:{c:305,a:196,e:87},32:{c:274,a:176,e:78},36:{c:226,a:145,e:64},42:{c:182,a:116,e:51},48:{c:148,a:95,e:42},60:{c:97,a:62,e:27},72:{c:68,a:43,e:19},84:{c:49,a:31,e:14}}},SE5000:{name:"SE5000",watts:480,isBar:!0,barCount:4,lW:.855,lL:.85,ppfd:{8:{c:1561,a:1101,e:597},10:{c:1478,a:1041,e:631},12:{c:1402,a:986,e:661},14:{c:1332,a:935,e:686},16:{c:1267,a:889,e:708},18:{c:1206,a:845,e:727},20:{c:1150,a:805,e:744},22:{c:1098,a:767,e:752},24:{c:1049,a:732,e:718},26:{c:1003,a:700,e:686},28:{c:960,a:669,e:656},30:{c:920,a:640,e:628},32:{c:883,a:614,e:601},36:{c:814,a:565,e:554},42:{c:725,a:502,e:492},48:{c:650,a:449,e:440},60:{c:531,a:366,e:358},72:{c:442,a:303,e:297},84:{c:373,a:256,e:251}}},SF7000:{name:"SF7000",watts:650,isBar:!1,barCount:0,lW:.737,lL:.558,ppfd:{8:{c:2560,a:1105,e:314},10:{c:2298,a:1052,e:359},12:{c:2053,a:983,e:394},14:{c:1881,a:955,e:434},16:{c:1714,a:912,e:465},18:{c:1597,a:903,e:506},20:{c:1441,a:833,e:520},22:{c:1328,a:798,e:543},24:{c:1218,a:752,e:556},26:{c:1138,a:734,e:582},28:{c:1059,a:704,e:598},30:{c:987,a:677,e:613},32:{c:922,a:651,e:626},36:{c:811,a:603,e:591},42:{c:678,a:541,e:530},48:{c:575,a:488,e:478},60:{c:429,a:403,e:395},72:{c:332,a:332,e:325},84:{c:265,a:265,e:259}}},G1000W:{name:"G1000W",watts:1e3,isBar:!0,barCount:8,lW:1.153,lL:1.122,ppfd:{8:{c:2156,a:1822,e:1555},10:{c:2068,a:1769,e:1527},12:{c:1985,a:1720,e:1501},14:{c:1908,a:1672,e:1476},16:{c:1834,a:1626,e:1451},18:{c:1765,a:1582,e:1427},20:{c:1700,a:1540,e:1404},22:{c:1638,a:1499,e:1382},24:{c:1580,a:1460,e:1360},26:{c:1524,a:1422,e:1339},28:{c:1472,a:1386,e:1319},30:{c:1422,a:1352,e:1299},32:{c:1375,a:1318,e:1280},36:{c:1287,a:1255,e:1230},42:{c:1170,a:1168,e:1145},48:{c:1068,a:1068,e:1047},60:{c:901,a:901,e:883},72:{c:770,a:770,e:755},84:{c:666,a:666,e:653}}}};function Qt(t,e,s){const i=t.ppfd,o=Object.keys(i).map(Number).sort((t,e)=>t-e);let a=o[0],r=o[o.length-1];for(let t=0;t<o.length-1;t++)if(e>=o[t]&&e<=o[t+1]){a=o[t],r=o[t+1];break}e<=o[0]&&(a=r=o[0]),e>=o[o.length-1]&&(a=r=o[o.length-1]);const n=a===r?0:(e-a)/(r-a),l=(t,e)=>Math.round((t+(e-t)*n)*s/100);return{center:l(i[a].c,i[r].c),avg:l(i[a].a,i[r].a),edge:l(i[a].e,i[r].e)}}function te(t,e){const s=Math.max(0,Math.min(1,t/e));let i,o,a;if(s<.2){const t=s/.2;i=0,o=Math.round(80*t),a=Math.round(160+95*t)}else if(s<.4){const t=(s-.2)/.2;i=0,o=Math.round(80+175*t),a=Math.round(255-255*t)}else if(s<.6){const t=(s-.4)/.2;i=Math.round(220*t),o=255,a=0}else if(s<.8){const t=(s-.6)/.2;i=Math.round(220+35*t),o=Math.round(255-120*t),a=0}else{const t=(s-.8)/.2;i=255,o=Math.round(135-135*t),a=0}return[i,o,a]}class ee extends ct{constructor(){super(...arguments),this.tab="view",this.rev=0,this.s={tW:.61,tL:1.22,tH:1.981,model:"SE4500",hin:18,plantIn:12,numPlants:2,dim:100,photo:18,metric:!1},this.manualDim=100,this.auto=!1,this.brightSrc="",this.T=null,this.scene=null,this.camera=null,this.renderer=null,this.raf=0,this.o={},this.cam={theta:.52,phi:.36,r:3.8,drag:!1,px:0,py:0},this.dirty=!0,this.needRender=!0,this.fitDone=!1,this.serverSynced=!1,this.localApplied=!1,this.saveT=null}setConfig(t){this.config=t;const e=t.defaults||{},s=t.tent||{};this.s.model=t.light_model&&Zt[t.light_model]?t.light_model:"SE4500",this.s.hin=e.height_inches??18,this.s.plantIn=e.plant_height_inches??12,this.s.numPlants=e.num_plants??2,this.s.dim=e.dimmer_percent??100,this.manualDim=this.s.dim,this.s.photo=e.photoperiod_hours??18,this.s.tW=Math.max(.3,.3048*(s.width_ft??2)),this.s.tL=Math.max(.6,.3048*(s.length_ft??4)),this.s.tH=Math.max(.9,.3048*(s.height_ft??6.5)),this.s.metric=this.resolveMetric(),this.serverSynced=!1,this.localApplied=!1,this.dirty=!0,this.fitDone=!1}getCardSize(){return 11}static getStubConfig(t){let e;if(t){const s=Object.keys(t.states).filter(t=>/^sensor\.sf_[a-z0-9]+_alarm_settings$/.test(t)).sort(),i=s[0]&&/^sensor\.sf_([a-z0-9]+)_alarm_settings$/.exec(s[0]);i&&(e=i[1])}return{type:"custom:ppfd-3d-card",title:"PPFD Visualizer",light_model:"SE4500",unit_system:"auto",...e?{panel:e}:{},defaults:{height_inches:18,plant_height_inches:12,num_plants:2,dimmer_percent:100,photoperiod_hours:18},tent:{width_ft:2,length_ft:4,height_ft:6.5}}}resolveMetric(){const t=(this.config?.unit_system||"auto").toLowerCase();if("metric"===t)return!0;if("imperial"===t)return!1;const e=this.hass?.config?.unit_system;return!(!e||!e.length)&&"mi"!==e.length}fmtSmall(t){return this.s.metric?`${Math.round(2.54*t)} cm`:`${Math.round(t)}"`}fmtTentDim(t){return this.s.metric?(.3048*t).toFixed(2):(+t).toFixed(1)}tentUnit(){return this.s.metric?"m":"ft"}optKey(){const t=this.config||{};return"ppfd:"+(t.card_id||t.light_model||"main")}panelSlot(){if(this.config?.panel)return this.config.panel;if(this.hass){const t=Object.keys(this.hass.states).filter(t=>/^sensor\.sf_[a-z0-9]+_alarm_settings$/.test(t)).sort();if(t.length){const e=/^sensor\.sf_([a-z0-9]+)_alarm_settings$/.exec(t[0]);if(e)return e[1]}}return null}alarmEntity(){const t=this.panelSlot();if(!t||!this.hass)return null;const e=`sensor.sf_${t}_alarm_settings`;return this.hass.states[e]?e:null}lsKey(){return`ppfd3d:${this.panelSlot()||"nopanel"}:${this.optKey()}`}blob(){return{model:this.s.model,hin:this.s.hin,plantIn:this.s.plantIn,numPlants:this.s.numPlants,photo:this.s.photo,dim:this.manualDim,tW:this.s.tW,tL:this.s.tL,tH:this.s.tH,auto:!!this.auto,src:this.brightSrc||""}}applyBlob(t){t&&(t.model&&Zt[t.model]&&(this.s.model=t.model),null!=t.hin&&(this.s.hin=t.hin),null!=t.plantIn&&(this.s.plantIn=t.plantIn),null!=t.numPlants&&(this.s.numPlants=t.numPlants),null!=t.photo&&(this.s.photo=t.photo),null!=t.dim&&(this.manualDim=t.dim,this.s.dim=t.dim),null!=t.tW&&(this.s.tW=t.tW),null!=t.tL&&(this.s.tL=t.tL),null!=t.tH&&(this.s.tH=t.tH),this.auto=!!t.auto,this.brightSrc=t.src||"")}hydrateLocal(){if(!this.localApplied){this.localApplied=!0;try{const t=localStorage.getItem(this.lsKey());t&&(this.applyBlob(JSON.parse(t)),this.dirty=!0)}catch{}}}adoptServer(){if(this.serverSynced)return;const t=this.alarmEntity();if(!t)return;this.serverSynced=!0;const e=this.hass.states[t].attributes.card_options,s=this.optKey();if(e&&void 0!==e[s])try{this.applyBlob(JSON.parse(e[s])),this.dirty=!0}catch{}}queueSave(){clearTimeout(this.saveT),this.saveT=setTimeout(()=>this.save(),700)}save(){const t=JSON.stringify(this.blob()),e=this.alarmEntity();e&&this.hass?.callService&&this.hass.callService("sf","set_card_option",{entity_id:e,key:this.optKey(),value:t});try{localStorage.setItem(this.lsKey(),t)}catch{try{const e=this.lsKey();for(const t of Object.keys(localStorage))t.startsWith("ppfd3d:")&&t!==e&&localStorage.removeItem(t);localStorage.setItem(e,t)}catch{}}}brightnessOf(t){if(!t)return 0;if(String(t.entity_id).startsWith("light.")){if("on"!==t.state)return 0;const e=t.attributes&&t.attributes.brightness;return null!=e?Math.round(e/255*100):100}const e=parseFloat(t.state);return isNaN(e)?0:Math.max(0,Math.min(100,Math.round(e)))}readLive(){if(!this.hass)return!1;let t=!1;const e=this.config?.entities||{};if(e.dimmer_percent){const s=this.hass.states[e.dimmer_percent];if(s){const e=parseFloat(s.state);if(!isNaN(e)){const s=Math.max(10,Math.min(100,e));s===this.s.dim||this.auto||(this.s.dim=s,this.manualDim=s,t=!0)}}}if(e.height_inches){const s=this.hass.states[e.height_inches];if(s){const e=parseFloat(s.state);if(!isNaN(e)){const s=Math.max(8,e);s!==this.s.hin&&(this.s.hin=s,t=!0)}}}if(this.auto&&this.brightSrc){const e=this.brightnessOf(this.hass.states[this.brightSrc]);e!==this.s.dim&&(this.s.dim=e,t=!0)}return t}willUpdate(t){if(t.has("config")&&this.hydrateLocal(),t.has("hass")&&this.hass){const t=this.resolveMetric();t!==this.s.metric&&(this.s.metric=t,this.dirty=!0),this.hydrateLocal(),this.adoptServer(),this.readLive()&&(this.dirty=!0)}}firstUpdated(){this.loadThree()}updated(){this.dirty&&(this.needRender=!0)}repaint(){this.rev++}tentInches(){return Math.round(this.s.tH/.0254)}onModel(t){this.s.model=t.target.value,this.dirty=!0,this.repaint(),this.queueSave()}onSlider(t,e){const s=Number(e.target.value),i=this.tentInches();"hin"===t?this.s.hin=Math.min(s,i):"plantIn"===t?this.s.plantIn=Math.min(s,i):"numPlants"===t?this.s.numPlants=isNaN(s)?1:Math.max(1,Math.min(12,Math.round(s))):"photo"===t?this.s.photo=s:"dim"===t&&(this.auto||(this.s.dim=s,this.manualDim=s)),this.dirty=!0,this.repaint(),this.queueSave()}onTent(t,e){const s=Number(e.target.value),i=this.s.metric?1:.3048,o=isNaN(s)?this.s[t]:s*i;"tW"===t?this.s.tW=Math.max(.3,o):"tL"===t?this.s.tL=Math.max(.6,o):this.s.tH=Math.max(.9,o);const a=this.tentInches();this.s.hin>a&&(this.s.hin=a),this.s.plantIn>a&&(this.s.plantIn=a),this.dirty=!0,this.repaint(),this.queueSave()}onAuto(t){if(this.auto=t.target.checked,this.auto){if(!this.brightSrc){const t=this.brightOptions();t.length&&(this.brightSrc=t[0].id)}this.readLive()}else this.s.dim=this.manualDim;this.dirty=!0,this.repaint(),this.queueSave()}onBrightSrc(t){this.brightSrc=t.target.value,this.auto&&this.readLive(),this.dirty=!0,this.repaint(),this.queueSave()}brightOptions(){if(!this.hass)return[];return Object.keys(this.hass.states).filter(t=>!!t.startsWith("light.sf_")||!(!t.startsWith("number.sf_")||!/schedule_brightness/i.test(t))).sort().map(t=>({id:t,name:this.hass.states[t].attributes.friendly_name||t}))}loadThree(){if(window.THREE)return void this.initThree();const t=window;if(!t._ppfdCBs){t._ppfdCBs=[];const e=document.createElement("script");e.src="https://cdnjs.cloudflare.com/ajax/libs/three.js/r128/three.min.js",e.onload=()=>t._ppfdCBs.forEach(t=>t()),document.head.appendChild(e)}t._ppfdCBs.push(()=>this.initThree())}canvas(){return this.renderRoot.querySelector("#c")}initThree(){const t=this.T=window.THREE,e=this.canvas();if(!t||!e)return;const s=e.parentElement?.offsetWidth||400;e.style.height="340px";const i=this.scene=new t.Scene;i.background=new t.Color(592914),this.camera=new t.PerspectiveCamera(36,s/340,.01,40);const o=this.renderer=new t.WebGLRenderer({canvas:e,antialias:!0});o.setSize(s,340),o.setPixelRatio(Math.min(devicePixelRatio,2)),i.add(new t.AmbientLight(3359829,1.1));const a=new t.DirectionalLight(16777215,.55);a.position.set(2,5,3),i.add(a),this.attachCam(e),this.dirty=!0,this.needRender=!0;const r=()=>{this.raf=requestAnimationFrame(r),this.dirty&&(this.dirty=!1,this.rebuild(),this.needRender=!0),this.needRender&&(this.needRender=!1,this.updCam(),o.render(i,this.camera))};r()}attachCam(t){t.addEventListener("mousedown",t=>{this.cam.drag=!0,this.cam.px=t.clientX,this.cam.py=t.clientY}),window.addEventListener("mouseup",()=>{this.cam.drag=!1}),window.addEventListener("mousemove",t=>{this.cam.drag&&(this.cam.theta-=.007*(t.clientX-this.cam.px),this.cam.phi=Math.max(.05,Math.min(1.3,this.cam.phi-.005*(t.clientY-this.cam.py))),this.cam.px=t.clientX,this.cam.py=t.clientY,this.needRender=!0)}),t.addEventListener("wheel",t=>{this.cam.r=Math.max(1.2,Math.min(10,this.cam.r+.005*t.deltaY)),this.needRender=!0},{passive:!0});let e=null;t.addEventListener("touchstart",t=>{1===t.touches.length&&(e={x:t.touches[0].clientX,y:t.touches[0].clientY,t:this.cam.theta,p:this.cam.phi})}),t.addEventListener("touchmove",t=>{e&&1===t.touches.length&&(this.cam.theta=e.t-.007*(t.touches[0].clientX-e.x),this.cam.phi=Math.max(.05,Math.min(1.3,e.p-.005*(t.touches[0].clientY-e.y))),this.needRender=!0)},{passive:!0})}updCam(){if(!this.camera)return;const{theta:t,phi:e,r:s}=this.cam,i=this.s.tH;this.camera.position.set(s*Math.cos(e)*Math.sin(t),s*Math.sin(e)+.38*i,s*Math.cos(e)*Math.cos(t)),this.camera.lookAt(0,.3*i,0)}rem(t){this.o[t]&&this.scene&&this.scene.remove(this.o[t]),this.o[t]=null}sprite(t,e){const s=this.T,i=document.createElement("canvas");i.width=128,i.height=64;const o=i.getContext("2d");return o.fillStyle="rgba(255,255,255,0.92)",o.font=`bold ${e}px sans-serif`,o.textAlign="center",o.textBaseline="middle",o.fillText(t,64,32),new s.Sprite(new s.SpriteMaterial({map:new s.CanvasTexture(i),transparent:!0,depthTest:!1}))}rebuild(){const t=this.T,e=this.scene;if(!t||!e)return;const{tW:s,tL:i,tH:o,model:a,hin:r,plantIn:n,numPlants:l,dim:c}=this.s,d=Zt[a]||Zt.SE4500,h=Math.max(1,r-n),p=Qt(d,h,c),u=.0254*n,f=.0254*r,m=s/2,g=i/2,v=s>i;this.rem("fr");const b=new t.Group,_=[[m,0,g],[m,0,-g],[-m,0,-g],[-m,0,g],[m,o,g],[m,o,-g],[-m,o,-g],[-m,o,g]],$=[];[[0,1],[1,2],[2,3],[3,0],[4,5],[5,6],[6,7],[7,4],[0,4],[1,5],[2,6],[3,7]].forEach(([t,e])=>$.push(..._[t],..._[e]));const x=new t.BufferGeometry;x.setAttribute("position",new t.Float32BufferAttribute($,3)),b.add(new t.LineSegments(x,new t.LineBasicMaterial({color:3822178})));const y=new t.Mesh(new t.BoxGeometry(s,o,i),new t.MeshStandardMaterial({color:12304282,side:t.BackSide,transparent:!0,opacity:.055,roughness:1}));y.position.set(0,o/2,0),b.add(y),e.add(b),this.o.fr=b,this.rem("ht");const w=new t.Group,S=Math.max(1.05*p.center,700),M=30,k=[],D=[],C=[],O=(v?d.lW:d.lL)/s,N=(v?d.lL:d.lW)/i,A=v?1:.7,T=v?.7:1;for(let t=0;t<=30;t++)for(let e=0;e<=M;e++){const o=e/M*s-m,a=t/30*i-g,r=2*(e/M-.5),n=2*(t/30-.5);let l;if(d.isBar){const t=Math.max(0,Math.abs(r)-.5*O)/(1-.5*O+.01),e=Math.max(0,Math.abs(n)-.5*N)/(1-.5*N+.01);l=p.edge+(p.center-p.edge)*Math.exp(-(t*t*3.8+e*e*9))}else{const t=Math.sqrt(r*r*A+n*n*T);l=p.edge+(p.center-p.edge)*Math.exp(-t*t*2.6)}l=Math.max(0,l),k.push(o,u+.004,a);const[c,h,f]=te(l,S);D.push(c/255,h/255,f/255)}for(let t=0;t<30;t++)for(let e=0;e<M;e++){const s=31*t+e;C.push(s,s+31,s+1,s+1,s+31,s+31+1)}const E=new t.BufferGeometry;E.setAttribute("position",new t.Float32BufferAttribute(k,3)),E.setAttribute("color",new t.Float32BufferAttribute(D,3)),E.setIndex(C),E.computeVertexNormals(),w.add(new t.Mesh(E,new t.MeshBasicMaterial({vertexColors:!0,side:t.DoubleSide,transparent:!0,opacity:.9}))),[[0,p.center],[.36*s,p.avg],[.36*-s,p.avg]].forEach(([t,e])=>{const s=this.sprite(Math.round(e)+"",22);s.position.set(t,u+.065,0),s.scale.set(.25,.12,1),w.add(s)}),e.add(w),this.o.ht=w,this.rem("li");const P=new t.Group,L=new t.MeshStandardMaterial({color:5926525,metalness:.55,roughness:.45});if(d.isBar){const e=d.barCount;for(let s=0;s<e;s++){const i=1===e?0:-d.lL/2+d.lL/(e-1)*s,o=new t.Mesh(new t.BoxGeometry(.026,.013,d.lW),L);o.position.set(i,f,0),P.add(o);const a=new t.Mesh(new t.BoxGeometry(.017,.004,.9*d.lW),new t.MeshBasicMaterial({color:16775392}));a.position.set(i,f-.006,0),P.add(a)}[-d.lW/2,d.lW/2].forEach(e=>{const s=new t.Mesh(new t.BoxGeometry(d.lL,.01,.016),new t.MeshStandardMaterial({color:4018012,metalness:.4}));s.position.set(0,f,e),P.add(s)})}else{const e=new t.Mesh(new t.BoxGeometry(d.lL,.02,d.lW),new t.MeshStandardMaterial({color:4873579,metalness:.4,roughness:.6}));e.position.set(0,f,0),P.add(e);const s=new t.MeshBasicMaterial({color:16775392});for(let e=0;e<4;e++)for(let i=0;i<8;i++){const o=new t.Mesh(new t.CircleGeometry(.013,8),s);o.rotation.x=-Math.PI/2,o.position.set(-d.lL/2+(i+.5)*(d.lL/8),f-.009,-d.lW/2+(e+.5)*(d.lW/4)),P.add(o)}}const z=Math.min(o-.02,f+.05);if(z>f+.04){const e=new t.LineBasicMaterial({color:8947848,transparent:!0,opacity:.5});[-d.lL/2+.04,d.lL/2-.04].forEach(s=>{const i=(new t.BufferGeometry).setFromPoints([new t.Vector3(s,z,0),new t.Vector3(s,f,0)]);P.add(new t.Line(i,e))})}const R=new t.PointLight(16772778,.8,2.2);if(R.position.set(0,f,0),P.add(R),P.rotation.y=v?Math.PI/2:0,e.add(P),this.o.li=P,this.rem("bm"),f>u+.01){const o=new t.Group,a=Math.min(.28,.07+p.center/6e3),r=new t.LineBasicMaterial({color:16768341,transparent:!0,opacity:a}),n=.38*d.lL,l=.38*d.lW;[[-n,-l],[n,-l],[n,l],[-n,l]].forEach(([e,a])=>{const n=Math.sign(e)*s/2*.88,l=Math.sign(a)*i/2*.88,c=(new t.BufferGeometry).setFromPoints([new t.Vector3(e,f,a),new t.Vector3(n,u+.005,l)]);o.add(new t.Line(c,r))});const c=(new t.BufferGeometry).setFromPoints([new t.Vector3(0,f+.005,0),new t.Vector3(0,u+.005,0)]);o.add(new t.Line(c,new t.LineBasicMaterial({color:16777215,transparent:!0,opacity:.2}))),o.rotation.y=v?Math.PI/2:0,e.add(o),this.o.bm=o}this.rem("pl");const F=new t.Group,I=.0254*n,B=Math.min(.25,.35*I+.08),H=new t.MeshStandardMaterial({color:1710618,roughness:.9}),W=new t.MeshStandardMaterial({color:4025128,roughness:.8}),j=new t.MeshStandardMaterial({color:3046686,roughness:.85,side:t.DoubleSide}),U=v?s:i,V=U/(l+1);for(let e=0;e<l;e++){const s=-U/2+V*(e+1),i=v?s:0,o=v?0:s,a=new t.Mesh(new t.CylinderGeometry(.06375,.075,B,12),H);a.position.set(i,B/2,o),F.add(a);const r=Math.max(.01,I-B);if(r>.015){const e=new t.Mesh(new t.CylinderGeometry(.011,.015,r,8),W);e.position.set(i,B+r/2,o),F.add(e);const s=Math.max(1,Math.floor(r/.09));for(let e=0;e<s;e++){const a=B+r*(.35+.55*e/Math.max(1,s-1)),n=Math.min(.11,.055+.16*r);for(let s=0;s<3;s++){const r=s*(2*Math.PI/3)+1.1*e,l=new t.Mesh(new t.SphereGeometry(n,6,4),j);l.scale.set(1,.2,.5),l.position.set(i+Math.cos(r)*n*.6,a,o+Math.sin(r)*n*.6),F.add(l)}}}}if(e.add(F),this.o.pl=F,this.rem("hl"),f>u+.01){const i=new t.Group,o=-s/2-.07,a=new t.LineDashedMaterial({color:16777215,transparent:!0,opacity:.45,dashSize:.04,gapSize:.03}),l=(new t.BufferGeometry).setFromPoints([new t.Vector3(o,f,0),new t.Vector3(o,u,0)]),c=new t.Line(l,a);c.computeLineDistances(),i.add(c);const d=this.sprite(this.fmtSmall(r-n),28);d.position.set(o-.11,(f+u)/2,0),d.scale.set(.24,.12,1),i.add(d);const h=new t.MeshBasicMaterial({color:16777215,transparent:!0,opacity:.5}),p=new t.Mesh(new t.ConeGeometry(.013,.035,8),h);p.position.set(o,f-.02,0),i.add(p);const m=new t.Mesh(new t.ConeGeometry(.013,.035,8),h);m.rotation.z=Math.PI,m.position.set(o,u+.02,0),i.add(m),e.add(i),this.o.hl=i}this.fitDone||(this.fitDone=!0,this.cam.r=this.fitDistance()),this.updCam()}fitDistance(){return Math.min(10,Math.max(4.2,2+1.8*Math.max(this.s.tW,this.s.tL,this.s.tH)))}disconnectedCallback(){if(super.disconnectedCallback(),this.raf&&cancelAnimationFrame(this.raf),this.renderer)try{this.renderer.dispose()}catch{}}render(){if(!this.config)return q;const t=this.s,e=Zt[t.model]||Zt.SE4500,s=Math.max(1,t.hin-t.plantIn),i=Qt(e,s,t.dim),o=(i.avg*t.photo*3600/1e6).toFixed(1),a=(r=i.avg)<200?{label:"Too dim",color:"#4488dd"}:r<400?{label:"Seedling / early veg",color:"#22bbaa"}:r<600?{label:"Vegetative growth",color:"#44bb44"}:r<800?{label:"Transition / early flower",color:"#bbaa22"}:r<1e3?{label:"Peak flower zone",color:"#ee8800"}:{label:"High intensity — watch heat",color:"#dd2222"};var r;const n=this.tentInches(),l=this.tentUnit(),c=this.config.title||"PPFD visualizer",d=this.brightOptions();return U`
      <div id="w">
        <div class="top">
        ...
        ${"view"===this.tab?U`
          ...
          <div class="ctrls">
            <div class="r3">
              <div class="cg"><span class="cl">Light height <span class="cv">${this.fmtSmall(t.hin)}</span></span><input type="range" min="8" max=${n} step="1" .value=${String(t.hin)} @input=${t=>this.onSlider("hin",t)}></div>
              <div class="cg"><span class="cl">Plant height <span class="cv">${this.fmtSmall(t.plantIn)}</span></span><input type="range" min="1" max=${n} step="1" .value=${String(t.plantIn)} @input=${t=>this.onSlider("plantIn",t)}></div>
        ...
        `:U`
          ...
          <div class="set">
            ...
            <div class="cg"><span class="cl">Light source</span>
              <select .value=${this.brightSrc} @change=${this.onBrightSrc}>
                ...
                ${d.map(t=>U`<option value=${t.id} ?selected=${this.brightSrc===t.id}>${t.name}</option>`)}
              </select>
            </div>
            <div class="hint">
              ${this.auto&&this.brightSrc?U`Reading ${this.hass?.states[this.brightSrc]?.attributes.friendly_name||this.brightSrc}: ${t.dim}%`:"Pick a Spider Farmer light (live brightness) or a Schedule Brightness (target) and the value tracks it live."}
            </div>
          </div>
          <div class="div"></div>
          ...
          <div class="hint" style="padding:0 12px 12px">Settings save automatically and sync across your devices.</div>
        `}
      </div>
    `}}ee.styles=r`
    :host { display: block; }
