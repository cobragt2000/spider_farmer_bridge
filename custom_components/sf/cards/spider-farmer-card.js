/*! spider-farmer-card v0.21.57 | MIT */
 ...
 */
const e=globalThis,i=e.ShadowRoot&&(void 0===e.ShadyCSS||e.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,s=Symbol(),o=new WeakMap;let a=class{constructor(t,e,i){if(this._$cssResult$=!0,i!==s)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=e}get styleSheet(){let t=this.o;const e=this.t;if(i&&void 0===t){const i=void 0!==e&&1===e.length;i&&(t=o.get(e)),void 0===t&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),i&&o.set(e,t))}return t}toString(){return this.cssText}};const n=(t,...e)=>{const i=1===t.length?t[0]:e.reduce((e,i,s)=>e+(t=>{if(!0===t._$cssResult$)return t.cssText;if("number"==typeof t)return t;throw Error("Value passed to 'css' function must be a 'css' function result: "+t+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(i)+t[s+1],t[0]);return new a(i,t,s)},r=i?t=>t:t=>t instanceof CSSStyleSheet?(t=>{let e="";for(const i of t.cssRules)e+=i.cssText;return(t=>new a("string"==typeof t?t:t+"",void 0,s))(e)})(t):t,{is:l,defineProperty:c,getOwnPropertyDescriptor:d,getOwnPropertyNames:h,getOwnPropertySymbols:p,getPrototypeOf:u}=Object,g=globalThis,m=g.trustedTypes,f=m?m.emptyScript:"",v=g.reactiveElementPolyfillSupport,b=(t,e)=>t,_={toAttribute(t,e){switch(e){case Boolean:t=t?f:null;break;case Object:case Array:t=null==t?t:JSON.stringify(t)}return t},fromAttribute(t,e){let i=t;switch(e){case Boolean:i=null!==t;break;case Number:i=null===t?null:Number(t);break;case Object:case Array:try{i=JSON.parse(t)}catch(t){i=null}}return i}},$=(t,e)=>!l(t,e),x={attribute:!0,type:String,converter:_,reflect:!1,useDefault:!1,hasChanged:$};
/**
 * @license
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const ht={attribute:!0,type:String,converter:_,reflect:!1,hasChanged:$},pt=(t=ht,e,i)=>{const{kind:s,metadata:o}=i;let a=globalThis.litPropertyMetadata.get(o);if(void 0===a&&globalThis.litPropertyMetadata.set(o,a=new Map),"setter"===s&&((t=Object.create(t)).wrapped=!0),a.set(i.name,t),"accessor"===s){const{name:s}=i;return{set(i){const o=e.get.call(this);e.set.call(this,i),this.requestUpdate(s,o,t,!0,i)},init(e){return void 0!==e&&this.C(s,void 0,t,e),e}}}if("setter"===s){const{name:s}=i;return function(i){const o=this[s];e.call(this,i),this.requestUpdate(s,o,t,!0,i)}}throw Error("Unsupported decorator location: "+s)};function ut(t){return(e,i)=>"object"==typeof i?pt(t,e,i):((t,e,i)=>{const s=e.hasOwnProperty(i);return e.constructor.createProperty(i,t),s?Object.getOwnPropertyDescriptor(e,i):void 0})(t,e,i)}
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function gt(t){return ut({...t,state:!0,attribute:!1})}const mt="#ff7a1a",ft=["S","M","T","W","T","F","S"],vt=/^sf_(dp\d+|ac5|ac10|st\d+)_/;function bt(t){return t.split(".")[1]??""}function _t(t,e,i,s){const o=s*Math.PI/180;return[t+i*Math.cos(o),e+i*Math.sin(o)]}function $t(t,e,i,s,o){const a=135+270*s,n=135+270*o,[r,l]=_t(t,e,i,a),[c,d]=_t(t,e,i,n),h=n-a>180?1:0;return`M ${r.toFixed(2)} ${l.toFixed(2)} A ${i} ${i} 0 ${h} 1 ${c.toFixed(2)} ${d.toFixed(2)}`}function xt(t){const e=t.currentTarget,i=e.parentElement?.querySelector(".sl-bub");if(!i)return;const s=Number(e.min||"0"),o=Number(e.max||"100"),a=Number(e.value),n=o>s?(a-s)/(o-s):0,r=function(t){const e=String(t),i=e.indexOf(".");return i>=0?e.length-i-1:0}(Number(e.step||"1")),l=Number.isFinite(a)?a.toFixed(r):e.value;i.textContent="1"===e.dataset.off&&a<=s?"off":`${l}${e.dataset.unit??""}`,i.style.left=`calc(${n} * (100% - 18px) + 9px)`}const yt=n`
  .sl-live {
...
`;function wt(t){const e=new Set;for(const i of Object.keys(t.states)){const t=bt(i).match(vt);t&&e.add(t[1])}return[...e].sort()}function St(t){return wt(t).filter(e=>/^(ac|st)\d/.test(e)&&!!t.states[`switch.sf_${e}_outlet_1`]||Object.keys(t.states).some(t=>{const i=bt(t);return i===`sf_${e}_temperature`||i===`sf_${e}_soil_avg_temperature`||i===`sf_${e}_light_1`||i===`sf_${e}_fan`||i===`sf_${e}_blower`}))}function kt(t){return wt(t).filter(e=>!!t.states[`switch.sf_${e}_outlet_1`])}function Ot(t,e){const i=`sf_${e}_`,s=Object.keys(t.states);return s.find(t=>bt(t)===`sf_${e}_temperature`)??s.find(t=>{const s=bt(t);return s.startsWith(i)&&!s.startsWith(`sf_${e}_env_`)})}function Dt(t,e){const i=Ot(t,e);return i?t.entities?.[i]?.device_id:void 0}function Ct(t,e){if(!e)return[];const i=Dt(t,e);return i?kt(t).filter(s=>{if(s===e)return!1;const o=Dt(t,s),a=o?t.devices?.[o]:void 0;return a?.via_device_id===i}):[]}function Mt(t,e){if(!t||!e)return"";const i=Ot(t,e);if(!i)return"";const s=t.entities?.[i]?.device_id,o=s?t.devices?.[s]:void 0;if(o)return o.name_by_user||o.name||"";const a=(t.states[i].attributes.friendly_name||"").match(/^(SF .+? [0-9A-Fa-f]{4})\b/);return a?a[1]:""}const Tt=[["temperature","Air Temp","mdi:thermometer"],["humidity","Air Humi","mdi:water-percent"],["vpd","Air VPD","mdi:water-opacity"],["leaf_vpd","Leaf VPD","mdi:leaf"],["co2","CO2","mdi:molecule-co2"],["ppfd","PPFD","mdi:white-balance-sunny"],["soil_avg_temperature","Soil Temp","mdi:thermometer"],["soil_avg_moisture","Moisture","mdi:water"],["soil_avg_ec","Soil EC","mdi:flash"]],Lt={temperature:"temp",humidity:"humi",vpd:"vpd",co2:"co2",ppfd:"ppfd",soil_avg_temperature:"tempSoil",soil_avg_moisture:"humiSoil",soil_avg_ec:"ECSoil"},Nt={temperature:"temp",humidity:"humi",co2:"co2"},Pt="#ff6b6b",Et="rgba(255,107,107,0.16)",Rt=(t,e=.16)=>{const i=/^#?([0-9a-fA-F]{6})$/.exec((t||"").trim());if(!i)return`rgba(255,107,107,${e})`;const s=parseInt(i[1],16);return`rgba(${s>>16&255},${s>>8&255},${255&s},${e})`},At=t=>"string"==typeof t&&/^#[0-9a-fA-F]{6}$/.test(t),Ft=t=>"alarms"===t||"targets"===t||"both"===t,zt=mt,Bt={"Time Slot":["ts_type","ts_start","ts_stop"],Cycle:["cycle_start","cycle_run","cycle_off","cycle_times"],Temperature:["temp_device"],Humidity:["humidity_device"],CO2:["co2_device"],"Drip Irrigation":["drip_soil","drip_avg"],Manual:[]},Ht=[{label:"General device",mode:"Manual",cfg:{dev_type:"0"}},{label:"Timer period",mode:"Time Slot",cfg:{dev_type:"1"}},{label:"Timer loop",mode:"Cycle",cfg:{dev_type:"2"}},{label:"Blower",mode:"Blower (Temperature Priority)",cfg:{dev_type:"3"}},{label:"Humidification",mode:"Humidity",cfg:{dev_type:"4",humidity_device:"Humidifying"}},{label:"Dehumidification",mode:"Humidity",cfg:{dev_type:"5",humidity_device:"Dehumidifying"}},{label:"Heater",mode:"Temperature",cfg:{dev_type:"6",temp_device:"Heating"}},{label:"Cooler",mode:"Temperature",cfg:{dev_type:"7",temp_device:"Cooling"}},{label:"CO2 Injection",mode:"CO2",cfg:{dev_type:"8",co2_device:"Aeration"}},{label:"Exhaust fan",mode:"CO2",cfg:{dev_type:"9",co2_device:"Exhaust"}},{label:"Light Env",mode:"Light Env",cfg:{}}],It={"Temperature Priority":"Blower (Temperature Priority)","Humidity Priority":"Blower (Humidity Priority)"},Vt=new Set(["Blower","Humidification","Dehumidification","Heater","Cooler","CO2 Injection","Exhaust fan"]),Qt=mt,Wt=t=>!!t&&("unavailable"===t.state||"unknown"===t.state),jt=t=>{const e=(t||"").match(/^(\d{1,2}):(\d{2})$/);if(!e)return null;const i=+e[1],s=+e[2];return i<=23&&s<=59?60*i+s:null},qt=(t,e,i,s,o="",a=!1)=>W`<div class="save-bar ${o}">
  ...
  <button class="discard-btn" ?disabled=${!e||o}
    @click=${s}>Discard</button>`)(t,e,i,s,a)}
    ...
    </select>`;if(this._graphLoading[i])return W`<div class="param-graph"><div class="pg-head"><span>${s}</span>${a}<span class="pg-now">…</span><ha-icon icon="mdi:close" @click=${()=>this.paramOpen=null}></ha-icon></div><span class="pg-note">Loading history…</span></div>`;const n=this._graph[i];if(!n||n.length<2)return W`<div class="param-graph"><div class="pg-head"><span>${s}</span>${a}<span class="pg-now"></span><ha-icon icon="mdi:close" @click=${()=>this.paramOpen=null}></ha-icon></div><span class="pg-note">Not enough history yet for ${s} at this range.</span></div>`;const r=n.map(t=>t.v),l=Math.min(...r),c=Math.max(...r),d=r.reduce((t,e)=>t+e,0)/r.length,h=r[r.length-1],p=Math.abs(d)<10?2:Math.abs(d)<100?1:0,u=t=>t.toFixed(p),g=this.bandInfo(t),m="leaf_vpd"===t||"alarms"!==this.colorSource?this.targetOutOfRange(t,h):this.outOfRange(Lt[t],h),f="above"===m?this.colHi:"below"===m?this.colLo:"near"===m?this.colWarn:"var(--primary-text-color)",v=520,b=120,_=n[0].t,$=n[n.length-1].t||_+1;let x=l,y=c;g&&(x=Math.min(x,g.warnLo),y=Math.max(y,g.warnHi));const w=.08*(y-x)||1;x-=w,y+=w;const S=t=>6+(t-_)/($-_)*508,k=t=>114-(t-x)/(y-x)*108,O=n.map((t,e)=>`${e?"L":"M"}${S(t.t).toFixed(1)} ${k(t.v).toFixed(1)}`).join(" "),D=`M${S(_).toFixed(1)} ${114..toFixed(1)} ${O.slice(1)} L${S($).toFixed(1)} ${114..toFixed(1)} Z`,C=this.accent(),M=r.indexOf(l),T=r.indexOf(c),L=(t,e)=>j`<line x1="0" x2=${v} y1=${k(t).toFixed(1)} y2=${k(t).toFixed(1)} stroke=${e} stroke-width="1" stroke-dasharray="3 3" opacity="0.6"></line>`,N=t=>this.graphRange>=168?new Date(t).toLocaleDateString([],{month:"numeric",day:"numeric"}):new Date(t).toLocaleTimeString([],{hour:"2-digit",minute:"2-digit",hour12:this.hour12}),P=this.graphRange>=168?7:6,E=Array.from({length:P+1},(t,e)=>_+e/P*($-_)),R=null!=this._graphSel?this._graphSel:null!=this._graphPin?this._graphPin:null,A=null!=R&&R>=0&&R<n.length?R:null,F=(t,e)=>{const i=t.currentTarget.getBoundingClientRect();if(!i.width)return;const s=Math.max(0,Math.min(1,(t.clientX-i.left)/i.width)),o=_+s*($-_);let a=0,r=1/0;for(let t=0;t<n.length;t++){const e=Math.abs(n[t].t-o);e<r&&(r=e,a=t)}this._graphSel=a,e&&(this._graphPin=a)},z=null!=A?n[A].v:h;return W`<div class="param-graph">
      <div class="pg-head">
        <span>${s}</span>${a}
      ...
      <div class="pg-plot">
        ...
        <svg viewBox="0 0 ${v} ${b}" preserveAspectRatio="none" class="pg-svg"
          ...
          ${E.map(t=>j`<line x1=${S(t).toFixed(1)} x2=${S(t).toFixed(1)} y1="0" y2=${b} stroke="var(--divider-color, #333)" stroke-width="1" opacity="0.35"></line>`)}
          ${g?j`
          ...
          ${null!=A?j`
            <line x1=${S(n[A].t).toFixed(1)} x2=${S(n[A].t).toFixed(1)} y1="0" y2=${b} stroke="var(--secondary-text-color)" stroke-width="1" opacity="0.7"></line>
      ...
      </div>`}soilProbeRows(t){const e=new RegExp(`^sf_${this.config.panel}_(soil\\d+)_${t}$`),i=[];for(const s of Object.keys(this.hass?.states??{})){const o=bt(s).match(e);o&&i.push({slot:o[1],name:this.soilSensorName(s,t),e:this.hass.states[s]})}return i.sort((t,e)=>Number(t.slot.replace(/\D/g,""))-Number(e.slot.replace(/\D/g,""))),i.map(({name:t,e:e})=>({name:t,e:e}))}soilSensorName(t,e){let i=this.hass?.states[t]?.attributes.friendly_name??"";const s=Mt(this.hass,this.config.panel);s&&i.startsWith(s)&&(i=i.slice(s.length).trim());const o="temperature"===e?"Temperature":"moisture"===e?"Moisture":"EC";return i=i.replace(new RegExp(`\\s*${o}\\s*$`,"i"),"").trim(),i||bt(t)}renderSoilPop(){const t=this.soilOpen;if(!t)return U;const e=this.soilProbeRows(t);if(!e.length)return U;return W`
      <div class="soil-pop">
      ...
      </div>`}lightSchedule(t,e){const i=this.config.panel,s=t=>{const e=this.get(t);return e&&"unknown"!==e.state&&"unavailable"!==e.state?e.state:""};let o=s(`text.sf_${i}_${t}_schedule_start`),a=s(`text.sf_${i}_${t}_schedule_stop`);if("PPFD"===e||"PPFD - Plan"===e){const e=s(`text.sf_${i}_${t}_ppfd_start`),n=s(`text.sf_${i}_${t}_ppfd_stop`);e&&n&&("00:00"!==e||"00:00"!==n)&&(o=e,a=n)}return[o,a]}lightDLI(t){if("light"!==t.domain)return U;const e=this.config.panel,i=t.suffix,s=this.modeOf(`select.sf_${e}_${i}_mode`);if("PPFD"!==s&&"PPFD - Plan"!==s)return U;const o=Number(this.get(`number.sf_${e}_${i}_ppfd_target`)?.state);if(!Number.isFinite(o)||o<=0)return U;const[a,n]=this.lightSchedule(i,s),r=/^(\d{1,2}):(\d{2})/.exec(a),l=/^(\d{1,2}):(\d{2})/.exec(n);if(!r||!l)return U;const c=(60*+l[1]+ +l[2]-(60*+r[1]+ +r[2])+1440)%1440/60;if(c<=0)return U;const d=o*c*.0036;return W`<div class="tile-dli">
      ...
      <button class="plan-btn ${s?"stop":"start"}"
        ...
        @click=${()=>{this.envSubView="plan",this.hass?.callService("switch",s?"turn_off":"turn_on",{entity_id:i}),this.setPlanLights(!s)}}>
      ...
      <span>${t}</span>${e}</label>`,f=t=>W`<div class="pe-cellrow">${t}</div>`,v=m("Go dark",n("go_dark",this.threshOpts())),b=m("Turn off",n("turn_off",this.threshOpts()));return W`
      <div class="pe-light">
      ...
      </div>`,r=(t,e)=>{if(!e||"object"!=typeof e)return U;const i=e.mode||"";let s="",o="";if("Manual"===i){const t=Number(e.ts_bri)||0;s=t>0?`${t}%`:"Off"}else"PPFD"===i?(s=`${e.ppfd_start}–${e.ppfd_stop}`,o=`PPFD ${Math.round(Number(e.ppfd_target)||0)}`):(s=`${e.ts_start}–${e.ts_stop}`,o=`${Math.round(Number(e.ts_bri)||0)}%`);return W`
        <div class="plan-metric">
          <span class="plan-metric-label">${t}</span>
          <span class="plan-metric-vals">
            ${s?W`<span>${s}</span>`:U}
      ...
      ${v?W`
        <div class="toggle-row" style="margin-top:6px">
          ...
          <button class="toggle ${_?"on":""}"
            ...
            @click=${()=>nt({outletQuickNames:!_})}></button>
        </div>
        <div class="set-note">
        ...
        <div class="toggle-row" style="margin-top:6px">
          ...
          <button class="toggle ${b?"on":""}"
            style=${b?`background:${t}`:U}
            @click=${()=>nt({outletQuickRemember:!b})}></button>
        </div>
        <div class="set-note">
      ...
      ${[{label:"Colours & tile appearance",tpl:ut},{label:"Dehumidifier cooldown timer",tpl:gt},{label:"Devices",tpl:_t},{label:"Header connection info",tpl:vt},{label:"Layout",tpl:xt},{label:"Outlets",tpl:$t},{label:"Overview",tpl:mt},{label:"Smart control",tpl:pt},{label:"Temperature source",tpl:ht},{label:"Tile extras",tpl:ft},{label:"VPD graph",tpl:bt}].sort((t,e)=>t.label.localeCompare(e.label)).map(t=>t.tpl)}
