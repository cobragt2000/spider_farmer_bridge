/*! spider-farmer-card v0.20.61 | MIT */
...
`;function wt(t){const e=new Set;for(const s of Object.keys(t.states)){const t=bt(s).match(vt);t&&e.add(t[1])}return[...e].sort()}function St(t){return wt(t).filter(e=>e.startsWith("st")&&!!t.states[`switch.sf_${e}_outlet_1`]||Object.keys(t.states).some(t=>{const s=bt(t);return s===`sf_${e}_temperature`||s===`sf_${e}_soil_avg_temperature`||s===`sf_${e}_light_1`||s===`sf_${e}_fan`||s===`sf_${e}_blower`}))}function Mt(t,e){const s=`sf_${e}_`,i=Object.keys(t.states);return i.find(t=>bt(t)===`sf_${e}_temperature`)??i.find(t=>{const i=bt(t);return i.startsWith(s)&&!i.startsWith(`sf_${e}_env_`)})}function kt(t,e){const s=Mt(t,e);return s?t.entities?.[s]?.device_id:void 0}function Dt(t,e){if(!e)return[];const s=kt(t,e);return s?function(t){return wt(t).filter(e=>!!t.states[`switch.sf_${e}_outlet_1`])}(t).filter(i=>{if(i===e)return!1;const o=kt(t,i),a=o?t.devices?.[o]:void 0;return a?.via_device_id===s}):[]}function Ct(t,e){if(!t||!e)return"";const s=Mt(t,e);if(!s)return"";const i=t.entities?.[s]?.device_id,o=i?t.devices?.[i]:void 0;if(o)return o.name_by_user||o.name||"";const a=(t.states[s].attributes.friendly_name||"").match(/^(SF .+? [0-9A-Fa-f]{4})\b/);return a?a[1]:""}const Ot=[["temperature","Air Temp","mdi:thermometer"],["humidity","Air Humi","mdi:water-percent"],["vpd","Air VPD","mdi:water-opacity"],["leaf_vpd","Leaf VPD","mdi:leaf"],["co2","CO2","mdi:molecule-co2"],["ppfd","PPFD","mdi:white-balance-sunny"],["soil_avg_temperature","Soil Temp","mdi:thermometer"],["soil_avg_moisture","Moisture","mdi:water"],["soil_avg_ec","Soil EC","mdi:flash"]],Nt={temperature:"temp",humidity:"humi",vpd:"vpd",co2:"co2",ppfd:"ppfd",soil_avg_temperature:"tempSoil",soil_avg_moisture:"humiSoil",soil_avg_ec:"ECSoil"},At={temperature:"temp",humidity:"humi",co2:"co2"},Tt="#ff6b6b",Et="rgba(255,107,107,0.16)",Lt=(t,e=.16)=>{const s=/^#?([0-9a-fA-F]{6})$/.exec((t||"").trim());if(!s)return`rgba(255,107,107,${e})`;const i=parseInt(s[1],16);return`rgba(${i>>16&255},${i>>8&255},${255&i},${e})`},Pt=t=>"string"==typeof t&&/^#[0-9a-fA-F]{6}$/.test(t),zt=t=>"alarms"===t||"targets"===t||"both"===t,Rt=mt,Ft={"Time Slot":["ts_type","ts_start","ts_stop"],Cycle:["cycle_start","cycle_run","cycle_off","cycle_times"],Temperature:["temp_device"],Humidity:["humidity_device"],CO2:["co2_device"],"Drip Irrigation":["drip_soil","drip_avg"],Manual:[]},It=mt,Bt=t=>!!t&&("unavailable"===t.state||"unknown"===t.state),Ht=t=>{const e=(t||"").match(/^(\d{1,2}):(\d{2})$/);if(!e)return null;const s=+e[1],i=+e[2];return s<=23&&i<=59?60*s+i:null},Wt=(t,e,s,i,o="")=>V`<div class="save-bar ${o}">
    ...
    @click=${i}>Discard</button>`)(t,e,s,i)}
      ...
      <div class="pg-plot">
        ...
        <svg viewBox="0 0 ${m} ${g}" preserveAspectRatio="none" class="pg-svg">
          ${p?U`
            <rect x="0" y=${w(p.warnHi).toFixed(1)} width=${m} height=${(w(p.bandHi)-w(p.warnHi)).toFixed(1)} fill=${Lt(this.colWarn,.16)}></rect>
            <rect x="0" y=${w(p.bandLo).toFixed(1)} width=${m} height=${(w(p.warnLo)-w(p.bandLo)).toFixed(1)} fill=${Lt(this.colWarn,.16)}></rect>
            <rect x="0" y=${w(p.bandHi).toFixed(1)} width=${m} height=${(w(p.bandLo)-w(p.bandHi)).toFixed(1)} fill=${Lt(this.colIn,.2)}></rect>
            ${N(p.bandHi,this.colIn)}${N(p.bandLo,this.colIn)}`:q}
          <path d=${M} fill=${Lt(k,.12)} stroke="none"></path>
      ...
      <div class="tile ${g?"clickable":""} ${d||p?"active":""}"
        ...
        <div class="tile-label">
          ...
          <span class="tl-right">
            ${r?V`<ha-icon icon="mdi:broom" title="Sensor cleaning"
        ...
        <div class="tile-val" style=${m||q}>${n}${a||r?q:V`<span class="unit">${o}</span>`}</div>
        ${r?V`<div class="tile-target" style="color:var(--warning-color,#ff9800)">${this.cleaningLabel()}${this.cleaningRemaining()?" · "+this.cleaningRemaining():""}</div>`:a?q:this.targetSubline(t,o)}
      ...
      <div class="tile tile-device clickable ${o?"active":""}"
        ...
        ${this.lightDLI(t)}
        ${this.fanBadge(t)}
      </div>`}lightSchedule(t,e){const s=this.config.panel,i=t=>{const e=this.get(t);return e&&"unknown"!==e.state&&"unavailable"!==e.state?e.state:""};let o=i(`text.sf_${s}_${t}_schedule_start`),a=i(`text.sf_${s}_${t}_schedule_stop`);if("PPFD"===e){const e=i(`text.sf_${s}_${t}_ppfd_start`),r=i(`text.sf_${s}_${t}_ppfd_stop`);e&&r&&("00:00"!==e||"00:00"!==r)&&(o=e,a=r)}return[o,a]}lightDLI(t){if("light"!==t.domain)return q;const e=this.config.panel,s=t.suffix,i=this.modeOf(`select.sf_${e}_${s}_mode`);if("PPFD"!==i)return q;const o=Number(this.get(`number.sf_${e}_${s}_ppfd_target`)?.state);if(!Number.isFinite(o)||o<=0)return q;const[a,r]=this.lightSchedule(s,i),n=/^(\d{1,2}):(\d{2})/.exec(a),l=/^(\d{1,2}):(\d{2})/.exec(r);if(!n||!l)return q;const c=(60*+l[1]+ +l[2]-(60*+n[1]+ +n[2])+1440)%1440/60;if(c<=0)return q;const d=o*c*.0036;return V`<div class="tile-dli">
      ...
      <div class="params-head">
        ...
        ${s}
      </div>`}renderOverview(){const t=Ot.map(t=>this.renderParam(t)).filter(t=>t!==q),e=this.soilStatsTile(),s=this.overviewDevices();return V`
      ...
      @click=${()=>o("mode",t)}>${t}</button>`,l="PPFD"===i.mode,c=l?"ppfd_start":"ts_start",d=l?"ppfd_stop":"ts_stop",h=this.durText(i[c],i[d]),p=this.numOpts(11,100,1,t=>`${t}%`),u=this.numOpts(20,2e3,10,t=>`${t} µmol`),f=this.offOpts(1,60,1,t=>`${t} min`),m=(t,e)=>V`<label class="pe-cell">
      ...
      ${t.map(t=>{const s=Ct(this.hass,t)||(t.startsWith("st")?"S-Station":`${t.toUpperCase()} Power Strip`);return V`
          ...
          ${e===t?this.renderOutletPop():q}`})}`}outletColorFor(t){switch((t=>"Time Slot"===t||"Cycle"===t?"sched":"Temperature"===t||"Humidity"===t||"CO2"===t?"env":"Drip Irrigation"===t?"drip":"manual")(t)){case"sched":return this.ocSched;case"env":return this.ocEnv;case"drip":return this.ocDrip;default:return this.ocManual}}outletModeDetail(t,e,s){const i=`sf_${t}_outlet_${e}`,o=t=>this.get(t)?.state??"";if("Temperature"===s){const t=o(`select.${i}_temp_device`);return"Heating"===t?{text:"Heating",cls:"od-heat"}:"Cooling"===t?{text:"Cooling",cls:"od-cool"}:null}if("Humidity"===s){const t=o(`select.${i}_humidity_device`);return"Humidifying"===t?{text:"Humidifying",cls:"od-hum"}:"Dehumidifying"===t?{text:"Dehumidifying",cls:"od-dehum"}:null}if("CO2"===s){const t=o(`select.${i}_co2_device`);return"Aeration"===t?{text:"Aeration",cls:"od-aer"}:"Exhaust"===t?{text:"Exhaust",cls:"od-exh"}:null}if("Time Slot"===s){const s=this.outletPeriods(t,e);if(s.length){const t=s[0],e=`${this.fmtClock(t.start)}–${this.fmtClock(t.end)}`;return{text:s.length>1?`${e} +${s.length-1}`:e,cls:"od-sched"}}const a=o(`text.${i}_ts_start`),r=o(`text.${i}_ts_stop`);return a&&r?{text:`${this.fmtClock(a)}–${this.fmtClock(r)}`,cls:"od-sched"}:null}if("Cycle"===s){const t=t=>{const e=Number(t);return Number.isFinite(e)&&e>=60&&e%60==0?e/60+"h":`${e}m`},e=o(`number.${i}_cycle_run`),s=o(`number.${i}_cycle_off`);if(e&&s){let a=`${t(e)} on · ${t(s)} off`;const r=o(`number.${i}_cycle_times`);r&&Number(r)>1&&(a+=` · ×${Math.round(Number(r))}`);const n=o(`text.${i}_cycle_start`);return n&&"00:00"!==n&&(a+=` @ ${this.fmtClock(n)}`),{text:a,cls:"od-sched"}}return null}return null}outletTile(t,e){const s="on"===this.draftVal(`switch.sf_${t}_outlet_${e}`),i=this.draftVal(`select.sf_${t}_outlet_${e}_mode`)||"",o=this.outletKey(t,e),a=this.outletOpen===o,r=this.accent(),n=s&&"off"!==this.outletColorMode?this.outletColorFor(i):"",l=n||r;let c="";return n&&"tile"===this.outletColorMode&&(c=`background:${Lt(n)};box-shadow:inset 0 0 0 1px ${n}`),a&&(c=`box-shadow:inset 0 0 0 1px ${r}`+(n&&"tile"===this.outletColorMode?`;background:${Lt(n)}`:"")),V`
      ...
      <div class="color-row">
        ${L("Above max",o,t=>N({hi:t}))}
        ${L("Below min",a,t=>N({lo:t}))}
        ${L("Near edge",n,t=>N({warn:t}))}
      </div>
      ...
      ${w?V`
            ...
            <div class="color-row">
              ${L("Manual",_,t=>N({ocManual:t}))}
              ${L("Scheduled",$,t=>N({ocSched:t}))}
            </div>
            <div class="color-row">
              ${L("Environment",x,t=>N({ocEnv:t}))}
              ${L("Drip",y,t=>N({ocDrip:t}))}
            </div>`:q}
      ...
      ${C?V`
            ...
            <div class="color-row">
              ${L("Manual",M,t=>N({dcManual:t}))}
              ${L("Scheduled",k,t=>N({dcSched:t}))}
              ${L("Auto",D,t=>N({dcAuto:t}))}
            </div>`:q}
  ...
  `,t([ut({attribute:!1})],Kt.prototype,"hass",void 0),t([ft()],Kt.prototype,"_config",void 0);const Jt=/^sf_(se\d+)_light$/;function Yt(t){const e=new Set;for(const s of Object.keys(t.states)){if(!s.startsWith("light."))continue;const t=bt(s).match(Jt);t&&e.add(t[1])}return[...e].sort((t,e)=>Number(t.replace(/\D/g,""))-Number(e.replace(/\D/g,"")))}class Xt extends ct{constructor(){super(...arguments),this.draft=null,this.ctlDraft={}}setConfig(t){this.config=t}getCardSize(){return 7}static getStubConfig(t){const e=t?Yt(t):[];return{type:"custom:spider-light-card",...e[0]?{light:e[0]}:{}}}accent(){return this.config.accent||mt}seSlot(){return this.config.light||(this.hass?Yt(this.hass)[0]:"")||"se1"}get(t){return this.hass?.states[t]}shouldUpdate(t){return t.has("config")||t.has("hass")||t.has("draft")||t.has("ctlDraft")}cur(t,e){return t in this.ctlDraft?this.ctlDraft[t]:e}stageCtl(t,e){this.ctlDraft={...this.ctlDraft,[t]:e}}isDirty(){return Object.keys(this.ctlDraft).length>0||null!==this.draft}applyAll(t){const e=this.ctlDraft,s=`light.sf_${t}_light`;if("bri"in e){const t=Number(e.bri);t>0?this.hass?.callService("light","turn_on",{entity_id:s,brightness_pct:t}):this.hass?.callService("light","turn_off",{entity_id:s})}"mode"in e&&this.hass?.callService("select","select_option",{entity_id:`select.sf_${t}_mode`,option:e.mode});for(const t of Object.keys(e))t.includes(".")&&(t.startsWith("number.")?this.hass?.callService("number","set_value",{entity_id:t,value:Number(e[t])}):t.startsWith("text.")&&this.hass?.callService("text","set_value",{entity_id:t,value:e[t]}));if("power"in e){const t="on"===e.power;t&&"bri"in e||this.hass?.callService("light",t?"turn_on":"turn_off",{entity_id:s})}this.draft&&this.saveSchedule(t),this.ctlDraft={}}discardAll(){Object.keys(this.ctlDraft).length&&(this.ctlDraft={}),null!==this.draft&&(this.draft=null)}render(){if(!this.hass||!this.config)return q;const t=this.seSlot(),e=this.get(`light.sf_${t}_light`);if(!e)return V`<ha-card>
      ...
      </ha-card>`;const s="on"===e.state,i=s?Math.max(0,Math.min(100,Math.round((e.attributes.brightness??0)/255*100))):0,o=this.get(`select.sf_${t}_mode`),a=this.cur("mode",o?.state??""),r="bri"in this.ctlDraft,n="on"===this.cur("power",s?"on":"off"),l=r?Number(this.ctlDraft.bri):n?i:0,c=r?l>0:n,d=Ct(this.hass,t),h=this.accent(),p=l/100,[u,f]=_t(100,100,78,135+270*p);return V`
      <ha-card>
        <div class="header">
        ...
        <div class="gauge">
          <svg viewBox="0 0 200 190" aria-hidden="true">
            ...
            ${c?U`<circle cx=${u.toFixed(2)} cy=${f.toFixed(2)} r="10"
  ...
  `,t([ut({attribute:!1})],Xt.prototype,"hass",void 0),t([ft()],Xt.prototype,"config",void 0),t([ft()],Xt.prototype,"draft",void 0),t([ft()],Xt.prototype,"ctlDraft",void 0);const Zt={SE4500:{name:"SE4500",watts:320,isBar:!0,barCount:3,lW:1.163,lL:.369,ppfd:{8:{c:1800,a:1350,e:900},10:{c:1500,a:1150,e:780},12:{c:1250,a:960,e:650},14:{c:1060,a:820,e:545},16:{c:910,a:700,e:465},18:{c:790,a:610,e:400},20:{c:690,a:530,e:350},22:{c:610,a:470,e:305},24:{c:545,a:420,e:270},26:{c:490,a:375,e:240},28:{c:440,a:340,e:215},30:{c:400,a:305,e:195},32:{c:360,a:275,e:175},36:{c:300,a:230,e:145},42:{c:240,a:184,e:115},48:{c:195,a:149,e:93},60:{c:150,a:115,e:72},72:{c:118,a:90,e:56},84:{c:95,a:72,e:45}}},SF2000:{name:"SF2000",watts:200,isBar:!1,barCount:0,lW:.864,lL:.432,ppfd:{8:{c:1600,a:1050,e:480},10:{c:1320,a:870,e:400},12:{c:1100,a:720,e:330},14:{c:920,a:600,e:275},16:{c:780,a:505,e:230},18:{c:660,a:430,e:193},20:{c:570,a:370,e:165},22:{c:495,a:320,e:143},24:{c:435,a:280,e:125},26:{c:385,a:248,e:110},28:{c:340,a:218,e:97},30:{c:305,a:196,e:87},32:{c:274,a:176,e:78},36:{c:226,a:145,e:64},42:{c:182,a:116,e:51},48:{c:148,a:95,e:42},60:{c:97,a:62,e:27},72:{c:68,a:43,e:19},84:{c:49,a:31,e:14}}},SE5000:{name:"SE5000",watts:480,isBar:!0,barCount:4,lW:.855,lL:.85,ppfd:{8:{c:1561,a:1101,e:597},10:{c:1478,a:1041,e:631},12:{c:1402,a:986,e:661},14:{c:1332,a:935,e:686},16:{c:1267,a:889,e:708},18:{c:1206,a:845,e:727},20:{c:1150,a:805,e:744},22:{c:1098,a:767,e:752},24:{c:1049,a:732,e:718},26:{c:1003,a:700,e:686},28:{c:960,a:669,e:656},30:{c:920,a:640,e:628},32:{c:883,a:614,e:601},36:{c:814,a:565,e:554},42:{c:725,a:502,e:492},48:{c:650,a:449,e:440},60:{c:531,a:366,e:358},72:{c:442,a:303,e:297},84:{c:373,a:256,e:251}}},SF7000:{name:"SF7000",watts:650,isBar:!1,barCount:0,lW:.737,lL:.558,ppfd:{8:{c:2560,a:1105,e:314},10:{c:2298,a:1052,e:359},12:{c:2053,a:983,e:394},14:{c:1881,a:955,e:434},16:{c:1714,a:912,e:465},18:{c:1597,a:903,e:506},20:{c:1441,a:833,e:520},22:{c:1328,a:798,e:543},24:{c:1218,a:752,e:556},26:{c:1138,a:734,e:582},28:{c:1059,a:704,e:598},30:{c:987,a:677,e:613},32:{c:922,a:651,e:626},36:{c:811,a:603,e:591},42:{c:678,a:541,e:530},48:{c:575,a:488,e:478},60:{c:429,a:403,e:395},72:{c:332,a:332,e:325},84:{c:265,a:265,e:259}}},G1000W:{name:"G1000W",watts:1e3,isBar:!0,barCount:8,lW:1.153,lL:1.122,ppfd:{8:{c:2156,a:1822,e:1555},10:{c:2068,a:1769,e:1527},12:{c:1985,a:1720,e:1501},14:{c:1908,a:1672,e:1476},16:{c:1834,a:1626,e:1451},18:{c:1765,a:1582,e:1427},20:{c:1700,a:1540,e:1404},22:{c:1638,a:1499,e:1382},24:{c:1580,a:1460,e:1360},26:{c:1524,a:1422,e:1339},28:{c:1472,a:1386,e:1319},30:{c:1422,a:1352,e:1299},32:{c:1375,a:1318,e:1280},36:{c:1287,a:1255,e:1230},42:{c:1170,a:1168,e:1145},48:{c:1068,a:1068,e:1047},60:{c:901,a:901,e:883},72:{c:770,a:770,e:755},84:{c:666,a:666,e:653}}}};function Qt(t,e,s){const i=t.ppfd,o=Object.keys(i).map(Number).sort((t,e)=>t-e);let a=o[0],r=o[o.length-1];for(let t=0;t<o.length-1;t++)if(e>=o[t]&&e<=o[t+1]){a=o[t],r=o[t+1];break}e<=o[0]&&(a=r=o[0]),e>=o[o.length-1]&&(a=r=o[o.length-1]);const n=a===r?0:(e-a)/(r-a),l=(t,e)=>Math.round((t+(e-t)*n)*s/100);return{center:l(i[a].c,i[r].c),avg:l(i[a].a,i[r].a),edge:l(i[a].e,i[r].e)}}function te(t,e){const s=Math.max(0,Math.min(1,t/e));let i,o,a;if(s<.2){const t=s/.2;i=0,o=Math.round(80*t),a=Math.round(160+95*t)}else if(s<.4){const t=(s-.2)/.2;i=0,o=Math.round(80+175*t),a=Math.round(255-255*t)}else if(s<.6){const t=(s-.4)/.2;i=Math.round(220*t),o=255,a=0}else if(s<.8){const t=(s-.6)/.2;i=Math.round(220+35*t),o=Math.round(255-120*t),a=0}else{const t=(s-.8)/.2;i=255,o=Math.round(135-135*t),a=0}return[i,o,a]}class ee extends ct{constructor(){super(...arguments),this.tab="view",this.rev=0,this.s={tW:.61,tL:1.22,tH:1.981,model:"SE4500",hin:18,plantIn:12,numPlants:2,dim:100,photo:18,metric:!1},this.manualDim=100,this.auto=!1,this.brightSrc="",this.T=null,this.scene=null,this.camera=null,this.renderer=null,this.raf=0,this.o={},this.cam={theta:.52,phi:.36,r:3.8,drag:!1,px:0,py:0},this.dirty=!0,this.needRender=!0,this.fitDone=!1,this.serverSynced=!1,this.localApplied=!1,this.saveT=null,this.saved=null}setConfig(t){this.config=t;const e=t.defaults||{},s=t.tent||{};this.s.model=t.light_model&&Zt[t.light_model]?t.light_model:"SE4500",this.s.hin=e.height_inches??18,this.s.plantIn=e.plant_height_inches??12,this.s.numPlants=e.num_plants??2,this.s.dim=e.dimmer_percent??100,this.manualDim=this.s.dim,this.s.photo=e.photoperiod_hours??18,this.s.tW=Math.max(.3,.3048*(s.width_ft??2)),this.s.tL=Math.max(.6,.3048*(s.length_ft??4)),this.s.tH=Math.max(.9,.3048*(s.height_ft??6.5)),this.s.metric=this.resolveMetric(),this.serverSynced=!1,this.localApplied=!1,this.dirty=!0,this.fitDone=!1,this.saved=this.blob()}getCardSize(){return 11}static getStubConfig(t){let e;if(t){const s=Object.keys(t.states).filter(t=>/^sensor\.sf_[a-z0-9]+_alarm_settings$/.test(t)).sort(),i=s[0]&&/^sensor\.sf_([a-z0-9]+)_alarm_settings$/.exec(s[0]);i&&(e=i[1])}return{type:"custom:ppfd-3d-card",title:"PPFD Visualizer",light_model:"SE4500",unit_system:"auto",...e?{panel:e}:{},defaults:{height_inches:18,plant_height_inches:12,num_plants:2,dimmer_percent:100,photoperiod_hours:18},tent:{width_ft:2,length_ft:4,height_ft:6.5}}}resolveMetric(){const t=(this.config?.unit_system||"auto").toLowerCase();if("metric"===t)return!0;if("imperial"===t)return!1;const e=this.hass?.config?.unit_system;return!(!e||!e.length)&&"mi"!==e.length}fmtSmall(t){return this.s.metric?`${Math.round(2.54*t)} cm`:`${Math.round(t)}"`}fmtTentDim(t){return this.s.metric?(.3048*t).toFixed(2):(+t).toFixed(1)}tentUnit(){return this.s.metric?"m":"ft"}optKey(){const t=this.config||{};return"ppfd:"+(t.card_id||t.light_model||"main")}panelSlot(){if(this.config?.panel)return this.config.panel;if(this.hass){const t=Object.keys(this.hass.states).filter(t=>/^sensor\.sf_[a-z0-9]+_alarm_settings$/.test(t)).sort();if(t.length){const e=/^sensor\.sf_([a-z0-9]+)_alarm_settings$/.exec(t[0]);if(e)return e[1]}}return null}alarmEntity(){const t=this.panelSlot();if(!t||!this.hass)return null;const e=`sensor.sf_${t}_alarm_settings`;return this.hass.states[e]?e:null}lsKey(){return`ppfd3d:${this.panelSlot()||"nopanel"}:${this.optKey()}`}blob(){return{model:this.s.model,hin:this.s.hin,plantIn:this.s.plantIn,numPlants:this.s.numPlants,photo:this.s.photo,dim:this.manualDim,tW:this.s.tW,tL:this.s.tL,tH:this.s.tH,auto:!!this.auto,src:this.brightSrc||""}}applyBlob(t){t&&(t.model&&Zt[t.model]&&(this.s.model=t.model),null!=t.hin&&(this.s.hin=t.hin),null!=t.plantIn&&(this.s.plantIn=t.plantIn),null!=t.numPlants&&(this.s.numPlants=t.numPlants),null!=t.photo&&(this.s.photo=t.photo),null!=t.dim&&(this.manualDim=t.dim,this.s.dim=t.dim),null!=t.tW&&(this.s.tW=t.tW),null!=t.tL&&(this.s.tL=t.tL),null!=t.tH&&(this.s.tH=t.tH),this.auto=!!t.auto,this.brightSrc=t.src||"")}hydrateLocal(){if(!this.localApplied){this.localApplied=!0;try{const t=localStorage.getItem(this.lsKey());t&&(this.applyBlob(JSON.parse(t)),this.dirty=!0)}catch{}this.saved=this.blob()}}adoptServer(){if(this.serverSynced)return;const t=this.alarmEntity();if(!t)return;this.serverSynced=!0;const e=this.hass.states[t].attributes.card_options,s=this.optKey();if(e&&void 0!==e[s])try{this.applyBlob(JSON.parse(e[s])),this.dirty=!0}catch{}this.saved=this.blob()}queueSaveView(){clearTimeout(this.saveT),this.saveT=setTimeout(()=>this.saveView(),700)}saveView(){const t=this.blob();if(this.saved)for(const e of ee.SET_FIELDS)t[e]=this.saved[e];this.persistBlob(t),this.saved=t}applySettings(){const t=this.blob();this.persistBlob(t),this.saved=t,this.repaint()}discardSettings(){this.saved&&(this.auto=!!this.saved.auto,this.brightSrc=this.saved.src||"",this.s.numPlants=this.saved.numPlants,this.s.tW=this.saved.tW,this.s.tL=this.saved.tL,this.s.tH=this.saved.tH,this.auto?this.readLive():this.s.dim=this.manualDim,this.dirty=!0,this.repaint())}settingsDirty(){const t=this.saved;return!!t&&(!!this.auto!=!!t.auto||(this.brightSrc||"")!==(t.src||"")||this.s.numPlants!==t.numPlants||this.s.tW!==t.tW||this.s.tL!==t.tL||this.s.tH!==t.tH)}persistBlob(t){const e=JSON.stringify(t),s=this.alarmEntity();s&&this.hass?.callService&&this.hass.callService("sf","set_card_option",{entity_id:s,key:this.optKey(),value:e});try{localStorage.setItem(this.lsKey(),e)}catch{try{const t=this.lsKey();for(const e of Object.keys(localStorage))e.startsWith("ppfd3d:")&&e!==t&&localStorage.removeItem(e);localStorage.setItem(t,e)}catch{}}}brightnessOf(t){if(!t)return 0;if(String(t.entity_id).startsWith("light.")){if("on"!==t.state)return 0;const e=t.attributes&&t.attributes.brightness;return null!=e?Math.round(e/255*100):100}const e=parseFloat(t.state);return isNaN(e)?0:Math.max(0,Math.min(100,Math.round(e)))}readLive(){if(!this.hass)return!1;let t=!1;const e=this.config?.entities||{};if(e.dimmer_percent){const s=this.hass.states[e.dimmer_percent];if(s){const e=parseFloat(s.state);if(!isNaN(e)){const s=Math.max(10,Math.min(100,e));s===this.s.dim||this.auto||(this.s.dim=s,this.manualDim=s,t=!0)}}}if(e.height_inches){const s=this.hass.states[e.height_inches];if(s){const e=parseFloat(s.state);if(!isNaN(e)){const s=Math.max(8,e);s!==this.s.hin&&(this.s.hin=s,t=!0)}}}if(this.auto&&this.brightSrc){const e=this.brightnessOf(this.hass.states[this.brightSrc]);e!==this.s.dim&&(this.s.dim=e,t=!0)}return t}willUpdate(t){if(t.has("config")&&this.hydrateLocal(),t.has("hass")&&this.hass){const t=this.resolveMetric();t!==this.s.metric&&(this.s.metric=t,this.dirty=!0),this.hydrateLocal(),this.adoptServer(),this.readLive()&&(this.dirty=!0)}}firstUpdated(){this.loadThree()}updated(){this.dirty&&(this.needRender=!0)}repaint(){this.rev++}tentInches(){return Math.round(this.s.tH/.0254)}onModel(t){this.s.model=t.target.value,this.dirty=!0,this.repaint(),this.queueSaveView()}onSlider(t,e){const s=Number(e.target.value),i=this.tentInches();"hin"===t?this.s.hin=Math.min(s,i):"plantIn"===t?this.s.plantIn=Math.min(s,i):"numPlants"===t?this.s.numPlants=isNaN(s)?1:Math.max(1,Math.min(12,Math.round(s))):"photo"===t?this.s.photo=s:"dim"===t&&(this.auto||(this.s.dim=s,this.manualDim=s)),this.dirty=!0,this.repaint(),"numPlants"!==t&&this.queueSaveView()}onTent(t,e){const s=Number(e.target.value),i=this.s.metric?1:.3048,o=isNaN(s)?this.s[t]:s*i;"tW"===t?this.s.tW=Math.max(.3,o):"tL"===t?this.s.tL=Math.max(.6,o):this.s.tH=Math.max(.9,o);const a=this.tentInches();this.s.hin>a&&(this.s.hin=a),this.s.plantIn>a&&(this.s.plantIn=a),this.dirty=!0,this.repaint()}onAuto(t){if(this.auto=t.target.checked,this.auto){if(!this.brightSrc){const t=this.brightOptions();t.length&&(this.brightSrc=t[0].id)}this.readLive()}else this.s.dim=this.manualDim;this.dirty=!0,this.repaint()}onBrightSrc(t){this.brightSrc=t.target.value,this.auto&&this.readLive(),this.dirty=!0,this.repaint()}brightOptions(){if(!this.hass)return[];return Object.keys(this.hass.states).filter(t=>!!t.startsWith("light.sf_")||!(!t.startsWith("number.sf_")||!/schedule_brightness/i.test(t))).sort().map(t=>({id:t,name:this.hass.states[t].attributes.friendly_name||t}))}loadThree(){if(window.THREE)return void this.initThree();const t=window;if(!t._ppfdCBs){t._ppfdCBs=[];const e=document.createElement("script");e.src="https://cdnjs.cloudflare.com/ajax/libs/three.js/r128/three.min.js",e.onload=()=>t._ppfdCBs.forEach(t=>t()),document.head.appendChild(e)}t._ppfdCBs.push(()=>this.initThree())}canvas(){return this.renderRoot.querySelector("#c")}initThree(){const t=this.T=window.THREE,e=this.canvas();if(!t||!e)return;const s=e.parentElement?.offsetWidth||400;e.style.height="340px";const i=this.scene=new t.Scene;i.background=new t.Color(592914),this.camera=new t.PerspectiveCamera(36,s/340,.01,40);const o=this.renderer=new t.WebGLRenderer({canvas:e,antialias:!0});o.setSize(s,340),o.setPixelRatio(Math.min(devicePixelRatio,2)),i.add(new t.AmbientLight(3359829,1.1));const a=new t.DirectionalLight(16777215,.55);a.position.set(2,5,3),i.add(a),this.attachCam(e),this.dirty=!0,this.needRender=!0;const r=()=>{this.raf=requestAnimationFrame(r),this.dirty&&(this.dirty=!1,this.rebuild(),this.needRender=!0),this.needRender&&(this.needRender=!1,this.updCam(),o.render(i,this.camera))};r()}attachCam(t){t.addEventListener("mousedown",t=>{this.cam.drag=!0,this.cam.px=t.clientX,this.cam.py=t.clientY}),window.addEventListener("mouseup",()=>{this.cam.drag=!1}),window.addEventListener("mousemove",t=>{this.cam.drag&&(this.cam.theta-=.007*(t.clientX-this.cam.px),this.cam.phi=Math.max(.05,Math.min(1.3,this.cam.phi-.005*(t.clientY-this.cam.py))),this.cam.px=t.clientX,this.cam.py=t.clientY,this.needRender=!0)}),t.addEventListener("wheel",t=>{this.cam.r=Math.max(1.2,Math.min(10,this.cam.r+.005*t.deltaY)),this.needRender=!0},{passive:!0});let e=null;t.addEventListener("touchstart",t=>{1===t.touches.length&&(e={x:t.touches[0].clientX,y:t.touches[0].clientY,t:this.cam.theta,p:this.cam.phi})}),t.addEventListener("touchmove",t=>{e&&1===t.touches.length&&(this.cam.theta=e.t-.007*(t.touches[0].clientX-e.x),this.cam.phi=Math.max(.05,Math.min(1.3,e.p-.005*(t.touches[0].clientY-e.y))),this.needRender=!0)},{passive:!0})}updCam(){if(!this.camera)return;const{theta:t,phi:e,r:s}=this.cam,i=this.s.tH;this.camera.position.set(s*Math.cos(e)*Math.sin(t),s*Math.sin(e)+.38*i,s*Math.cos(e)*Math.cos(t)),this.camera.lookAt(0,.3*i,0)}rem(t){this.o[t]&&this.scene&&this.scene.remove(this.o[t]),this.o[t]=null}sprite(t,e){const s=this.T,i=document.createElement("canvas");i.width=128,i.height=64;const o=i.getContext("2d");return o.fillStyle="rgba(255,255,255,0.92)",o.font=`bold ${e}px sans-serif`,o.textAlign="center",o.textBaseline="middle",o.fillText(t,64,32),new s.Sprite(new s.SpriteMaterial({map:new s.CanvasTexture(i),transparent:!0,depthTest:!1}))}rebuild(){const t=this.T,e=this.scene;if(!t||!e)return;const{tW:s,tL:i,tH:o,model:a,hin:r,plantIn:n,numPlants:l,dim:c}=this.s,d=Zt[a]||Zt.SE4500,h=Math.max(1,r-n),p=Qt(d,h,c),u=.0254*n,f=.0254*r,m=s/2,g=i/2,v=s>i;this.rem("fr");const b=new t.Group,_=[[m,0,g],[m,0,-g],[-m,0,-g],[-m,0,g],[m,o,g],[m,o,-g],[-m,o,-g],[-m,o,g]],$=[];[[0,1],[1,2],[2,3],[3,0],[4,5],[5,6],[6,7],[7,4],[0,4],[1,5],[2,6],[3,7]].forEach(([t,e])=>$.push(..._[t],..._[e]));const x=new t.BufferGeometry;x.setAttribute("position",new t.Float32BufferAttribute($,3)),b.add(new t.LineSegments(x,new t.LineBasicMaterial({color:3822178})));const y=new t.Mesh(new t.BoxGeometry(s,o,i),new t.MeshStandardMaterial({color:12304282,side:t.BackSide,transparent:!0,opacity:.055,roughness:1}));y.position.set(0,o/2,0),b.add(y),e.add(b),this.o.fr=b,this.rem("ht");const w=new t.Group,S=Math.max(1.05*p.center,700),M=30,k=[],D=[],C=[],O=(v?d.lW:d.lL)/s,N=(v?d.lL:d.lW)/i,A=v?1:.7,T=v?.7:1;for(let t=0;t<=30;t++)for(let e=0;e<=M;e++){const o=e/M*s-m,a=t/30*i-g,r=2*(e/M-.5),n=2*(t/30-.5);let l;if(d.isBar){const t=Math.max(0,Math.abs(r)-.5*O)/(1-.5*O+.01),e=Math.max(0,Math.abs(n)-.5*N)/(1-.5*N+.01);l=p.edge+(p.center-p.edge)*Math.exp(-(t*t*3.8+e*e*9))}else{const t=Math.sqrt(r*r*A+n*n*T);l=p.edge+(p.center-p.edge)*Math.exp(-t*t*2.6)}l=Math.max(0,l),k.push(o,u+.004,a);const[c,h,f]=te(l,S);D.push(c/255,h/255,f/255)}for(let t=0;t<30;t++)for(let e=0;e<M;e++){const s=31*t+e;C.push(s,s+31,s+1,s+1,s+31,s+31+1)}const E=new t.BufferGeometry;E.setAttribute("position",new t.Float32BufferAttribute(k,3)),E.setAttribute("color",new t.Float32BufferAttribute(D,3)),E.setIndex(C),E.computeVertexNormals(),w.add(new t.Mesh(E,new t.MeshBasicMaterial({vertexColors:!0,side:t.DoubleSide,transparent:!0,opacity:.9}))),[[0,p.center],[.36*s,p.avg],[.36*-s,p.avg]].forEach(([t,e])=>{const s=this.sprite(Math.round(e)+"",22);s.position.set(t,u+.065,0),s.scale.set(.25,.12,1),w.add(s)}),e.add(w),this.o.ht=w,this.rem("li");const L=new t.Group,P=new t.MeshStandardMaterial({color:5926525,metalness:.55,roughness:.45});if(d.isBar){const e=d.barCount;for(let s=0;s<e;s++){const i=1===e?0:-d.lL/2+d.lL/(e-1)*s,o=new t.Mesh(new t.BoxGeometry(.026,.013,d.lW),P);o.position.set(i,f,0),L.add(o);const a=new t.Mesh(new t.BoxGeometry(.017,.004,.9*d.lW),new t.MeshBasicMaterial({color:16775392}));a.position.set(i,f-.006,0),L.add(a)}[-d.lW/2,d.lW/2].forEach(e=>{const s=new t.Mesh(new t.BoxGeometry(d.lL,.01,.016),new t.MeshStandardMaterial({color:4018012,metalness:.4}));s.position.set(0,f,e),L.add(s)})}else{const e=new t.Mesh(new t.BoxGeometry(d.lL,.02,d.lW),new t.MeshStandardMaterial({color:4873579,metalness:.4,roughness:.6}));e.position.set(0,f,0),L.add(e);const s=new t.MeshBasicMaterial({color:16775392});for(let e=0;e<4;e++)for(let i=0;i<8;i++){const o=new t.Mesh(new t.CircleGeometry(.013,8),s);o.rotation.x=-Math.PI/2,o.position.set(-d.lL/2+(i+.5)*(d.lL/8),f-.009,-d.lW/2+(e+.5)*(d.lW/4)),L.add(o)}}const z=Math.min(o-.02,f+.05);if(z>f+.04){const e=new t.LineBasicMaterial({color:8947848,transparent:!0,opacity:.5});[-d.lL/2+.04,d.lL/2-.04].forEach(s=>{const i=(new t.BufferGeometry).setFromPoints([new t.Vector3(s,z,0),new t.Vector3(s,f,0)]);L.add(new t.Line(i,e))})}const R=new t.PointLight(16772778,.8,2.2);if(R.position.set(0,f,0),L.add(R),L.rotation.y=v?Math.PI/2:0,e.add(L),this.o.li=L,this.rem("bm"),f>u+.01){const o=new t.Group,a=Math.min(.28,.07+p.center/6e3),r=new t.LineBasicMaterial({color:16768341,transparent:!0,opacity:a}),n=.38*d.lL,l=.38*d.lW;[[-n,-l],[n,-l],[n,l],[-n,l]].forEach(([e,a])=>{const n=Math.sign(e)*s/2*.88,l=Math.sign(a)*i/2*.88,c=(new t.BufferGeometry).setFromPoints([new t.Vector3(e,f,a),new t.Vector3(n,u+.005,l)]);o.add(new t.Line(c,r))});const c=(new t.BufferGeometry).setFromPoints([new t.Vector3(0,f+.005,0),new t.Vector3(0,u+.005,0)]);o.add(new t.Line(c,new t.LineBasicMaterial({color:16777215,transparent:!0,opacity:.2}))),o.rotation.y=v?Math.PI/2:0,e.add(o),this.o.bm=o}this.rem("pl");const F=new t.Group,I=.0254*n,B=Math.min(.25,.35*I+.08),H=new t.MeshStandardMaterial({color:1710618,roughness:.9}),W=new t.MeshStandardMaterial({color:4025128,roughness:.8}),j=new t.MeshStandardMaterial({color:3046686,roughness:.85,side:t.DoubleSide}),V=v?s:i,U=V/(l+1);for(let e=0;e<l;e++){const s=-V/2+U*(e+1),i=v?s:0,o=v?0:s,a=new t.Mesh(new t.CylinderGeometry(.06375,.075,B,12),H);a.position.set(i,B/2,o),F.add(a);const r=Math.max(.01,I-B);if(r>.015){const e=new t.Mesh(new t.CylinderGeometry(.011,.015,r,8),W);e.position.set(i,B+r/2,o),F.add(e);const s=Math.max(1,Math.floor(r/.09));for(let e=0;e<s;e++){const a=B+r*(.35+.55*e/Math.max(1,s-1)),n=Math.min(.11,.055+.16*r);for(let s=0;s<3;s++){const r=s*(2*Math.PI/3)+1.1*e,l=new t.Mesh(new t.SphereGeometry(n,6,4),j);l.scale.set(1,.2,.5),l.position.set(i+Math.cos(r)*n*.6,a,o+Math.sin(r)*n*.6),F.add(l)}}}}if(e.add(F),this.o.pl=F,this.rem("hl"),f>u+.01){const i=new t.Group,o=-s/2-.07,a=new t.LineDashedMaterial({color:16777215,transparent:!0,opacity:.45,dashSize:.04,gapSize:.03}),l=(new t.BufferGeometry).setFromPoints([new t.Vector3(o,f,0),new t.Vector3(o,u,0)]),c=new t.Line(l,a);c.computeLineDistances(),i.add(c);const d=this.sprite(this.fmtSmall(r-n),28);d.position.set(o-.11,(f+u)/2,0),d.scale.set(.24,.12,1),i.add(d);const h=new t.MeshBasicMaterial({color:16777215,transparent:!0,opacity:.5}),p=new t.Mesh(new t.ConeGeometry(.013,.035,8),h);p.position.set(o,f-.02,0),i.add(p);const m=new t.Mesh(new t.ConeGeometry(.013,.035,8),h);m.rotation.z=Math.PI,m.position.set(o,u+.02,0),i.add(m),e.add(i),this.o.hl=i}this.fitDone||(this.fitDone=!0,this.cam.r=this.fitDistance()),this.updCam()}fitDistance(){return Math.min(10,Math.max(4.2,2+1.8*Math.max(this.s.tW,this.s.tL,this.s.tH)))}disconnectedCallback(){if(super.disconnectedCallback(),this.raf&&cancelAnimationFrame(this.raf),this.renderer)try{this.renderer.dispose()}catch{}}render(){if(!this.config)return q;const t=this.s,e=Zt[t.model]||Zt.SE4500,s=Math.max(1,t.hin-t.plantIn),i=Qt(e,s,t.dim),o=(i.avg*t.photo*3600/1e6).toFixed(1),a=(r=i.avg)<200?{label:"Too dim",color:"#4488dd"}:r<400?{label:"Seedling / early veg",color:"#22bbaa"}:r<600?{label:"Vegetative growth",color:"#44bb44"}:r<800?{label:"Transition / early flower",color:"#bbaa22"}:r<1e3?{label:"Peak flower zone",color:"#ee8800"}:{label:"High intensity — watch heat",color:"#dd2222"};var r;const n=this.tentInches(),l=this.tentUnit(),c=this.config.title||"PPFD visualizer",d=this.brightOptions();return V`
    ...
    `}}ee.SET_FIELDS=["auto","src","numPlants","tW","tL","tH"],ee.styles=r`
    :host { display: block; }
