/*! spider-farmer-card v0.21.8 | MIT */
...
`;function wt(t){const e=new Set;for(const s of Object.keys(t.states)){const t=bt(s).match(vt);t&&e.add(t[1])}return[...e].sort()}function St(t){return wt(t).filter(e=>e.startsWith("st")&&!!t.states[`switch.sf_${e}_outlet_1`]||Object.keys(t.states).some(t=>{const s=bt(t);return s===`sf_${e}_temperature`||s===`sf_${e}_soil_avg_temperature`||s===`sf_${e}_light_1`||s===`sf_${e}_fan`||s===`sf_${e}_blower`}))}function kt(t){return wt(t).filter(e=>!!t.states[`switch.sf_${e}_outlet_1`])}function Ct(t,e){const s=`sf_${e}_`,i=Object.keys(t.states);return i.find(t=>bt(t)===`sf_${e}_temperature`)??i.find(t=>{const i=bt(t);return i.startsWith(s)&&!i.startsWith(`sf_${e}_env_`)})}function Ot(t,e){const s=Ct(t,e);return s?t.entities?.[s]?.device_id:void 0}function Dt(t,e){if(!e)return[];const s=Ot(t,e);return s?kt(t).filter(i=>{if(i===e)return!1;const o=Ot(t,i),a=o?t.devices?.[o]:void 0;return a?.via_device_id===s}):[]}function Mt(t,e){if(!t||!e)return"";const s=Ct(t,e);if(!s)return"";const i=t.entities?.[s]?.device_id,o=i?t.devices?.[i]:void 0;if(o)return o.name_by_user||o.name||"";const a=(t.states[s].attributes.friendly_name||"").match(/^(SF .+? [0-9A-Fa-f]{4})\b/);return a?a[1]:""}const Tt=[["temperature","Air Temp","mdi:thermometer"],["humidity","Air Humi","mdi:water-percent"],["vpd","Air VPD","mdi:water-opacity"],["leaf_vpd","Leaf VPD","mdi:leaf"],["co2","CO2","mdi:molecule-co2"],["ppfd","PPFD","mdi:white-balance-sunny"],["soil_avg_temperature","Soil Temp","mdi:thermometer"],["soil_avg_moisture","Moisture","mdi:water"],["soil_avg_ec","Soil EC","mdi:flash"]],Nt={temperature:"temp",humidity:"humi",vpd:"vpd",co2:"co2",ppfd:"ppfd",soil_avg_temperature:"tempSoil",soil_avg_moisture:"humiSoil",soil_avg_ec:"ECSoil"},Lt={temperature:"temp",humidity:"humi",co2:"co2"},At="#ff6b6b",Pt="rgba(255,107,107,0.16)",Rt=(t,e=.16)=>{const s=/^#?([0-9a-fA-F]{6})$/.exec((t||"").trim());if(!s)return`rgba(255,107,107,${e})`;const i=parseInt(s[1],16);return`rgba(${i>>16&255},${i>>8&255},${255&i},${e})`},Et=t=>"string"==typeof t&&/^#[0-9a-fA-F]{6}$/.test(t),zt=t=>"alarms"===t||"targets"===t||"both"===t,Ft=ft,It={"Time Slot":["ts_type","ts_start","ts_stop"],Cycle:["cycle_start","cycle_run","cycle_off","cycle_times"],Temperature:["temp_device"],Humidity:["humidity_device"],CO2:["co2_device"],"Drip Irrigation":["drip_soil","drip_avg"],Manual:[]},Bt=ft,Ht=t=>!!t&&("unavailable"===t.state||"unknown"===t.state),Vt=t=>{const e=(t||"").match(/^(\d{1,2}):(\d{2})$/);if(!e)return null;const s=+e[1],i=+e[2];return s<=23&&i<=59?60*s+i:null},Wt=(t,e,s,i,o="",a=!1)=>q`<div class="save-bar ${o}">
  ...
  <button class="discard-btn" ?disabled=${!e||o}
    @click=${i}>Discard</button>`)(t,e,s,i,a)}
      ...
      <div class="pg-stats">
        ...
        ${p?q`<span>band <b>${h(p.bandLo)}–${h(p.bandHi)}</b> ${i}</span>`:U}
      </div>
      <div class="pg-plot">
        <div class="pg-yax"><span>${h(_)}</span><span>${h(x)}</span></div>
      ...
      <div class="tile ${m?"clickable":""} ${d||p?"active":""}"
        ...
        <div class="tile-val" style=${f||U}>${r}${a||n?U:q`<span class="unit">${o}</span>`}</div>
      ...
      <div class="soil-pop">
        ...
        ${e.map(({name:e,e:s})=>{const i=Ht(s),o=s.attributes.unit_of_measurement||"",a=this.hass?.formatEntityState?this.hass.formatEntityState(s).replace(o,"").trim():s.state,n="temperature"===t?"tempSoil":"moisture"===t?"humiSoil":"ECSoil",r=i?null:this.readingColor(n,s.state);return q`
      ...
      <div class="params-head">
        ...
        ${s}
      </div>`}renderOverview(){const t=Tt.map(t=>this.renderParam(t)).filter(t=>t!==U),e=this.soilStatsTile(),s=this.overviewDevices();return q`
    ...
    </div>`}liveModeRow(t,e){const s=this.get(e);if(!s)return U;const i=s.attributes.options??[],o=this.modeOf(e,s.state);return q`<div class="dev-row ${e in this.draft?"staged":""}">
      <span class="dev-lbl">${t}</span>
      <div class="ctl-input">
      ...
      ${Ut.map(([t,s,i,o,a])=>this.get(`number.sf_${e}_${s}`)?q`
          <div class="env-row">
      ...
      @click=${()=>o("mode",t)}>${t}</button>`,l="PPFD"===i.mode,c=l?"ppfd_start":"ts_start",d=l?"ppfd_stop":"ts_stop",h=this.durText(i[c],i[d]),p=this.numOpts(11,100,1,t=>`${t}%`),u=this.numOpts(20,2e3,10,t=>`${t} µmol`),g=this.offOpts(1,60,1,t=>`${t} min`),f=(t,e)=>q`<label class="pe-cell">
      <span>${t}</span>${e}</label>`,m=t=>q`<div class="pe-cellrow">${t}</div>`,v=f("Go dark",n("go_dark",this.threshOpts())),b=f("Turn off",n("turn_off",this.threshOpts()));return q`
      <div class="pe-light">
      ...
      </div>`:U}renderLeafVpdTargets(){const t=this.get(this.eid("number","leaf_vpd_min")),e=this.get(this.eid("number","leaf_vpd_max"));if(!t||!e)return U;const s=(t,e)=>{const s=this.eid("number",t);return q`
      ...
      `)}
      <div class="olog-axis"><span>${this.ologRange>=168?"7d ago":"24h ago"}</span><span>now</span></div>`}renderDeviceLog(){const t=this.overviewDevices();if(!t.length)return q`<div class="set-note">No devices on this controller.</div>`;const e=this.accent(),s=(t,s)=>q`<button class="olog-rb ${this.ologRange===t?"on":""}"
      ...
      ${o.length?q`
            ...
            </div>`:q`<div class="cali-empty">No log entries on this date.</div>`}`}render(){if(!this.hass||!this.config)return U;const t=this.hasOutlets();let e=this.tab;"outlets"!==e||t||(e="overview"),"olog"!==e||t&&this.showOutletsLog||(e="overview"),"vpd"!==e||this.showVpd||(e="overview"),"dlog"!==e||this.showDeviceLog&&this.overviewDevices().length>0||(e="overview");const s=this.accent(),i=(t,i)=>q`<button class="tab ${e===t?"active":""}"
        style=${e===t?`color:${s};border-color:${s}`:""}
        @click=${()=>this.tab=t}>${i}</button>`,o=Mt(this.hass,this.config.panel);return q`
      <ha-card style=${this.layoutStyle()||U}>
        <div class="header">
          <span class="title">${this.config.title||"Spider Farmer"}</span>
          ${o?q`<span class="device">${o}</span>`:U}
          ${this.renderConn()}
        </div>
        ${q`<div class="tabs">
              ${i("overview","Overview")}
      ...
      <div class="seg-row">
        ${Q("alarms","Alarms","mdi:bell-outline")}
        ${Q("targets","Targets","mdi:target")}
        ${Q("both","Both","mdi:set-center")}
      </div>
      ...
      <div class="seg-row">
        ${V(s,"off","No color","mdi:circle-off-outline",()=>H({mode:"off"}))}
        ${V(s,"tile","Tile color","mdi:square-rounded",()=>H({mode:"tile"}))}
        ${V(s,"text","Text color","mdi:format-color-text",()=>H({mode:"text"}))}
      </div>
      <div class="color-row">
        ${j("Above max",o,t=>H({hi:t}))}
        ${j("Below min",a,t=>H({lo:t}))}
        ${j("Near edge",r,t=>H({warn:t}))}
      </div>
      ...
      <div class="seg-row">
        ${V(i,"off","No color","mdi:circle-off-outline",()=>H({modeIn:"off"}))}
        ${V(i,"tile","Tile color","mdi:square-rounded",()=>H({modeIn:"tile"}))}
        ${V(i,"text","Text color","mdi:format-color-text",()=>H({modeIn:"text"}))}
      </div>
      <div class="color-row">
        ${j("In range",n,t=>H({in:t}))}
      </div>
      ...
      ${P?q`
            ...
            <div class="set-note">
              ...
              <span style="color:${L}">Environment</span>,
              <span style="color:${A}">Drip</span>. Off outlets stay neutral.
            </div>
            <div class="seg-row">
              ${V(M,"off","No color","mdi:circle-off-outline",()=>H({omode:"off"}))}
              ${V(M,"tile","Tile color","mdi:square-rounded",()=>H({omode:"tile"}))}
              ${V(M,"text","Text color","mdi:format-color-text",()=>H({omode:"text"}))}
            </div>
            <div class="color-row">
              ${j("Manual",T,t=>H({ocManual:t}))}
              ${j("Scheduled",N,t=>H({ocSched:t}))}
            </div>
            <div class="color-row">
              ${j("Environment",L,t=>H({ocEnv:t}))}
              ${j("Drip",A,t=>H({ocDrip:t}))}
            </div>`:U}
      ...
      ${I?q`
            ...
            <div class="set-note">
              ...
              <span style="color:${E}">Manual</span>,
              <span style="color:${z}">Scheduled</span>,
              <span style="color:${F}">Auto</span> (Environment / PPFD). A
              <span style="color:${At}">fault</span> always overrides.
            </div>
            <div class="seg-row">
              ${V(R,"off","No color","mdi:circle-off-outline",()=>H({dmode:"off"}))}
              ${V(R,"tile","Tile color","mdi:square-rounded",()=>H({dmode:"tile"}))}
              ${V(R,"text","Text color","mdi:format-color-text",()=>H({dmode:"text"}))}
            </div>
            <div class="color-row">
              ${j("Manual",E,t=>H({dcManual:t}))}
              ${j("Scheduled",z,t=>H({dcSched:t}))}
              ${j("Auto",F,t=>H({dcAuto:t}))}
            </div>`:U}
        ...
        ${g?q`
          <div class="toggle-row" style="margin-top:6px">
            ...
            <select style="max-width:60%"
              @change=${t=>H({connSignal:t.target.value})}>
      ...
      <div class="toggle-row" style="margin-top:8px">
        ...
        <button class="toggle ${y?"on":""}"
          ...
          @click=${()=>H({showDeviceQuick:!y})}></button>
      </div>
      <div class="set-note">
      ...
      ${y?q`
        <div class="toggle-row" style="margin-top:6px">
          ...
          <button class="toggle ${w?"on":""}"
            ...
            @click=${()=>H({deviceQuickRemember:!w})}></button>
        </div>
        <div class="set-note">
      ...
      <div class="toggle-row" style="margin-top:8px">
        ...
        <button class="toggle ${v?"on":""}"
          ...
          @click=${()=>H({showOutletQuick:!v})}></button>
      </div>
      <div class="set-note">
      ...
      ${v?q`
        <div class="toggle-row" style="margin-top:6px">
          ...
          <button class="toggle ${b?"on":""}"
            ...
            @click=${()=>H({outletQuickRemember:!b})}></button>
        </div>
        <div class="set-note">
      ...
      ${k?q`
        ...
        <input type="range" min="70" max="150" step="5" .value=${String(C)}
          style="width:100%"
          @input=${t=>H({scale:Number(t.target.value)})} />
  ...
  `,t([ut({attribute:!1})],Kt.prototype,"hass",void 0),t([gt()],Kt.prototype,"_config",void 0);const Jt=/^sf_(se\d+)_light$/;function Yt(t){const e=new Set;for(const s of Object.keys(t.states)){if(!s.startsWith("light."))continue;const t=bt(s).match(Jt);t&&e.add(t[1])}return[...e].sort((t,e)=>Number(t.replace(/\D/g,""))-Number(e.replace(/\D/g,"")))}class Xt extends ct{constructor(){super(...arguments),this.draft=null,this.ctlDraft={}}setConfig(t){this.config=t}getCardSize(){return 7}static getStubConfig(t){const e=t?Yt(t):[];return{type:"custom:spider-light-card",...e[0]?{light:e[0]}:{}}}accent(){return this.config.accent||ft}seSlot(){return this.config.light||(this.hass?Yt(this.hass)[0]:"")||"se1"}get(t){return this.hass?.states[t]}shouldUpdate(t){return t.has("config")||t.has("hass")||t.has("draft")||t.has("ctlDraft")}cur(t,e){return t in this.ctlDraft?this.ctlDraft[t]:e}stageCtl(t,e){this.ctlDraft={...this.ctlDraft,[t]:e}}isDirty(){return Object.keys(this.ctlDraft).length>0||null!==this.draft}applyAll(t){const e=this.ctlDraft,s=`light.sf_${t}_light`;if("bri"in e){const t=Number(e.bri);t>0?this.hass?.callService("light","turn_on",{entity_id:s,brightness_pct:t}):this.hass?.callService("light","turn_off",{entity_id:s})}"mode"in e&&this.hass?.callService("select","select_option",{entity_id:`select.sf_${t}_mode`,option:e.mode});for(const t of Object.keys(e))t.includes(".")&&(t.startsWith("number.")?this.hass?.callService("number","set_value",{entity_id:t,value:Number(e[t])}):t.startsWith("text.")&&this.hass?.callService("text","set_value",{entity_id:t,value:e[t]}));if("power"in e){const t="on"===e.power;t&&"bri"in e||this.hass?.callService("light",t?"turn_on":"turn_off",{entity_id:s})}this.draft&&this.saveSchedule(t),this.ctlDraft={}}discardAll(){Object.keys(this.ctlDraft).length&&(this.ctlDraft={}),null!==this.draft&&(this.draft=null)}render(){if(!this.hass||!this.config)return U;const t=this.seSlot(),e=this.get(`light.sf_${t}_light`);if(!e)return q`<ha-card>
      ...
      </ha-card>`;const s="on"===e.state,i=s?Math.max(0,Math.min(100,Math.round((e.attributes.brightness??0)/255*100))):0,o=this.get(`select.sf_${t}_mode`),a=this.cur("mode",o?.state??""),n="bri"in this.ctlDraft,r="on"===this.cur("power",s?"on":"off"),l=n?Number(this.ctlDraft.bri):r?i:0,c=n?l>0:r,d=Mt(this.hass,t),h=this.accent(),p=l/100,[u,g]=xt(100,100,78,135+270*p);return q`
      <ha-card>
        <div class="header">
        ...
        <div class="gauge">
          <svg viewBox="0 0 200 190" aria-hidden="true">
            ...
            ${c&&p>0?Q`<path d=${_t(100,100,78,0,p)} fill="none"
